...
void c_gltext::build_fonts() {
    ...
    /* ~~ our rendering font ~~ */
    HFONT font =
        CreateFontA(-15, 0, 0, 0, FW_MEDIUM, FALSE, FALSE, FALSE, ANSI_CHARSET,
...
void c_gltext::print(float x, float y, const unsigned char color[3],
                     const char *format, ...) {
...
vec3_t c_gltext::centered_text(float x, float y, float width, float height,
