...
struct FStaticMeshLODElement {
    ...
    DWORD bEnableShadowCasting : 1;      // 0x0008 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    unsigned char UnknownData00[0x4];    // 0x000C (0x0004) MISSED OFFSET
    DWORD bEnableCollision : 1;          // 0x0010 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
};
...
struct FStaticMeshLODInfo {
    TArray<struct FStaticMeshLODElement>
        Elements;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FRigidBodyContactInfo {
    ...
    struct FVector
        ContactVelocity[0x2];  // 0x001C (0x0018) [0x0000000000000000]
    class UPhysicalMaterial*
        PhysMaterial[0x2];  // 0x0034 (0x0010) [0x0000000000000000]
};

// ScriptStruct Engine.Actor.CollisionImpactData
// 0x0028
struct FCollisionImpactData {
    TArray<struct FRigidBodyContactInfo>
        ContactInfos;  // 0x0000 (0x0010) [0x0000000000000000]
    struct FVector
        TotalNormalForceVector;  // 0x0010 (0x000C) [0x0000000000000000]
    struct FVector
        TotalFrictionForceVector;  // 0x001C (0x000C) [0x0000000000000000]
};
...
struct FSeqOpInputLink {
    ...
    DWORD
        bDisabledPIE : 1;  // 0x0018 (0x0004) [0x0000000000000000] [0x00000002]
...
struct FTraceHitInfo {
    ...
    class UPhysicalMaterial*
        PhysMaterial;       // 0x0008 (0x0008) [0x0000000000000000]
    ...
    class UPrimitiveComponent*
        HitComponent;  // 0x0020 (0x0008) [0x0000000000000000]
};
...
struct FLightingChannelContainer {
    DWORD
        bInitialized : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000001]
    ...
    DWORD CompositeDynamic : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                 // [0x00000010]
...
struct FRBCollisionChannelContainer {
    ...
    DWORD GameplayPhysics : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                // [0x00000020]
    DWORD
        EffectPhysics : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000040]
    ...
    DWORD FracturedMeshPart : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                  // [0x00004000]
    DWORD BlockingVolume : 1;     // 0x0000 (0x0004) [0x0000000000000000]
                                  // [0x00008000]
    DWORD DeadPawn : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00010000]
    DWORD Clothing : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00020000]
    DWORD ClothingCollision : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                  // [0x00040000]
    DWORD Pickup : 1;     // 0x0000 (0x0004) [0x0000000000000000] [0x00080000]
    DWORD FlexAsset : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00100000]
    DWORD CanBecomeDynamic : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                 // [0x00200000]
    DWORD KnockedDownPawn : 1;   // 0x0000 (0x0004) [0x0000000000000000]
                                 // [0x00400000]
...
struct FMaterialViewRelevance {
    ...
    DWORD
        bTranslucent : 1;   // 0x0000 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bDistortion : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD
        bOneLayerDistortionRelevance : 1;  // 0x0000 (0x0004)
                                           // [0x0000000000000000] [0x00000008]
    DWORD bLit : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000010]
    DWORD bUsesSceneColor : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                // [0x00000020]
};
...
struct FTextureGroupContainer {
    DWORD TEXTUREGROUP_World : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                   // [0x00000001]
    DWORD TEXTUREGROUP_WorldNormalMap : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000002]
    DWORD TEXTUREGROUP_WorldSpecular : 1;   // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000004]
    DWORD TEXTUREGROUP_Character : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                       // [0x00000008]
    DWORD TEXTUREGROUP_CharacterNormalMap : 1;  // 0x0000 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000010]
    DWORD TEXTUREGROUP_CharacterSpecular : 1;   // 0x0000 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000020]
    DWORD TEXTUREGROUP_Weapon : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                    // [0x00000040]
    DWORD
        TEXTUREGROUP_WeaponNormalMap : 1;   // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000080]
    DWORD TEXTUREGROUP_WeaponSpecular : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000100]
    DWORD TEXTUREGROUP_Vehicle : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000200]
    DWORD
        TEXTUREGROUP_VehicleNormalMap : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000400]
    DWORD
        TEXTUREGROUP_VehicleSpecular : 1;  // 0x0000 (0x0004)
                                           // [0x0000000000000000] [0x00000800]
    DWORD TEXTUREGROUP_Cinematic : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                       // [0x00001000]
    DWORD TEXTUREGROUP_Effects : 1;    // 0x0000 (0x0004) [0x0000000000000000]
                                       // [0x00002000]
    DWORD TEXTUREGROUP_EffectsNotFiltered : 1;  // 0x0000 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00004000]
    DWORD TEXTUREGROUP_Skybox : 1;    // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00008000]
    DWORD TEXTUREGROUP_UI : 1;        // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00010000]
    DWORD TEXTUREGROUP_Lightmap : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00020000]
    DWORD TEXTUREGROUP_RenderTarget : 1;  // 0x0000 (0x0004)
                                          // [0x0000000000000000] [0x00040000]
    DWORD
        TEXTUREGROUP_MobileFlattened : 1;  // 0x0000 (0x0004)
                                           // [0x0000000000000000] [0x00080000]
    DWORD TEXTUREGROUP_ProcBuilding_Face : 1;      // 0x0000 (0x0004)
                                                   // [0x0000000000000000]
                                                   // [0x00100000]
    DWORD TEXTUREGROUP_ProcBuilding_LightMap : 1;  // 0x0000 (0x0004)
                                                   // [0x0000000000000000]
                                                   // [0x00200000]
    DWORD TEXTUREGROUP_Shadowmap : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                       // [0x00400000]
    DWORD
        TEXTUREGROUP_ColorLookupTable : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00800000]
    DWORD TEXTUREGROUP_Terrain_Heightmap : 1;     // 0x0000 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x01000000]
    DWORD TEXTUREGROUP_Terrain_Weightmap : 1;     // 0x0000 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x02000000]
    DWORD TEXTUREGROUP_ImageBasedReflection : 1;  // 0x0000 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x04000000]
    DWORD TEXTUREGROUP_Bokeh : 1;     // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x08000000]
    DWORD TEXTUREGROUP_Creature : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x10000000]
    DWORD TEXTUREGROUP_CreatureNormalMap : 1;  // 0x0000 (0x0004)
                                               // [0x0000000000000000]
                                               // [0x20000000]
    DWORD
        TEXTUREGROUP_CreatureSpecular : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x40000000]
    DWORD TEXTUREGROUP_Weapon3rd : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                       // [0x80000000]
    DWORD TEXTUREGROUP_Weapon3rdNormalMap : 1;  // 0x0004 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000001]
    DWORD TEXTUREGROUP_Weapon3rdSpecular : 1;   // 0x0004 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000002]
    DWORD TEXTUREGROUP_Splattermap : 1;  // 0x0004 (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    DWORD TEXTUREGROUP_Cosmetic : 1;     // 0x0004 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
    DWORD TEXTUREGROUP_CosmeticNormalMap : 1;  // 0x0004 (0x0004)
                                               // [0x0000000000000000]
                                               // [0x00000010]
    DWORD
        TEXTUREGROUP_CosmeticSpecular : 1;  // 0x0004 (0x0004)
                                            // [0x0000000000000000] [0x00000020]
    DWORD TEXTUREGROUP_UIWithMips : 1;  // 0x0004 (0x0004) [0x0000000000000000]
                                        // [0x00000040]
};
...
struct FTexture2DMipMap {
    struct FUntypedBulkData_Mirror
        Data;   // 0x0000 (0x0040) [0x0000000000000000]
...
struct FPlayerResponseLine {
    ...
    TArray<struct FKeyValuePair>
        PlayerInfo;  // 0x0024 (0x0010) [0x0000000000000000]
};
...
struct FServerResponseLine {
    ...
    TArray<struct FKeyValuePair>
        ServerInfo;  // 0x0058 (0x0010) [0x0000000000000000]
    TArray<struct FPlayerResponseLine>
        PlayerInfo;  // 0x0068 (0x0010) [0x0000000000000000]
};
...
struct FNamedSession {
    ...
    class UOnlineGameSettings*
        GameSettings;  // 0x0010 (0x0008) [0x0000000000000000]
    TArray<struct FOnlineRegistrant>
        Registrants;  // 0x0018 (0x0010) [0x0000000000000000]
    TArray<struct FOnlineArbitrationRegistrant>
        ArbitrationRegistrants;  // 0x0028 (0x0010) [0x0000000000000000]
};
...
struct FExchangeRuleSets {
    TArray<struct FExchangeRule>
        Sources;         // 0x0000 (0x0010) [0x0000000000000000]
...
struct FSessionUpdateInfo {
    TArray<struct FSessionMemberInfo>
        MembersJoined;  // 0x0000 (0x0010) [0x0000000000000000]
    TArray<struct FSessionMemberInfo>
        MembersLeft;                    // 0x0010 (0x0010) [0x0000000000000000]
    DWORD bHostDeviceTokenChanged : 1;  // 0x0020 (0x0004) [0x0000000000000000]
                                        // [0x00000001]
    DWORD bInitializationStateChanged : 1;  // 0x0020 (0x0004)
                                            // [0x0000000000000000] [0x00000002]
    DWORD bMatchmakingStatusChanged : 1;    // 0x0020 (0x0004)
                                            // [0x0000000000000000] [0x00000004]
    DWORD bMemberJoinedOrLeft : 1;   // 0x0020 (0x0004) [0x0000000000000000]
                                     // [0x00000008]
    DWORD bMemberStatusChanged : 1;  // 0x0020 (0x0004) [0x0000000000000000]
                                     // [0x00000010]
    DWORD bSessionJoinabilityChanged : 1;  // 0x0020 (0x0004)
                                           // [0x0000000000000000] [0x00000020]
    DWORD bCustomPropertyChange : 1;  // 0x0020 (0x0004) [0x0000000000000000]
                                      // [0x00000040]
    DWORD bMemberCustomPropertyChange : 1;  // 0x0020 (0x0004)
                                            // [0x0000000000000000] [0x00000080]
};
...
struct FSocialPostImageFlags {
    DWORD bIsUserGeneratedImage : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00000001]
    DWORD bIsGameGeneratedImage : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00000002]
    DWORD bIsAchievementImage : 1;    // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00000004]
    DWORD
        bIsMediaImage : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000008]
};
...
struct FSocialPostPrivileges {
    DWORD
        bCanPostImage : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD
        bCanPostLink : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000002]
};
...
struct FOnlinePartyMember {
    ...
    DWORD bIsInPartyVoice : 1;  // 0x0020 (0x0004) [0x0000000000000000]
                                // [0x00000002]
    DWORD bIsTalking : 1;  // 0x0020 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bIsInGameSession : 1;    // 0x0020 (0x0004) [0x0000000000000000]
                                   // [0x00000008]
    DWORD bIsPlayingThisGame : 1;  // 0x0020 (0x0004) [0x0000000000000000]
                                   // [0x00000010]
...
struct FPermissionsResult {
    ...
    DWORD bHasPermission : 1;        // 0x0030 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
};
...
struct FMarketplaceInventoryItem {
    ...
    TArray<struct FString>
        ContainerIds;                  // 0x001C (0x0010) [0x0000000000000000]
...
struct FMarketplaceProductAvailability {
    TArray<struct FString>
        AcceptablePaymentInstrumentTypes;  // 0x0000 (0x0010)
                                           // [0x0000000000000000]
    ...
    DWORD bIsPurchasable : 1;         // 0x0084 (0x0004) [0x0000000000000000]
                                      // [0x00000001]
...
struct FMarketplaceProductDetails {
    ...
    DWORD bIsPartOfAnyBundle : 1;  // 0x0050 (0x0004) [0x0000000000000000]
                                   // [0x00000002]
    struct FString ReducedName;    // 0x0054 (0x0010) [0x0000000000000000]
    TArray<struct FMarketplaceProductImage>
        Images;                      // 0x0064 (0x0010) [0x0000000000000000]
    unsigned char DetailsReadState;  // 0x0074 (0x0001) [0x0000000000000000]
    TArray<struct FMarketplaceProductAvailability>
        Availabilities;                 // 0x0078 (0x0010) [0x0000000000000000]
...
struct FAchievementDetails {
    ...
    DWORD bWasAchievedOnline : 1;        // 0x0054 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    DWORD bWasAchievedOffline : 1;       // 0x0054 (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    ...
    TArray<struct FString>
        PlatformsAvailableOn;     // 0x008C (0x0010) [0x0000000000000000]
    unsigned char ProgressState;  // 0x009C (0x0001) [0x0000000000000000]
    TArray<struct FAchievementReward>
        Rewards;  // 0x00A0 (0x0010) [0x0000000000000000]
    TArray<struct FAchievementMediaAsset>
        MediaAssets;           // 0x00B0 (0x0010) [0x0000000000000000]
    struct FString ProductID;  // 0x00C0 (0x0010) [0x0000000000000000]
    struct FString
        ServiceConfigurationID;  // 0x00D0 (0x0010) [0x0000000000000000]
    TArray<struct FAchievementTitleAssociation>
        TitleAssociations;  // 0x00E0 (0x0010) [0x0000000000000000]
};
...
struct FOnlineFriendMessage {
    struct FUniqueNetId
        SendingPlayerId;               // 0x0000 (0x0008) [0x0000000000000000]
    struct FString SendingPlayerNick;  // 0x0008 (0x0010) [0x0000000000000000]
    DWORD bIsFriendInvite : 1;         // 0x0018 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD
        bIsGameInvite : 1;  // 0x0018 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD
        bWasAccepted : 1;  // 0x0018 (0x0004) [0x0000000000000000] [0x00000004]
...
struct FRemoteTalker {
    ...
    DWORD
        bIsRegistered : 1;  // 0x000C (0x0004) [0x0000000000000000] [0x00000004]
...
struct FLocalTalker {
    ...
    DWORD bHasNetworkedVoice : 1;    // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
    DWORD bIsRecognizingSpeech : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000004]
    ...
    DWORD
        bIsRegistered : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000020]
...
struct FOnlineContent {
    ...
    TArray<struct FString>
        ContentPackages;  // 0x0040 (0x0010) [0x0000000000000000]
    TArray<struct FString>
        ContentFiles;  // 0x0050 (0x0010) [0x0000000000000000]
};
...
struct FOnlineFriend {
    ...
    DWORD bIsPlayingThisGame : 1;  // 0x0034 (0x0004) [0x0000000000000000]
                                   // [0x00000004]
    DWORD bIsJoinable : 1;  // 0x0034 (0x0004) [0x0000000000000000] [0x00000008]
    DWORD bHasVoiceSupport : 1;  // 0x0034 (0x0004) [0x0000000000000000]
                                 // [0x00000010]
    DWORD
        bHaveInvited : 1;  // 0x0034 (0x0004) [0x0000000000000000] [0x00000020]
    DWORD bHasInvitedYou : 1;  // 0x0034 (0x0004) [0x0000000000000000]
                               // [0x00000040]
};
...
struct FOnlineProfile {
    ...
    struct FString
        ApplicationDisplayName;        // 0x0018 (0x0010) [0x0000000000000000]
    ...
    struct FString ApplicationDisplayPictureResizeURL;  // 0x0048 (0x0010)
                                                        // [0x0000000000000000]
    struct FString
        PublicGamerPictureURL;  // 0x0058 (0x0010) [0x0000000000000000]
    struct FString
        GameDisplayPictureResizeURL;  // 0x0068 (0x0010) [0x0000000000000000]
};
...
struct FTWPostProcessSettings {
    ...
    DWORD bOverride_Bloom_Intensity : 1;  // 0x004C (0x0004)
                                          // [0x0000000000000000] [0x00000001]
    float Bloom_Intensity;               // 0x0050 (0x0004) [0x0000000000000000]
    DWORD bOverride_Bloom_Width : 1;     // 0x0054 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    float Bloom_Width;                   // 0x0058 (0x0004) [0x0000000000000000]
    DWORD bOverride_Bloom_Exposure : 1;  // 0x005C (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    float Bloom_Exposure;                // 0x0060 (0x0004) [0x0000000000000000]
    DWORD bOverride_Bloom_Threshold : 1;  // 0x0064 (0x0004)
                                          // [0x0000000000000000] [0x00000001]
    ...
    DWORD
        bOverride_Fog_Start_Distance : 1;  // 0x0074 (0x0004)
                                           // [0x0000000000000000] [0x00000001]
    float Fog_Start_Distance;  // 0x0078 (0x0004) [0x0000000000000000]
    DWORD bOverride_Fog_MaxStrength_Distance : 1;  // 0x007C (0x0004)
                                                   // [0x0000000000000000]
                                                   // [0x00000001]
    float Fog_MaxStrength_Distance;  // 0x0080 (0x0004) [0x0000000000000000]
    DWORD bOverride_Fog_AnimationCutoff_Distance : 1;  // 0x0084 (0x0004)
                                                       // [0x0000000000000000]
                                                       // [0x00000001]
    float Fog_AnimationCutoff_Distance;  // 0x0088 (0x0004) [0x0000000000000000]
    DWORD bOverride_Fog_Intensity : 1;   // 0x008C (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    float Fog_Intensity;                 // 0x0090 (0x0004) [0x0000000000000000]
    DWORD bOverride_Fog_MinAmount : 1;   // 0x0094 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    float Fog_MinAmount;                 // 0x0098 (0x0004) [0x0000000000000000]
    DWORD bOverride_Fog_Color : 1;       // 0x009C (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    ...
    DWORD MB_TileMaxEnabled : 1;         // 0x00B4 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD bForceGameplayDOF : 1;         // 0x00B4 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    DWORD bForceGameplayBloom : 1;       // 0x00B4 (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    DWORD bForceGameplayImageGrain : 1;  // 0x00B4 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
    DWORD bForceGameplayTranslucencyTint : 1;  // 0x00B4 (0x0004)
                                               // [0x0000000000000000]
                                               // [0x00000010]
    DWORD
        bEnableScreenSpaceReflections : 1;  // 0x00B4 (0x0004)
                                            // [0x0000000000000000] [0x00000020]
    DWORD
        bBlurEnabled : 1;  // 0x00B4 (0x0004) [0x0000000000000000] [0x00000040]
...
struct FLUTBlender {
    TArray<class UTexture*>
        LUTTextures;           // 0x0000 (0x0010) [0x0000000000000000]
...
struct FMobilePostProcessSettings {
    DWORD bOverride_Mobile_BlurAmount : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000001]
    DWORD bOverride_Mobile_TransitionTime : 1;  // 0x0000 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000002]
    DWORD
        bOverride_Mobile_Bloom_Scale : 1;  // 0x0000 (0x0004)
                                           // [0x0000000000000000] [0x00000004]
    DWORD bOverride_Mobile_Bloom_Threshold : 1;  // 0x0000 (0x0004)
                                                 // [0x0000000000000000]
                                                 // [0x00000008]
    DWORD bOverride_Mobile_Bloom_Tint : 1;       // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000010]
    DWORD
        bOverride_Mobile_DOF_Distance : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000020]
    DWORD
        bOverride_Mobile_DOF_MinRange : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000040]
    DWORD
        bOverride_Mobile_DOF_MaxRange : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000080]
    DWORD bOverride_Mobile_DOF_NearBlurFactor : 1;  // 0x0000 (0x0004)
                                                    // [0x0000000000000000]
                                                    // [0x00000100]
    DWORD bOverride_Mobile_DOF_FarBlurFactor : 1;   // 0x0000 (0x0004)
                                                    // [0x0000000000000000]
                                                    // [0x00000200]
    ...
    struct FLinearColor
        Mobile_Bloom_Tint;            // 0x0014 (0x0010) [0x0000000000000000]
...
struct FUberPostProcessSettings {
    ...
    DWORD MotionBlur_FullMotionBlur : 1;  // 0x0050 (0x0004)
                                          // [0x0000000000000000] [0x00000001]
    float MotionBlur_CameraRotationThreshold;     // 0x0054 (0x0004)
                                                  // [0x0000000000000000]
    float MotionBlur_CameraTranslationThreshold;  // 0x0058 (0x0004)
                                                  // [0x0000000000000000]
    float MotionBlur_InterpolationDuration;       // 0x005C (0x0004)
                                                  // [0x0000000000000000]
    struct FLinearColor
        RimShader_Color;  // 0x0060 (0x0010) [0x0000000000000000]
    float RimShader_InterpolationDuration;  // 0x0070 (0x0004)
                                            // [0x0000000000000000]
    float Scene_ImageGrainScale;  // 0x0074 (0x0004) [0x0000000000000000]
    struct FMobileColorGradingParams
        MobileColorGrading;  // 0x0078 (0x003C) [0x0000000000000000]
    struct FMobilePostProcessSettings
        MobilePostProcess;  // 0x00B4 (0x0038) [0x0000000000000000]
};

// ScriptStruct Engine.PostProcessVolume.PostProcessSettings
// 0x0220
struct FPostProcessSettings {
    DWORD bOverride_EnableBloom : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00000001]
    DWORD bOverride_EnableDOF : 1;    // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00000002]
    DWORD bOverride_EnableMotionBlur : 1;   // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000004]
    DWORD bOverride_EnableSceneEffect : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000008]
    DWORD bOverride_AllowAmbientOcclusion : 1;   // 0x0000 (0x0004)
                                                 // [0x0000000000000000]
                                                 // [0x00000010]
    DWORD bOverride_OverrideRimShaderColor : 1;  // 0x0000 (0x0004)
                                                 // [0x0000000000000000]
                                                 // [0x00000020]
    DWORD bOverride_EnableDistanceFog : 1;       // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000040]
    DWORD bOverride_Bloom_Scale : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00000080]
    DWORD bOverride_Bloom_Threshold : 1;  // 0x0000 (0x0004)
                                          // [0x0000000000000000] [0x00000100]
    DWORD bOverride_Bloom_Tint : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000200]
    DWORD bOverride_Bloom_ScreenBlendThreshold : 1;   // 0x0000 (0x0004)
                                                      // [0x0000000000000000]
                                                      // [0x00000400]
    DWORD bOverride_Bloom_InterpolationDuration : 1;  // 0x0000 (0x0004)
                                                      // [0x0000000000000000]
                                                      // [0x00000800]
    DWORD
        bOverride_DOF_FalloffExponent : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00001000]
    DWORD
        bOverride_DOF_BlurKernelSize : 1;  // 0x0000 (0x0004)
                                           // [0x0000000000000000] [0x00002000]
    DWORD bOverride_DOF_BlurBloomKernelSize : 1;  // 0x0000 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x00004000]
    DWORD bOverride_DOF_MaxNearBlurAmount : 1;    // 0x0000 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x00008000]
    DWORD bOverride_DOF_MinBlurAmount : 1;        // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00010000]
    DWORD bOverride_DOF_MaxFarBlurAmount : 1;  // 0x0000 (0x0004)
                                               // [0x0000000000000000]
                                               // [0x00020000]
    DWORD bOverride_DOF_FocusType : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                        // [0x00040000]
    DWORD bOverride_DOF_FocusInnerRadius : 1;  // 0x0000 (0x0004)
                                               // [0x0000000000000000]
                                               // [0x00080000]
    DWORD bOverride_DOF_FocusDistance : 1;     // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00100000]
    DWORD bOverride_DOF_FocusPosition : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00200000]
    DWORD bOverride_DOF_InterpolationDuration : 1;  // 0x0000 (0x0004)
                                                    // [0x0000000000000000]
                                                    // [0x00400000]
    DWORD bOverride_DOF_BokehTexture : 1;           // 0x0000 (0x0004)
                                           // [0x0000000000000000] [0x00800000]
    DWORD bOverride_MotionBlur_MaxVelocity : 1;  // 0x0000 (0x0004)
                                                 // [0x0000000000000000]
                                                 // [0x01000000]
    DWORD bOverride_MotionBlur_Amount : 1;       // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x02000000]
    DWORD bOverride_MotionBlur_FullMotionBlur : 1;  // 0x0000 (0x0004)
                                                    // [0x0000000000000000]
                                                    // [0x04000000]
    DWORD bOverride_MotionBlur_CameraRotationThreshold : 1;  // 0x0000 (0x0004)
                                                             // [0x0000000000000000]
                                                             // [0x08000000]
    DWORD
        bOverride_MotionBlur_CameraTranslationThreshold : 1;  // 0x0000 (0x0004)
                                                              // [0x0000000000000000]
                                                              // [0x10000000]
    DWORD bOverride_MotionBlur_InterpolationDuration : 1;  // 0x0000 (0x0004)
                                                           // [0x0000000000000000]
                                                           // [0x20000000]
    DWORD
        bOverride_Scene_Desaturation : 1;  // 0x0000 (0x0004)
                                           // [0x0000000000000000] [0x40000000]
    DWORD bOverride_Scene_Colorize : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x80000000]
    DWORD bOverride_Scene_TonemapperScale : 1;  // 0x0004 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000001]
    DWORD bOverride_Scene_ImageGrainScale : 1;  // 0x0004 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000002]
    DWORD bOverride_Scene_HighLights : 1;       // 0x0004 (0x0004)
                                           // [0x0000000000000000] [0x00000004]
    DWORD bOverride_Scene_MidTones : 1;  // 0x0004 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
    DWORD bOverride_Scene_Shadows : 1;   // 0x0004 (0x0004) [0x0000000000000000]
                                         // [0x00000010]
    DWORD bOverride_Scene_InterpolationDuration : 1;  // 0x0004 (0x0004)
                                                      // [0x0000000000000000]
                                                      // [0x00000020]
    DWORD bOverride_Scene_ColorGradingLUT : 1;        // 0x0004 (0x0004)
                                                      // [0x0000000000000000]
                                                      // [0x00000040]
    DWORD bOverride_RimShader_Color : 1;              // 0x0004 (0x0004)
                                          // [0x0000000000000000] [0x00000080]
    DWORD bOverride_RimShader_InterpolationDuration : 1;  // 0x0004 (0x0004)
                                                          // [0x0000000000000000]
                                                          // [0x00000100]
    DWORD
        bOverride_MobileColorGrading : 1;  // 0x0004 (0x0004)
                                           // [0x0000000000000000] [0x00000200]
    DWORD
        bEnableBloom : 1;  // 0x0004 (0x0004) [0x0000000000000000] [0x00000400]
    DWORD bEnableDOF : 1;  // 0x0004 (0x0004) [0x0000000000000000] [0x00000800]
    DWORD bEnableMotionBlur : 1;        // 0x0004 (0x0004) [0x0000000000000000]
                                        // [0x00001000]
    DWORD bEnableSceneEffect : 1;       // 0x0004 (0x0004) [0x0000000000000000]
                                        // [0x00002000]
    DWORD bAllowAmbientOcclusion : 1;   // 0x0004 (0x0004) [0x0000000000000000]
                                        // [0x00004000]
    DWORD bOverrideRimShaderColor : 1;  // 0x0004 (0x0004) [0x0000000000000000]
                                        // [0x00008000]
    DWORD bEnableDistanceFog : 1;       // 0x0004 (0x0004) [0x0000000000000000]
                                        // [0x00010000]
    struct FTWPostProcessSettings
        TripwireSettings;  // 0x0008 (0x00BC) [0x0000000000000000]
    struct FUberPostProcessSettings
        LegacySettings;                 // 0x00C4 (0x00EC) [0x0000000000000000]
    ...
    class UTexture*
        ColorGrading_LookupTable;        // 0x01F4 (0x0008) [0x0000000000000000]
...
struct FRenderingPerformanceOverrides {
    DWORD bAllowAmbientOcclusion : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD bAllowDominantWholeSceneDynamicShadows : 1;  // 0x0000 (0x0004)
                                                       // [0x0000000000000000]
                                                       // [0x00000002]
    DWORD bAllowMotionBlurSkinning : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    DWORD bAllowTemporalAA : 1;          // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
...
struct FViewTargetTransitionParams {
    ...
    DWORD
        bLockOutgoing : 1;  // 0x000C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct FSeqOpOutputLink {
    TArray<struct FSeqOpOutputInputLink>
        Links;                // 0x0000 (0x0010) [0x0000000000000000]
    ...
    DWORD
        bDisabledPIE : 1;  // 0x0020 (0x0004) [0x0000000000000000] [0x00000004]
    ...
    DWORD
        bIsActivated : 1;  // 0x0040 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct FSeqVarLink {
    ...
    TArray<class USequenceVariable*>
        LinkedVariables;        // 0x0008 (0x0010) [0x0000000000000000]
    ...
    DWORD bSequenceNeverReadsOnlyWritesToThisVar : 1;  // 0x0038 (0x0004)
                                                       // [0x0000000000000000]
                                                       // [0x00000002]
    DWORD bModifiesLinkedObject : 1;  // 0x0038 (0x0004) [0x0000000000000000]
                                      // [0x00000004]
    ...
    DWORD
        bAllowAnyType : 1;  // 0x0050 (0x0004) [0x0000000000000000] [0x00000001]
...
struct FSeqEventLink {
    ...
    TArray<class USequenceEvent*>
        LinkedEvents;         // 0x0008 (0x0010) [0x0000000000000000]
    struct FString LinkDesc;  // 0x0018 (0x0010) [0x0000000000000000]
...
struct FLocalizedStringSettingMetaData {
    ...
    TArray<struct FStringIdToStringMapping>
        ValueMappings;  // 0x001C (0x0010) [0x0000000000000000]
};
...
struct FSettingsPropertyPropertyMetaData {
    ...
    TArray<struct FIdToStringMapping>
        ValueMappings;  // 0x0020 (0x0010) [0x0000000000000000]
    TArray<struct FSettingsData>
        PredefinedValues;  // 0x0030 (0x0010) [0x0000000000000000]
...
struct FOnlineGameSearchORClause {
    TArray<struct FOnlineGameSearchParameter>
        OrParams;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FOnlineGameSearchQuery {
    TArray<struct FOnlineGameSearchORClause>
        OrClauses;  // 0x0000 (0x0010) [0x0000000000000000]
    TArray<struct FOnlineGameSearchSortClause>
        SortClauses;  // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct FOverrideSkill {
    ...
    TArray<struct FUniqueNetId>
        Players;                    // 0x0004 (0x0010) [0x0000000000000000]
...
struct FOnlineGameSearchResult {
    class UOnlineGameSettings*
        GameSettings;              // 0x0000 (0x0008) [0x0000000000000000]
...
struct FSkelMeshComponentLODInfo {
    ...
    DWORD bNeedsInstanceWeightUpdate : 1;  // 0x0010 (0x0004)
                                           // [0x0000000000000000] [0x00000001]
    DWORD bAlwaysUseInstanceWeights : 1;   // 0x0010 (0x0004)
                                           // [0x0000000000000000] [0x00000002]
...
struct FAnimBlendChild {
    ...
    DWORD bMirrorSkeleton : 1;  // 0x0018 (0x0004) [0x0000000000000000]
                                // [0x00000001]
...
struct FConnectedPeerInfo {
    ...
    DWORD bLostConnectionToHost : 1;  // 0x000C (0x0004) [0x0000000000000000]
                                      // [0x00000001]
};
...
struct FDebugTextInfo {
    ...
    struct FVector
        SrcActorDesiredOffset;         // 0x0014 (0x000C) [0x0000000000000000]
    ...
    DWORD bAbsoluteLocation : 1;       // 0x003C (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD bKeepAttachedToActor : 1;    // 0x003C (0x0004) [0x0000000000000000]
                                       // [0x00000002]
...
struct FInputMatchRequest {
    ...
    struct FScriptDelegate
        MatchDelegate;                 // 0x0020 (0x0010) [0x0000000000000000]
    unsigned char UnknownData00[0x4];  // 0x0024 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
...
struct FKSphereElem {
    ...
    DWORD bNoRBCollision : 1;  // 0x0044 (0x0004) [0x0000000000000000]
                               // [0x00000001]
    DWORD
        bPerPolyShape : 1;  // 0x0044 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bNoUECollision : 1;  // 0x0044 (0x0004) [0x0000000000000000]
                               // [0x00000004]
...
struct FKBoxElem {
    ...
    DWORD bNoRBCollision : 1;  // 0x004C (0x0004) [0x0000000000000000]
                               // [0x00000001]
    DWORD
        bPerPolyShape : 1;  // 0x004C (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bNoUECollision : 1;  // 0x004C (0x0004) [0x0000000000000000]
                               // [0x00000004]
...
struct FKSphylElem {
    ...
    DWORD bNoRBCollision : 1;  // 0x0048 (0x0004) [0x0000000000000000]
                               // [0x00000001]
    DWORD
        bPerPolyShape : 1;  // 0x0048 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bNoUECollision : 1;  // 0x0048 (0x0004) [0x0000000000000000]
                               // [0x00000004]
...
struct FKConvexElem {
    ...
    TArray<struct FPlane>
        PermutedVertexData;   // 0x0010 (0x0010) [0x0000000000000000]
    TArray<int> FaceTriData;  // 0x0020 (0x0010) [0x0000000000000000]
    TArray<struct FVector>
        EdgeDirections;  // 0x0030 (0x0010) [0x0000000000000000]
    TArray<struct FVector>
        FaceNormalDirections;  // 0x0040 (0x0010) [0x0000000000000000]
    TArray<struct FPlane>
        FacePlaneData;    // 0x0050 (0x0010) [0x0000000000000000]
...
struct FKAggregateGeom {
    TArray<struct FKSphereElem>
        SphereElems;                    // 0x0000 (0x0010) [0x0000000000000000]
    TArray<struct FKBoxElem> BoxElems;  // 0x0010 (0x0010) [0x0000000000000000]
    TArray<struct FKSphylElem>
        SphylElems;  // 0x0020 (0x0010) [0x0000000000000000]
    TArray<struct FKConvexElem>
        ConvexElems;  // 0x0030 (0x0010) [0x0000000000000000]
    TArray<struct FKConvexElem>
        BoxMirrorConvexElems;    // 0x0040 (0x0010) [0x0000000000000000]
    struct FPointer RenderInfo;  // 0x0050 (0x0008) [0x0000000000000000]
    DWORD bSkipCloseAndParallelChecks : 1;  // 0x0058 (0x0004)
                                            // [0x0000000000000000] [0x00000001]
};
...
struct FKCachedConvexDataElement {
    TArray<unsigned char>
        ConvexElementData;       // 0x0000 (0x0010) [0x0000000000000000]
...
struct FKCachedConvexData {
    TArray<struct FKCachedConvexDataElement>
        CachedConvexElements;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FReverbSettings {
    DWORD
        bApplyReverb : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000001]
...
struct FInteriorSettings {
    DWORD
        bIsWorldInfo : 1;   // 0x0000 (0x0004) [0x0000000000000000] [0x00000001]
...
struct AAmbientSoundSimpleToggleable_FCheckpointRecord {
    DWORD bCurrentlyPlaying : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                  // [0x00000001]
};
...
struct FDelegateArray {
    TArray<struct FScriptDelegate>
        Delegates;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FSkelControlModifier {
    ...
    TArray<struct FTimeModifier>
        Modifiers;  // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct FWeightNodeRule {
    ...
    class UAnimNodeBlendBase*
        CachedNode;  // 0x0008 (0x0008) [0x0000000000000000]
    class UAnimNodeSlot*
        CachedSlotNode;         // 0x0010 (0x0008) [0x0000000000000000]
...
struct FPerBoneMaskInfo {
    TArray<struct FBranchInfo>
        BranchList;       // 0x0000 (0x0010) [0x0000000000000000]
    float DesiredWeight;  // 0x0010 (0x0004) [0x0000000000000000]
    float BlendTimeToGo;  // 0x0014 (0x0004) [0x0000000000000000]
    TArray<struct FWeightRule>
        WeightRuleList;                 // 0x0018 (0x0010) [0x0000000000000000]
    DWORD bWeightBasedOnNodeRules : 1;  // 0x0028 (0x0004) [0x0000000000000000]
                                        // [0x00000001]
    DWORD bDisableForNonLocalHumanPlayers : 1;  // 0x0028 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000002]
    DWORD
        bPendingBlend : 1;  // 0x0028 (0x0004) [0x0000000000000000] [0x00000004]
    TArray<float> PerBoneWeights;  // 0x002C (0x0010) [0x0000000000000000]
    TArray<unsigned char>
        TransformReqBone;       // 0x003C (0x0010) [0x0000000000000000]
...
struct FAimOffsetProfile {
    ...
    TArray<struct FAimComponent>
        AimComponents;         // 0x0018 (0x0010) [0x0000000000000000]
...
struct FChildBoneBlendInfo {
    ...
    TArray<unsigned char>
        TargetRequiredBones;  // 0x0028 (0x0010) [0x0000000000000000]
};
...
// 0x0028
struct FSynchGroup {
    TArray<class UAnimNodeSequence*>
        SeqNodes;  // 0x0000 (0x0010) [0x0000000000000000]
    class UAnimNodeSequence*
        MasterNode;                // 0x0010 (0x0008) [0x0000000000000000]
    struct FName GroupName;        // 0x0018 (0x0008) [0x0000000000000000]
    DWORD bFireSlaveNotifies : 1;  // 0x0020 (0x0004) [0x0000000000000000]
                                   // [0x00000001]
...
struct FLocalizedSubtitle {
    ...
    TArray<struct FSubtitleCue>
        Subtitles;      // 0x0010 (0x0010) [0x0000000000000000]
    DWORD bMature : 1;  // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bManualWordWrap : 1;  // 0x0020 (0x0004) [0x0000000000000000]
                                // [0x00000002]
...
struct FDominantShadowInfo {
    ...
    struct FBox
        LightSpaceImportanceBounds;  // 0x0080 (0x001C) [0x0000000000000000]
...
struct FLightmassPrimitiveSettings {
    DWORD bUseTwoSidedLighting : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
    DWORD bShadowIndirectOnly : 1;   // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
    DWORD
        bUseEmissiveForStaticLighting : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000004]
...
struct FLightmassDebugOptions {
    ...
    DWORD
        bStatsEnabled : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bGatherBSPSurfacesAcrossComponents : 1;  // 0x0000 (0x0004)
                                                   // [0x0000000000000000]
                                                   // [0x00000004]
    float CoplanarTolerance;  // 0x0004 (0x0004) [0x0000000000000000]
    DWORD bUseDeterministicLighting : 1;  // 0x0008 (0x0004)
                                          // [0x0000000000000000] [0x00000001]
    DWORD bUseImmediateImport : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                    // [0x00000002]
    DWORD bImmediateProcessMappings : 1;  // 0x0008 (0x0004)
                                          // [0x0000000000000000] [0x00000004]
    DWORD
        bSortMappings : 1;  // 0x0008 (0x0004) [0x0000000000000000] [0x00000008]
    DWORD bDumpBinaryFiles : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                 // [0x00000010]
    DWORD bDebugMaterials : 1;   // 0x0008 (0x0004) [0x0000000000000000]
                                 // [0x00000020]
    DWORD
        bPadMappings : 1;  // 0x0008 (0x0004) [0x0000000000000000] [0x00000040]
    DWORD bDebugPaddings : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                               // [0x00000080]
    DWORD bOnlyCalcDebugTexelMappings : 1;  // 0x0008 (0x0004)
                                            // [0x0000000000000000] [0x00000100]
    DWORD bUseRandomColors : 1;       // 0x0008 (0x0004) [0x0000000000000000]
                                      // [0x00000200]
    DWORD bColorBordersGreen : 1;     // 0x0008 (0x0004) [0x0000000000000000]
                                      // [0x00000400]
    DWORD bColorByExecutionTime : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                      // [0x00000800]
    float ExecutionTimeDivisor;       // 0x000C (0x0004) [0x0000000000000000]
    DWORD
        bInitialized : 1;  // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};

// ScriptStruct Engine.EngineTypes.SwarmDebugOptions
// 0x0004
struct FSwarmDebugOptions {
    DWORD bDistributionEnabled : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
    DWORD bForceContentExport : 1;   // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
    DWORD
        bInitialized : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000004]
};
...
struct FTrailSamplePoint {
    ...
    struct FTrailSocketSamplePoint
        FirstEdgeSample;  // 0x0004 (0x0018) [0x0000000000000000]
    struct FTrailSocketSamplePoint
        ControlPointSample;  // 0x001C (0x0018) [0x0000000000000000]
    struct FTrailSocketSamplePoint
        SecondEdgeSample;  // 0x0034 (0x0018) [0x0000000000000000]
};
...
struct FAnimGroup {
    TArray<class UAnimNodeSequence*>
        SeqNodes;  // 0x0000 (0x0010) [0x0000000000000000]
    class UAnimNodeSequence*
        SynchMaster;  // 0x0010 (0x0008) [0x0000000000000000]
    class UAnimNodeSequence*
        NotifyMaster;        // 0x0018 (0x0008) [0x0000000000000000]
...
struct FSkelControlListHead {
    ...
    class USkelControlBase*
        ControlHead;  // 0x0008 (0x0008) [0x0000000000000000]
...
struct FPreviewSkelMeshStruct {
    ...
    class USkeletalMesh*
        PreviewSkelMesh;  // 0x0008 (0x0008) [0x0000000000000000]
    TArray<class UMorphTargetSet*>
        PreviewMorphSets;  // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct FPreviewSocketStruct {
    ...
    class USkeletalMesh*
        PreviewSkelMesh;  // 0x0010 (0x0008) [0x0000000000000000]
    class UStaticMesh*
        PreviewStaticMesh;  // 0x0018 (0x0008) [0x0000000000000000]
};
...
struct FPreviewAnimSetsStruct {
    ...
    TArray<class UAnimSet*>
        PreviewAnimSets;  // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct FNxDestructibleDepthParameters {
    DWORD TAKE_IMPACT_DAMAGE : 1;        // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD IGNORE_POSE_UPDATES : 1;       // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    DWORD IGNORE_RAYCAST_CALLBACKS : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    DWORD IGNORE_CONTACT_CALLBACKS : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
...
struct FNxDestructibleParametersFlag {
    DWORD ACCUMULATE_DAMAGE : 1;      // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00000001]
    DWORD ASSET_DEFINED_SUPPORT : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                      // [0x00000002]
    DWORD
        WORLD_SUPPORT : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD DEBRIS_TIMEOUT : 1;            // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
    DWORD DEBRIS_MAX_SEPARATION : 1;     // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000010]
    DWORD CRUMBLE_SMALLEST_CHUNKS : 1;   // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000020]
    DWORD ACCURATE_RAYCASTS : 1;         // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000040]
    DWORD USE_VALID_BOUNDS : 1;          // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000080]
    DWORD FORM_EXTENDED_STRUCTURES : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                         // [0x00000100]
};
...
struct FNxDestructibleParameters {
    struct FNxDestructibleDamageParameters
        DamageParameters;  // 0x0000 (0x0014) [0x0000000000000000]
    struct FNxDestructibleDebrisParameters
        DebrisParameters;  // 0x0014 (0x002C) [0x0000000000000000]
    struct FNxDestructibleAdvancedParameters
        AdvancedParameters;             // 0x0040 (0x0018) [0x0000000000000000]
    ...
    DWORD bFormExtendedStructures : 1;  // 0x0078 (0x0004) [0x0000000000000000]
                                        // [0x00000001]
    ...
    struct FNxDestructibleParametersFlag
        Flags;                   // 0x00C0 (0x0004) [0x0000000000000000]
    ...
    TArray<struct FNxDestructibleDepthParameters>
        DepthParameters;              // 0x00D0 (0x0010) [0x0000000000000000]
    int DynamicChunksDominanceGroup;  // 0x00E0 (0x0004) [0x0000000000000000]
    DWORD UseDynamicChunksGroupsMask : 1;  // 0x00E4 (0x0004)
                                           // [0x0000000000000000] [0x00000001]
    unsigned char DynamicChunksChannel;  // 0x00E8 (0x0001) [0x0000000000000000]
    struct FRBCollisionChannelContainer
        DynamicChunksCollideWithChannels;  // 0x00EC (0x0004)
                                           // [0x0000000000000000]
};
...
struct FNotificationInfo {
    ...
    TArray<struct FNotificationMessageInfo>
        MessageInfo;  // 0x0018 (0x0010) [0x0000000000000000]
};

// ScriptStruct Engine.AppNotificationsBase.LaunchNotificationInfo
// 0x002C
struct FLaunchNotificationInfo {
    DWORD bWasLaunchedViaNotification : 1;  // 0x0000 (0x0004)
                                            // [0x0000000000000000] [0x00000001]
    struct FNotificationInfo
        Notification;  // 0x0004 (0x0028) [0x0000000000000000]
};
...
struct FStaticMeshComponentLODInfo {
    TArray<class UShadowMap2D*>
        ShadowMaps;  // 0x0000 (0x0010) [0x0000000000000000]
    TArray<class UObject*>
        ShadowVertexBuffers;   // 0x0010 (0x0010) [0x0000000000000000]
    struct FPointer LightMap;  // 0x0020 (0x0008) [0x0000000000000000]
    struct FPointer
        OverrideVertexColors;  // 0x0028 (0x0008) [0x0000000000000000]
    TArray<struct FPaintedVertex>
        PaintedVertices;  // 0x0030 (0x0010) [0x0000000000000000]
    class UTWSplatterMap2D*
        SplatterMap;  // 0x0040 (0x0008) [0x0000000000000000]
};
...
struct FCameraShakeInstance {
    ...
    DWORD
        bBlendingOut : 1;  // 0x001C (0x0004) [0x0000000000000000] [0x00000001]
...
struct FMobileDistanceFieldParams {
    ...
    DWORD
        EnableShadow : 1;  // 0x000C (0x0004) [0x0000000000000000] [0x00000001]
    ...
    struct FDepthFieldGlowInfo
        GlowInfo;   // 0x002C (0x0024) [0x0000000000000000]
...
struct FFontRenderInfo {
    ...
    DWORD
        bEnableShadow : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000002]
    struct FDepthFieldGlowInfo
        GlowInfo;  // 0x0004 (0x0024) [0x0000000000000000]
};
...
struct FSetSaveDataCallbackStruct {
    ...
    unsigned char UnknownData00[0x4];  // 0x0008 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
};
...
struct FInputKeyAction {
    ...
    TArray<struct FSeqOpOutputInputLink>
        TriggeredOps;  // 0x000C (0x0010) [0x0000000000000000]
    TArray<class USequenceOp*>
        ActionsToExecute;  // 0x001C (0x0010) [0x0000000000000000]
};
...
struct FInputEventParameters {
    ...
    DWORD
        bCtrlPressed : 1;  // 0x001C (0x0004) [0x0000000000000000] [0x00000002]
    DWORD
        bShiftPressed : 1;  // 0x001C (0x0004) [0x0000000000000000] [0x00000004]
};
...
struct FUIAxisEmulationDefinition {
    ...
    DWORD bEmulateButtonPress : 1;      // 0x0010 (0x0004) [0x0000000000000000]
                                        // [0x00000001]
    struct FName
        InputKeyToEmulate[0x2];  // 0x0014 (0x0010) [0x0000000000000000]
};
...
struct FAutoCompleteNode {
    ...
    TArray<int>
        AutoCompleteListIndices;         // 0x0004 (0x0010) [0x0000000000000000]
...
struct FFireLink {
    ...
    int PackedProperties_CoverPairRefAndDynamicInfo;  // 0x0010 (0x0004)
                                                      // [0x0000000000000000]
    DWORD
        bFallbackLink : 1;  // 0x0014 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bDynamicIndexInited : 1;  // 0x0014 (0x0004) [0x0000000000000000]
                                    // [0x00000002]
};
...
struct FCoverSlot {
    ...
    TArray<struct FFireLink>
        RejectedFireLinks;  // 0x0048 (0x0010) [0x0000000000000000]
    TArray<int>
        ExposedCoverPackedProperties;  // 0x0058 (0x0010) [0x0000000000000000]
    int TurnTargetPackedProperties;    // 0x0068 (0x0004) [0x0000000000000000]
    TArray<struct FSlotMoveRef>
        SlipRefs;  // 0x006C (0x0010) [0x0000000000000000]
    TArray<struct FCoverInfo>
        OverlapClaimsList;  // 0x007C (0x0010) [0x0000000000000000]
    ...
    DWORD bForceCanPopUp : 1;  // 0x008C (0x0004) [0x0000000000000000]
                               // [0x00000004]
    ...
    DWORD bForceCanCoverSlip_Left : 1;   // 0x008C (0x0004) [0x0000000000000000]
                                         // [0x00000040]
    DWORD bForceCanCoverSlip_Right : 1;  // 0x008C (0x0004) [0x0000000000000000]
                                         // [0x00000080]
    DWORD bCanCoverSlip_Left : 1;        // 0x008C (0x0004) [0x0000000000000000]
                                         // [0x00000100]
    DWORD bCanCoverSlip_Right : 1;       // 0x008C (0x0004) [0x0000000000000000]
                                         // [0x00000200]
    DWORD bCanSwatTurn_Left : 1;         // 0x008C (0x0004) [0x0000000000000000]
                                         // [0x00000400]
    DWORD bCanSwatTurn_Right : 1;        // 0x008C (0x0004) [0x0000000000000000]
                                         // [0x00000800]
    ...
    DWORD
        bAllowMantle : 1;  // 0x008C (0x0004) [0x0000000000000000] [0x00004000]
    DWORD bAllowCoverSlip : 1;  // 0x008C (0x0004) [0x0000000000000000]
                                // [0x00008000]
    DWORD
        bAllowClimbUp : 1;  // 0x008C (0x0004) [0x0000000000000000] [0x00010000]
    DWORD bAllowSwatTurn : 1;        // 0x008C (0x0004) [0x0000000000000000]
                                     // [0x00020000]
    DWORD bForceNoGroundAdjust : 1;  // 0x008C (0x0004) [0x0000000000000000]
                                     // [0x00040000]
    DWORD bPlayerOnly : 1;  // 0x008C (0x0004) [0x0000000000000000] [0x00080000]
    DWORD bPreferLeanOverPopup : 1;  // 0x008C (0x0004) [0x0000000000000000]
                                     // [0x00100000]
    DWORD
        bDestructible : 1;  // 0x008C (0x0004) [0x0000000000000000] [0x00200000]
    DWORD bSelected : 1;    // 0x008C (0x0004) [0x0000000000000000] [0x00400000]
    DWORD bFailedToFindSurface : 1;  // 0x008C (0x0004) [0x0000000000000000]
                                     // [0x00800000]
};
...
struct FCoverReplicationInfo {
    ...
    TArray<unsigned char>
        SlotsDisabled;  // 0x0018 (0x0010) [0x0000000000000000]
    TArray<unsigned char>
        SlotsAdjusted;  // 0x0028 (0x0010) [0x0000000000000000]
    TArray<struct FManualCoverTypeInfo>
        SlotsCoverTypeChanged;  // 0x0038 (0x0010) [0x0000000000000000]
};
...
struct FPresetGeneratedPoint {
    ...
    DWORD
        TangentsValid : 1;  // 0x0008 (0x0004) [0x0000000000000000] [0x00000001]
...
struct FPlayerDataStoreGroup {
    ...
    TArray<class UUIDataStore*>
        DataStores;  // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct FLightmassMaterialInterfaceSettings {
    DWORD bCastShadowAsMasked : 1;     // 0x0000 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    ...
    DWORD bOverrideCastShadowAsMasked : 1;  // 0x0018 (0x0004)
                                            // [0x0000000000000000] [0x00000001]
    DWORD bOverrideEmissiveBoost : 1;  // 0x0018 (0x0004) [0x0000000000000000]
                                       // [0x00000002]
    DWORD bOverrideDiffuseBoost : 1;   // 0x0018 (0x0004) [0x0000000000000000]
                                       // [0x00000004]
    DWORD bOverrideSpecularBoost : 1;  // 0x0018 (0x0004) [0x0000000000000000]
                                       // [0x00000008]
    DWORD bOverrideExportResolutionScale : 1;       // 0x0018 (0x0004)
                                                    // [0x0000000000000000]
                                                    // [0x00000010]
    DWORD bOverrideDistanceFieldPenumbraScale : 1;  // 0x0018 (0x0004)
                                                    // [0x0000000000000000]
                                                    // [0x00000020]
};
...
struct FMaterialInput {
    class UMaterialExpression*
        Expression;            // 0x0000 (0x0008) [0x0000000000000000]
...
struct APhysicsVolume_FCheckpointRecord {
    DWORD
        bPainCausing : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000001]
...
struct FLensFlareElementMaterials {
    TArray<class UMaterialInterface*>
        ElementMaterials;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct ADynamicBlockingVolume_FCheckpointRecord {
    ...
    DWORD bCollideActors : 1;  // 0x0018 (0x0004) [0x0000000000000000]
                               // [0x00000001]
    DWORD
        bBlockActors : 1;  // 0x0018 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bNeedsReplication : 1;  // 0x0018 (0x0004) [0x0000000000000000]
                                  // [0x00000004]
};
...
struct FParticleEventKismetData : FParticleEventData {
    DWORD UsePSysCompLocation : 1;  // 0x0034 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
    struct FVector Normal;          // 0x0038 (0x000C) [0x0000000000000000]
};
...
struct FFlexEmitterPreSimPositions {
    TArray<struct FVector>
        FlexPreSimPositions;  // 0x0000 (0x0010) [0x0000000000000000]
    int EmitterIndex;         // 0x0010 (0x0004) [0x0000000000000000]
};

// ScriptStruct
// Engine.ParticleSystemComponent.ViewParticleEmitterInstanceMotionBlurInfo
// 0x0048
struct FViewParticleEmitterInstanceMotionBlurInfo {
    struct FMap_Mirror
        EmitterInstanceMBInfoMap;  // 0x0000 (0x0048) [0x0000000000000000]
};

// ScriptStruct
// Engine.ParticleSystemComponent.ParticleEmitterInstanceMotionBlurInfo 0x0048
struct FParticleEmitterInstanceMotionBlurInfo {
    struct FMap_Mirror
        ParticleMBInfoMap;  // 0x0000 (0x0048) [0x0000000000000000]
};
...
struct FEmitterBaseInfo {
    class UParticleSystemComponent*
        PSC;                           // 0x0000 (0x0008) [0x0000000000000000]
    class AActor* Base;                // 0x0008 (0x0008) [0x0000000000000000]
    struct FVector RelativeLocation;   // 0x0010 (0x000C) [0x0000000000000000]
    struct FRotator RelativeRotation;  // 0x001C (0x000C) [0x0000000000000000]
    DWORD bInheritBaseScale : 1;       // 0x0028 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
};
...
struct FStatColorMapping {
    ...
    TArray<struct FStatColorMapEntry>
        ColorMap;  // 0x0010 (0x0010) [0x0000000000000000]
    DWORD
        DisableBlend : 1;  // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct FPrimitiveMaterialRef {
    class UPrimitiveComponent*
        Primitive;      // 0x0000 (0x0008) [0x0000000000000000]
...
struct FMaterialReferenceList {
    class UMaterialInterface*
        TargetMaterial;  // 0x0000 (0x0008) [0x0000000000000000]
    TArray<struct FPrimitiveMaterialRef>
        AffectedMaterialRefs;  // 0x0008 (0x0010) [0x0000000000000000]
    TArray<struct FPostProcessMaterialRef>
        AffectedPPChainMaterialRefs;  // 0x0018 (0x0010) [0x0000000000000000]
};
...
struct AInterpActor_FCheckpointRecord {
    ...
    DWORD bNeedsPositionReplication : 1;  // 0x001C (0x0004)
                                          // [0x0000000000000000] [0x00000004]
};
...
struct FFontImportOptionsData {
    ...
    DWORD bEnableAntialiasing : 1;  // 0x0014 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
    DWORD bEnableBold : 1;  // 0x0014 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD
        bEnableItalic : 1;  // 0x0014 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bEnableUnderline : 1;  // 0x0014 (0x0004) [0x0000000000000000]
                                 // [0x00000008]
    ...
    DWORD bCreatePrintableOnly : 1;    // 0x005C (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD bIncludeASCIIRange : 1;      // 0x005C (0x0004) [0x0000000000000000]
                                       // [0x00000002]
    struct FLinearColor
        ForegroundColor;                 // 0x0060 (0x0010) [0x0000000000000000]
    DWORD bEnableDropShadow : 1;         // 0x0070 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    ...
    DWORD bEnableLegacyMode : 1;         // 0x0094 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    int Kerning;                         // 0x0098 (0x0004) [0x0000000000000000]
    DWORD bUseDistanceFieldAlpha : 1;    // 0x009C (0x0004) [0x0000000000000000]
                                         // [0x00000001]
...
struct FWaveformSample {
    ...
    unsigned char
        RightTriggerAmplitude;           // 0x0003 (0x0001) [0x0000000000000000]
...
struct FFragmentGroup {
    ...
    DWORD bGroupIsRooted : 1;     // 0x0010 (0x0004) [0x0000000000000000]
                                  // [0x00000001]
};
...
struct FHostMigrationState {
    unsigned char
        HostMigrationProgress;           // 0x0000 (0x0001) [0x0000000000000000]
    ...
    struct FString
        HostMigrationTravelURL;       // 0x000C (0x0010) [0x0000000000000000]
    DWORD bHostMigrationEnabled : 1;  // 0x001C (0x0004) [0x0000000000000000]
                                      // [0x00000001]
};
...
struct FMusicTrackStruct {
    ...
    DWORD bPersistentAcrossLevels : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                        // [0x00000002]
...
struct FNavMeshPathGoalEvaluatorCacheDatum {
    ...
    class UNavMeshPathGoalEvaluator*
        List[0x5];  // 0x0004 (0x0028) [0x0000000000000000]
};
...
struct FWorldFractureSettings {
    ...
    DWORD bEnableChanceOfPhysicsChunkOverride : 1;  // 0x0004 (0x0004)
                                                    // [0x0000000000000000]
                                                    // [0x00000001]
    DWORD bLimitExplosionChunkSize : 1;  // 0x0004 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    float MaxExplosionChunkSize;         // 0x0008 (0x0004) [0x0000000000000000]
    DWORD bLimitDamageChunkSize : 1;     // 0x000C (0x0004) [0x0000000000000000]
                                         // [0x00000001]
...
struct FPhysXEmitterVerticalProperties {
    ...
    int PacketsPerPhysXParticleSystemMax;      // 0x000C (0x0004)
                                               // [0x0000000000000000]
    DWORD bApplyCylindricalPacketCulling : 1;  // 0x0010 (0x0004)
                                               // [0x0000000000000000]
                                               // [0x00000001]
...
struct FPhysXVerticalProperties {
    struct FPhysXEmitterVerticalProperties
        Emitters;  // 0x0000 (0x0018) [0x0000000000000000]
};
...
struct FLightmassWorldInfoSettings {
    ...
    DWORD bEnableAdvancedEnvironmentColor : 1;  // 0x0010 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000001]
    ...
    float EnvironmentLightTerminatorAngle;  // 0x001C (0x0004)
                                            // [0x0000000000000000]
    struct FVector
        EnvironmentLightDirection;       // 0x0020 (0x000C) [0x0000000000000000]
    ...
    DWORD bUseAmbientOcclusion : 1;      // 0x003C (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD bEnableImageReflectionShadowing : 1;    // 0x003C (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x00000002]
    ...
    DWORD bVisualizeMaterialDiffuse : 1;   // 0x0054 (0x0004)
                                           // [0x0000000000000000] [0x00000001]
    DWORD bVisualizeAmbientOcclusion : 1;  // 0x0054 (0x0004)
                                           // [0x0000000000000000] [0x00000002]
    DWORD bCompressShadowmap : 1;  // 0x0054 (0x0004) [0x0000000000000000]
                                   // [0x00000004]
};
...
struct FApexModuleDestructibleSettings {
    ...
    DWORD bOverrideMaxChunkSeparationLOD : 1;  // 0x0010 (0x0004)
                                               // [0x0000000000000000]
                                               // [0x00000001]
};
...
struct FPhysXSimulationProperties {
    DWORD
        bUseHardware : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bFixedTimeStep : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                               // [0x00000002]
...
struct FPhysXSceneProperties {
    struct FPhysXSimulationProperties
        PrimaryScene;  // 0x0000 (0x000C) [0x0000000000000000]
    struct FPhysXSimulationProperties
        CompartmentRigidBody;  // 0x000C (0x000C) [0x0000000000000000]
    struct FPhysXSimulationProperties
        CompartmentFluid;  // 0x0018 (0x000C) [0x0000000000000000]
    struct FPhysXSimulationProperties
        CompartmentCloth;  // 0x0024 (0x000C) [0x0000000000000000]
    struct FPhysXSimulationProperties
        CompartmentSoftBody;  // 0x0030 (0x000C) [0x0000000000000000]
};
...
struct FFullyLoadedPackagesInfo {
    ...
    TArray<struct FName>
        PackagesToLoad;  // 0x0014 (0x0010) [0x0000000000000000]
    TArray<class UObject*>
        LoadedObjects;  // 0x0024 (0x0010) [0x0000000000000000]
};
...
struct FLevelStreamingStatus {
    ...
    DWORD bShouldBeLoaded : 1;   // 0x0008 (0x0004) [0x0000000000000000]
                                 // [0x00000001]
    DWORD bShouldBeVisible : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                 // [0x00000002]
};
...
struct FGameTypePrefix {
    ...
    DWORD bUsesCommonPackage : 1;  // 0x0010 (0x0004) [0x0000000000000000]
                                   // [0x00000001]
    struct FString GameType;       // 0x0014 (0x0010) [0x0000000000000000]
    TArray<struct FString>
        AdditionalGameTypes;  // 0x0024 (0x0010) [0x0000000000000000]
    TArray<struct FString>
        ForcedObjects;  // 0x0034 (0x0010) [0x0000000000000000]
};
...
struct FGameSessionInformation {
    ...
    struct FString
        GameplaySessionTimestamp;    // 0x0018 (0x0010) [0x0000000000000000]
    ...
    DWORD bGameplaySessionInProgress : 1;  // 0x0030 (0x0004)
                                           // [0x0000000000000000] [0x00000001]
...
struct FSplitscreenData {
    TArray<struct FPerPlayerSplitscreenData>
        PlayerData;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FDebugDisplayProperty {
    ...
    DWORD bSpecialProperty : 1;  // 0x0010 (0x0004) [0x0000000000000000]
                                 // [0x00000001]
};
...
struct FActorToLookAt {
    ...
    DWORD CurrentlyBeingLookedAt : 1;  // 0x0018 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
};
...
struct FKeyBind {
    ...
    DWORD
        bIgnoreShift : 1;  // 0x0018 (0x0004) [0x0000000000000000] [0x00000010]
...
// ScriptStruct
// Engine.InstancedStaticMeshComponent.InstancedStaticMeshInstanceData 0x0050
...
// ScriptStruct
// Engine.InstancedStaticMeshComponent.InstancedStaticMeshMappingInfo 0x0020
struct FInstancedStaticMeshMappingInfo {
    ...
    class UShadowMap2D*
        ShadowmapTexture;  // 0x0018 (0x0008) [0x0000000000000000]
};
...
struct FCurveEdTab {
    ...
    TArray<struct FCurveEdEntry>
        Curves;             // 0x0010 (0x0010) [0x0000000000000000]
...
struct FAnimSetBakeAndPruneStatus {
    ...
    DWORD bReferencedButUnused : 1;  // 0x0010 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
    DWORD bSkipBakeAndPrune : 1;     // 0x0010 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
    DWORD
        bSkipCooking : 1;  // 0x0010 (0x0004) [0x0000000000000000] [0x00000004]
};
...
struct FSubTrackGroup {
    ...
    DWORD
        bIsCollapsed : 1;   // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
...
// ScriptStruct
// Engine.InterpTrackInstFloatMaterialParam.FloatMaterialParamMICData 0x0020
struct FFloatMaterialParamMICData {
    TArray<class UMaterialInstanceConstant*>
        MICs;                      // 0x0000 (0x0010) [0x0000000000000000]
...
// ScriptStruct
// Engine.InterpTrackInstVectorMaterialParam.VectorMaterialParamMICData 0x0020
struct FVectorMaterialParamMICData {
    TArray<class UMaterialInstanceConstant*>
        MICs;  // 0x0000 (0x0010) [0x0000000000000000]
    TArray<struct FVector>
        MICResetVectors;  // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct FInterpLookupTrack {
    TArray<struct FInterpLookupPoint>
        Points;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FLandscapeWeightmapUsage {
    class ULandscapeComponent*
        ChannelUsage[0x4];  // 0x0000 (0x0020) [0x0000000000000000]
};
...
struct FLandscapeLayerStruct {
    class ULandscapeLayerInfoObject*
        LayerInfoObj;  // 0x0000 (0x0008) [0x0000000000000000]
    class UMaterialInstanceConstant*
        ThumbnailMIC;              // 0x0008 (0x0008) [0x0000000000000000]
...
struct FLandscapeLayerInfo {
    ...
    DWORD bNoWeightBlend : 1;  // 0x000C (0x0004) [0x0000000000000000]
                               // [0x00000001]
    class UPhysicalMaterial*
        PhysMaterial;  // 0x0010 (0x0008) [0x0000000000000000]
    class UMaterialInstanceConstant*
        ThumbnailMIC;       // 0x0018 (0x0008) [0x0000000000000000]
...
struct FWeightmapLayerAllocationInfo {
    struct FName LayerName;  // 0x0000 (0x0008) [0x0000000000000000]
    unsigned char
        WeightmapTextureIndex;  // 0x0008 (0x0001) [0x0000000000000000]
    unsigned char
        WeightmapTextureChannel;  // 0x0009 (0x0001) [0x0000000000000000]
};
...
struct FGizmoSelectData {
    ...
    unsigned char UnknownData00
        [0x48];  // 0x0008 (0x0048) UNKNOWN PROPERTY: MapProperty
                 // Engine.LandscapeGizmoActiveActor.GizmoSelectData.WeightDataMap
};
...
struct FLensFlareElement {
    ...
    DWORD bUseSourceDistance : 1;        // 0x000C (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    DWORD bNormalizeRadialDistance : 1;  // 0x000C (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    DWORD bModulateColorBySource : 1;    // 0x000C (0x0004) [0x0000000000000000]
                                         // [0x00000008]
    struct FVector Size;                 // 0x0010 (0x000C) [0x0000000000000000]
    TArray<class UMaterialInterface*>
        LFMaterials;  // 0x001C (0x0010) [0x0000000000000000]
    struct FRawDistributionFloat
        LFMaterialIndex;  // 0x002C (0x0024) [0x0000000000000000]
    struct FRawDistributionFloat
        Scaling;  // 0x0050 (0x0024) [0x0000000000000000]
    struct FRawDistributionVector
        AxisScaling;  // 0x0074 (0x0024) [0x0000000000000000]
    struct FRawDistributionFloat
        Rotation;                    // 0x0098 (0x0024) [0x0000000000000000]
    DWORD bOrientTowardsSource : 1;  // 0x00BC (0x0004) [0x0000000000000000]
                                     // [0x00000001]
    struct FRawDistributionVector
        Color;                           // 0x00C0 (0x0024) [0x0000000000000000]
    struct FRawDistributionFloat Alpha;  // 0x00E4 (0x0024) [0x0000000000000000]
    struct FRawDistributionVector
        Offset;  // 0x0108 (0x0024) [0x0000000000000000]
    struct FRawDistributionVector
        DistMap_Scale;  // 0x012C (0x0024) [0x0000000000000000]
    struct FRawDistributionVector
        DistMap_Color;  // 0x0150 (0x0024) [0x0000000000000000]
    struct FRawDistributionFloat
        DistMap_Alpha;  // 0x0174 (0x0024) [0x0000000000000000]
};
...
struct FCurrentPostProcessVolumeInfo {
    struct FPostProcessSettings
        LastSettings;  // 0x0000 (0x0220) [0x0000000000000000]
    class APostProcessVolume*
        LastVolumeUsed;    // 0x0220 (0x0008) [0x0000000000000000]
...
struct FPostProcessSettingsOverride {
    struct FPostProcessSettings
        Settings;           // 0x0000 (0x0220) [0x0000000000000000]
    DWORD bBlendingIn : 1;  // 0x0220 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD
        bBlendingOut : 1;  // 0x0220 (0x0004) [0x0000000000000000] [0x00000002]
    ...
    struct FInterpCurveFloat
        TimeAlphaCurve;  // 0x0238 (0x0014) [0x0000000000000000]
};
...
struct FLayerBlendInput {
    ...
    struct FExpressionInput
        HeightInput;                   // 0x0040 (0x0034) [0x0000000000000000]
    float PreviewWeight;               // 0x0074 (0x0004) [0x0000000000000000]
    struct FPointer InstanceOverride;  // 0x0078 (0x0008) [0x0000000000000000]
};

// ScriptStruct
// Engine.MaterialExpressionMaterialFunctionCall.FunctionExpressionInput 0x004C
struct FFunctionExpressionInput {
    class UMaterialExpressionFunctionInput*
        ExpressionInput;             // 0x0000 (0x0008) [0x0000000000000000]
...
// ScriptStruct
// Engine.MaterialExpressionMaterialFunctionCall.FunctionExpressionOutput 0x003C
struct FFunctionExpressionOutput {
    class UMaterialExpressionFunctionOutput*
        ExpressionOutput;             // 0x0000 (0x0008) [0x0000000000000000]
...
struct FParameterValueOverTime {
    ...
    DWORD
        bAutoActivate : 1;  // 0x001C (0x0004) [0x0000000000000000] [0x00000002]
    float CycleTime;        // 0x0020 (0x0004) [0x0000000000000000]
    DWORD bNormalizeTime : 1;  // 0x0024 (0x0004) [0x0000000000000000]
                               // [0x00000001]
    float OffsetTime;          // 0x0028 (0x0004) [0x0000000000000000]
    DWORD bOffsetFromEnd : 1;  // 0x002C (0x0004) [0x0000000000000000]
                               // [0x00000001]
};
...
struct FScalarParameterValueOverTime : FParameterValueOverTime {
    ...
    struct FInterpCurveFloat
        ParameterValueCurve;  // 0x0034 (0x0014) [0x0000000000000000]
};
...
struct FVectorParameterValueOverTime : FParameterValueOverTime {
    ...
    struct FInterpCurveVector
        ParameterValueCurve;  // 0x0040 (0x0014) [0x0000000000000000]
};

// ScriptStruct
// Engine.MaterialInstanceTimeVarying.LinearColorParameterValueOverTime
// 0x0024(0x0054 - 0x0030)
...
struct FMorphNodeConn {
    TArray<class UMorphNodeBase*>
        ChildNodes;         // 0x0000 (0x0010) [0x0000000000000000]
...
// 0x0010
struct FPathStore {
    TArray<struct FEdgePointer>
        EdgeList;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FNavMeshPathParams {
    ...
    DWORD bNeedsMantleValidityTest : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    DWORD
        bAbleToSearch : 1;  // 0x0008 (0x0004) [0x0000000000000000] [0x00000004]
...
struct FOnlineProfileSetting {
    ...
    struct FSettingsProperty
        ProfileSetting;  // 0x0004 (0x001C) [0x0000000000000000]
};
...
struct FRecentParty {
    ...
    TArray<struct FUniqueNetId>
        PartyMembers;  // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct FOnlineStatsRow {
    ...
    struct FString NickName;       // 0x001C (0x0010) [0x0000000000000000]
    TArray<struct FOnlineStatsColumn>
        Columns;  // 0x002C (0x0010) [0x0000000000000000]
};
...
struct FParticleRandomSeedInfo {
    struct FName ParameterName;      // 0x0000 (0x0008) [0x0000000000000000]
    DWORD bGetSeedFromInstance : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
    DWORD bInstanceSeedIsIndex : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
    DWORD bResetSeedOnEmitterLooping : 1;  // 0x0008 (0x0004)
                                           // [0x0000000000000000] [0x00000004]
    TArray<int> RandomSeeds;  // 0x000C (0x0010) [0x0000000000000000]
};

// ScriptStruct
// Engine.ParticleModuleAttractorBoneSocket.AttractLocationBoneSocketInfo 0x0014
...
struct FParticleEvent_GenerateInfo {
    ...
    DWORD
        FirstTimeOnly : 1;  // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD
        LastTimeOnly : 1;  // 0x0010 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD UseReflectedImpactVector : 1;  // 0x0010 (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    struct FName CustomName;             // 0x0014 (0x0008) [0x0000000000000000]
    TArray<class UParticleModuleEventSendToGame*>
        ParticleModuleEventsToSendToGame;  // 0x001C (0x0010)
                                           // [0x0000000000000000]
};
...
struct FOrbitOptions {
    DWORD bProcessDuringSpawn : 1;   // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
    DWORD bProcessDuringUpdate : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
    DWORD bUseEmitterTime : 1;       // 0x0000 (0x0004) [0x0000000000000000]
                                     // [0x00000004]
};
...
struct FEmitterDynamicParameter {
    struct FName ParamName;     // 0x0000 (0x0008) [0x0000000000000000]
    DWORD bUseEmitterTime : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                // [0x00000001]
    DWORD bSpawnTimeOnly : 1;   // 0x0008 (0x0004) [0x0000000000000000]
                                // [0x00000002]
    unsigned char ValueMethod;  // 0x000C (0x0001) [0x0000000000000000]
    DWORD bScaleVelocityByParamValue : 1;  // 0x0010 (0x0004)
                                           // [0x0000000000000000] [0x00000001]
    struct FRawDistributionFloat
        ParamValue;  // 0x0014 (0x0024) [0x0000000000000000]
};
...
// ScriptStruct
// Engine.ParticleModuleTypeDataPhysX.PhysXEmitterVerticalLodProperties 0x0010
...
struct FLODSoloTrack {
    TArray<unsigned char>
        SoloEnableSetting;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FParticleSystemReplayFrame {
    TArray<struct FParticleEmitterReplayFrame>
        Emitters;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FPBParamSwatch {
    ...
    TArray<struct FPBMaterialParam>
        Params;  // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct FPBVariationInfo {
    ...
    DWORD bMeshOnTopOfFacePoly : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
};
...
struct FPBFracMeshCompInfo {
    class UFracturedStaticMeshComponent*
        FracMeshComp;        // 0x0000 (0x0008) [0x0000000000000000]
...
struct FPBMemUsageInfo {
    ...
    class UProcBuildingRuleset*
        Ruleset;                 // 0x0008 (0x0008) [0x0000000000000000]
...
struct FPBMeshCompInfo {
    class UStaticMeshComponent*
        MeshComp;            // 0x0000 (0x0008) [0x0000000000000000]
    int TopLevelScopeIndex;  // 0x0008 (0x0004) [0x0000000000000000]
};
...
struct FPBScopeProcessInfo {
    class AProcBuilding*
        OwningBuilding;  // 0x0000 (0x0008) [0x0000000000000000]
    class UProcBuildingRuleset*
        Ruleset;                    // 0x0008 (0x0008) [0x0000000000000000]
    struct FName RulesetVariation;  // 0x0010 (0x0008) [0x0000000000000000]
    DWORD bGenerateLODPoly : 1;     // 0x0018 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
    DWORD bPartOfNonRect : 1;       // 0x0018 (0x0004) [0x0000000000000000]
                                    // [0x00000002]
};
...
struct FBuildingMatOverrides {
    TArray<class UMaterialInterface*>
        MaterialOptions;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FBuildingMeshInfo {
    ...
    class UDistributionVector*
        Translation;  // 0x0014 (0x0008) [0x0000000000000000]
    class UDistributionVector*
        Rotation;                        // 0x001C (0x0008) [0x0000000000000000]
    DWORD bMeshScaleTranslation : 1;     // 0x0024 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD bOverrideMeshLightMapRes : 1;  // 0x0024 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    int OverriddenMeshLightMapRes;       // 0x0028 (0x0004) [0x0000000000000000]
    TArray<class UMaterialInterface*>
        MaterialOverrides;  // 0x002C (0x0010) [0x0000000000000000]
    TArray<struct FBuildingMatOverrides>
        SectionOverrides;  // 0x003C (0x0010) [0x0000000000000000]
};
...
struct FPhysXParticleImpactInfo {
    ...
    class UAkBaseSoundObject*
        ImpactSound;  // 0x0004 (0x0008) [0x0000000000000000]
};
...
struct FQueuedActivationInfo {
    class USequenceEvent*
        ActivatedEvent;           // 0x0000 (0x0008) [0x0000000000000000]
...
struct FSwitchObjectCase {
    ...
    DWORD
        bDefaultValue : 1;  // 0x0008 (0x0004) [0x0000000000000000] [0x00000002]
};
...
struct FSkeletalMeshOptimizationSettings {
    ...
    DWORD bRecalcNormals : 1;            // 0x0020 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
...
struct FTriangleSortSettings {
    ...
    struct FName
        CustomLeftRightBoneName;  // 0x0004 (0x0008) [0x0000000000000000]
};
...
struct FSkeletalMeshLODInfo {
    ...
    TArray<unsigned char>
        TriangleSorting;  // 0x0028 (0x0010) [0x0000000000000000]
    TArray<struct FTriangleSortSettings>
        TriangleSortSettings;        // 0x0038 (0x0010) [0x0000000000000000]
    DWORD bDisableCompressions : 1;  // 0x0048 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
    DWORD bHasBeenSimplified : 1;    // 0x0048 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
};
...
struct FApexClothingAssetInfo {
    TArray<struct FApexClothingLodInfo>
        ClothingLodInfo;             // 0x0000 (0x0010) [0x0000000000000000]
...
struct ASkeletalMeshActor_FCheckpointRecord {
    ...
    DWORD bSavedPosition : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                               // [0x00000004]
    struct FVector Location;   // 0x0004 (0x000C) [0x0000000000000000]
...
// ScriptStruct
// Engine.SkeletalMeshActorBasedOnExtremeContent.SkelMaterialSetterDatum 0x000C
struct FSkelMaterialSetterDatum {
    int MaterialIndex;  // 0x0000 (0x0004) [0x0000000000000000]
    class UMaterialInterface*
        TheMaterial;  // 0x0004 (0x0008) [0x0000000000000000]
};
...
struct FSoundClassProperties {
    ...
    DWORD
        bApplyEffects : 1;  // 0x001C (0x0004) [0x0000000000000000] [0x00000001]
    ...
    DWORD bCenterChannelOnly : 1;    // 0x001C (0x0004) [0x0000000000000000]
                                     // [0x00000020]
    DWORD bApplyAmbientVolumes : 1;  // 0x001C (0x0004) [0x0000000000000000]
                                     // [0x00000040]
};
...
struct FSoundClassAdjuster {
    ...
    DWORD bApplyToChildren : 1;    // 0x0014 (0x0004) [0x0000000000000000]
                                   // [0x00000001]
...
struct FDistanceDatum {
    ...
    struct FRawDistributionFloat
        FadeInDistance;  // 0x0014 (0x0024) [0x0000000000000000]
    struct FRawDistributionFloat
        FadeOutDistance;  // 0x0038 (0x0024) [0x0000000000000000]
};
...
struct FRecogVocabulary {
    TArray<struct FRecognisableWord>
        WhoDictionary;  // 0x0000 (0x0010) [0x0000000000000000]
    TArray<struct FRecognisableWord>
        WhatDictionary;  // 0x0010 (0x0010) [0x0000000000000000]
    TArray<struct FRecognisableWord>
        WhereDictionary;              // 0x0020 (0x0010) [0x0000000000000000]
    struct FString VocabName;         // 0x0030 (0x0010) [0x0000000000000000]
    TArray<unsigned char> VocabData;  // 0x0040 (0x0010) [0x0000000000000000]
    TArray<unsigned char>
        WorkingVocabData;  // 0x0050 (0x0010) [0x0000000000000000]
};
...
struct FSpeedTreeStaticLight {
    ...
    class UShadowMap1D*
        BranchShadowMap;                 // 0x0010 (0x0008) [0x0000000000000000]
    class UShadowMap1D* FrondShadowMap;  // 0x0018 (0x0008) [0x0000000000000000]
    class UShadowMap1D*
        LeafMeshShadowMap;  // 0x0020 (0x0008) [0x0000000000000000]
    class UShadowMap1D*
        LeafCardShadowMap;  // 0x0028 (0x0008) [0x0000000000000000]
    class UShadowMap1D*
        BillboardShadowMap;  // 0x0030 (0x0008) [0x0000000000000000]
};
...
struct FSplineConnection {
    class USplineComponent*
        SplineComponent;            // 0x0000 (0x0008) [0x0000000000000000]
...
// ScriptStruct
// Engine.StaticMeshActorBasedOnExtremeContent.SMMaterialSetterDatum 0x000C
...
struct FVehicleState {
    ...
    DWORD bServerHandbrake : 1;      // 0x0044 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
...
struct FTerrainLayer {
    ...
    DWORD WireframeHighlighted : 1;  // 0x001C (0x0004) [0x0000000000000000]
                                     // [0x00000002]
...
struct FTerrainDecoration {
    class UPrimitiveComponentFactory*
        Factory;               // 0x0000 (0x0008) [0x0000000000000000]
    ...
    TArray<struct FTerrainDecorationInstance>
        Instances;  // 0x001C (0x0010) [0x0000000000000000]
};
...
struct FTerrainDecoLayer {
    struct FString Name;  // 0x0000 (0x0010) [0x0000000000000000]
    TArray<struct FTerrainDecoration>
        Decorations;    // 0x0010 (0x0010) [0x0000000000000000]
...
struct FCachedTerrainMaterialArray {
    TArray<struct FPointer>
        CachedMaterials;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct ATrigger_FCheckpointRecord {
    DWORD bCollideActors : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                               // [0x00000001]
};
...
struct FLevelStreamingData {
    DWORD bShouldBeLoaded : 1;     // 0x0000 (0x0004) [0x0000000000000000]
                                   // [0x00000001]
    DWORD bShouldBeVisible : 1;    // 0x0000 (0x0004) [0x0000000000000000]
                                   // [0x00000002]
    DWORD bShouldBlockOnLoad : 1;  // 0x0000 (0x0004) [0x0000000000000000]
                                   // [0x00000004]
...
struct FBasicLobbyInfo {
    ...
    TArray<struct FLobbyMetaData>
        LobbySettings;  // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct FLobbyMember {
    ...
    TArray<struct FLobbyMetaData>
        PlayerSettings;  // 0x0008 (0x0010) [0x0000000000000000]
};

// ScriptStruct Engine.TWOnlineLobby.ActiveLobbyInfo
// 0x0010(0x0028 - 0x0018)
struct FActiveLobbyInfo : FBasicLobbyInfo {
    TArray<struct FLobbyMember>
        Members;  // 0x0018 (0x0010) [0x0000000000000000]
};

// ScriptStruct
// Engine.UIDataProvider_OnlinePlayerStorage.PlayerStorageArrayProvider 0x000C
struct FPlayerStorageArrayProvider {
    int PlayerStorageId;  // 0x0000 (0x0004) [0x0000000000000000]
    class UUIDataProvider_OnlinePlayerStorageArray*
        Provider;  // 0x0004 (0x0008) [0x0000000000000000]
};

// ScriptStruct
// Engine.UIDataStore_DynamicResource.DynamicResourceProviderDefinition 0x0020
...
struct FGameResourceDataProvider {
    struct FName ProviderTag;          // 0x0000 (0x0008) [0x0000000000000000]
    struct FString ProviderClassName;  // 0x0008 (0x0010) [0x0000000000000000]
    DWORD bExpandProviders : 1;        // 0x0018 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
...
struct FUIInputKeyData {
    struct FRawInputKeyEventData
        InputKeyData;  // 0x0000 (0x000C) [0x0000000000000000]
    struct FString
        ButtonFontMarkupString;  // 0x000C (0x0010) [0x0000000000000000]
};
...
struct FUIDataStoreInputAlias {
    ...
    struct FUIInputKeyData
        PlatformInputKeys[0x3];  // 0x0008 (0x0054) [0x0000000000000000]
};
...
struct FGameSearchCfg {
    ...
    class UClass*
        DefaultGameSettingsClass;  // 0x0008 (0x0008) [0x0000000000000000]
    class UClass*
        SearchResultsProviderClass;  // 0x0010 (0x0008) [0x0000000000000000]
    class UUIDataProvider_Settings*
        DesiredSettingsProvider;      // 0x0018 (0x0008) [0x0000000000000000]
...
struct FGameSettingsCfg {
    ...
    class UUIDataProvider_Settings*
        Provider;  // 0x0008 (0x0008) [0x0000000000000000]
    class UOnlineGameSettings*
        GameSettings;           // 0x0010 (0x0008) [0x0000000000000000]
...
struct FPlayerNickMetaData {
    ...
    struct FString
        PlayerNickColumnName;  // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct FSoundEventMapping {
    ...
    class UAkBaseSoundObject*
        SoundToPlay;  // 0x0008 (0x0008) [0x0000000000000000]
};
