...
struct FInterpCurveVector2D {
    TArray<struct FInterpCurvePointVector2D>
...
struct FInterpCurveFloat {
    TArray<struct FInterpCurvePointFloat>
        Points;                  // 0x0000 (0x0010) [0x0000000000000000]
    unsigned char InterpMethod;  // 0x0010 (0x0001) [0x0000000000000000]
};
...
struct FInterpCurveVector {
    TArray<struct FInterpCurvePointVector>
        Points;                  // 0x0000 (0x0010) [0x0000000000000000]
    unsigned char InterpMethod;  // 0x0010 (0x0001) [0x0000000000000000]
};
...
struct FRawDistribution {
    ...
    unsigned char
        LookupTableNumElements;          // 0x0002 (0x0001) [0x0000000000000000]
...
struct FInterpCurveLinearColor {
    TArray<struct FInterpCurvePointLinearColor>
        Points;                  // 0x0000 (0x0010) [0x0000000000000000]
    unsigned char InterpMethod;  // 0x0010 (0x0001) [0x0000000000000000]
};
...
struct FInterpCurveQuat {
    TArray<struct FInterpCurvePointQuat>
        Points;                  // 0x0000 (0x0010) [0x0000000000000000]
    unsigned char InterpMethod;  // 0x0010 (0x0001) [0x0000000000000000]
};
...
struct FInterpCurveTwoVectors {
    TArray<struct FInterpCurvePointTwoVectors>
        Points;                  // 0x0000 (0x0010) [0x0000000000000000]
    unsigned char InterpMethod;  // 0x0010 (0x0001) [0x0000000000000000]
};
...
struct FSparseArray_Mirror {
    ...
    struct FBitArray_Mirror
        AllocationFlags;  // 0x0010 (0x0020) [0x0000000000000000]
...
struct FSet_Mirror {
    struct FSparseArray_Mirror
        Elements;          // 0x0000 (0x0038) [0x0000000000000000]
...
struct FRawDistributionFloat : FRawDistribution {
    class UDistributionFloat*
        Distribution;  // 0x001C (0x0008) [0x0000000000000000]
};
