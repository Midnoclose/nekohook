...
struct UAkComponent_execSetRTPCValue_Parms {
    // struct FString                                  RTPCString;
    // // 0x0000 (0x0010) [0x0000000000000000] float RTPCValue; // 0x0010
...
struct UAkComponent_execPlayEvent_Parms {
    // class UAkEvent*                                 in_Event;
    // // 0x0000 (0x0008) [0x0000000000000000] DWORD bIsSpatialized : 1;
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001] DWORD bIsOccluded :
    // 1;                                  		// 0x000C (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bDoNotCheckOcclusion : 1;
