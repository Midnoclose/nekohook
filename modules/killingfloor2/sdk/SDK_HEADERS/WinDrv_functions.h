...
void UFacebookWindows::OnFacebookFriendsRequestComplete() {
    ...
    if (!pFnOnFacebookFriendsRequestComplete)
        pFnOnFacebookFriendsRequestComplete =
            (UFunction*)UObject::GObjObjects()->Data[41847];

    UFacebookWindows_execOnFacebookFriendsRequestComplete_Parms
        OnFacebookFriendsRequestComplete_Parms;

    this->ProcessEvent(pFnOnFacebookFriendsRequestComplete,
                       &OnFacebookFriendsRequestComplete_Parms, NULL);
};
...
void UFacebookWindows::eventRequestFacebookFriends() {
    ...
    if (!pFnRequestFacebookFriends)
        pFnRequestFacebookFriends =
            (UFunction*)UObject::GObjObjects()->Data[41846];

    UFacebookWindows_eventRequestFacebookFriends_Parms
        RequestFacebookFriends_Parms;

    this->ProcessEvent(pFnRequestFacebookFriends, &RequestFacebookFriends_Parms,
                       NULL);
};
...
void UFacebookWindows::OnFacebookMeRequestComplete() {
    ...
    if (!pFnOnFacebookMeRequestComplete)
        pFnOnFacebookMeRequestComplete =
            (UFunction*)UObject::GObjObjects()->Data[41839];

    UFacebookWindows_execOnFacebookMeRequestComplete_Parms
        OnFacebookMeRequestComplete_Parms;

    this->ProcessEvent(pFnOnFacebookMeRequestComplete,
                       &OnFacebookMeRequestComplete_Parms, NULL);
};
...
void UFacebookWindows::eventRequestFacebookMeInfo() {
    ...
    if (!pFnRequestFacebookMeInfo)
        pFnRequestFacebookMeInfo =
            (UFunction*)UObject::GObjObjects()->Data[41838];

    UFacebookWindows_eventRequestFacebookMeInfo_Parms
        RequestFacebookMeInfo_Parms;

    this->ProcessEvent(pFnRequestFacebookMeInfo, &RequestFacebookMeInfo_Parms,
                       NULL);
};
...
void UFacebookWindows::FacebookRequestCallback() {
    ...
    if (!pFnFacebookRequestCallback)
        pFnFacebookRequestCallback =
            (UFunction*)UObject::GObjObjects()->Data[41833];

    UFacebookWindows_execFacebookRequestCallback_Parms
        FacebookRequestCallback_Parms;

    this->ProcessEvent(pFnFacebookRequestCallback,
                       &FacebookRequestCallback_Parms, NULL);
};
...
void UFacebookWindows::ProcessFacebookRequest() {
    ...
    if (!pFnProcessFacebookRequest)
        pFnProcessFacebookRequest =
            (UFunction*)UObject::GObjObjects()->Data[41830];

    UFacebookWindows_execProcessFacebookRequest_Parms
        ProcessFacebookRequest_Parms;

    pFnProcessFacebookRequest->FunctionFlags |= ~0x400;

    this->ProcessEvent(pFnProcessFacebookRequest, &ProcessFacebookRequest_Parms,
                       NULL);
...
void UFacebookWindows::FacebookRequest() {
    ...
    if (!pFnFacebookRequest)
        pFnFacebookRequest = (UFunction*)UObject::GObjObjects()->Data[41828];
...
void UFacebookWindows::Disconnect() {
    ...
    if (!pFnDisconnect)
        pFnDisconnect = (UFunction*)UObject::GObjObjects()->Data[41827];
...
void UFacebookWindows::IsAuthorized() {
    ...
    if (!pFnIsAuthorized)
        pFnIsAuthorized = (UFunction*)UObject::GObjObjects()->Data[41825];
...
void UFacebookWindows::Authorize() {
    ...
    if (!pFnAuthorize)
        pFnAuthorize = (UFunction*)UObject::GObjObjects()->Data[41823];
...
void UFacebookWindows::Init() {
    ...
    if (!pFnInit) pFnInit = (UFunction*)UObject::GObjObjects()->Data[41821];
...
void UHttpRequestWindows::ProcessRequest() {
    ...
    if (!pFnProcessRequest)
        pFnProcessRequest = (UFunction*)UObject::GObjObjects()->Data[41899];
...
void UHttpRequestWindows::SetHeader() {
    ...
    if (!pFnSetHeader)
        pFnSetHeader = (UFunction*)UObject::GObjObjects()->Data[41895];
...
void UHttpRequestWindows::SetContentAsString() {
    ...
    if (!pFnSetContentAsString)
        pFnSetContentAsString = (UFunction*)UObject::GObjObjects()->Data[41892];
...
void UHttpRequestWindows::SetContent() {
    ...
    if (!pFnSetContent)
        pFnSetContent = (UFunction*)UObject::GObjObjects()->Data[41888];
...
void UHttpRequestWindows::SetURL() {
    ...
    if (!pFnSetURL) pFnSetURL = (UFunction*)UObject::GObjObjects()->Data[41885];
...
void UHttpRequestWindows::SetVerb() {
    ...
    if (!pFnSetVerb)
        pFnSetVerb = (UFunction*)UObject::GObjObjects()->Data[41882];
...
void UHttpRequestWindows::GetVerb() {
    ...
    if (!pFnGetVerb)
        pFnGetVerb = (UFunction*)UObject::GObjObjects()->Data[41880];
...
void UHttpRequestWindows::GetContent() {
    ...
    if (!pFnGetContent)
        pFnGetContent = (UFunction*)UObject::GObjObjects()->Data[41877];
...
void UHttpRequestWindows::GetURL() {
    ...
    if (!pFnGetURL) pFnGetURL = (UFunction*)UObject::GObjObjects()->Data[41875];
...
void UHttpRequestWindows::GetContentLength() {
    ...
    if (!pFnGetContentLength)
        pFnGetContentLength = (UFunction*)UObject::GObjObjects()->Data[41873];
...
void UHttpRequestWindows::GetContentType() {
    ...
    if (!pFnGetContentType)
        pFnGetContentType = (UFunction*)UObject::GObjObjects()->Data[41871];
...
void UHttpRequestWindows::GetURLParameter() {
    ...
    if (!pFnGetURLParameter)
        pFnGetURLParameter = (UFunction*)UObject::GObjObjects()->Data[41868];
...
void UHttpRequestWindows::GetHeaders() {
    ...
    if (!pFnGetHeaders)
        pFnGetHeaders = (UFunction*)UObject::GObjObjects()->Data[41865];
...
void UHttpRequestWindows::GetHeader() {
    ...
    if (!pFnGetHeader)
        pFnGetHeader = (UFunction*)UObject::GObjObjects()->Data[41862];
...
void UHttpResponseWindows::GetResponseCode() {
    ...
    if (!pFnGetResponseCode)
        pFnGetResponseCode = (UFunction*)UObject::GObjObjects()->Data[41931];
...
void UHttpResponseWindows::GetContentAsString() {
    ...
    if (!pFnGetContentAsString)
        pFnGetContentAsString = (UFunction*)UObject::GObjObjects()->Data[41929];
...
void UHttpResponseWindows::GetContent() {
    ...
    if (!pFnGetContent)
        pFnGetContent = (UFunction*)UObject::GObjObjects()->Data[41926];
...
void UHttpResponseWindows::GetURL() {
    ...
    if (!pFnGetURL) pFnGetURL = (UFunction*)UObject::GObjObjects()->Data[41924];
...
void UHttpResponseWindows::GetContentLength() {
    ...
    if (!pFnGetContentLength)
        pFnGetContentLength = (UFunction*)UObject::GObjObjects()->Data[41922];
...
void UHttpResponseWindows::GetContentType() {
    ...
    if (!pFnGetContentType)
        pFnGetContentType = (UFunction*)UObject::GObjObjects()->Data[41920];
...
void UHttpResponseWindows::GetURLParameter() {
    ...
    if (!pFnGetURLParameter)
        pFnGetURLParameter = (UFunction*)UObject::GObjObjects()->Data[41917];
...
void UHttpResponseWindows::GetHeaders() {
    ...
    if (!pFnGetHeaders)
        pFnGetHeaders = (UFunction*)UObject::GObjObjects()->Data[41914];
...
void UHttpResponseWindows::GetHeader() {
    ...
    if (!pFnGetHeader)
        pFnGetHeader = (UFunction*)UObject::GObjObjects()->Data[41911];
...
void UHttpRequestWindowsMcp::ProcessRequest() {
    ...
    if (!pFnProcessRequest)
        pFnProcessRequest = (UFunction*)UObject::GObjObjects()->Data[41904];
