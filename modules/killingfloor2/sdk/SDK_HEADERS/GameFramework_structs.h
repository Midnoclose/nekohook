...
struct FAgentArchetypeInfo {
    ...
    TArray<class UObject*>
        GroupMembers;  // 0x0014 (0x0010) [0x0000000000000000]
};

// ScriptStruct GameFramework.GameTypes.CrowdSpawnInfoItem
// 0x0090
struct FCrowdSpawnInfoItem {
    class USeqAct_GameCrowdPopulationManagerToggle*
        SeqSpawner;             // 0x0000 (0x0008) [0x0000000000000000]
    DWORD bSpawningActive : 1;  // 0x0008 (0x0004) [0x0000000000000000]
                                // [0x00000001]
    ...
    TArray<class AGameCrowdAgent*>
        ActiveAgents;  // 0x0018 (0x0010) [0x0000000000000000]
    TArray<struct FAgentArchetypeInfo>
        AgentArchetypes;               // 0x0028 (0x0010) [0x0000000000000000]
    ...
    DWORD bForceObstacleChecking : 1;  // 0x0050 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD bForceNavMeshPathing : 1;    // 0x0050 (0x0004) [0x0000000000000000]
                                       // [0x00000002]
    DWORD
        bEnableCrowdLightEnvironment : 1;  // 0x0050 (0x0004)
                                           // [0x0000000000000000] [0x00000004]
    DWORD
        bCastShadows : 1;  // 0x0050 (0x0004) [0x0000000000000000] [0x00000008]
    struct FLightingChannelContainer
        AgentLightingChannel;     // 0x0054 (0x0004) [0x0000000000000000]
    ...
    TArray<class AGameCrowdDestination*>
        PotentialSpawnPoints;           // 0x0060 (0x0010) [0x0000000000000000]
    ...
    TArray<class AGameCrowdDestination*>
        PrioritizedSpawnPoints;          // 0x007C (0x0010) [0x0000000000000000]
...
struct FGameSpecialMoveInfo {
    ...
    class UGameSpecialMove*
        SpecialMoveInstance;  // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct FTakeHitInfo {
    ...
    class UPhysicalMaterial*
        PhysicalMaterial;               // 0x002C (0x0008) [0x0000000000000000]
...
struct FScreenShakeStruct {
    ...
    DWORD bOverrideTargetingDampening : 1;  // 0x0070 (0x0004)
...
struct FScreenShakeAnimStruct {
    ...
    DWORD bUseDirectionalAnimVariants : 1;  // 0x0008 (0x0004)
                                            // [0x0000000000000000] [0x00000001]
    ...
    DWORD bRandomSegment : 1;       // 0x0034 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
    float RandomSegmentDuration;    // 0x0038 (0x0004) [0x0000000000000000]
    DWORD bSingleInstance : 1;      // 0x003C (0x0004) [0x0000000000000000]
                                    // [0x00000001]
};
...
struct FAvoidOtherSampleItem {
    ...
    DWORD
        bFallbackOnly : 1;  // 0x0008 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct FBehaviorEntry {
    class UGameCrowdAgentBehavior*
        BehaviorArchetype;      // 0x0000 (0x0008) [0x0000000000000000]
    class AActor* LookAtActor;  // 0x0008 (0x0008) [0x0000000000000000]
    float BehaviorFrequency;    // 0x0010 (0x0004) [0x0000000000000000]
    DWORD
        bNeverRepeat : 1;  // 0x0014 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD
        bHasBeenUsed : 1;  // 0x0014 (0x0004) [0x0000000000000000] [0x00000002]
...
struct FRequiredMobileInputConfig {
    ...
    TArray<struct FString>
        RequireZoneNames;           // 0x0010 (0x0010) [0x0000000000000000]
    DWORD bIsAttractModeGroup : 1;  // 0x0020 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
};
...
struct FGameCrowdAttachmentList {
    ...
    TArray<struct FGameCrowdAttachmentInfo>
        List;  // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct FEventsBase {
    ...
    TArray<struct FGameEvents>
        EventsByClass;  // 0x0048 (0x0010) [0x0000000000000000]
};
...
struct FGameEvent {
    TArray<float>
        EventCountByTimePeriod;  // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct FTeamEvents {
    ...
    struct FDamageEvents
        DamageAsPlayerEvents;  // 0x00A0 (0x0058) [0x0000000000000000]
    struct FDamageEvents
        DamageAsTargetEvents;  // 0x00F8 (0x0058) [0x0000000000000000]
    struct FProjectileEvents
        ProjectileEvents;           // 0x0150 (0x0058) [0x0000000000000000]
...
struct FCamFocusPointParams {
    ...
    DWORD
        bAlwaysFocus : 1;  // 0x0030 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD
        bAdjustCamera : 1;  // 0x0030 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD
        bIgnoreTrace : 1;  // 0x0030 (0x0004) [0x0000000000000000] [0x00000004]
...
struct FTouchData {
    ...
    TArray<struct FTouchDataEvent>
        Events;            // 0x003C (0x0010) [0x0000000000000000]
...
struct FMobileInputGroup {
    ...
    TArray<class UMobileInputZone*>
        AssociatedZones;  // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct FUVCoords {
    DWORD
        bCustomCoords : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000001]
...
struct FDragElementInfo {
    ...
    DWORD bCanDropInOver : 1;    // 0x0010 (0x0004) [0x0000000000000000]
                                 // [0x00000001]
...
struct FMenuListDragInfo {
    DWORD bIsDragging : 1;  // 0x0000 (0x0004) [0x0000000000000000] [0x00000001]
    class UMobileMenuListItem*
        TouchedItem;  // 0x0004 (0x0008) [0x0000000000000000]
    struct FSelectedMenuItem
        OrigSelectedItem;         // 0x000C (0x000C) [0x0000000000000000]
    ...
    struct FDragHistoryData
        UpdateHistory[0x4];         // 0x002C (0x0020) [0x0000000000000000]
    int NumUpdates;                 // 0x004C (0x0004) [0x0000000000000000]
    DWORD bHasSelectedChanged : 1;  // 0x0050 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
};
...
struct FMenuListMovementInfo {
    ...
    struct FSelectedMenuItem
        OrigSelectedItem;  // 0x0004 (0x000C) [0x0000000000000000]
...
struct FPropertyInfo {
    ...
    DWORD bModifyProperty : 1;     // 0x0008 (0x0004) [0x0000000000000000]
                                   // [0x00000001]
