...
void UAkComponent::IsPlaying() {
    ...
    if (!pFnIsPlaying)
        pFnIsPlaying = (UFunction*)UObject::GObjObjects()->Data[47819];
...
void UAkComponent::SetRTPCValue() {
    ...
    if (!pFnSetRTPCValue)
        pFnSetRTPCValue = (UFunction*)UObject::GObjObjects()->Data[47816];
...
void UAkComponent::PlayEvent() {
    ...
    if (!pFnPlayEvent)
        pFnPlayEvent = (UFunction*)UObject::GObjObjects()->Data[47811];
...
void UAkComponent::StopEvents() {
    ...
    if (!pFnStopEvents)
        pFnStopEvents = (UFunction*)UObject::GObjObjects()->Data[47810];
