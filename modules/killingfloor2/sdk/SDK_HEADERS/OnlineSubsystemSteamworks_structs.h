...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineLobbyInterfaceSteamworks.LobbySortFilter
// 0x0014
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineGameInterfaceSteamworks.ServerQueryToRulesResponseMapping
// 0x000C
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineGameInterfaceSteamworks.ServerQueryToPingResponseMapping
// 0x000C
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineGameInterfaceSteamworks.ServerQueryToPlayerListResponseMapping
// 0x000C
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineGameInterfaceSteamworks.ClientFilterORClause
// 0x0048
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineGameInterfaceSteamworks.MatchmakingQueryState
// 0x0080
struct FMatchmakingQueryState {
    class UOnlineGameSearch*
        GameSearch;  // 0x0000 (0x0008) [0x0000000000000000]
    TArray<struct FServerQueryToRulesResponseMapping>
        QueryToRulesResponseMap;  // 0x0008 (0x0010) [0x0000000000000000]
    TArray<struct FServerQueryToPingResponseMapping>
        QueryToPingResponseMap;  // 0x0018 (0x0010) [0x0000000000000000]
    struct FServerQueryToPlayerListResponseMapping
        PlayerListQuery;                 // 0x0028 (0x000C) [0x0000000000000000]
    struct FPointer ServerListResponse;  // 0x0034 (0x0008) [0x0000000000000000]
    unsigned char
        CurrentMatchmakingType;  // 0x003C (0x0001) [0x0000000000000000]
    struct FPointer
        CurrentMatchmakingQuery;  // 0x0040 (0x0008) [0x0000000000000000]
    TArray<struct FClientFilterORClause>
        ActiveClientsideFilters;  // 0x0048 (0x0010) [0x0000000000000000]
    TArray<class UOnlineGameSettings*>
        PendingRulesSearchSettings;  // 0x0058 (0x0010) [0x0000000000000000]
    TArray<class UOnlineGameSettings*>
        PendingPingSearchSettings;     // 0x0068 (0x0010) [0x0000000000000000]
    DWORD bIgnoreRefreshComplete : 1;  // 0x0078 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    float LastActivityTimestamp;       // 0x007C (0x0004) [0x0000000000000000]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineGameInterfaceSteamworks.FilterKeyToSteamKeyMapping
// 0x003C
struct FFilterKeyToSteamKeyMapping {
    ...
    DWORD bReverseFilter : 1;    // 0x0028 (0x0004) [0x0000000000000000]
                                 // [0x00000001]
    struct FString IgnoreValue;  // 0x002C (0x0010) [0x0000000000000000]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineGameInterfaceSteamworks.FavoriteServer 0x000C
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.LeaderboardHandle 0x0008
struct FLeaderboardHandle {
    struct FQWord Dud;  // 0x0000 (0x0008) [0x0000000000000000]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.LeaderboardTemplate
// 0x0028
struct FLeaderboardTemplate {
    ...
    struct FLeaderboardHandle
        LeaderboardRef;                  // 0x001C (0x0008) [0x0000000000000000]
    DWORD bLeaderboardInitializing : 1;  // 0x0024 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD bLeaderboardInitiated : 1;     // 0x0024 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.DeferredLeaderboardRead
// 0x002C
struct FDeferredLeaderboardRead {
    ...
    TArray<struct FUniqueNetId>
        PlayerList;  // 0x001C (0x0010) [0x0000000000000000]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.DeferredLeaderboardWrite
// 0x0024
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.LeaderboardEntry 0x0020
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.ViewIdToLeaderboardName
// 0x0014
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.SteamPlayerClanData
// 0x0020
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.ProfileSettingsCache
// 0x0038
struct FProfileSettingsCache {
    class UOnlineProfileSettings*
        Profile;  // 0x0000 (0x0008) [0x0000000000000000]
    TArray<struct FScriptDelegate>
        ReadDelegates;  // 0x0008 (0x0010) [0x0000000000000000]
    TArray<struct FScriptDelegate>
        WriteDelegates;  // 0x0018 (0x0010) [0x0000000000000000]
    TArray<struct FScriptDelegate>
        ProfileDataChangedDelegates;  // 0x0028 (0x0010) [0x0000000000000000]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.DeviceIdCache 0x0024
struct FDeviceIdCache {
    int DeviceID;  // 0x0000 (0x0004) [0x0000000000000000]
    struct FScriptDelegate
        DeviceSelectionMulticast;      // 0x0004 (0x0010) [0x0000000000000000]
    unsigned char UnknownData00[0x4];  // 0x0008 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    TArray<struct FScriptDelegate>
        DeviceSelectionDelegates;  // 0x0014 (0x0010) [0x0000000000000000]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.LocalTalkerSteam
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.AchievementProgressStat
// 0x0010
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.AchievementMappingInfo
// 0x001C
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.QueuedAvatarRequest
// 0x0024
struct FQueuedAvatarRequest {
    ...
    struct FScriptDelegate
        ReadOnlineAvatarCompleteDelegate;  // 0x0014 (0x0010)
                                           // [0x0000000000000000]
    unsigned char UnknownData00[0x4];  // 0x0018 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.SteamUserCloudMetadata
// 0x0020
struct FSteamUserCloudMetadata {
    struct FString UserId;  // 0x0000 (0x0010) [0x0000000000000000]
    TArray<struct FEmsFile>
        UserCloudMetadata;  // 0x0010 (0x0010) [0x0000000000000000]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.SteamUserCloud 0x0020
struct FSteamUserCloud {
    struct FString UserId;  // 0x0000 (0x0010) [0x0000000000000000]
    TArray<struct FTitleFile>
        UserCloudFileData;  // 0x0010 (0x0010) [0x0000000000000000]
};

// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.ControllerConnectionState
// 0x0008
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.OnlineStatusMapping
// 0x0014
...
// ScriptStruct
// OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.PendingPlayerStats 0x0058
