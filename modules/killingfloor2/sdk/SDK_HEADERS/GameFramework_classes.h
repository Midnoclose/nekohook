...
class AGameAIController : public AAIController {
   public:
    ...
    DWORD bHasRunawayCommandList : 1;   // 0x0464 (0x0004) [0x0000000000000000]
                                        // [0x00000001]
    DWORD bAILogging : 1;  // 0x0464 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bAILogToWindow : 1;       // 0x0464 (0x0004) [0x0000000000000000]
                                    // [0x00000004]
    DWORD bFlushAILogEachLine : 1;  // 0x0464 (0x0004) [0x0000000000000000]
                                    // [0x00000008]
    DWORD bMapBasedLogName : 1;     // 0x0464 (0x0004) [0x0000000000000000]
                                    // [0x00000010]
    DWORD
        bAIDrawDebug : 1;  // 0x0464 (0x0004) [0x0000000000000000] [0x00000020]
    ...
    TArray<struct FAICmdHistoryItem>
        CommandHistory;                // 0x0474 (0x0010) [0x0000000000000000]
    int CommandHistoryNum;             // 0x0484 (0x0004) [0x0000000000000000]
    TArray<struct FName> AILogFilter;  // 0x0488 (0x0010) [0x0000000000000000]
    struct FString
        DemoActionString;  // 0x0498 (0x0010) [0x0000000000170000] ( CPF_Travel
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[2822];
...
class AGamePawn : public APawn {
   public:
    DWORD bLastHitWasHeadShot : 1;   // 0x0558 (0x0004) [0x0000000000320000]
                                     // [0x00000001] ( CPF_EditConst )
    DWORD bRespondToExplosions : 1;  // 0x0558 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
...
class UDynamicSpriteComponent : public USpriteComponent {
   public:
    struct FInterpCurveFloat
        AnimatedScale;  // 0x0260 (0x0014) [0x0000000000000000]
    struct FInterpCurveLinearColor
        AnimatedColor;  // 0x0274 (0x0014) [0x0000000000000000]
    struct FInterpCurveVector2D
        AnimatedPosition;           // 0x0288 (0x0014) [0x0000000000000000]
...
class AFrameworkGame : public AGameInfo {
   public:
    TArray<struct FRequiredMobileInputConfig>
        RequiredMobileInputConfigs;  // 0x0498 (0x0010) [0x0000000000000000]
...
class UGameAICommand : public UAICommandBase {
   public:
    ...
    class AGameAIController*
        GameAIOwner;      // 0x0070 (0x0008) [0x0000000000000000]
    struct FName Status;  // 0x0078 (0x0008) [0x0000000000000000]
    DWORD bAllowNewSameClassInstance : 1;  // 0x0080 (0x0004)
                                           // [0x0000000000000000] [0x00000001]
    DWORD bReplaceActiveSameClassInstance : 1;  // 0x0080 (0x0004)
                                                // [0x0000000000000000]
                                                // [0x00000002]
    DWORD bAborted : 1;  // 0x0080 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bIgnoreNotifies : 1;   // 0x0080 (0x0004) [0x0000000000000000]
                                 // [0x00000008]
    DWORD bIgnoreStepAside : 1;  // 0x0080 (0x0004) [0x0000000000000000]
                                 // [0x00000010]
    DWORD bPendingPop : 1;  // 0x0080 (0x0004) [0x0000000000000000] [0x00000020]
    DWORD bDisableSteering : 1;    // 0x0080 (0x0004) [0x0000000000000000]
                                   // [0x00000040]
...
class AGamePlayerController : public APlayerController {
   public:
    DWORD bWarnCrowdMembers : 1;     // 0x0770 (0x0004) [0x0000000000000000]
                                     // [0x00000001]
    DWORD bDebugCrowdAwareness : 1;  // 0x0770 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
    DWORD bIsWarmupPaused : 1;       // 0x0770 (0x0004) [0x0000000000000000]
                                     // [0x00000004]
...
class UGameCheatManager : public UCheatManager {
   public:
    class ADebugCameraController*
        DebugCameraControllerRef;  // 0x0080 (0x0008) [0x0000000000000000]
    class UClass*
        DebugCameraControllerClass;  // 0x0088 (0x0008) [0x0000000000000000]
    struct FString
        DebugCameraControllerClassName;  // 0x0090 (0x0010) [0x0000000000000000]
...
class AGameCrowdAgent : public ACrowdAgentBase {
   public:
    struct FPointer
        VfTable_IInterface_RVO;        // 0x024C (0x0008) [0x0000000000000000]
    ...
    class AGameCrowdDestination*
        CurrentDestination;  // 0x0274 (0x0008) [0x0000000000000000]
    class AGameCrowdDestination*
        BehaviorDestination;  // 0x027C (0x0008) [0x0000000000000000]
    class AGameCrowdDestination*
        PreviousDestination;   // 0x0284 (0x0008) [0x0000000000000000]
    ...
    class UDynamicLightEnvironmentComponent*
        LightEnvironment;        // 0x0298 (0x0008) [0x0000000000000000]
    int ConformTraceFrameCount;  // 0x02A0 (0x0004) [0x0000000000000000]
    TArray<struct FNearbyDynamicItem>
        NearbyDynamics;  // 0x02A4 (0x0010) [0x0000000000000000]
    DWORD
        bUniformScale : 1;  // 0x02B4 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bCheckForObstacles : 1;  // 0x02B4 (0x0004) [0x0000000000000000]
                                   // [0x00000002]
    DWORD bUseNavMeshPathing : 1;  // 0x02B4 (0x0004) [0x0000000000000000]
                                   // [0x00000004]
    DWORD bWantsSeePlayerNotification : 1;  // 0x02B4 (0x0004)
                                            // [0x0000000000000000] [0x00000008]
    DWORD bAllowPitching : 1;  // 0x02B4 (0x0004) [0x0000000000000000]
                               // [0x00000010]
    DWORD
        bHitObstacle : 1;  // 0x02B4 (0x0004) [0x0000000000000000] [0x00000020]
    DWORD
        bBadHitNormal : 1;  // 0x02B4 (0x0004) [0x0000000000000000] [0x00000040]
    DWORD bSimulateThisTick : 1;    // 0x02B4 (0x0004) [0x0000000000000000]
                                    // [0x00000080]
    DWORD bPotentialEncounter : 1;  // 0x02B4 (0x0004) [0x0000000000000000]
                                    // [0x00000100]
    DWORD bIsPanicked : 1;  // 0x02B4 (0x0004) [0x0000000000000000] [0x00000200]
    DWORD bWantsGroupIdle : 1;  // 0x02B4 (0x0004) [0x0000000000000000]
                                // [0x00000400]
    DWORD bPreferVisibleDestination : 1;  // 0x02B4 (0x0004)
                                          // [0x0000000000000000] [0x00000800]
    DWORD bPreferVisibleDestinationOnSpawn : 1;  // 0x02B4 (0x0004)
                                                 // [0x0000000000000000]
                                                 // [0x00001000]
    DWORD bHasNotifiedSpawner : 1;  // 0x02B4 (0x0004) [0x0000000000000000]
                                    // [0x00002000]
    DWORD bIsInSpawnPool : 1;       // 0x02B4 (0x0004) [0x0000000000000000]
                                    // [0x00004000]
    ...
    TArray<struct FAvoidOtherSampleItem>
        AvoidOtherSampleList;         // 0x02D4 (0x0010) [0x0000000000000000]
    ...
    struct FVector
        LastKnownGoodPosition;         // 0x0334 (0x000C) [0x0000000000000000]
    ...
    class UClass*
        NavigationHandleClass;  // 0x035C (0x0008) [0x0000000000000000]
    class UNavigationHandle*
        NavigationHandle;                // 0x0364 (0x0008) [0x0000000000000000]
    ...
    TArray<struct FRecentInteraction>
        RecentInteractions;            // 0x0394 (0x0010) [0x0000000000000000]
    ...
    class UAudioComponent*
        AmbientSoundComponent;  // 0x03D4 (0x0008) [0x0000000000000000]
    class UGameCrowdAgentBehavior*
        CurrentBehavior;  // 0x03DC (0x0008) [0x0000000000000000]
    float
        CurrentBehaviorActivationTime;  // 0x03E4 (0x0004) [0x0000000000000000]
    TArray<struct FBehaviorEntry>
        EncounterAgentBehaviors;  // 0x03E8 (0x0010) [0x0000000000000000]
    TArray<struct FBehaviorEntry>
        SeePlayerBehaviors;    // 0x03F8 (0x0010) [0x0000000000000000]
    float MaxSeePlayerDistSq;  // 0x0408 (0x0004) [0x0000000000000000]
    float SeePlayerInterval;   // 0x040C (0x0004) [0x0000000000000000]
    TArray<struct FBehaviorEntry>
        SpawnBehaviors;  // 0x0410 (0x0010) [0x0000000000000000]
    TArray<struct FBehaviorEntry>
        UneasyBehaviors;  // 0x0420 (0x0010) [0x0000000000000000]
    TArray<struct FBehaviorEntry>
        AlertBehaviors;  // 0x0430 (0x0010) [0x0000000000000000]
    TArray<struct FBehaviorEntry>
        PanicBehaviors;  // 0x0440 (0x0010) [0x0000000000000000]
    TArray<struct FBehaviorEntry>
        RandomBehaviors;  // 0x0450 (0x0010) [0x0000000000000000]
    TArray<struct FBehaviorEntry>
        TakeDamageBehaviors;       // 0x0460 (0x0010) [0x0000000000000000]
    ...
    TArray<struct FBehaviorEntry>
        GroupWaitingBehaviors;   // 0x047C (0x0010) [0x0000000000000000]
    ...
    class UGameCrowdSpawnerInterface*
        MySpawner;                     // 0x0498 (0x0010) [0x0000000000000000]
    unsigned char UnknownData00[0x8];  // 0x04A0 (0x0008) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    ...
    class AGameCrowdDestination*
        DebugSpawnDest;  // 0x04BC (0x0008) [0x0000000000000000]
...
class AGameCrowdAgentSkeletal : public AGameCrowdAgent {
   public:
    class USkeletalMeshComponent*
        SkeletalMeshComponent;  // 0x04C4 (0x0008) [0x0000000000000000]
    class UAnimNodeBlend*
        SpeedBlendNode;                 // 0x04CC (0x0008) [0x0000000000000000]
    class UAnimNodeSlot* FullBodySlot;  // 0x04D4 (0x0008) [0x0000000000000000]
    class UAnimNodeSequence*
        ActionSeqNode;  // 0x04DC (0x0008) [0x0000000000000000]
    class UAnimNodeSequence*
        WalkSeqNode;  // 0x04E4 (0x0008) [0x0000000000000000]
    class UAnimNodeSequence*
        RunSeqNode;                      // 0x04EC (0x0008) [0x0000000000000000]
    ...
    TArray<struct FName>
        DeathAnimNames;              // 0x052C (0x0010) [0x0000000000000000]
    ...
    TArray<struct FGameCrowdAttachmentList>
        Attachments;                   // 0x0554 (0x0010) [0x0000000000000000]
    float MaxTargetAcquireTime;        // 0x0564 (0x0004) [0x0000000000000000]
    DWORD bUseRootMotionVelocity : 1;  // 0x0568 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD bAllowSkeletonUpdateChangeBasedOnTickResult : 1;  // 0x0568 (0x0004)
                                                            // [0x0000000000000000]
                                                            // [0x00000002]
    DWORD bTickWhenNotVisible : 1;       // 0x0568 (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    DWORD bIsPlayingIdleAnimation : 1;   // 0x0568 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
    DWORD bIsPlayingDeathAnimation : 1;  // 0x0568 (0x0004) [0x0000000000000000]
                                         // [0x00000010]
    DWORD
        bIsPlayingImportantAnimation : 1;  // 0x0568 (0x0004)
                                           // [0x0000000000000000] [0x00000020]
    DWORD bAnimateThisTick : 1;       // 0x0568 (0x0004) [0x0000000000000000]
                                      // [0x00000040]
...
class AGameCrowdAgentSM : public AGameCrowdAgent {
   public:
    ...
    class UMaterialInstanceConstant*
        MeshColor;  // 0x04CC (0x0008) [0x0000000000000000]
...
class UGameCrowdAgentBehavior : public UObject {
   public:
    ...
    DWORD
        bIdleBehavior : 1;  // 0x006C (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bFaceActionTargetFirst : 1;  // 0x006C (0x0004) [0x0000000000000000]
                                       // [0x00000002]
    DWORD bIsViralBehavior : 1;        // 0x006C (0x0004) [0x0000000000000000]
                                       // [0x00000004]
    DWORD bPassOnIsViralBehaviorFlag : 1;  // 0x006C (0x0004)
                                           // [0x0000000000000000] [0x00000008]
    ...
    float DurationOfViralBehaviorPropagation;  // 0x0088 (0x0004)
                                               // [0x0000000000000000]
    float TimeToStopPropagatingViralBehavior;  // 0x008C (0x0004)
                                               // [0x0000000000000000]
...
class UGameCrowdBehavior_PlayAnimation : public UGameCrowdAgentBehavior {
   public:
    ...
    DWORD bUseRootMotion : 1;            // 0x00B4 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD
        bLookAtPlayer : 1;  // 0x00B4 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bLooping : 1;     // 0x00B4 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bBlendBetweenAnims : 1;      // 0x00B4 (0x0004) [0x0000000000000000]
                                       // [0x00000008]
    ...
    class USeqAct_PlayAgentAnimation*
        AnimSequence;    // 0x00C8 (0x0008) [0x0000000000000000]
...
class UGameCrowdBehavior_WaitInQueue : public UGameCrowdAgentBehavior {
   public:
    DWORD bStoppingBehavior : 1;  // 0x009C (0x0004) [0x0000000000000000]
                                  // [0x00000001]
    class AGameCrowdDestinationQueuePoint*
        QueuePosition;  // 0x00A0 (0x0008) [0x0000000000000000]
...
class UGameCrowdGroup : public UObject {
   public:
    TArray<class AGameCrowdAgent*>
        Members;  // 0x0060 (0x0010) [0x0000000000000000]
...
class AGameCrowdInfoVolume : public AVolume {
   public:
    TArray<class AGameCrowdDestination*>
        PotentialSpawnPoints;  // 0x0280 (0x0010) [0x0000000000000000]
...
class AGameCrowdInteractionPoint : public AActor {
   public:
    DWORD bIsEnabled : 1;  // 0x0244 (0x0004) [0x0000000000150000] [0x00000001]
                           // ( CPF_Travel | CPF_GlobalConfig )
    class UCylinderComponent*
        CylinderComponent;  // 0x0248 (0x0008) [0x0000000000000000]
...
class AGameCrowdDestination : public AGameCrowdInteractionPoint {
   public:
    struct FPointer
        VfTable_IEditorLinkSelectionInterface;  // 0x0250 (0x0008)
                                                // [0x0000000000000000]
    DWORD bKillWhenReached : 1;  // 0x0258 (0x0004) [0x0000000000000000]
                                 // [0x00000001]
    DWORD bAllowAsPreviousDestination : 1;  // 0x0258 (0x0004)
                                            // [0x0000000000000000] [0x00000002]
    DWORD bAvoidWhenPanicked : 1;       // 0x0258 (0x0004) [0x0000000000000000]
                                        // [0x00000004]
    DWORD bSkipBehaviorIfPanicked : 1;  // 0x0258 (0x0004) [0x0000000000000000]
                                        // [0x00000008]
    DWORD bFleeDestination : 1;         // 0x0258 (0x0004) [0x0000000000000000]
                                        // [0x00000010]
    DWORD bMustReachExactly : 1;        // 0x0258 (0x0004) [0x0000000000000000]
                                        // [0x00000020]
    DWORD bHasRestrictions : 1;         // 0x0258 (0x0004) [0x0000000000000000]
                                        // [0x00000040]
    DWORD bAllowsSpawning : 1;          // 0x0258 (0x0004) [0x0000000000000000]
                                        // [0x00000080]
    DWORD bAllowCloudSpawning : 1;      // 0x0258 (0x0004) [0x0000000000000000]
                                        // [0x00000100]
    DWORD bAllowVisibleSpawning : 1;    // 0x0258 (0x0004) [0x0000000000000000]
                                        // [0x00000200]
    DWORD
        bLineSpawner : 1;  // 0x0258 (0x0004) [0x0000000000000000] [0x00000400]
    DWORD
        bSpawnAtEdge : 1;  // 0x0258 (0x0004) [0x0000000000000000] [0x00000800]
    DWORD bSoftPerimeter : 1;  // 0x0258 (0x0004) [0x0000000000000000]
                               // [0x00001000]
    DWORD bIsVisible : 1;  // 0x0258 (0x0004) [0x0000000000000000] [0x00002000]
    DWORD bWillBeVisible : 1;          // 0x0258 (0x0004) [0x0000000000000000]
                                       // [0x00004000]
    DWORD bCanSpawnHereNow : 1;        // 0x0258 (0x0004) [0x0000000000000000]
                                       // [0x00008000]
    DWORD bIsBeyondSpawnDistance : 1;  // 0x0258 (0x0004) [0x0000000000000000]
                                       // [0x00010000]
    DWORD bAdjacentToVisibleNode : 1;  // 0x0258 (0x0004) [0x0000000000000000]
                                       // [0x00020000]
    DWORD bHasNavigationMesh : 1;      // 0x0258 (0x0004) [0x0000000000000000]
                                       // [0x00040000]
    TArray<class AGameCrowdDestination*>
        NextDestinations;  // 0x025C (0x0010) [0x0000000000000000]
    class AGameCrowdDestinationQueuePoint*
        QueueHead;      // 0x026C (0x0008) [0x0000000000000000]
    ...
    TArray<class UClass*>
        SupportedAgentClasses;  // 0x0280 (0x0010) [0x0000000000000000]
    TArray<class UObject*>
        SupportedArchetypes;  // 0x0290 (0x0010) [0x0000000000000000]
    TArray<class UClass*>
        RestrictedAgentClasses;  // 0x02A0 (0x0010) [0x0000000000000000]
    TArray<class UObject*>
        RestrictedArchetypes;     // 0x02B0 (0x0010) [0x0000000000000000]
    ...
    TArray<struct FBehaviorEntry>
        ReachedBehaviors;  // 0x02D0 (0x0010) [0x0000000000000000]
    class AGameCrowdAgent*
        AgentEnRoute;     // 0x02E0 (0x0008) [0x0000000000000000]
    float Priority;       // 0x02E8 (0x0004) [0x0000000000000000]
    float LastSpawnTime;  // 0x02EC (0x0004) [0x0000000000000000]
    class AGameCrowdPopulationManager*
        MyPopMgr;  // 0x02F0 (0x0008) [0x0000000000000000]
...
class AGameCrowdDestinationQueuePoint : public AGameCrowdInteractionPoint {
   public:
    class AGameCrowdDestinationQueuePoint*
        NextQueuePosition;  // 0x0250 (0x0008) [0x0000000000000000]
    class AGameCrowdInteractionPoint*
        PreviousQueuePosition;           // 0x0258 (0x0008) [0x0000000000000000]
    class AGameCrowdAgent* QueuedAgent;  // 0x0260 (0x0008) [0x0000000000000000]
    class AGameCrowdDestination*
        QueueDestination;              // 0x0268 (0x0008) [0x0000000000000000]
    DWORD bClearingQueue : 1;          // 0x0270 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD bPendingAdvance : 1;         // 0x0270 (0x0004) [0x0000000000000000]
                                       // [0x00000002]
...
class AGameCrowdPopulationManager : public ACrowdPopulationManagerBase {
   public:
    ...
    struct FCrowdSpawnInfoItem
        CloudSpawnInfo;  // 0x024C (0x0090) [0x0000000000000000]
    TArray<struct FCrowdSpawnInfoItem>
        ScriptedSpawnInfo;  // 0x02DC (0x0010) [0x0000000000000000]
    class AGameCrowdInfoVolume*
        ActiveCrowdInfoVolume;  // 0x02EC (0x0008) [0x0000000000000000]
    TArray<class AGameCrowdDestination*>
        GlobalPotentialSpawnPoints;      // 0x02F4 (0x0010) [0x0000000000000000]
    ...
    class UClass*
        NavigationHandleClass;  // 0x0310 (0x0008) [0x0000000000000000]
    class UNavigationHandle*
        NavigationHandle;  // 0x0318 (0x0008) [0x0000000000000000]
    class AGameCrowdAgent*
        QueryingAgent;  // 0x0320 (0x0008) [0x0000000000000000]
    TArray<struct FCrowdSpawnerPlayerInfo>
        PlayerInfo;                  // 0x0328 (0x0010) [0x0000000000000000]
    float LastPlayerInfoUpdateTime;  // 0x0338 (0x0004) [0x0000000000000000]
    DWORD
        bDebugSpawns : 1;   // 0x033C (0x0004) [0x0000000000000000] [0x00000001]
...
class AGameCrowdReplicationActor : public AActor {
   public:
    class USeqAct_GameCrowdSpawner*
        Spawner;  // 0x0244 (0x0008) [0x0000000000150000]              (
                  // CPF_Travel | CPF_GlobalConfig )
    DWORD bSpawningActive : 1;  // 0x024C (0x0004) [0x0000000000160000]
                                // [0x00000001] ( CPF_EditConst |
                                // CPF_GlobalConfig )
    int DestroyAllCount;  // 0x0250 (0x0004) [0x0000000000170000]              (
...
class UGameExplosion : public UObject {
   public:
    DWORD bDirectionalExplosion : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                                      // [0x00000001]
    DWORD bIgnoreInstigator : 1;      // 0x0060 (0x0004) [0x0000000000000000]
                                      // [0x00000002]
    DWORD bAllowTeammateCringes : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                                      // [0x00000004]
    DWORD bFullDamageToAttachee : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                                      // [0x00000008]
    DWORD bAttachExplosionEmitterToAttachee : 1;  // 0x0060 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x00000010]
    DWORD bPerformRadialBlurRelevanceCheck : 1;   // 0x0060 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x00000020]
    DWORD bCausesFracture : 1;      // 0x0060 (0x0004) [0x0000000000000000]
                                    // [0x00000040]
    DWORD bAllowPerMaterialFX : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                                    // [0x00000080]
    DWORD
        bParticleSystemIsBeingOverriddenDontUsePhysMatVersion : 1;  // 0x0060
                                                                    // (0x0004)
                                                                    // [0x0000000000000000]
                                                                    // [0x00000100]
    DWORD bSkipDefaultPhysMatParticleSystem : 1;  // 0x0060 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x00000200]
    DWORD bUseMapSpecificValues : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                                      // [0x00000400]
    DWORD bUseOverlapCheck : 1;       // 0x0060 (0x0004) [0x0000000000000000]
                                      // [0x00000800]
    DWORD bOrientCameraShakeTowardsEpicenter : 1;  // 0x0060 (0x0004)
                                                   // [0x0000000000000000]
                                                   // [0x00001000]
    DWORD bAutoControllerVibration : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                                         // [0x00002000]
    ...
    class AActor*
        ActorToIgnoreForDamage;  // 0x0078 (0x0008) [0x0000000000000000]
    class UClass*
        ActorClassToIgnoreForDamage;  // 0x0080 (0x0008) [0x0000000000000000]
    class UClass*
        ActorClassToIgnoreForKnockdownsAndCringes;  // 0x0088 (0x0008)
                                                    // [0x0000000000000000]
    ...
    class UParticleSystem*
        ParticleEmitterTemplate;  // 0x00B0 (0x0008) [0x0000000000000000]
    ...
    class UAkBaseSoundObject*
        ExplosionSound;  // 0x00DC (0x0008) [0x0000000000000000]
    class UAkBaseSoundObject*
        ExplosionSoundHurtSomeone;  // 0x00E4 (0x0008) [0x0000000000000000]
    class UPointLightComponent*
        ExploLight;                      // 0x00EC (0x0008) [0x0000000000000000]
    ...
    class URadialBlurComponent*
        ExploRadialBlur;                 // 0x0104 (0x0008) [0x0000000000000000]
...
class AGameExplosionActor : public AActor {
   public:
    DWORD
        bHasExploded : 1;  // 0x0244 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bExplodeMoreThanOnce : 1;  // 0x0244 (0x0004) [0x0000000000000000]
                                     // [0x00000002]
    DWORD bTrackExplosionParticleSystemLifespan : 1;  // 0x0244 (0x0004)
                                                      // [0x0000000000000000]
                                                      // [0x00000004]
    DWORD bDrawDebug : 1;  // 0x0244 (0x0004) [0x0000000000000000] [0x00000008]
    class UPointLightComponent*
        ExplosionLight;             // 0x0248 (0x0008) [0x0000000000000000]
    ...
    class URadialBlurComponent*
        ExplosionRadialBlur;            // 0x0260 (0x0008) [0x0000000000000000]
    ...
    class UGameExplosion*
        ExplosionTemplate;  // 0x0280 (0x0008) [0x0000000000000000]
    class URB_RadialImpulseComponent*
        RadialImpulseComponent;  // 0x0288 (0x0008) [0x0000000000000000]
    class AController*
        InstigatorController;  // 0x0290 (0x0008) [0x0000000000000000]
    class AActor*
        HitActorFromPhysMaterialTrace;  // 0x0298 (0x0008) [0x0000000000000000]
    struct FVector HitLocationFromPhysMaterialTrace;  // 0x02A0 (0x000C)
                                                      // [0x0000000000000000]
    class AActor* Attachee;  // 0x02AC (0x0008) [0x0000000000000000]
    class AController*
        AttacheeController;             // 0x02B4 (0x0008) [0x0000000000000000]
    float DirectionalExplosionMinDot;   // 0x02BC (0x0004) [0x0000000000000000]
    struct FVector ExplosionDirection;  // 0x02C0 (0x000C) [0x0000000000150000]
                                        // ( CPF_Travel | CPF_GlobalConfig )
...
class ADebugCameraController : public AGamePlayerController {
   public:
    ...
    DWORD bShowSelectedInfo : 1;   // 0x0798 (0x0004) [0x0000000000000000]
                                   // [0x00000001]
    DWORD bDrawDebugText : 1;      // 0x0798 (0x0004) [0x0000000000000000]
                                   // [0x00000002]
    DWORD bIsFrozenRendering : 1;  // 0x0798 (0x0004) [0x0000000000000000]
                                   // [0x00000004]
    class UClass* HUDClass;        // 0x079C (0x0008) [0x0000000000000000]
    class APlayerController*
        OriginalControllerRef;      // 0x07A4 (0x0008) [0x0000000000000000]
    class UPlayer* OriginalPlayer;  // 0x07AC (0x0008) [0x0000000000000000]
    class UDrawFrustumComponent*
        DrawFrustum;              // 0x07B4 (0x0008) [0x0000000000000000]
    class AActor* SelectedActor;  // 0x07BC (0x0008) [0x0000000000000000]
    class UPrimitiveComponent*
        SelectedComponent;  // 0x07C4 (0x0008) [0x0000000000000000]
...
class AMobileHUD : public AHUD {
   public:
    DWORD
        bShowGameHud : 1;  // 0x0564 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bShowMobileHud : 1;   // 0x0564 (0x0004) [0x0000000000000000]
                                // [0x00000002]
    DWORD bForceMobileHUD : 1;  // 0x0564 (0x0004) [0x0000000000000000]
                                // [0x00000004]
    DWORD bShowMobileTilt : 1;  // 0x0564 (0x0004) [0x0000000000000000]
                                // [0x00000008]
    DWORD
        bDebugTouches : 1;  // 0x0564 (0x0004) [0x0000000000000000] [0x00000010]
    DWORD bDebugZones : 1;  // 0x0564 (0x0004) [0x0000000000000000] [0x00000020]
    DWORD bDebugZonePresses : 1;  // 0x0564 (0x0004) [0x0000000000000000]
                                  // [0x00000040]
    DWORD bShowMotionDebug : 1;   // 0x0564 (0x0004) [0x0000000000000000]
                                  // [0x00000080]
    class UTexture2D*
        JoystickBackground;  // 0x0568 (0x0008) [0x0000000000000000]
    struct FTextureUVs
        JoystickBackgroundUVs;          // 0x0570 (0x0010) [0x0000000000000000]
    ...
    class UTexture2D*
        ButtonImages[0x2];              // 0x0598 (0x0010) [0x0000000000000000]
    ...
    class UTexture2D*
        TrackballBackground;  // 0x05D4 (0x0008) [0x0000000000000000]
    struct FTextureUVs
        TrackballBackgroundUVs;  // 0x05DC (0x0010) [0x0000000000000000]
    class UTexture2D*
        TrackballTouchIndicator;  // 0x05EC (0x0008) [0x0000000000000000]
    struct FTextureUVs
        TrackballTouchIndicatorUVs;  // 0x05F4 (0x0010) [0x0000000000000000]
    class UTexture2D*
        SliderImages[0x4];              // 0x0604 (0x0020) [0x0000000000000000]
    ...
    TArray<class USeqEvent_HudRender*>
        KismetRenderEvents;  // 0x0670 (0x0010) [0x0000000000000000]
...
class UMobileInputZone : public UObject {
   public:
    ...
    DWORD bScalePawnMovement : 1;     // 0x00A8 (0x0004) [0x0000000000000000]
                                      // [0x00000001]
    ...
    DWORD bRelativeSizeX : 1;     // 0x00A8 (0x0004) [0x0000000000000000]
                                  // [0x00000008]
    DWORD bRelativeSizeY : 1;     // 0x00A8 (0x0004) [0x0000000000000000]
                                  // [0x00000010]
    DWORD bActiveSizeYFromX : 1;  // 0x00A8 (0x0004) [0x0000000000000000]
                                  // [0x00000020]
    DWORD bSizeYFromSizeX : 1;    // 0x00A8 (0x0004) [0x0000000000000000]
                                  // [0x00000040]
    DWORD bApplyGlobalScaleToActiveSizes : 1;  // 0x00A8 (0x0004)
                                               // [0x0000000000000000]
                                               // [0x00000080]
    DWORD bCenterX : 1;  // 0x00A8 (0x0004) [0x0000000000000000] [0x00000100]
    DWORD bCenterY : 1;  // 0x00A8 (0x0004) [0x0000000000000000] [0x00000200]
    DWORD
        bIsInvisible : 1;  // 0x00A8 (0x0004) [0x0000000000000000] [0x00000400]
    DWORD bQuickDoubleTap : 1;        // 0x00A8 (0x0004) [0x0000000000000000]
                                      // [0x00000800]
    DWORD bCenterOnEvent : 1;         // 0x00A8 (0x0004) [0x0000000000000000]
                                      // [0x00001000]
    DWORD bSliderHasTrack : 1;        // 0x00A8 (0x0004) [0x0000000000000000]
                                      // [0x00002000]
    DWORD bFloatingTiltZone : 1;      // 0x00A8 (0x0004) [0x0000000000000000]
                                      // [0x00004000]
    DWORD bUseGentleTransitions : 1;  // 0x00A8 (0x0004) [0x0000000000000000]
                                      // [0x00008000]
    DWORD bAllowFirstDeltaForTrackballZone : 1;  // 0x00A8 (0x0004)
                                                 // [0x0000000000000000]
                                                 // [0x00010000]
    DWORD
        bRenderGuides : 1;  // 0x00A8 (0x0004) [0x0000000000000000] [0x00020000]
    DWORD bIsDoubleTapAndHold : 1;  // 0x00A8 (0x0004) [0x0000000000000000]
                                    // [0x00040000]
    ...
    float
        ResetCenterAfterInactivityTime;  // 0x00E4 (0x0004) [0x0000000000000000]
    ...
    struct FString
        OverrideTexture1Name;            // 0x010C (0x0010) [0x0000000000000000]
    ...
    struct FString
        OverrideTexture2Name;          // 0x0134 (0x0010) [0x0000000000000000]
    ...
    struct FVector2D
        PreviousLocations[0x6];         // 0x0174 (0x0030) [0x0000000000000000]
    ...
    class UMobilePlayerInput*
        InputOwner;                   // 0x01CC (0x0008) [0x0000000000000000]
    float TransitionTime;             // 0x01D4 (0x0004) [0x0000000000000000]
    struct FVector2D EscapeVelocity;  // 0x01D8 (0x0008) [0x0000000000000000]
    TArray<class USeqEvent_MobileZoneBase*>
        MobileSeqEventHandlers;       // 0x01E0 (0x0010) [0x0000000000000000]
    ...
    struct FScriptDelegate
        __OnProcessInputDelegate__Delegate;  // 0x0200 (0x0010)
                                             // [0x0000000000000000]
    unsigned char UnknownData00[0x4];  // 0x0204 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnTapDelegate__Delegate;     // 0x0210 (0x0010) [0x0000000000000000]
    unsigned char UnknownData01[0x4];  // 0x0214 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnDoubleTapDelegate__Delegate;  // 0x0220 (0x0010)
                                          // [0x0000000000000000]
    unsigned char UnknownData02[0x4];  // 0x0224 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnProcessSlide__Delegate;    // 0x0230 (0x0010) [0x0000000000000000]
    unsigned char UnknownData03[0x4];  // 0x0234 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnPreDrawZone__Delegate;     // 0x0240 (0x0010) [0x0000000000000000]
    unsigned char UnknownData04[0x4];  // 0x0244 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnPostDrawZone__Delegate;    // 0x0250 (0x0010) [0x0000000000000000]
    unsigned char UnknownData05[0x4];  // 0x0254 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
...
class UMobileMenuObject : public UObject {
   public:
    DWORD bHasBeenInitialized : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
    DWORD
        bRelativeLeft : 1;  // 0x0060 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD
        bRelativeTop : 1;  // 0x0060 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bRelativeWidth : 1;           // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000008]
    DWORD bRelativeHeight : 1;          // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000010]
    DWORD bApplyGlobalScaleLeft : 1;    // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000020]
    DWORD bApplyGlobalScaleTop : 1;     // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000040]
    DWORD bApplyGlobalScaleWidth : 1;   // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000080]
    DWORD bApplyGlobalScaleHeight : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000100]
    DWORD bHeightRelativeToWidth : 1;   // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000200]
    DWORD bXOffsetIsActual : 1;         // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000400]
    DWORD bYOffsetIsActual : 1;         // 0x0060 (0x0004) [0x0000000000000000]
                                        // [0x00000800]
    ...
    DWORD bIsHighlighted : 1;  // 0x0060 (0x0004) [0x0000000000000000]
                               // [0x00008000]
    DWORD bTellSceneBeforeRendering : 1;  // 0x0060 (0x0004)
    ...
    class UMobilePlayerInput*
        InputOwner;                      // 0x00B0 (0x0008) [0x0000000000000000]
    ...
    class UMobileMenuObject*
        RelativeTo;  // 0x00D4 (0x0008) [0x0000000000000000]
...
class UMobileMenuScene : public UObject {
   public:
    ...
    TArray<class UMobileMenuObject*>
        MenuObjects;                // 0x0070 (0x0010) [0x0000000000000000]
    class UFont* SceneCaptionFont;  // 0x0080 (0x0008) [0x0000000000000000]
    class UMobilePlayerInput*
        InputOwner;  // 0x0088 (0x0008) [0x0000000000000000]
    DWORD bSceneDoesNotRequireInput : 1;  // 0x0090 (0x0004)
                                          // [0x0000000000000000] [0x00000001]
    DWORD
        bRelativeLeft : 1;  // 0x0090 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD
        bRelativeTop : 1;  // 0x0090 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bRelativeWidth : 1;           // 0x0090 (0x0004) [0x0000000000000000]
                                        // [0x00000008]
    DWORD bRelativeHeight : 1;          // 0x0090 (0x0004) [0x0000000000000000]
                                        // [0x00000010]
    DWORD bApplyGlobalScaleLeft : 1;    // 0x0090 (0x0004) [0x0000000000000000]
                                        // [0x00000020]
    DWORD bApplyGlobalScaleTop : 1;     // 0x0090 (0x0004) [0x0000000000000000]
                                        // [0x00000040]
    DWORD bApplyGlobalScaleWidth : 1;   // 0x0090 (0x0004) [0x0000000000000000]
                                        // [0x00000080]
    DWORD bApplyGlobalScaleHeight : 1;  // 0x0090 (0x0004) [0x0000000000000000]
                                        // [0x00000100]
...
class UMobilePlayerInput : public UPlayerInput {
   public:
    ...
    class UMobileMenuObject*
        InteractiveObject;  // 0x0450 (0x0008) [0x0000000000000000]
    struct FDouble
        InteractiveObjectLastTime;  // 0x0458 (0x0008) [0x0000000000000000]
    TArray<struct FMobileInputGroup>
        MobileInputGroups;   // 0x0460 (0x0010) [0x0000000000000000]
    int CurrentMobileGroup;  // 0x0470 (0x0004) [0x0000000000000000]
    TArray<class UMobileInputZone*>
        MobileInputZones;  // 0x0474 (0x0010) [0x0000000000000000]
    TArray<struct FMobileInputZoneClassMap>
        MobileInputZoneClasses;          // 0x0484 (0x0010) [0x0000000000000000]
    ...
    DWORD bAllowTouchesInCinematic : 1;  // 0x04C0 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD bDisableTouchInput : 1;        // 0x04C0 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    DWORD bAbsoluteTouchLocations : 1;   // 0x04C0 (0x0004) [0x0000000000000000]
                                         // [0x00000004]
    DWORD bCollapseTouchInput : 1;       // 0x04C0 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
    DWORD bFakeMobileTouches : 1;        // 0x04C0 (0x0004) [0x0000000000000000]
                                         // [0x00000010]
    DWORD bDisableSceneRender : 1;       // 0x04C0 (0x0004) [0x0000000000000000]
                                         // [0x00000020]
    float ZoneTimeout;                   // 0x04C4 (0x0004) [0x0000000000000000]
    TArray<class UMobileMenuScene*>
        MobileMenuStack;               // 0x04C8 (0x0010) [0x0000000000000000]
    ...
    TArray<class USeqEvent_MobileBase*>
        MobileSeqEventHandlers;  // 0x04EC (0x0010) [0x0000000000000000]
    TArray<class USeqEvent_MobileRawInput*>
        MobileRawInputSeqEventHandlers;  // 0x04FC (0x0010) [0x0000000000000000]
    struct FVector2D
        MobileViewportOffset;  // 0x050C (0x0008) [0x0000000000000000]
    struct FVector2D
        MobileViewportSize;  // 0x0514 (0x0008) [0x0000000000000000]
    struct FScriptDelegate
        __OnTouchNotHandledInMenu__Delegate;  // 0x051C (0x0010)
                                              // [0x0000000000000000]
    unsigned char UnknownData00[0x4];  // 0x0520 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnPreviewTouch__Delegate;    // 0x052C (0x0010) [0x0000000000000000]
    unsigned char UnknownData01[0x4];  // 0x0530 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnInputTouch__Delegate;      // 0x053C (0x0010) [0x0000000000000000]
    unsigned char UnknownData02[0x4];  // 0x0540 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
...
class UNavMeshPath_BiasAgainstPolysWithinDistanceOfLocations
    : public UNavMeshPathConstraint {
   public:
    ...
    TArray<struct FVector>
        LocationsToCheck;  // 0x0094 (0x0010) [0x0000000000000000]
...
UClass* UNavMeshPath_BiasAgainstPolysWithinDistanceOfLocations::pClassPointer =
    NULL;
...
class USeqAct_GameCrowdPopulationManagerToggle : public USequenceAction {
   public:
    ...
    class UGameCrowd_ListOfAgents*
        CrowdAgentList;             // 0x0154 (0x0008) [0x0000000000000000]
    DWORD bClearOldArchetypes : 1;  // 0x015C (0x0004) [0x0000000000000000]
                                    // [0x00000001]
    DWORD
        bEnableCrowdLightEnvironment : 1;  // 0x015C (0x0004)
                                           // [0x0000000000000000] [0x00000002]
    DWORD
        bCastShadows : 1;  // 0x015C (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bFillPotentialSpawnPoints : 1;  // 0x015C (0x0004)
                                          // [0x0000000000000000] [0x00000008]
    DWORD bForceObstacleChecking : 1;  // 0x015C (0x0004) [0x0000000000000000]
                                       // [0x00000010]
    DWORD bForceNavMeshPathing : 1;    // 0x015C (0x0004) [0x0000000000000000]
                                       // [0x00000020]
    DWORD bIndividualSpawner : 1;      // 0x015C (0x0004) [0x0000000000000000]
                                       // [0x00000040]
...
class USeqAct_GameCrowdSpawner
    : public USeqAct_GameCrowdPopulationManagerToggle {
   public:
   private:
    static UClass* pClassPointer;
...
class USeqAct_ModifyProperty : public USequenceAction {
   public:
    TArray<struct FPropertyInfo>
        Properties;  // 0x0150 (0x0010) [0x0000000000000000]
...
class USeqAct_PlayAgentAnimation : public USeqAct_Latent {
   public:
    ...
    DWORD bUseRootMotion : 1;            // 0x0180 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD bFaceActionTargetFirst : 1;    // 0x0180 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    DWORD bLooping : 1;  // 0x0180 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bBlendBetweenAnims : 1;  // 0x0180 (0x0004) [0x0000000000000000]
                                   // [0x00000008]
...
class USeqEvent_MobileButton : public USeqEvent_MobileZoneBase {
   public:
    DWORD bWasActiveLastFrame : 1;  // 0x0180 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
    DWORD bSendPressedOnlyOnTouchDown : 1;  // 0x0180 (0x0004)
                                            // [0x0000000000000000] [0x00000002]
    DWORD bSendPressedOnlyOnTouchUp : 1;    // 0x0180 (0x0004)
...
class USeqEvent_MobileObjectPicker : public USeqEvent_MobileRawInput {
   public:
    ...
    DWORD
        bCheckonTouch : 1;  // 0x0188 (0x0004) [0x0000000000000000] [0x00000001]
...
class USeqEvent_MobileSwipe : public USeqEvent_MobileRawInput {
   public:
    ...
    TArray<class AActor*>
        TouchedActors;    // 0x0194 (0x0010) [0x0000000000000000]
...
class UGameSkelCtrl_Recoil : public USkelControlBase {
   public:
    DWORD bBoneSpaceRecoil : 1;  // 0x00F4 (0x0004) [0x0000000000000000]
                                 // [0x00000001]
    DWORD bPlayRecoil : 1;  // 0x00F4 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD bOldPlayRecoil : 1;  // 0x00F4 (0x0004) [0x0000000000000000]
                               // [0x00000004]
    DWORD
        bApplyControl : 1;  // 0x00F4 (0x0004) [0x0000000000000000] [0x00000008]
...
class UGameCameraBase : public UObject {
   public:
    class AGamePlayerCamera*
        PlayerCamera;  // 0x0060 (0x0008) [0x0000000000000000]
    DWORD bResetCameraInterpolation : 1;  // 0x0068 (0x0004)
                                          // [0x0000000000000000] [0x00000001]
...
class UGameThirdPersonCamera : public UGameCameraBase {
   public:
    ...
    float
        WorstLocPenetrationExtentScale;  // 0x0070 (0x0004) [0x0000000000000000]
    ...
    struct FVector
        LastActualOriginOffset;  // 0x0084 (0x000C) [0x0000000000000000]
    struct FVector
        LastActualCameraOrigin;  // 0x0090 (0x000C) [0x0000000000000000]
    struct FRotator
        LastActualCameraOriginRot;  // 0x009C (0x000C) [0x0000000000000000]
    ...
    struct FVector
        LastIdealCameraOrigin;  // 0x00BC (0x000C) [0x0000000000000000]
    struct FRotator
        LastIdealCameraOriginRot;  // 0x00C8 (0x000C) [0x0000000000000000]
    class UGameThirdPersonCameraMode*
        ThirdPersonCamDefault;  // 0x00D4 (0x0008) [0x0000000000000000]
    class UClass*
        ThirdPersonCamDefaultClass;  // 0x00DC (0x0008) [0x0000000000000000]
    class UGameThirdPersonCameraMode*
        CurrentCamMode;                // 0x00E4 (0x0008) [0x0000000000000000]
    ...
    struct FVector
        ActualFocusPointWorldLoc;      // 0x0110 (0x000C) [0x0000000000000000]
    struct FVector LastFocusPointLoc;  // 0x011C (0x000C) [0x0000000000000000]
    struct FCamFocusPointParams
        FocusPoint;                   // 0x0128 (0x0038) [0x0000000000000000]
    DWORD bFocusPointSet : 1;         // 0x0160 (0x0004) [0x0000000000000000]
                                      // [0x00000001]
    DWORD bFocusPointSuccessful : 1;  // 0x0160 (0x0004) [0x0000000000000000]
                                      // [0x00000002]
    DWORD bDoingACameraTurn : 1;      // 0x0160 (0x0004) [0x0000000000000000]
                                      // [0x00000004]
    DWORD
        bTurnAlignTargetWhenFinished : 1;  // 0x0160 (0x0004)
                                           // [0x0000000000000000] [0x00000008]
    DWORD bDrawDebug : 1;  // 0x0160 (0x0004) [0x0000000000000000] [0x00000010]
    DWORD bDoingDirectLook : 1;         // 0x0160 (0x0004) [0x0000000000000000]
                                        // [0x00000020]
    DWORD bDebugChangedCameraMode : 1;  // 0x0160 (0x0004) [0x0000000000000000]
                                        // [0x00000040]
    DWORD bDoSeamlessPivotTransition : 1;  // 0x0160 (0x0004)
    ...
    struct FVector
        LastWorstLocationLocal;        // 0x0188 (0x000C) [0x0000000000000000]
    struct FVector LastWorstLocation;  // 0x0194 (0x000C) [0x0000000000000000]
    struct FVector
        LastPreModifierCameraLoc;  // 0x01A0 (0x000C) [0x0000000000000000]
    struct FRotator
        LastPreModifierCameraRot;  // 0x01AC (0x000C) [0x0000000000000000]
    TArray<struct FPenetrationAvoidanceFeeler>
        PenetrationAvoidanceFeelers;  // 0x01B8 (0x0010) [0x0000000000000000]
    struct FVector
        LastOffsetAdjustment;  // 0x01C8 (0x000C) [0x0000000000000000]
...
class AGamePlayerCamera : public ACamera {
   public:
    class UGameCameraBase*
        ThirdPersonCam;  // 0x064C (0x0008) [0x0000000000000000]
    class UClass*
        ThirdPersonCameraClass;       // 0x0654 (0x0008) [0x0000000000000000]
    ...
    class UGameCameraBase*
        CurrentCamera;                 // 0x066C (0x0008) [0x0000000000000000]
    DWORD bUseForcedCamFOV : 1;        // 0x0674 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD bInterpolateCamChanges : 1;  // 0x0674 (0x0004) [0x0000000000000000]
                                       // [0x00000002]
    DWORD
        bResetInterp : 1;  // 0x0674 (0x0004) [0x0000000000000000] [0x00000004]
...
class UGameThirdPersonCameraMode : public UObject {
   public:
    class UGameThirdPersonCamera*
        ThirdPersonCam;             // 0x0060 (0x0008) [0x0000000000000000]
    float FOVAngle;                 // 0x0068 (0x0004) [0x0000000000000000]
    float BlendTime;                // 0x006C (0x0004) [0x0000000000000000]
    DWORD bLockedToViewTarget : 1;  // 0x0070 (0x0004) [0x0000000000000000]
                                    // [0x00000001]
    DWORD bDirectLook : 1;  // 0x0070 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD
        bFollowTarget : 1;  // 0x0070 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bInterpLocation : 1;  // 0x0070 (0x0004) [0x0000000000000000]
                                // [0x00000008]
    DWORD bUsePerAxisOriginLocInterp : 1;  // 0x0070 (0x0004)
                                           // [0x0000000000000000] [0x00000010]
    DWORD bInterpRotation : 1;          // 0x0070 (0x0004) [0x0000000000000000]
                                        // [0x00000020]
    DWORD bRotInterpSpeedConstant : 1;  // 0x0070 (0x0004) [0x0000000000000000]
                                        // [0x00000040]
    DWORD bDoPredictiveAvoidance : 1;   // 0x0070 (0x0004) [0x0000000000000000]
                                        // [0x00000080]
    DWORD bValidateWorstLoc : 1;        // 0x0070 (0x0004) [0x0000000000000000]
                                        // [0x00000100]
    DWORD bSkipCameraCollision : 1;     // 0x0070 (0x0004) [0x0000000000000000]
                                        // [0x00000200]
    DWORD
        bSmoothViewOffsetPitchChanges : 1;  // 0x0070 (0x0004)
                                            // [0x0000000000000000] [0x00000400]
    DWORD bApplyDeltaViewOffset : 1;  // 0x0070 (0x0004) [0x0000000000000000]
                                      // [0x00000800]
    ...
    DWORD bNoFOVPostProcess : 1;  // 0x0070 (0x0004) [0x0000000000000000]
                                  // [0x00004000]
    DWORD bInterpViewOffsetOnlyForCamTransition : 1;  // 0x0070 (0x0004)
                                                      // [0x0000000000000000]
                                                      // [0x00008000]
    ...
    struct FVector
        PerAxisOriginLocInterpSpeed;  // 0x0088 (0x000C) [0x0000000000000000]
    float OriginRotInterpSpeed;       // 0x0094 (0x0004) [0x0000000000000000]
    struct FVector
        StrafeLeftAdjustment;  // 0x0098 (0x000C) [0x0000000000000000]
    struct FVector
        StrafeRightAdjustment;           // 0x00A4 (0x000C) [0x0000000000000000]
    ...
    struct FVector TargetRelativeCameraOriginOffset;  // 0x0104 (0x000C)
                                                      // [0x0000000000000000]
    struct FViewOffsetData ViewOffset;  // 0x0110 (0x0024) [0x0000000000000000]
    struct FViewOffsetData
        ViewOffset_ViewportAdjustments[0x6];  // 0x0134 (0x00D8)
                                              // [0x0000000000000000]
    ...
    struct FVector2D
        DOF_RadiusDistRange;            // 0x0244 (0x0008) [0x0000000000000000]
...
class UGameThirdPersonCameraMode_Default : public UGameThirdPersonCameraMode {
   public:
    ...
    DWORD bTemporaryOriginRotInterp : 1;  // 0x025C (0x0004)
                                          // [0x0000000000000000] [0x00000001]
    float
        TemporaryOriginRotInterpSpeed;  // 0x0260 (0x0004) [0x0000000000000000]
...
class UGameSpecialMove : public UObject {
   public:
    ...
    DWORD bLastCanDoSpecialMove : 1;     // 0x0074 (0x0004) [0x0000000000000000]
                                         // [0x00000001]
    DWORD bReachPreciseDestination : 1;  // 0x0074 (0x0004) [0x0000000000000000]
                                         // [0x00000002]
    DWORD bReachedPreciseDestination : 1;  // 0x0074 (0x0004)
                                           // [0x0000000000000000] [0x00000004]
    DWORD bReachPreciseRotation : 1;    // 0x0074 (0x0004) [0x0000000000000000]
                                        // [0x00000008]
    DWORD bReachedPreciseRotation : 1;  // 0x0074 (0x0004) [0x0000000000000000]
                                        // [0x00000010]
    DWORD bForcePrecisePosition : 1;    // 0x0074 (0x0004) [0x0000000000000000]
                                        // [0x00000020]
    ...
    struct FVector
        PreciseDestRelOffset;  // 0x008C (0x000C) [0x0000000000000000]
    float PreciseRotationInterpolationTime;  // 0x0098 (0x0004)
                                             // [0x0000000000000000]
...
class UGameStateObject : public UGameplayEventsHandler {
   public:
    ...
    DWORD bIsMatchStarted : 1;          // 0x00AC (0x0004) [0x0000000000000000]
                                        // [0x00000001]
    DWORD bIsRoundStarted : 1;          // 0x00AC (0x0004) [0x0000000000000000]
                                        // [0x00000002]
...
class UGameStatsAggregator : public UGameplayEventsHandler {
   public:
    ...
    TArray<struct FAggregateEventMapping>
        AggregatesList;  // 0x0090 (0x0010) [0x0000000000000000]
    struct FMap_Mirror
        AggregateEventsMapping;  // 0x00A0 (0x0048) [0x0000000000000000]
    TArray<struct FGameplayEventMetaData>
        AggregateEvents;               // 0x00E8 (0x0010) [0x0000000000000000]
    ...
    TArray<struct FTeamEvents>
        AllTeamEvents;  // 0x0150 (0x0010) [0x0000000000000000]
    TArray<struct FPlayerEvents>
        AllPlayerEvents;  // 0x0160 (0x0010) [0x0000000000000000]
    struct FWeaponEvents
        AllWeaponEvents;  // 0x0170 (0x0058) [0x0000000000000000]
    struct FProjectileEvents
        AllProjectileEvents;           // 0x01C8 (0x0058) [0x0000000000000000]
    struct FPawnEvents AllPawnEvents;  // 0x0220 (0x0058) [0x0000000000000000]
    struct FDamageEvents
        AllDamageEvents;  // 0x0278 (0x0058) [0x0000000000000000]
...
class UGameWaveForms : public UObject {
   public:
    class UForceFeedbackWaveform*
        CameraShakeMediumShort;  // 0x0060 (0x0008) [0x0000000000000000]
    class UForceFeedbackWaveform*
        CameraShakeMediumLong;  // 0x0068 (0x0008) [0x0000000000000000]
    class UForceFeedbackWaveform*
        CameraShakeBigShort;  // 0x0070 (0x0008) [0x0000000000000000]
    class UForceFeedbackWaveform*
        CameraShakeBigLong;  // 0x0078 (0x0008) [0x0000000000000000]
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[41997];
...
class USeqAct_ToggleMouseCursor : public USequenceAction {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[42002];
...
class ADebugCameraHUD : public AHUD {
   public:
    DWORD bDrawDebugText : 1;  // 0x0564 (0x0004) [0x0000000000000000]
                               // [0x00000001]
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[42058];
...
class UDebugCameraInput : public UPlayerInput {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[42061];
...
class UGameAICmd_Hover_MoveToGoal : public UGameAICommand {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[42562];
...
class UGameAICmd_Hover_MoveToGoal_Mesh : public UGameAICommand {
   public:
    ...
    DWORD bFinalApproach : 1;          // 0x00A0 (0x0004) [0x0000000000000000]
                                       // [0x00000002]
    DWORD bFallbackMoveToMesh : 1;     // 0x00A0 (0x0004) [0x0000000000000000]
                                       // [0x00000004]
    ...
    struct FBasedPosition
        LastMoveTargetPathLocation;  // 0x00E8 (0x0038) [0x0000000000000000]
    struct FVector
        InitialFinalDestination;  // 0x0120 (0x000C) [0x0000000000000000]
...
class UGameCrowd_ListOfAgents : public UObject {
   public:
    TArray<struct FAgentArchetypeInfo>
        ListOfAgents;  // 0x0060 (0x0010) [0x0000000000000000]
...
class UGameCrowdSpawnerInterface : public UInterface {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[43071];
...
class UGameExplosionContent : public UObject {
   public:
    ...
    DWORD bOrientCameraShakeTowardsEpicenter : 1;  // 0x0060 (0x0004)
                                                   ...
                                                   // [0x00000002]
    class UAkBaseSoundObject*
        ExplosionSound;                  // 0x0064 (0x0008) [0x0000000000000000]
    ...
    class UPointLightComponent*
        ExploLight;               // 0x00A4 (0x0008) [0x0000000000000000]
    float ExploLightFadeOutTime;  // 0x00AC (0x0004) [0x0000000000000000]
    class URadialBlurComponent*
        ExploRadialBlur;               // 0x00B0 (0x0008) [0x0000000000000000]
    ...
    class UParticleSystem*
        ParticleEmitterTemplate;  // 0x00C0 (0x0008) [0x0000000000000000]
    class AFogVolumeSphericalDensityInfo*
        FogVolumeArchetype;  // 0x00C8 (0x0008) [0x0000000000000000]
...
class UGameFixedCamera : public UGameCameraBase {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[43665];
...
class AGameKActorSpawnableEffect : public AKActor {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[43676];
...
class AMobileDebugCameraController : public ADebugCameraController {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[44211];
...
class AMobileDebugCameraHUD : public AMobileHUD {
   public:
    DWORD bDrawDebugText : 1;  // 0x0680 (0x0004) [0x0000000000000000]
                               // [0x00000001]
...
class UMobileMenuBar : public UMobileMenuObject {
   public:
    ...
    TArray<class UMobileMenuBarItem*>
        Items;  // 0x00E8 (0x0010) [0x0000000000000000]
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[44775];
...
class UMobileMenuBarItem : public UObject {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[44818];
...
class UMobileMenuElement : public UObject {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[44853];
...
class AMobileMenuGame : public AGameInfo {
   public:
    class UClass*
        InitialSceneToDisplayClass;  // 0x0498 (0x0008) [0x0000000000000000]
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[44870];
...
class UMobileMenuInventory : public UMobileMenuObject {
   public:
    TArray<class UMobileMenuElement*>
        Slots;  // 0x00DC (0x0010) [0x0000000000000000]
    TArray<class UMobileMenuElement*>
        Items;                // 0x00EC (0x0010) [0x0000000000000000]
    float SideLeewayPercent;  // 0x00FC (0x0004) [0x0000000000000000]
    struct FRenderElementInfo
        CurrentElement;            // 0x0100 (0x0008) [0x0000000000000000]
    struct FDragElementInfo Drag;  // 0x0108 (0x0028) [0x0000000000000000]
    struct FVector2D ScaleSize;    // 0x0130 (0x0008) [0x0000000000000000]
    DWORD bRenderDragItem : 1;     // 0x0138 (0x0004) [0x0000000000000000]
                                   // [0x00000001]
    struct FScriptDelegate
        __OnUpdateItemInSlot__Delegate;  // 0x013C (0x0010) [0x0000000000000000]
    unsigned char UnknownData00[0x4];  // 0x0140 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __DoCanPutItemInSlot__Delegate;  // 0x014C (0x0010) [0x0000000000000000]
    unsigned char UnknownData01[0x4];  // 0x0150 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnUpdateDrag__Delegate;      // 0x015C (0x0010) [0x0000000000000000]
    unsigned char UnknownData02[0x4];  // 0x0160 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
...
class UMobileMenuList : public UMobileMenuObject {
   public:
    DWORD bIsVerticalList : 1;         // 0x00DC (0x0004) [0x0000000000000000]
                                       // [0x00000001]
    DWORD bDisableScrolling : 1;       // 0x00DC (0x0004) [0x0000000000000000]
                                       // [0x00000002]
    DWORD bForceSelectedToLineup : 1;  // 0x00DC (0x0004) [0x0000000000000000]
                                       // [0x00000004]
    DWORD bTapToScrollToItem : 1;      // 0x00DC (0x0004) [0x0000000000000000]
                                       // [0x00000008]
    DWORD bLoops : 1;      // 0x00DC (0x0004) [0x0000000000000000] [0x00000010]
    float SelectedOffset;  // 0x00E0 (0x0004) [0x0000000000000000]
    TArray<class UMobileMenuListItem*>
        Items;  // 0x00E4 (0x0010) [0x0000000000000000]
    struct FSelectedMenuItem
        SelectedItem;               // 0x00F4 (0x000C) [0x0000000000000000]
    struct FMenuListDragInfo Drag;  // 0x0100 (0x0054) [0x0000000000000000]
    struct FMenuListMovementInfo
        Movement;                 // 0x0154 (0x001C) [0x0000000000000000]
...
class UMobileMenuObjectProxy : public UMobileMenuObject {
   public:
    struct FScriptDelegate
        __OnTouchEvent__Delegate;      // 0x00DC (0x0010) [0x0000000000000000]
    unsigned char UnknownData00[0x4];  // 0x00E0 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
    struct FScriptDelegate
        __OnRenderObject__Delegate;    // 0x00EC (0x0010) [0x0000000000000000]
    unsigned char UnknownData01[0x4];  // 0x00F0 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
...
class USeqEvent_MobileTouchInputVolume : public USequenceEvent {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[45263];
...
class UTouchableElement3D : public UInterface {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[45266];
...
class APlayerCollectorGame : public AGameInfo {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[45292];
...
class UPMESTG_LeaveADecalBase : public UParticleModuleEventSendToGame {
   public:
    class UClass*
        PhysicalMaterialPropertyClass;  // 0x0060 (0x0008) [0x0000000000000000]
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[45307];
...
class USeqEvent_HudRenderImage : public USeqEvent_HudRender {
   ...
   public:
    static UClass* StaticClass() {
        if (!pClassPointer)
            pClassPointer = (UClass*)UObject::GObjObjects()->Data[45390];
