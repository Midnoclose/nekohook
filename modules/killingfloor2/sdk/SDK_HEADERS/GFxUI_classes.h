...
class UGFxEngine : public UObject {
   public:
    TArray<struct FGCReference>
        GCReferences;  // 0x0060 (0x0010) [0x0000000000000000]
...
class UGFxInteraction : public UInteraction {
   public:
    struct FPointer
        VfTable_FCallbackEventDevice;  // 0x00B0 (0x0008) [0x0000000000000000]
    DWORD bFakeMobileTouches : 1;      // 0x00B8 (0x0004) [0x0000000000000000]
                                       // [0x00000001]
   ...
   public:
    ...
    unsigned char
        UnknownData00[0x48];  // 0x0078 (0x0048) UNKNOWN PROPERTY: MapProperty
                              // GFxUI.GFxMoviePlayer.ASUClasses
    unsigned char
        UnknownData01[0x48];  // 0x00C0 (0x0048) UNKNOWN PROPERTY: MapProperty
                              // GFxUI.GFxMoviePlayer.ASUObjects
    int NextASUObject;        // 0x0108 (0x0004) [0x0000000000000000]
    class USwfMovie* MovieInfo;  // 0x010C (0x0008) [0x0000000000000000]
    DWORD
        bMovieIsOpen : 1;  // 0x0114 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bDisplayWithHudOff : 1;      // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00000002]
    DWORD bEnableGammaCorrection : 1;  // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00000004]
    DWORD
        bWidgetsInitializedThisFrame : 1;  // 0x0114 (0x0004)
                                           // [0x0000000000000000] [0x00000008]
    DWORD bLogUnhandedWidgetInitializations : 1;  // 0x0114 (0x0004)
                                                  // [0x0000000000000000]
                                                  // [0x00000010]
    ...
    DWORD bPauseGameWhileActive : 1;   // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00000100]
    DWORD bDisableWorldRendering : 1;  // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00000200]
    DWORD bCaptureWorldRendering : 1;  // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00000400]
    DWORD bCloseOnLevelChange : 1;     // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00000800]
    DWORD bOnlyOwnerFocusable : 1;     // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00001000]
    DWORD bForceFullViewport : 1;      // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00002000]
    DWORD bDiscardNonOwnerInput : 1;   // 0x0114 (0x0004) [0x0000000000000000]
                                       // [0x00004000]
    DWORD
        bCaptureInput : 1;  // 0x0114 (0x0004) [0x0000000000000000] [0x00008000]
    DWORD bCaptureMouseInput : 1;  // 0x0114 (0x0004) [0x0000000000000000]
                                   // [0x00010000]
    DWORD bIgnoreMouseInput : 1;   // 0x0114 (0x0004) [0x0000000000000000]
                                   // [0x00020000]
    DWORD
        bIsSplitscreenLayoutModified : 1;  // 0x0114 (0x0004)
                                           // [0x0000000000000000] [0x00040000]
    DWORD bShowHardwareMouseCursor : 1;  // 0x0114 (0x0004) [0x0000000000000000]
                                         // [0x00080000]
    DWORD bBlurLesserMovies : 1;         // 0x0114 (0x0004) [0x0000000000000000]
                                         // [0x00100000]
    DWORD bHideLesserMovies : 1;         // 0x0114 (0x0004) [0x0000000000000000]
                                         // [0x00200000]
    DWORD bIsPriorityBlurred : 1;        // 0x0114 (0x0004) [0x0000000000000000]
                                         // [0x00400000]
    DWORD bIsPriorityHidden : 1;         // 0x0114 (0x0004) [0x0000000000000000]
                                         // [0x00800000]
    DWORD bIgnoreVisibilityEffect : 1;   // 0x0114 (0x0004) [0x0000000000000000]
                                         // [0x01000000]
    DWORD bIgnoreBlurEffect : 1;         // 0x0114 (0x0004) [0x0000000000000000]
                                         // [0x02000000]
    class UTextureRenderTarget2D*
        RenderTexture;                 // 0x0118 (0x0008) [0x0000000000000000]
    ...
    TArray<struct FName>
        FocusIgnoreKeys;  // 0x013C (0x0010) [0x0000000000000000]
    TArray<struct FExternalTexture>
        ExternalTextures;  // 0x014C (0x0010) [0x0000000000000000]
    TArray<struct FSoundThemeBinding>
        SoundThemes;                  // 0x015C (0x0010) [0x0000000000000000]
    ...
    TArray<struct FGFxWidgetBinding>
        WidgetBindings;  // 0x0170 (0x0010) [0x0000000000000000]
    unsigned char
        UnknownData02[0x48];  // 0x0180 (0x0048) UNKNOWN PROPERTY: MapProperty
                              // GFxUI.GFxMoviePlayer.WidgetPathBindings
    class UGFxObject*
        SplitscreenLayoutObject;   // 0x01C8 (0x0008) [0x0000000000000000]
    int SplitscreenLayoutYAdjust;  // 0x01D0 (0x0004) [0x0000000000000000]
    struct FScriptDelegate
        __OnPostAdvance__Delegate;     // 0x01D4 (0x0010) [0x0000000000000000]
    unsigned char UnknownData03[0x4];  // 0x01D8 (0x0004) FIX WRONG TYPE SIZE OF
                                       // PREVIUS PROPERTY
...
class UGFxObject : public UObject {
   public:
    ...
    TArray<struct FGFxWidgetBinding>
        SubWidgetBindings;  // 0x0090 (0x0010) [0x0000000000000000]
...
class UGFxRawData : public UObject {
   public:
    ...
    TArray<struct FString>
        ReferencedSwfs;                 // 0x0070 (0x0010) [0x0000000000000000]
    TArray<class UObject*> References;  // 0x0080 (0x0010) [0x0000000000000000]
    TArray<class UObject*>
        UserReferences;  // 0x0090 (0x0010) [0x0000000000000000]
...
class USwfMovie : public UGFxRawData {
   public:
    DWORD
        bUsesFontlib : 1;  // 0x00A0 (0x0004) [0x0000000000000000] [0x00000001]
    DWORD bSetSRGBOnImportedTextures : 1;  // 0x00A0 (0x0004)
                                           // [0x0000000000000000] [0x00000002]
    DWORD
        bPackTextures : 1;  // 0x00A0 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bForceSquarePacking : 1;       // 0x00A0 (0x0004) [0x0000000000000000]
                                         // [0x00000008]
...
class UGFxAction_OpenMovie : public USequenceAction {
   public:
    ...
    DWORD
        bCaptureInput : 1;  // 0x0168 (0x0004) [0x0000000000000000] [0x00000002]
    DWORD
        bStartPaused : 1;  // 0x0168 (0x0004) [0x0000000000000000] [0x00000004]
    DWORD bEnableGammaCorrection : 1;  // 0x0168 (0x0004) [0x0000000000000000]
                                       // [0x00000008]
    DWORD bDisplayWithHudOff : 1;      // 0x0168 (0x0004) [0x0000000000000000]
                                       // [0x00000010]
    unsigned char RenderTextureMode;   // 0x016C (0x0001) [0x0000000000000000]
    class UTextureRenderTarget2D*
        RenderTexture;                 // 0x0170 (0x0008) [0x0000000000000000]
    TArray<struct FName> CaptureKeys;  // 0x0178 (0x0010) [0x0000000000000000]
    TArray<struct FName>
        FocusIgnoreKeys;  // 0x0188 (0x0010) [0x0000000000000000]
...
class UGFxEvent_FSCommand : public USequenceEvent {
   public:
    ...
    class UGFxFSCmdHandler_Kismet*
        Handler;  // 0x0188 (0x0008) [0x0000000000000000]
...
class UGFxClikWidget : public UGFxObject {
   public:
    ...
    struct FScriptDelegate
        __EventListener__Delegate;     // 0x00A8 (0x0010) [0x0000000000000000]
