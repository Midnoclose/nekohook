...
struct UFacebookWindows_execOnFacebookFriendsRequestComplete_Parms {
    ...
    // [0x0000000000000000] [0x00000001] struct FString JsonPayload;
    // // 0x0014 (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0024 (0x0008) [0x0000000000000000] class UJsonObject* FriendsJson;
    // // 0x002C (0x0008) [0x0000000000000000] int JsonIndex;
    // // 0x0034 (0x0004) [0x0000000000000000] struct
    // FPlatformInterfaceDelegateResult         DelegateResult;
    // // 0x0038 (0x0040) [0x0000000000000000] struct FFacebookFriend Friend;
    // // 0x0078 (0x0020) [0x0000000000000000]
};
...
struct UFacebookWindows_execOnFacebookMeRequestComplete_Parms {
    ...
    // [0x0000000000000000] [0x00000001] struct FString JsonPayload;
    // // 0x0014 (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0024 (0x0008) [0x0000000000000000] struct
    // FPlatformInterfaceDelegateResult         DelegateResult;
    // // 0x002C (0x0040) [0x0000000000000000]
};
...
struct UFacebookWindows_execFacebookRequestCallback_Parms {
    ...
    // Response;                                         		// 0x0008 (0x0008)
    // [0x0000000000000000] DWORD bDidSucceed : 1; // 0x0010 (0x0004)
    // [0x0000000000000000] [0x00000001] struct FString Payload;
...
struct UFacebookWindows_execProcessFacebookRequest_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] int ResponseCode;
...
struct UHttpRequestWindows_execSetHeader_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString HeaderValue;
...
struct UHttpRequestWindowsMcp_execProcessRequest_Parms {
    // DWORD                                           ReturnValue : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FString URL;
