...
struct AInternetLink_eventResolved_Parms {
    // struct FIpAddr                                  Addr;
    // // 0x0000 (0x0014) [0x0000000000000000]
};
...
struct AInternetLink_execStringToIpAddr_Parms {
    // struct FString                                  Str;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FIpAddr Addr;
    // // 0x0010 (0x0014) [0x0000000000000000] DWORD ReturnValue : 1;
...
struct AInternetLink_execIpAddrToString_Parms {
    // struct FIpAddr                                  Arg;
    // // 0x0000 (0x0014) [0x0000000000000000] struct FString ReturnValue;
...
struct AInternetLink_execParseURL_Parms {
    // struct FString                                  URL;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString Addr;
    // // 0x0010 (0x0010) [0x0000000000000000] int PortNum;
    // // 0x0020 (0x0004) [0x0000000000000000] struct FString LevelName;
    // // 0x0024 (0x0010) [0x0000000000000000] struct FString EntryName;
...
struct ATcpLink_eventReceivedBinary_Parms {
    // int                                             Count;
    // // 0x0000 (0x0004) [0x0000000000000000] unsigned char B[ 0xFF ];
    // // 0x0004 (0x00FF) [0x0000000000000000]
};
...
struct ATcpLink_execReadBinary_Parms {
    // int                                             Count;
    // // 0x0000 (0x0004) [0x0000000000000000] unsigned char B[ 0xFF ];
    // // 0x0004 (0x00FF) [0x0000000000000000] int ReturnValue;
    // // 0x0104 (0x0004) [0x0000000000000000]
};
...
struct ATcpLink_execReadText_Parms {
    // struct FString                                  Str;
    // // 0x0000 (0x0010) [0x0000000000000000] int ReturnValue;
...
struct ATcpLink_execOpen_Parms {
    // struct FIpAddr                                  Addr;
    // // 0x0000 (0x0014) [0x0000000000000000] DWORD ReturnValue : 1;
...
struct ATcpLink_execBindPort_Parms {
    // int                                             PortNum;
    // // 0x0000 (0x0004) [0x0000000000000000] DWORD bUseNextAvailable : 1;
    // // 0x0004 (0x0004) [0x0000000000000000] [0x00000001] int ReturnValue;
...
struct UMcpServiceBase_execGetUserAuthURL_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString ReturnValue;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString AuthTicket;
...
struct UOnlineEventsInterfaceMcp_execUploadMatchmakingStats_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UOnlineMatchmakingStats*
    // MMStats;                                          		// 0x0008 (0x0008)
...
struct UOnlineEventsInterfaceMcp_execUpdatePlaylistPopulation_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] int NumPlayers;
...
struct UOnlineEventsInterfaceMcp_execUploadGameplayEventsData_Parms {
    // struct FUniqueNetId                             UniqueId;
    // // 0x0000 (0x0008) [0x0000000000000000] TArray< unsigned char > Payload;
...
struct UOnlineEventsInterfaceMcp_execUploadPlayerData_Parms {
    // struct FUniqueNetId                             UniqueId;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FString PlayerNick;
    // // 0x0008 (0x0010) [0x0000000000000000] class UOnlineProfileSettings*
    // ProfileSettings;                                  		// 0x0018 (0x0008)
    // [0x0000000000000000] class UOnlinePlayerStorage* PlayerStorage;
    // // 0x0020 (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
...
struct UOnlineNewsInterfaceMcp_execGetNews_Parms {
    ...
    // // 0x0000 (0x0001) [0x0000000000000000] unsigned char NewsType;
    // // 0x0001 (0x0001) [0x0000000000000000] struct FString ReturnValue;
    // // 0x0004 (0x0010) [0x0000000000000000] int NewsIndex;
...
struct UOnlineTitleFileDownloadBase_execReadTitleFile_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] unsigned char FileType;
    // // 0x0010 (0x0001) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UOnlineTitleFileDownloadMcp_execGetTitleFileState_Parms {
    // struct FString                                  Filename;
    // // 0x0000 (0x0010) [0x0000000000000000] unsigned char ReturnValue;
    // // 0x0010 (0x0001) [0x0000000000000000] int FileIndex;
    // // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UOnlineTitleFileDownloadWeb_execOnFileListReceived_Parms {
    ...
    // [0x0000000000000000] [0x00000001] int Index; // 0x0014 (0x0004)
    // [0x0000000000000000] struct FScriptDelegate RequestTitleFileListDelegate;
    // // 0x0018 (0x0010) [0x0000000000000000] TArray< struct FString >
    // ResponseStr;                                      		// 0x0028 (0x0010)
    // [0x0000000000000000] DWORD bSuccess : 1; // 0x0038 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UOnlineTitleFileDownloadWeb_execRequestTitleFileList_Parms {
    ...
    // UHttpRequestInterface*                    HTTPRequest;
    // // 0x0004 (0x0008) [0x0000000000000000] struct FString URL;
    // // 0x000C (0x0010) [0x0000000000000000]
};
...
struct UOnlineTitleFileDownloadWeb_execOnFileDownloadComplete_Parms {
    ...
    // Response;                                         		// 0x0008 (0x0008)
    // [0x0000000000000000] DWORD bDidSucceed : 1; // 0x0010 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bSuccess : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] int FileIndex;
    // // 0x0018 (0x0004) [0x0000000000000000] int Idx;
    // // 0x001C (0x0004) [0x0000000000000000] struct FString Filename;
    // // 0x0020 (0x0010) [0x0000000000000000] TArray< unsigned char >
    // BinaryData;                                       		// 0x0030 (0x0010)
    // [0x0000000000000000] struct FString FileCompressionTypeString;
...
struct UOnlineTitleFileDownloadWeb_execReadTitleFile_Parms {
    ...
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] int FileIndex;
    // // 0x0018 (0x0004) [0x0000000000000000] int Idx;
    // // 0x001C (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UOnlineTitleFileDownloadWeb_execUncompressTitleFileContents_Parms {
    // unsigned char                                   FileCompressionType;
    // // 0x0000 (0x0001) [0x0000000000000000] TArray< unsigned char >
    // CompressedFileContents;                           		// 0x0004 (0x0010)
    // [0x0000000000000000] TArray< unsigned char > UncompressedFileContents;
...
struct UTitleFileDownloadCache_execSaveTitleFile_Parms {
    // struct FString                                  Filename;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString LogicalName;
...
struct UMcpMessageBase_execCacheMessageContents_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString MessageId;
...
struct UMcpMessageBase_execCacheMessage_Parms {
    ...
    // // 0x0000 (0x0064) [0x0000000000000000]
};
...
struct UMcpMessageBase_execOnQueryMessageContentsComplete_Parms {
    // struct FString                                  MessageId;
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bWasSuccessful : 1;
...
struct UMcpMessageBase_execGetMessageList_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpMessageList
    // MessageList;                                      		// 0x0010 (0x0020)
    // [0x0000000000000000]
};
...
struct UMcpMessageBase_execOnCreateMessageComplete_Parms {
    // struct FMcpMessage                              Message;
    // // 0x0000 (0x0064) [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0064 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0068 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpMessageBase_execCreateMessage_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString FromUniqueUserId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString FromFriendlyName;
    // // 0x0020 (0x0010) [0x0000000000000000] struct FString MessageType;
    // // 0x0030 (0x0010) [0x0000000000000000] struct FString PushMessage;
    // // 0x0040 (0x0010) [0x0000000000000000] struct FString ValidUntil;
    // // 0x0050 (0x0010) [0x0000000000000000] TArray< unsigned char >
    // MessageContents;                                  		// 0x0060 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpMessageBase_execCreateInstance_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass*
    // McpMessageBaseClass;                              		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMcpMessageBase* NewInstance;
...
struct UMcpMessageManager_execCacheMessageContents_Parms {
    ...
    // MessageContentsIndex;                             		// 0x0024 (0x0004)
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0028 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpMessageManager_execGetMessageById_Parms {
    // struct FString                                  MessageId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpMessage Message;
    // // 0x0010 (0x0064) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0074 (0x0004) [0x0000000000000000] [0x00000001] int
    // MessageListsSize;                                 		// 0x0078 (0x0004)
    // [0x0000000000000000] int MessageListsItr; // 0x007C (0x0004)
    // [0x0000000000000000] int MessageItr; // 0x0080 (0x0004)
    // [0x0000000000000000]
};
...
struct UMcpMessageManager_execCacheMessage_Parms {
    // struct FMcpMessage                              Message;
    // // 0x0000 (0x0064) [0x0000000000000000] int AddAt;
    // // 0x0064 (0x0004) [0x0000000000000000] int MessageIndex;
    // // 0x0068 (0x0004) [0x0000000000000000] int MessageListIndex;
    // // 0x006C (0x0004) [0x0000000000000000] struct FMcpMessageList
    // UserMessageList;                                  		// 0x0070 (0x0020)
    // [0x0000000000000000] DWORD bWasFound : 1; // 0x0090 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UMcpMessageManager_execGetMessageContents_Parms {
    ...
    // MessageContents;                                  		// 0x0010 (0x0010)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0020 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bWasSuccessful : 1;
    // // 0x0024 (0x0004) [0x0000000000000000] [0x00000001] int
    // MessageContentsIndex;                             		// 0x0028 (0x0004)
    // [0x0000000000000000]
};
...
struct UMcpMessageManager_execOnQueryMessageContentsRequestComplete_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UHttpResponseInterface*
    // HttpResponse;                                     		// 0x0008 (0x0008)
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int ResponseCode;
    // // 0x0014 (0x0004) [0x0000000000000000] TArray< unsigned char >
    // MessageContents;                                  		// 0x0018 (0x0010)
    // [0x0000000000000000] struct FString MessageId;
    // // 0x0028 (0x0010) [0x0000000000000000] struct FMcpMessage Message;
    // // 0x0038 (0x0064) [0x0000000000000000]
};
...
struct UMcpMessageManager_execQueryMessageContents_Parms {
    // struct FString                                  MessageId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0010 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // QueryMessageContentsRequest;                      		// 0x0020 (0x0008)
    // [0x0000000000000000]
};
...
struct UMcpMessageManager_execGetMessageList_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpMessageList
    // MessageList;                                      		// 0x0010 (0x0020)
    // [0x0000000000000000] int MessageListIndex; // 0x0030 (0x0004)
    // [0x0000000000000000]
};
...
struct UMcpMessageManager_execOnQueryMessagesRequestComplete_Parms {
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int ResponseCode;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FString Error;
    // // 0x0018 (0x0010) [0x0000000000000000] struct FString JsonString;
    // // 0x0028 (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0038 (0x0008) [0x0000000000000000] int JsonIndex;
    // // 0x0040 (0x0004) [0x0000000000000000] struct FMcpMessage Message;
    // // 0x0044 (0x0064) [0x0000000000000000] struct FString
    // MessageCompressionTypeString;                     		// 0x00A8 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpMessageManager_execQueryMessages_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0010 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // QueryMessagesRequest;                             		// 0x0020 (0x0008)
    // [0x0000000000000000]
};
...
struct UMcpMessageManager_execOnDeleteMessageRequestComplete_Parms {
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int ResponseCode;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FString Content;
    // // 0x0018 (0x0010) [0x0000000000000000] struct FString MessageId;
...
struct UMcpMessageManager_execDeleteMessage_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0010 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // DeleteMessageRequest;                             		// 0x0020 (0x0008)
    // [0x0000000000000000]
};
...
struct UMcpMessageManager_execOnCreateMessageRequestComplete_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int ResponseCode;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FString Content;
    // // 0x0018 (0x0010) [0x0000000000000000] struct FMcpMessage
    // CreatedMessage;                                   		// 0x0028 (0x0064)
    // [0x0000000000000000]
};
...
struct UMcpMessageManager_execCreateMessage_Parms {
    ...
    // // 0x0050 (0x0010) [0x0000000000000000] TArray< unsigned char >
    // MessageContents;                                  		// 0x0060 (0x0010)
    // [0x0000000000000000] struct FString                                  URL;
    // // 0x0070 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // CreateMessageRequest;                             		// 0x0080 (0x0008)
    // [0x0000000000000000] struct FMcpMessage Message;
    // // 0x0088 (0x0064) [0x0000000000000000] struct FString
    // ToUniqueUserIdsStr;                               		// 0x00EC (0x0010)
    // [0x0000000000000000] int                                             Idx;
    // // 0x00FC (0x0004) [0x0000000000000000]
};
...
struct UMcpMessageManager_eventFinishedAsyncUncompression_Parms {
    // DWORD                                           bWasSuccessful : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] TArray< unsigned
    // char >                         UncompressedMessageContents;
    // // 0x0004 (0x0010) [0x0000000000000000] struct FString MessageId;
    // // 0x0014 (0x0010) [0x0000000000000000]
};
...
struct UMcpMessageManager_execStartAsyncUncompression_Parms {
    // struct FString                                  MessageId;
    // // 0x0000 (0x0010) [0x0000000000000000] unsigned char
    // MessageCompressionType;                           		// 0x0010 (0x0001)
    // [0x0000000000000000] TArray< unsigned char > MessageContent;
    // // 0x0014 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0024 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpMessageManager_execStartAsyncCompression_Parms {
    // unsigned char                                   MessageCompressionType;
    // // 0x0000 (0x0001) [0x0000000000000000] TArray< unsigned char >
    // MessageContent;                                   		// 0x0004 (0x0010)
    // [0x0000000000000000] class UHttpRequestInterface* Request;
...
struct UMcpUserCloudFileDownload_execCallDeleteUserFileCompleteDelegates_Parms {
    ...
    // [0x0000000000000000] int Index; // 0x0024 (0x0004) [0x0000000000000000]
    // struct FScriptDelegate                          CallDelegate;
    // // 0x0028 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserCloudFileDownload_execOnHTTPRequestDeleteUserFileComplete_Parms {
    ...
    // Response;                                         		// 0x0008 (0x0008)
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int EntryIdx;
    // // 0x0014 (0x0004) [0x0000000000000000] int FileIdx;
    // // 0x0018 (0x0004) [0x0000000000000000] struct FString Filename;
    // // 0x001C (0x0010) [0x0000000000000000] struct FString UserId;
    // // 0x002C (0x0010) [0x0000000000000000] DWORD bResult : 1;
    // // 0x003C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpUserCloudFileDownload_execDeleteUserFile_Parms {
    ...
    // // 0x0028 (0x0004) [0x0000000000000000] [0x00000001] int EntryIdx;
    // // 0x002C (0x0004) [0x0000000000000000] int FileIdx;
    // // 0x0030 (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x0034 (0x0010) [0x0000000000000000] DWORD bPending : 1;
    // // 0x0044 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpUserCloudFileDownload_execGetUserFileIndexForRequest_Parms {
    // class UHttpRequestInterface*                    Request;
    // // 0x0000 (0x0008) [0x0000000000000000] int UserIdx;
    // // 0x0008 (0x0004) [0x0000000000000000] int FileIdx;
...
struct UMcpUserCloudFileDownload_execWriteUserFile_Parms {
    ...
    // FileContents;                                     		// 0x0020 (0x0010)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0030 (0x0004)
    // [0x0000000000000000] [0x00000001] int EntryIdx; // 0x0034 (0x0004)
    // [0x0000000000000000] int FileIdx; // 0x0038 (0x0004) [0x0000000000000000]
    // struct FString                                  URL;
    // // 0x003C (0x0010) [0x0000000000000000] DWORD bPending : 1;
    // // 0x004C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpUserCloudFileDownload_execOnHTTPRequestReadUserFileComplete_Parms {
    ...
    // // 0x001C (0x0010) [0x0000000000000000] struct FString UserId;
    // // 0x002C (0x0010) [0x0000000000000000] DWORD bResult : 1;
    // // 0x003C (0x0004) [0x0000000000000000] [0x00000001] TArray< unsigned
    // char >                         FileContents;
    // // 0x0040 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserCloudFileDownload_execReadUserFile_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString Filename;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] int EntryIdx;
    // // 0x0024 (0x0004) [0x0000000000000000] int FileIdx;
    // // 0x0028 (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x002C (0x0010) [0x0000000000000000] DWORD bPending : 1;
    // // 0x003C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpUserCloudFileDownload_execGetUserFileList_Parms {
    ...
    // [0x0000000000000000] int EntryIdx; // 0x0020 (0x0004)
    // [0x0000000000000000] int FileIdx; // 0x0024 (0x0004) [0x0000000000000000]
};
...
struct
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int EntryIdx;
    // // 0x0014 (0x0004) [0x0000000000000000] int JsonIdx;
    // // 0x0018 (0x0004) [0x0000000000000000] struct FString JsonString;
    // // 0x001C (0x0010) [0x0000000000000000] struct FString UserId;
    // // 0x002C (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x003C (0x0008) [0x0000000000000000] DWORD bResult : 1;
    // // 0x0044 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpUserCloudFileDownload_execEnumerateUserFiles_Parms {
    // struct FString                                  UserId;
    // // 0x0000 (0x0010) [0x0000000000000000] int EntryIdx;
    // // 0x0010 (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x0014 (0x0010) [0x0000000000000000] DWORD bPending : 1;
    // // 0x0024 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpUserCloudFileDownload_execClearFile_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString Filename;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] DWORD bResult : 1;
    // // 0x0024 (0x0004) [0x0000000000000000] [0x00000001] int EntryIdx;
    // // 0x0028 (0x0004) [0x0000000000000000] int FileIdx;
...
struct UMcpUserCloudFileDownload_execClearFiles_Parms {
    // struct FString                                  UserId;
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] DWORD bResult : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] int EntryIdx;
    // // 0x0018 (0x0004) [0x0000000000000000] int FileIdx;
...
struct UMcpUserCloudFileDownload_execGetFileContents_Parms {
    ...
    // FileContents;                                     		// 0x0020 (0x0010)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0030 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bResult : 1;
    // // 0x0034 (0x0004) [0x0000000000000000] [0x00000001] int EntryIdx;
    // // 0x0038 (0x0004) [0x0000000000000000] int FileIdx;
    // // 0x003C (0x0004) [0x0000000000000000]
};
...
struct UMeshBeaconClient_execDebugRender_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] int HistoryIdx;
    // // 0x0008 (0x0004) [0x0000000000000000] float XL;
    // // 0x000C (0x0004) [0x0000000000000000] float YL;
    // // 0x0010 (0x0004) [0x0000000000000000] float Offset;
    // // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UMeshBeaconClient_execSendHostNewGameSessionResponse_Parms {
    ...
    // SessionName;                                      		// 0x0004 (0x0008)
    // [0x0000000000000000] class UClass* SearchClass;
    // // 0x000C (0x0008) [0x0000000000000000] unsigned char
    // PlatformSpecificInfo[ 0x50 ];                     		// 0x0014 (0x0050)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0064 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UMeshBeaconClient_execOnCreateNewSessionRequestReceived_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass* SearchClass;
    // // 0x0008 (0x0008) [0x0000000000000000] TArray< struct FPlayerMember >
    // Players;                                          		// 0x0010 (0x0010)
    // [0x0000000000000000]
};
...
struct UMeshBeaconClient_execOnTravelRequestReceived_Parms {
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass* SearchClass;
    // // 0x0008 (0x0008) [0x0000000000000000] unsigned char
    // PlatformSpecificInfo[ 0x50 ];                     		// 0x0010 (0x0050)
    // [0x0000000000000000]
};
...
struct UMeshBeaconClient_execOnReceivedBandwidthTestResults_Parms {
    ...
    // // 0x0000 (0x0001) [0x0000000000000000] unsigned char TestResult;
    // // 0x0001 (0x0001) [0x0000000000000000] struct FConnectionBandwidthStats
    // BandwidthStats;                                   		// 0x0004 (0x000C)
    // [0x0000000000000000]
};
...
struct UMeshBeaconClient_execOnConnectionRequestResult_Parms {
    // unsigned char                                   ConnectionResult;
    // // 0x0000 (0x0001) [0x0000000000000000]
};
...
struct UMeshBeaconClient_execBeginBandwidthTest_Parms {
    // unsigned char                                   TestType;
    // // 0x0000 (0x0001) [0x0000000000000000] int TestBufferSize;
    // // 0x0004 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMeshBeaconClient_execRequestConnection_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FClientConnectionRequest
    // ClientRequest;                                    		// 0x0010 (0x0028)
    // [0x0000000000000000] DWORD bRegisterSecureAddress : 1;
    // // 0x0038 (0x0004) [0x0000000000000000] [0x00000001] DWORD ReturnValue :
    // 1;                                  		// 0x003C (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UMeshBeaconHost_execDebugRender_Parms {
    ...
    // CurOptimalHostId;                                 		// 0x0008 (0x0008)
    // [0x0000000000000000] int ClientIdx; // 0x0010 (0x0004)
    // [0x0000000000000000] int HistoryIdx; // 0x0014 (0x0004)
    // [0x0000000000000000] struct FUniqueNetId NetId;
    // // 0x0018 (0x0008) [0x0000000000000000] float XL;
    // // 0x0020 (0x0004) [0x0000000000000000] float YL;
    // // 0x0024 (0x0004) [0x0000000000000000] float Offset;
...
struct UMeshBeaconHost_execDumpConnections_Parms {
    // int                                             ClientIdx;
    // // 0x0000 (0x0004) [0x0000000000000000] int HistoryIdx;
    // // 0x0004 (0x0004) [0x0000000000000000] struct FUniqueNetId NetId;
...
struct UMeshBeaconHost_execRequestClientCreateNewSession_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] struct FName SessionName;
    // // 0x0008 (0x0008) [0x0000000000000000] class UClass* SearchClass;
    // // 0x0010 (0x0008) [0x0000000000000000] TArray< struct FPlayerMember >
    // Players;                                          		// 0x0018 (0x0010)
...
struct UMeshBeaconHost_execOnFinishedBandwidthTest_Parms {
    // struct FUniqueNetId                             PlayerNetId;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char TestType;
    // // 0x0008 (0x0001) [0x0000000000000000] unsigned char TestResult;
    // // 0x0009 (0x0001) [0x0000000000000000] struct FConnectionBandwidthStats
    // BandwidthStats;                                   		// 0x000C (0x000C)
    // [0x0000000000000000]
};
...
struct UMeshBeaconHost_execOnReceivedClientConnectionRequest_Parms {
    ...
    // // 0x0000 (0x0060) [0x0000000000000000]
};
...
struct UMeshBeaconHost_execRequestClientBandwidthTest_Parms {
    // struct FUniqueNetId                             PlayerNetId;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char TestType;
    // // 0x0008 (0x0001) [0x0000000000000000] int TestBufferSize;
...
struct UOnlineSubsystemCommonImpl_execGetRegisteredPlayers_Parms {
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] TArray< struct FUniqueNetId >
    // OutRegisteredPlayers;                             		// 0x0008 (0x0010)
    // [0x0000000000000000] int                                             Idx;
    // // 0x0018 (0x0004) [0x0000000000000000] int PlayerIdx;
    // // 0x001C (0x0004) [0x0000000000000000]
};
...
struct UOnlineAuthInterfaceImpl_execFindLocalServerAuthSession_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] struct FLocalAuthSession
    // OutSessionInfo;                                   		// 0x0008 (0x0024)
...
struct UOnlineAuthInterfaceImpl_execFindServerAuthSession_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] struct FAuthSession
    // OutSessionInfo;                                   		// 0x0008 (0x0028)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0030 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UOnlineAuthInterfaceImpl_execAllServerAuthSessions_Parms {
    ...
    // // 0x0000 (0x0028) [0x0000000000000000]
};
...
struct UOnlineAuthInterfaceImpl_execEndRemoteServerAuthSession_Parms {
    ...
    // // 0x0008 (0x0014) [0x0000000000000000]
};
...
struct UOnlineAuthInterfaceImpl_execSendServerAuthResponse_Parms {
    // class UPlayer*                                  ClientConnection;
    // // 0x0000 (0x0008) [0x0000000000000000] int AuthTicketUID;
...
struct UOnlineAuthInterfaceImpl_execOnServerAuthComplete_Parms {
    ...
    // ServerUID;                                        		// 0x0004 (0x0008)
    // [0x0000000000000000] class UPlayer* ServerConnection;
    // // 0x000C (0x0008) [0x0000000000000000] struct FString ExtraInfo;
    // // 0x0014 (0x0010) [0x0000000000000000]
};
...
struct UOnlineAuthInterfaceImpl_execOnClientAuthComplete_Parms {
    // DWORD                                           bSuccess : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FUniqueNetId
    // ClientUID;                                        		// 0x0004 (0x0008)
    // [0x0000000000000000] class UPlayer* ClientConnection;
    // // 0x000C (0x0008) [0x0000000000000000] struct FString ExtraInfo;
    // // 0x0014 (0x0010) [0x0000000000000000]
};
...
struct UOnlineAuthInterfaceImpl_execOnServerAuthRequest_Parms {
    // class UPlayer*                                  ClientConnection;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FUniqueNetId ClientUID;
    // // 0x0008 (0x0008) [0x0000000000000000] struct FIpAddr ClientIP;
    // // 0x0010 (0x0014) [0x0000000000000000] int ClientPort;
...
struct UOnlineGameInterfaceImpl_execSendPlayerList_Parms {
    // TArray< class APlayerReplicationInfo* >         Players;
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execOnQosStatusChanged_Parms {
    // int                                             NumComplete;
    // // 0x0000 (0x0004) [0x0000000000000000] int NumTotal;
...
struct UOnlineGameInterfaceImpl_execBindSessionGuidToSearch_Parms {
    ...
    // // 0x0000 (0x0001) [0x0000000000000000] class UOnlineGameSearch*
    // SearchSettings;                                   		// 0x0004 (0x0008)
    // [0x0000000000000000] struct FString SessionGuid;
...
struct UOnlineGameInterfaceImpl_execBindPlatformSpecificSessionToSearch_Parms {
    ...
    // // 0x0000 (0x0001) [0x0000000000000000] class UOnlineGameSearch*
    // SearchSettings;                                   		// 0x0004 (0x0008)
    // [0x0000000000000000] unsigned char PlatformSpecificInfo[ 0x50 ];
    // // 0x000C (0x0050) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x005C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execReadSessionGuidBySessionName_Parms {
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FString SessionGuid;
    // // 0x0008 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct
    ...
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char
    // PlatformSpecificInfo[ 0x50 ];                     		// 0x0008 (0x0050)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0058 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execReadPlatformSpecificSessionInfo_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] unsigned char
    // PlatformSpecificInfo[ 0x50 ];                     		// 0x0010 (0x0050)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0060 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execClearPlayTogetherStartedDelegate_Parms {
    ...
    // PlayTogetherStartedDelegate;                      		// 0x0004 (0x0010)
    // [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execGetArbitratedPlayers_Parms {
    ...
    // FOnlineArbitrationRegistrant >   ReturnValue;
...
struct
    ...
    // struct FScriptDelegate                          RetrieveIPDelegate;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct
    ...
    // struct FScriptDelegate                          NewRetrieveIPDelegate;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execOnRetrievedGameSettingsForIP_Parms {
    ...
    // FOnlineGameSearchResult                  ConnectResult;
    // // 0x0004 (0x0010) [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execGetResolvedConnectString_Parms {
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FString ConnectInfo;
    // // 0x0008 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct
    ...
    // struct FScriptDelegate QuerySessionsForUserCompleteDelegate;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execQuerySessionsByKeyword_Parms {
    // unsigned char                                   LocalPlayerNum;
    // // 0x0000 (0x0001) [0x0000000000000000] struct FString Keyword;
    // // 0x0004 (0x0010) [0x0000000000000000] class UOnlineGameSearch*
    // SearchSettings;                                   		// 0x0014 (0x0008)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x001C (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execLeaveOnlineSession_Parms {
    // unsigned char                                   LocalPlayerNum;
    // // 0x0000 (0x0001) [0x0000000000000000] struct FName SessionName;
    // // 0x0004 (0x0008) [0x0000000000000000] DWORD bClearSessionIfHost : 1;
...
struct UOnlineGameInterfaceImpl_execClearMatchStatusChangedDelegate_Parms {
    // struct FScriptDelegate MatchStatusChangedDelegate;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execOnMatchStatusChanged_Parms {
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char Status;
    // // 0x0008 (0x0001) [0x0000000000000000]
};
...
struct
    ...
    // struct FScriptDelegate UpdateSessionPropertiesCompleteDelegate;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execDeleteCustomMemberProperty_Parms {
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FString PropertyName;
    // // 0x0008 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execSetCustomMemberProperty_Parms {
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FString PropertyName;
    // // 0x0008 (0x0010) [0x0000000000000000] struct FString PropertyValue;
...
struct
    ...
    // struct FScriptDelegate DeleteMatchTicketCompleteDelegate;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execDeleteMatchTicketWithHopper_Parms {
    // unsigned char                                   ScoutingPlayerNum;
    // // 0x0000 (0x0001) [0x0000000000000000] struct FName SessionName;
    // // 0x0004 (0x0008) [0x0000000000000000] struct FString HopperName;
    // // 0x000C (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x001C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct
    ...
    // struct FScriptDelegate QueryMatchmakingForSessionCompleteDelegate;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execQueryMatchmakingForSessionWithHopper_Parms {
    // unsigned char                                   ScoutingPlayerNum;
    // // 0x0000 (0x0001) [0x0000000000000000] struct FName SessionName;
    // // 0x0004 (0x0008) [0x0000000000000000] int MatchTimeout;
    // // 0x000C (0x0004) [0x0000000000000000] struct FString HopperName;
    // // 0x0010 (0x0010) [0x0000000000000000] unsigned char
    // CreateGameSessionType;                            		// 0x0020 (0x0001)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0024 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execQueryMatchmakingForSession_Parms {
    ...
    // // 0x0000 (0x0001) [0x0000000000000000] struct FName SessionName;
    // // 0x0004 (0x0008) [0x0000000000000000] int MatchTimeout;
    // // 0x000C (0x0004) [0x0000000000000000] unsigned char
    // CreateGameSessionType;                            		// 0x0010 (0x0001)
...
struct
    ...
    // struct FScriptDelegate MultiplayerSessionChangeDelegate;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execOnMultiplayerSessionChange_Parms {
    // struct FName                                    SessionName;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FSessionUpdateInfo
    // SessionChanges;                                   		// 0x0008 (0x0024)
    // [0x0000000000000000]
};
...
struct UOnlineGameInterfaceImpl_execJoinOnlineGameByMatchingParams_Parms {
    ...
    // JoinedGameSettings;                               		// 0x0008 (0x0008)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0010 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execJoinOnlineGameBySessionHandle_Parms {
    // unsigned char                                   PlayerNum;
    // // 0x0000 (0x0001) [0x0000000000000000] struct FName SessionName;
    // // 0x0004 (0x0008) [0x0000000000000000] struct FString InSessionGuid;
    // // 0x000C (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x001C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execCreateOnlineGame_Parms {
    // unsigned char                                   HostingPlayerNum;
    // // 0x0000 (0x0001) [0x0000000000000000] struct FName SessionName;
    // // 0x0004 (0x0008) [0x0000000000000000] class UOnlineGameSettings*
    // NewGameSettings;                                  		// 0x000C (0x0008)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0014 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UOnlineGameInterfaceImpl_execGetGameServerRemoteAddress_Parms {
    // struct FString                                  RemoteAddressString;
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UOnlinePlaylistManager_execOnReadDataCenterIdComplete_Parms {
    ...
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Filename;                                         		// 0x0004 (0x0010)
    // [0x0000000000000000] TArray< unsigned char > FileData;
    // // 0x0014 (0x0010) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_eventSendPlaylistPopulationUpdate_Parms {
    // int                                             NumPlayers;
    // // 0x0000 (0x0004) [0x0000000000000000] class UOnlineEventsInterface*
    // EventsInterface;                                  		// 0x0004 (0x0010)
    // [0x0000000000000000] class UOnlineSubsystem* OnlineSub; // 0x0014
...
struct UOnlinePlaylistManager_execGetPopulationInfoFromPlaylist_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] int WorldwideTotal;
    // // 0x0004 (0x0004) [0x0000000000000000] int RegionTotal;
    // // 0x0008 (0x0004) [0x0000000000000000] int PlaylistIndex;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execGetContentIdsFromPlaylist_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] TArray< int > ContentIds;
    // // 0x0004 (0x0010) [0x0000000000000000] int PlaylistIndex;
    // // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execGetInventorySwapFromPlaylist_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] class UClass* SourceInventory;
    // // 0x0004 (0x0008) [0x0000000000000000] class UClass* ReturnValue;
    // // 0x000C (0x0008) [0x0000000000000000] int PlaylistIndex;
    // // 0x0014 (0x0004) [0x0000000000000000] int SwapIndex;
...
struct UOnlinePlaylistManager_execGetMapCycleFromPlaylist_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] TArray< struct FName > MapCycle;
    // // 0x0004 (0x0010) [0x0000000000000000] int PlaylistIndex;
    // // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execGetMatchType_Parms {
    ...
    // // 0x0004 (0x0004) [0x0000000000000000] int PlaylistIndex;
    // // 0x0008 (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execIsPlaylistArbitrated_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0004 (0x0004) [0x0000000000000000] [0x00000001] int PlaylistIndex;
    // // 0x0008 (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execGetLoadBalanceIdFromPlaylist_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] int LoadBalanceId;
    // // 0x0004 (0x0004) [0x0000000000000000] int PlaylistIndex;
    // // 0x0008 (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execGetTeamInfoFromPlaylist_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] int TeamSize;
    // // 0x0004 (0x0004) [0x0000000000000000] int TeamCount;
    // // 0x0008 (0x0004) [0x0000000000000000] int MaxPartySize;
    // // 0x000C (0x0004) [0x0000000000000000] int PlaylistIndex;
    // // 0x0010 (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execHasAnyGameSettings_Parms {
    ...
    // // 0x0000 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0004 (0x0004) [0x0000000000000000] [0x00000001] int PlaylistIndex;
    // // 0x0008 (0x0004) [0x0000000000000000] int GameIndex;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execGetGameSettings_Parms {
    // int                                             PlaylistId;
    // // 0x0000 (0x0004) [0x0000000000000000] int GameSettingsId;
    // // 0x0004 (0x0004) [0x0000000000000000] class UOnlineGameSettings*
    // ReturnValue;                                      		// 0x0008 (0x0008)
    // [0x0000000000000000] int PlaylistIndex; // 0x0010 (0x0004)
    // [0x0000000000000000] int GameIndex; // 0x0014 (0x0004)
    // [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execOnReadTitleFileComplete_Parms {
    ...
    // Filename;                                         		// 0x0004 (0x0010)
    // [0x0000000000000000] class UOnlineSubsystem* OnlineSub; // 0x0014
    // (0x0008) [0x0000000000000000] int FileIndex;
    // // 0x001C (0x0004) [0x0000000000000000]
};
...
struct UOnlinePlaylistManager_execDownloadPlaylist_Parms {
    // class UOnlineSubsystem*                         OnlineSub;
    // // 0x0000 (0x0008) [0x0000000000000000] int FileIndex;
    // // 0x0008 (0x0004) [0x0000000000000000]
};
...
struct UPartyBeaconClient_execRequestReservationUpdate_Parms {
    // struct FOnlineGameSearchResult                  DesiredHost;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FUniqueNetId
    // RequestingPartyLeader;                            		// 0x0010 (0x0008)
    // [0x0000000000000000] TArray< struct FPlayerReservation > PlayersToAdd;
    // // 0x0018 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0028 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UPartyBeaconClient_execRequestReservation_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FUniqueNetId
    // RequestingPartyLeader;                            		// 0x0010 (0x0008)
    // [0x0000000000000000] TArray< struct FPlayerReservation > Players;
    // // 0x0018 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0028 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UPartyBeaconClient_execOnReservationRequestComplete_Parms {
    // unsigned char                                   ReservationResult;
    // // 0x0000 (0x0001) [0x0000000000000000]
};
...
struct UPartyBeaconHost_execDumpReservations_Parms {
    ...
    // // 0x0004 (0x0004) [0x0000000000000000] struct FUniqueNetId NetId;
    // // 0x0008 (0x0008) [0x0000000000000000] struct FPlayerReservation
    // PlayerRes;                                        		// 0x0010 (0x0024)
    // [0x0000000000000000]
};
...
struct UPartyBeaconHost_execGetPartyLeaders_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] int PartyIndex;
    // // 0x0010 (0x0004) [0x0000000000000000]
};
...
struct UPartyBeaconHost_execGetPlayers_Parms {
    // TArray< struct FUniqueNetId >                   Players;
    // // 0x0000 (0x0010) [0x0000000000000000] int PlayerIndex;
    // // 0x0010 (0x0004) [0x0000000000000000] int PartyIndex;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FPlayerReservation
    // PlayerRes;                                        		// 0x0018 (0x0024)
    // [0x0000000000000000]
};
...
struct UPartyBeaconHost_eventUnregisterParty_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] int PlayerIndex;
    // // 0x0008 (0x0004) [0x0000000000000000] int PartyIndex;
    // // 0x000C (0x0004) [0x0000000000000000] class UOnlineSubsystem*
    // OnlineSub;                                        		// 0x0010 (0x0008)
    // [0x0000000000000000] struct FPlayerReservation PlayerRes;
    // // 0x0018 (0x0024) [0x0000000000000000]
};
...
struct UPartyBeaconHost_eventUnregisterPartyMembers_Parms {
    // int                                             Index;
    // // 0x0000 (0x0004) [0x0000000000000000] int PartyIndex;
    // // 0x0004 (0x0004) [0x0000000000000000] class UOnlineSubsystem*
    // OnlineSub;                                        		// 0x0008 (0x0008)
    // [0x0000000000000000] struct FPlayerReservation PlayerRes;
    // // 0x0010 (0x0024) [0x0000000000000000]
};
...
struct UPartyBeaconHost_eventRegisterPartyMembers_Parms {
    ...
    // // 0x0004 (0x0004) [0x0000000000000000] class UOnlineSubsystem*
    // OnlineSub;                                        		// 0x0008 (0x0008)
    // [0x0000000000000000] class UOnlineRecentPlayersList* PlayersList;
    // // 0x0010 (0x0008) [0x0000000000000000] TArray< struct FUniqueNetId >
    // Members;                                          		// 0x0018 (0x0010)
    // [0x0000000000000000] struct FPlayerReservation PlayerRes;
    // // 0x0028 (0x0024) [0x0000000000000000]
};
...
struct UPartyBeaconHost_execHandlePlayerLogout_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] DWORD bMaintainParty : 1;
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UPartyBeaconHost_execUpdatePartyReservationEntry_Parms {
    // struct FUniqueNetId                             PartyLeader;
    // // 0x0000 (0x0008) [0x0000000000000000] TArray< struct FPlayerReservation
    // >             PlayerMembers;                                    		//
    // 0x0008 (0x0010) [0x0000000000000000] unsigned char ReturnValue;
...
struct UPartyBeaconHost_execAddPartyReservationEntry_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] TArray< struct FPlayerReservation
    // >             PlayerMembers;                                    		//
    // 0x0008 (0x0010) [0x0000000000000000] int TeamNum;
    // // 0x0018 (0x0004) [0x0000000000000000] DWORD bIsHost : 1;
    // // 0x001C (0x0004) [0x0000000000000000] [0x00000001] unsigned char
    // ReturnValue;                                      		// 0x0020 (0x0001)
    // [0x0000000000000000]
};
...
struct UPartyBeaconHost_execInitHostBeacon_Parms {
    // int                                             InNumTeams;
    // // 0x0000 (0x0004) [0x0000000000000000] int InNumPlayersPerTeam;
    // // 0x0004 (0x0004) [0x0000000000000000] int InNumReservations;
    // // 0x0008 (0x0004) [0x0000000000000000] struct FName InSessionName;
    // // 0x000C (0x0008) [0x0000000000000000] int InForceTeamNum;
    // // 0x0014 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UWebRequest_execDecodeFormData_Parms {
    // struct FString                                  Data;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString Token[ 0x2 ];
    // // 0x0010 (0x0020) [0x0000000000000000] struct FString ch;
    // // 0x0030 (0x0010) [0x0000000000000000] int I;
    // // 0x0040 (0x0004) [0x0000000000000000] int H1;
    // // 0x0044 (0x0004) [0x0000000000000000] int H2;
    // // 0x0048 (0x0004) [0x0000000000000000] int Limit;
    // // 0x004C (0x0004) [0x0000000000000000] int T;
    // // 0x0050 (0x0004) [0x0000000000000000]
};
...
struct UWebRequest_execGetVariableNumber_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] int Number;
    // // 0x0010 (0x0004) [0x0000000000000000] struct FString DefaultValue;
    // // 0x0014 (0x0010) [0x0000000000000000] struct FString ReturnValue;
...
struct UWebRequest_execGetVariable_Parms {
    // struct FString                                  VariableName;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString DefaultValue;
...
struct UWebResponse_execSendStandardHeaders_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bCache : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UWebResponse_execHTTPError_Parms {
    // int                                             ErrorNum;
    // // 0x0000 (0x0004) [0x0000000000000000] struct FString Data;
    // // 0x0004 (0x0010) [0x0000000000000000]
};
...
struct UWebResponse_execAddHeader_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bReplace : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int I;
    // // 0x0014 (0x0004) [0x0000000000000000] int Idx;
    // // 0x0018 (0x0004) [0x0000000000000000] struct FString Part;
    // // 0x001C (0x0010) [0x0000000000000000] struct FString Entry;
...
struct UWebResponse_execSendCachedFile_Parms {
    // struct FString                                  Filename;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString ContentType;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UWebResponse_eventSendText_Parms {
    // struct FString                                  Text;
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bNoCRLF : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UWebResponse_execSubst_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString Value;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD bClear : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UUIDataStore_OnlinePlaylists_execGetOnlinePlaylistProvider_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] int PlaylistId;
    // // 0x0008 (0x0004) [0x0000000000000000] int ProviderIndex;
    // // 0x000C (0x0004) [0x0000000000000000] class UOnlinePlaylistProvider*
    // ReturnValue;                                      		// 0x0010 (0x0008)
    // [0x0000000000000000] class UUIDataStore_OnlinePlaylists* PlaylistDS;
    // // 0x0018 (0x0008) [0x0000000000000000] TArray< class
    // UUIResourceDataProvider* >        Providers;
    // // 0x0020 (0x0010) [0x0000000000000000] class UOnlinePlaylistProvider*
    // OPP;                                              		// 0x0030 (0x0008)
    // [0x0000000000000000]
};
...
struct UUIDataStore_OnlinePlaylists_execGetPlaylistProvider_Parms {
    // struct FName                                    ProviderTag;
    // // 0x0000 (0x0008) [0x0000000000000000] int ProviderIndex;
    // // 0x0008 (0x0004) [0x0000000000000000] class UUIResourceDataProvider*
    // out_Provider;                                     		// 0x000C (0x0008)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0014 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UUIDataStore_OnlinePlaylists_execGetResourceProviders_Parms {
    ...
    // UUIResourceDataProvider* >        out_Providers;
    // // 0x0008 (0x0010) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UWebApplication_execPostQuery_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UWebResponse* Response;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct AWebServer_execGetApplication_Parms {
    // struct FString                                  URI;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SubURI;
    // // 0x0010 (0x0010) [0x0000000000000000] class UWebApplication*
    // ReturnValue;                                      		// 0x0020 (0x0008)
    // [0x0000000000000000] int                                             I;
    // // 0x0028 (0x0004) [0x0000000000000000] int L;
    // // 0x002C (0x0004) [0x0000000000000000]
};
...
struct AWebServer_execPostBeginPlay_Parms {
    // int                                             I;
    // // 0x0000 (0x0004) [0x0000000000000000] class UClass* ApplicationClass;
    // // 0x0004 (0x0008) [0x0000000000000000] struct FIpAddr L;
    // // 0x000C (0x0014) [0x0000000000000000] struct FString S;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UImageServer_eventQuery_Parms {
    // class UWebRequest*                              Request;
    // // 0x0000 (0x0008) [0x0000000000000000] class UWebResponse* Response;
    // // 0x0008 (0x0008) [0x0000000000000000] struct FString Image;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct UMcpClashMobBase_execUpdateChallengeUserReward_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0010 (0x0010) [0x0000000000000000] int UserReward;
...
struct UMcpClashMobBase_execOnUpdateChallengeUserRewardComplete_Parms {
    // DWORD                                           bWasSuccessful : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // UniqueChallengeId;                                		// 0x0004 (0x0010)
    // [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0014 (0x0010) [0x0000000000000000] struct FString Error;
    // // 0x0024 (0x0010) [0x0000000000000000]
};
...
struct UMcpClashMobBase_execUpdateChallengeUserProgress_Parms {
    // struct FString                                  UniqueChallengeId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD bDidComplete : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] int GoalProgress;
    // // 0x0024 (0x0004) [0x0000000000000000]
};
...
struct UMcpClashMobBase_execGetChallengeUserStatus_Parms {
    // struct FString                                  UniqueChallengeId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct
    // FMcpClashMobChallengeUserStatus          OutChallengeUserStatus;
    // // 0x0020 (0x0080) [0x0000000000000000]
};
...
struct UMcpClashMobBase_execQueryChallengeMultiUserStatus_Parms {
    // struct FString                                  UniqueChallengeId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< struct FString >
    // UserIdsToRead;                                    		// 0x0020 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpClashMobBase_execDeleteCachedChallengeFile_Parms {
    // struct FString                                  UniqueChallengeId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString DLName;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct UMcpClashMobBase_execGetChallengeFileList_Parms {
    // struct FString                                  UniqueChallengeId;
    // // 0x0000 (0x0010) [0x0000000000000000] TArray< struct
    // FMcpClashMobChallengeFile >      OutChallengeFiles;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct UMcpClashMobBase_execOnDownloadChallengeFileComplete_Parms {
    ...
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // UniqueChallengeId;                                		// 0x0004 (0x0010)
    // [0x0000000000000000] struct FString DLName; // 0x0014 (0x0010)
    // [0x0000000000000000] struct FString Filename; // 0x0024 (0x0010)
    // [0x0000000000000000] struct FString Error; // 0x0034 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpClashMobBase_execCreateInstance_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass*
    // McpClashMobBaseClass;                             		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMcpClashMobBase* NewInstance;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // UniqueChallengeId;                                		// 0x0014 (0x0010)
    // [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0024 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0034 (0x0010) [0x0000000000000000] DWORD bResult : 1;
    // // 0x0044 (0x0004) [0x0000000000000000] [0x00000001] int UserQueryIdx;
    // // 0x0048 (0x0004) [0x0000000000000000] int ChallengeQueryIdx;
    // // 0x004C (0x0004) [0x0000000000000000]
};
...
struct UMcpClashMobManager_execUpdateChallengeUserReward_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0010 (0x0010) [0x0000000000000000] int UserReward;
    // // 0x0020 (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x0024 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0034 (0x0010) [0x0000000000000000] int ChallengeQueryIdx;
    // // 0x0044 (0x0004) [0x0000000000000000] int UserQueryIdx;
    // // 0x0048 (0x0004) [0x0000000000000000] DWORD bPending : 1;
    // // 0x004C (0x0004) [0x0000000000000000] [0x00000001] class
    // UHttpRequestInterface*                    Request;
...
struct UMcpClashMobManager_execUpdateChallengeUserProgress_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD bDidComplete : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] int GoalProgress;
    // // 0x0024 (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x0028 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0038 (0x0010) [0x0000000000000000] int ChallengeQueryIdx;
    // // 0x0048 (0x0004) [0x0000000000000000] int UserQueryIdx;
    // // 0x004C (0x0004) [0x0000000000000000] DWORD bPending : 1;
    // // 0x0050 (0x0004) [0x0000000000000000] [0x00000001] class
    // UHttpRequestInterface*                    Request;
...
struct UMcpClashMobManager_execGetChallengeUserStatus_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] struct
    // FMcpClashMobChallengeUserStatus          OutChallengeUserStatus;
    // // 0x0020 (0x0080) [0x0000000000000000] int UserStatusIdx;
    // // 0x00A0 (0x0004) [0x0000000000000000] struct
    // FMcpClashMobChallengeUserStatus          DefaultStatus;
    // // 0x00A4 (0x0080) [0x0000000000000000]
};
...
struct
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // JSONStr;                                          		// 0x0014 (0x0010)
    // [0x0000000000000000] struct FString UniqueChallengeId;
    // // 0x0024 (0x0010) [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0034 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0044 (0x0010) [0x0000000000000000] DWORD bResult : 1;
    // // 0x0054 (0x0004) [0x0000000000000000] [0x00000001] int UserQueryIdx;
    // // 0x0058 (0x0004) [0x0000000000000000] int ChallengeQueryIdx;
    // // 0x005C (0x0004) [0x0000000000000000] int UserStatusIdx;
    // // 0x0060 (0x0004) [0x0000000000000000] int TempUserStatusIdx;
    // // 0x0064 (0x0004) [0x0000000000000000]
};
...
struct UMcpClashMobManager_execQueryChallengeMultiUserStatus_Parms {
    ...
    // UserIdsToRead;                                    		// 0x0020 (0x0010)
    // [0x0000000000000000] struct FString                                  URL;
    // // 0x0030 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0040 (0x0010) [0x0000000000000000] struct FString JSONStr;
    // // 0x0050 (0x0010) [0x0000000000000000] int ChallengeQueryIdx;
    // // 0x0060 (0x0004) [0x0000000000000000] int UserQueryIdx;
    // // 0x0064 (0x0004) [0x0000000000000000] int UserIdIdx;
    // // 0x0068 (0x0004) [0x0000000000000000] DWORD bPending : 1;
    // // 0x006C (0x0004) [0x0000000000000000] [0x00000001] class
    // UHttpRequestInterface*                    Request;
...
struct UMcpClashMobManager_execQueryChallengeUserStatus_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString UniqueUserId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0020 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0030 (0x0010) [0x0000000000000000] int ChallengeQueryIdx;
    // // 0x0040 (0x0004) [0x0000000000000000] int UserQueryIdx;
    // // 0x0044 (0x0004) [0x0000000000000000] DWORD bPending : 1;
...
struct UMcpClashMobManager_execDeleteCachedChallengeFile_Parms {
    // struct FString                                  UniqueChallengeId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString DLName;
    // // 0x0010 (0x0010) [0x0000000000000000] int ChallengeIdx;
    // // 0x0020 (0x0004) [0x0000000000000000] int FileIdx;
    // // 0x0024 (0x0004) [0x0000000000000000]
};
...
struct UMcpClashMobManager_execGetChallengeFileContents_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< unsigned char >
    // OutFileContents;                                  		// 0x0020 (0x0010)
    // [0x0000000000000000] int ChallengeIdx; // 0x0030 (0x0004)
    // [0x0000000000000000] int FileIdx; // 0x0034 (0x0004) [0x0000000000000000]
};
...
struct UMcpClashMobManager_execOnDownloadMcpFileComplete_Parms {
    // DWORD                                           bWasSuccessful : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // DLName;                                           		// 0x0004 (0x0010)
    // [0x0000000000000000] TArray< unsigned char > FileContents;
    // // 0x0014 (0x0010) [0x0000000000000000] int ChallengeIdx;
    // // 0x0024 (0x0004) [0x0000000000000000] int FileIdx;
    // // 0x0028 (0x0004) [0x0000000000000000] struct FString Filename;
    // // 0x002C (0x0010) [0x0000000000000000]
};
...
struct UMcpClashMobManager_execOnLoadCachedFileComplete_Parms {
    ...
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // DLName;                                           		// 0x0004 (0x0010)
    // [0x0000000000000000] DWORD bRequiresDownload : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // FileHashCache;                                    		// 0x0018 (0x0010)
    // [0x0000000000000000] struct FString FileHashChallenge;
    // // 0x0028 (0x0010) [0x0000000000000000] struct FString Filename;
    // // 0x0038 (0x0010) [0x0000000000000000] int ChallengeIdx;
    // // 0x0048 (0x0004) [0x0000000000000000] int FileIdx;
    // // 0x004C (0x0004) [0x0000000000000000] TArray< unsigned char >
    // FileContents;                                     		// 0x0050 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpClashMobManager_execDownloadChallengeFile_Parms {
    // struct FString                                  UniqueChallengeId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString DLName;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0020 (0x0010) [0x0000000000000000] int ChallengeIdx;
    // // 0x0030 (0x0004) [0x0000000000000000] int FileIdx;
    // // 0x0034 (0x0004) [0x0000000000000000] DWORD bPending : 1;
    // // 0x0038 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpClashMobManager_execGetChallengeFileList_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] TArray< struct
    // FMcpClashMobChallengeFile >      OutChallengeFiles;
    // // 0x0010 (0x0010) [0x0000000000000000] int ChallengeEventIdx;
    // // 0x0020 (0x0004) [0x0000000000000000]
};
...
struct UMcpClashMobManager_execOnQueryChallengeListHTTPRequestComplete_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // JSONStr;                                          		// 0x0014 (0x0010)
    // [0x0000000000000000] struct FString ErrorStr; // 0x0024 (0x0010)
    // [0x0000000000000000] DWORD bResult : 1; // 0x0034 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UMcpClashMobManager_execQueryChallengeList_Parms {
    // struct FString                                  URL;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD bPending : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpGroupsBase_execAcceptGroupInvite_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString GroupID;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD bShouldAccept : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpGroupsBase_execGetGroupInviteList_Parms {
    // struct FString                                  UserId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpGroupList InviteList;
    // // 0x0010 (0x0020) [0x0000000000000000]
};
...
struct UMcpGroupsBase_execAddGroupMembers_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< struct FString >
    // MemberIds;                                        		// 0x0020 (0x0010)
    // [0x0000000000000000] DWORD bRequiresAcceptance : 1;
...
struct UMcpGroupsBase_execGetGroupMembers_Parms {
    // struct FString                                  GroupID;
    // // 0x0000 (0x0010) [0x0000000000000000] TArray< struct FMcpGroupMember >
    // GroupMembers;                                     		// 0x0010 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpGroupsBase_execGetGroupList_Parms {
    // struct FString                                  UserId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpGroupList GroupList;
    // // 0x0010 (0x0020) [0x0000000000000000]
};
...
struct UMcpGroupsBase_execOnCreateGroupComplete_Parms {
    ...
    // // 0x0000 (0x0044) [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0044 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0048 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpGroupsBase_execCreateGroup_Parms {
    // struct FString                                  OwnerId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString GroupName;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct UMcpGroupsBase_execCreateInstance_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass*
    // McpGroupsManagerClass;                            		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMcpGroupsBase* NewInstance;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct UMcpGroupsManager_execCacheGroupMember_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString GroupID;
    // // 0x0010 (0x0010) [0x0000000000000000] unsigned char AcceptState;
    // // 0x0020 (0x0001) [0x0000000000000000] int MemberIndex;
    // // 0x0024 (0x0004) [0x0000000000000000] struct FMcpGroupList GroupList;
    // // 0x0028 (0x0020) [0x0000000000000000] int GroupListIndex;
    // // 0x0048 (0x0004) [0x0000000000000000] struct FMcpGroup GroupTemp;
    // // 0x004C (0x0044) [0x0000000000000000] int GroupIndex;
    // // 0x0090 (0x0004) [0x0000000000000000] int AddAt;
...
struct UMcpGroupsManager_execCacheGroup_Parms {
    // struct FString                                  RequesterId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpGroup Group;
    // // 0x0010 (0x0044) [0x0000000000000000] int AddAt;
    // // 0x0054 (0x0004) [0x0000000000000000] int GroupIndex;
    // // 0x0058 (0x0004) [0x0000000000000000] int GroupListIndex;
    // // 0x005C (0x0004) [0x0000000000000000] struct FMcpGroupList
    // UserGroupList;                                    		// 0x0060 (0x0020)
    // [0x0000000000000000] DWORD bWasFound : 1; // 0x0080 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UMcpGroupsManager_execOnAcceptGroupInviteRequestComplete_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int ResponseCode;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FString Content;
    // // 0x0018 (0x0010) [0x0000000000000000] struct FString GroupID;
    // // 0x0028 (0x0010) [0x0000000000000000]
};
...
struct UMcpGroupsManager_execAcceptGroupInvite_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString GroupID;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD bShouldAccept : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] struct FString URL;
    // // 0x0024 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // AcceptGroupInviteRequest;                         		// 0x0034 (0x0008)
    // [0x0000000000000000]
};
...
struct UMcpGroupsManager_execOnDeleteAllGroupsRequestComplete_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int ResponseCode;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FString Content;
    // // 0x0018 (0x0010) [0x0000000000000000] struct FString RequesterId;
    // // 0x0028 (0x0010) [0x0000000000000000]
};
...
struct UMcpGroupsManager_execDeleteAllGroups_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0010 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // DeleteGroupRequest;                               		// 0x0020 (0x0008)
    // [0x0000000000000000]
};
...
struct UMcpGroupsManager_execRemoveGroupMembers_Parms {
    ...
    // MemberIds;                                        		// 0x0020 (0x0010)
    // [0x0000000000000000] struct FString                                  URL;
    // // 0x0030 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // RemoveGroupMembersRequest;                        		// 0x0040 (0x0008)
    // [0x0000000000000000] struct FString JsonPayload;
    // // 0x0048 (0x0010) [0x0000000000000000] int Index;
...
struct UMcpGroupsManager_execAddGroupMembers_Parms {
    ...
    // MemberIds;                                        		// 0x0020 (0x0010)
    // [0x0000000000000000] DWORD bRequiresAcceptance : 1;
    // // 0x0030 (0x0004) [0x0000000000000000] [0x00000001] struct FString URL;
    // // 0x0034 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // AddGroupMembersRequest;                           		// 0x0044 (0x0008)
    // [0x0000000000000000] struct FString JsonPayload;
    // // 0x004C (0x0010) [0x0000000000000000] int Index;
...
struct UMcpGroupsManager_execGetGroupMembers_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] TArray< struct FMcpGroupMember >
    // GroupMembers;                                     		// 0x0010 (0x0010)
    // [0x0000000000000000] int GroupIndex; // 0x0020 (0x0004)
    // [0x0000000000000000] struct FMcpGroupList GroupList;
    // // 0x0024 (0x0020) [0x0000000000000000] struct FMcpGroup GroupTemp;
    // // 0x0044 (0x0044) [0x0000000000000000]
};
...
struct UMcpGroupsManager_execOnQueryGroupMembersRequestComplete_Parms {
    ...
    // // 0x0028 (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0038 (0x0008) [0x0000000000000000] int JsonIndex;
    // // 0x0040 (0x0004) [0x0000000000000000] unsigned char AcceptState;
    // // 0x0044 (0x0001) [0x0000000000000000] struct FString MemberId;
    // // 0x0048 (0x0010) [0x0000000000000000] struct FString GroupID;
    // // 0x0058 (0x0010) [0x0000000000000000]
};
...
struct UMcpGroupsManager_execQueryGroupMembers_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString GroupID;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0020 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // QueryGroupMembersRequest;                         		// 0x0030 (0x0008)
    // [0x0000000000000000]
};
...
struct UMcpGroupsManager_execGetGroupList_Parms {
    // struct FString                                  UserId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpGroupList GroupList;
    // // 0x0010 (0x0020) [0x0000000000000000] int GroupListIndex;
...
struct UMcpGroupsManager_execOnQueryGroupsRequestComplete_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int ResponseCode;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FString Error;
    // // 0x0018 (0x0010) [0x0000000000000000] struct FMcpGroup Group;
    // // 0x0028 (0x0044) [0x0000000000000000] struct FString JsonString;
    // // 0x006C (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x007C (0x0008) [0x0000000000000000] int JsonIndex;
    // // 0x0084 (0x0004) [0x0000000000000000] struct FString RequesterId;
    // // 0x0088 (0x0010) [0x0000000000000000]
};
...
struct UMcpGroupsManager_execQueryGroups_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0010 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // QueryGroupsRequest;                               		// 0x0020 (0x0008)
    // [0x0000000000000000]
};
...
struct UMcpGroupsManager_execDeleteGroup_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0020 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // DeleteGroupRequest;                               		// 0x0030 (0x0008)
    // [0x0000000000000000]
};
...
struct UMcpGroupsManager_execOnCreateGroupRequestComplete_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int ResponseCode;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FString Content;
    // // 0x0018 (0x0010) [0x0000000000000000] struct FMcpGroup CreatedGroup;
    // // 0x0028 (0x0044) [0x0000000000000000] struct FString JsonString;
    // // 0x006C (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x007C (0x0008) [0x0000000000000000]
};
...
struct UMcpGroupsManager_execCreateGroup_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0020 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // CreateGroupRequest;                               		// 0x0030 (0x0008)
    // [0x0000000000000000] struct FMcpGroup FailedGroup;
    // // 0x0038 (0x0044) [0x0000000000000000]
};
...
struct UMcpIdMappingBase_execGetIdMappings_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] TArray< struct FMcpIdMapping >
    // IDMappings;                                       		// 0x0010 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpIdMappingBase_execQueryMappings_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString ExternalType;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct UMcpIdMappingBase_execOnAddMappingComplete_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString ExternalId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString ExternalType;
    // // 0x0020 (0x0010) [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0030 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0034 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpIdMappingBase_execCreateInstance_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass*
    // McpIdMappingBaseClass;                            		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMcpIdMappingBase* NewInstance;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct UMcpIdMappingManager_execGetIdMappings_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] TArray< struct FMcpIdMapping >
    // IDMappings;                                       		// 0x0010 (0x0010)
    // [0x0000000000000000] int Index; // 0x0020 (0x0004) [0x0000000000000000]
    // int                                             AddAt;
    // // 0x0024 (0x0004) [0x0000000000000000]
};
...
struct UMcpIdMappingManager_execOnQueryMappingsRequestComplete_Parms {
    ...
    // Response;                                         		// 0x0008 (0x0008)
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int Index;
    // // 0x0014 (0x0004) [0x0000000000000000] int AddAt;
    // // 0x0018 (0x0004) [0x0000000000000000] int ResponseCode;
    // // 0x001C (0x0004) [0x0000000000000000] struct FString JsonString;
    // // 0x0020 (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0030 (0x0008) [0x0000000000000000] int JsonIndex;
    // // 0x0038 (0x0004) [0x0000000000000000] int AccountIndex;
    // // 0x003C (0x0004) [0x0000000000000000] DWORD bWasFound : 1;
    // // 0x0040 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // McpId;                                            		// 0x0044 (0x0010)
    // [0x0000000000000000] struct FString ExternalId;
    // // 0x0054 (0x0010) [0x0000000000000000] struct FString ExternalType;
    // // 0x0064 (0x0010) [0x0000000000000000]
};
...
struct UMcpIdMappingManager_execQueryMappings_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0020 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x0030 (0x0008)
    // [0x0000000000000000] int AddAt; // 0x0038 (0x0004) [0x0000000000000000]
    // struct FString                                  JsonPayload;
    // // 0x003C (0x0010) [0x0000000000000000] int Index;
    // // 0x004C (0x0004) [0x0000000000000000] DWORD bFirst : 1;
    // // 0x0050 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpIdMappingManager_execAddMapping_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString ExternalId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString ExternalType;
    // // 0x0020 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0030 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x0040 (0x0008)
    // [0x0000000000000000] int AddAt; // 0x0048 (0x0004) [0x0000000000000000]
};
...
struct UMcpManagedValueManagerBase_execOnDeleteValueComplete_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlot;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FName ValueId;
    // // 0x0020 (0x0008) [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0028 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x002C (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpManagedValueManagerBase_execOnUpdateValueComplete_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlot;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FName ValueId;
    // // 0x0020 (0x0008) [0x0000000000000000] int Value;
    // // 0x0028 (0x0004) [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x002C (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0030 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpManagedValueManagerBase_execGetValue_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlot;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FName ValueId;
    // // 0x0020 (0x0008) [0x0000000000000000] int ReturnValue;
    // // 0x0028 (0x0004) [0x0000000000000000]
};
...
struct UMcpManagedValueManagerBase_execGetValues_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlot;
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< struct FManagedValue >
    // ReturnValue;                                      		// 0x0020 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpManagedValueManagerBase_execOnReadSaveSlotComplete_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlot;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0024 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpManagedValueManagerBase_execCreateInstance_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass*
    // McpManagedValueManagerBaseClass;                  		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMcpManagedValueManagerBase* NewInstance;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct UMcpManagedValueManager_execOnDeleteValueRequestComplete_Parms {
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int Index;
    // // 0x0014 (0x0004) [0x0000000000000000] int ResponseCode;
    // // 0x0018 (0x0004) [0x0000000000000000] int SaveSlotIndex;
    // // 0x001C (0x0004) [0x0000000000000000] int ValueIndex;
    // // 0x0020 (0x0004) [0x0000000000000000]
};
...
struct UMcpManagedValueManager_execDeleteValue_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlot;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FName ValueId;
    // // 0x0020 (0x0008) [0x0000000000000000] struct FString URL;
    // // 0x0028 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x0038 (0x0008)
    // [0x0000000000000000] int AddAt; // 0x0040 (0x0004) [0x0000000000000000]
};
...
struct UMcpManagedValueManager_execOnUpdateValueRequestComplete_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int Index;
    // // 0x0014 (0x0004) [0x0000000000000000] int ResponseCode;
    // // 0x0018 (0x0004) [0x0000000000000000] struct FString ResponseString;
    // // 0x001C (0x0010) [0x0000000000000000] int UpdatedValue;
    // // 0x002C (0x0004) [0x0000000000000000]
};
...
struct UMcpManagedValueManager_execUpdateValue_Parms {
    ...
    // // 0x0020 (0x0008) [0x0000000000000000] int Value;
    // // 0x0028 (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x002C (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x003C (0x0008)
    // [0x0000000000000000] int AddAt; // 0x0044 (0x0004) [0x0000000000000000]
};
...
struct UMcpManagedValueManager_execGetValue_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] struct FName ValueId;
    // // 0x0020 (0x0008) [0x0000000000000000] int ReturnValue;
    // // 0x0028 (0x0004) [0x0000000000000000] int SaveSlotIndex;
    // // 0x002C (0x0004) [0x0000000000000000] int ValueIndex;
    // // 0x0030 (0x0004) [0x0000000000000000] int Value;
...
struct UMcpManagedValueManager_execGetValues_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< struct FManagedValue >
    // ReturnValue;                                      		// 0x0020 (0x0010)
    // [0x0000000000000000] int SaveSlotIndex; // 0x0030 (0x0004)
    // [0x0000000000000000] TArray< struct FManagedValue > EmptyArray;
...
struct UMcpManagedValueManager_execParseValuesForSaveSlot_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlot;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString JsonPayload;
    // // 0x0020 (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0030 (0x0008) [0x0000000000000000] int JsonIndex;
    // // 0x0038 (0x0004) [0x0000000000000000] int SaveSlotIndex;
    // // 0x003C (0x0004) [0x0000000000000000] int ManagedValueIndex;
    // // 0x0040 (0x0004) [0x0000000000000000] struct FName ValueId;
    // // 0x0044 (0x0008) [0x0000000000000000] int Value;
    // // 0x004C (0x0004) [0x0000000000000000]
};
...
struct UMcpManagedValueManager_execFindSaveSlotIndex_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlot;
    // // 0x0010 (0x0010) [0x0000000000000000] int ReturnValue;
    // // 0x0020 (0x0004) [0x0000000000000000] int SaveSlotIndex;
    // // 0x0024 (0x0004) [0x0000000000000000]
};
...
struct UMcpServerTimeBase_execOnQueryServerTimeComplete_Parms {
    // DWORD                                           bWasSuccessful : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // DateTimeStr;                                      		// 0x0004 (0x0010)
    // [0x0000000000000000] struct FString Error; // 0x0014 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpServerTimeBase_execCreateInstance_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass*
    // McpServerTimeBaseClass;                           		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMcpServerTimeBase* NewInstance;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct UMcpServerTimeManager_execOnQueryServerTimeHTTPRequestComplete_Parms {
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // TimeStr;                                          		// 0x0014 (0x0010)
    // [0x0000000000000000] struct FString ResponseStr;
    // // 0x0024 (0x0010) [0x0000000000000000] struct FString ErrorStr;
    // // 0x0034 (0x0010) [0x0000000000000000] int Idx;
    // // 0x0044 (0x0004) [0x0000000000000000] DWORD bResult : 1;
...
struct UMcpUserInventoryBase_execOnRecordIapComplete_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< struct FString >
    // UpdatedItemIds;                                   		// 0x0020 (0x0010)
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0030 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0034 (0x0010)
    // [0x0000000000000000]
...
struct UMcpUserInventoryBase_execRecordIap_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString Receipt;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserInventoryBase_execOnDeleteItemComplete_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString InstanceItemId;
    // // 0x0020 (0x0010) [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0030 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0034 (0x0010)
    // [0x0000000000000000]
...
struct UMcpUserInventoryBase_execDeleteItem_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString InstanceItemId;
    // // 0x0020 (0x0010) [0x0000000000000000] int StoreVersion;
    // // 0x0030 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryBase_execOnConsumeItemComplete_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString InstanceItemId;
    // // 0x0020 (0x0010) [0x0000000000000000] TArray< struct FString >
    // UpdatedItemIds;                                   		// 0x0030 (0x0010)
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0040 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0044 (0x0010)
    // [0x0000000000000000]
...
struct UMcpUserInventoryBase_execConsumeItem_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString InstanceItemId;
    // // 0x0020 (0x0010) [0x0000000000000000] int Quantity;
    // // 0x0030 (0x0004) [0x0000000000000000] int StoreVersion;
    // // 0x0034 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryBase_execOnEarnItemComplete_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString GlobalItemId;
    // // 0x0020 (0x0010) [0x0000000000000000] TArray< struct FString >
    // UpdatedItemIds;                                   		// 0x0030 (0x0010)
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0040 (0x0004) [0x0000000000000000] [0x00000001] struct FString
...
struct UMcpUserInventoryBase_execSellItem_Parms {
    ...
    // // 0x0020 (0x0010) [0x0000000000000000] int Quantity;
    // // 0x0030 (0x0004) [0x0000000000000000] int StoreVersion;
    // // 0x0034 (0x0004) [0x0000000000000000] TArray< struct
    // FMcpInventoryItemContainer >     ExpectedResultItems;
...
struct UMcpUserInventoryBase_execPurchaseItem_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString GlobalItemId;
    // // 0x0020 (0x0010) [0x0000000000000000] TArray< struct FString >
    // PurchaseItemIds;                                  		// 0x0030 (0x0010)
    // [0x0000000000000000] int Quantity; // 0x0040 (0x0004)
    // [0x0000000000000000] int StoreVersion; // 0x0044 (0x0004)
    // [0x0000000000000000] float Scalar; // 0x0048 (0x0004)
    // [0x0000000000000000]
};
...
struct UMcpUserInventoryBase_execGetInventoryItem_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString InstanceItemId;
    // // 0x0020 (0x0010) [0x0000000000000000] struct FMcpInventoryItem
    // OutInventoryItem;                                 		// 0x0030 (0x004C)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x007C (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UMcpUserInventoryBase_execGetInventoryItems_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< struct FMcpInventoryItem
    // >              OutInventoryItems;                                		//
    // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserInventoryBase_execGetSaveSlotList_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] TArray< struct FString >
    // ReturnValue;                                      		// 0x0010 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpUserInventoryBase_execCreateSaveSlot_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString ParentSaveSlotId;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserInventoryBase_execCreateInstance_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass*
    // McpUserInventoryBaseClass;                        		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMcpUserInventoryBase* NewInstance;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execOnRecordIapRequestComplete_Parms {
    ...
    // // 0x0014 (0x0004) [0x0000000000000000] int ResponseCode;
    // // 0x0018 (0x0004) [0x0000000000000000] struct FString ResponseString;
    // // 0x001C (0x0010) [0x0000000000000000] TArray< struct FString >
    // UpdatedItemIds;                                   		// 0x002C (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execOnDeleteItemRequestComplete_Parms {
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int Index;
    // // 0x0014 (0x0004) [0x0000000000000000] int SaveSlotIndex;
    // // 0x0018 (0x0004) [0x0000000000000000] int ItemIndex;
    // // 0x001C (0x0004) [0x0000000000000000] int ResponseCode;
    // // 0x0020 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execDeleteItem_Parms {
    ...
    // // 0x0030 (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x0034 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x0044 (0x0008)
    // [0x0000000000000000] int AddAt; // 0x004C (0x0004) [0x0000000000000000]
    // int                                             ExistingIndex;
    // // 0x0050 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execConsumeItem_Parms {
    ...
    // // 0x0020 (0x0010) [0x0000000000000000] int Quantity;
    // // 0x0030 (0x0004) [0x0000000000000000] int StoreVersion;
    // // 0x0034 (0x0004) [0x0000000000000000] struct FString URL;
    // // 0x0038 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x0048 (0x0008)
    // [0x0000000000000000] int AddAt; // 0x0050 (0x0004) [0x0000000000000000]
    // int                                             ExistingIndex;
    // // 0x0054 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execOnSellItemRequestComplete_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int Index;
    // // 0x0014 (0x0004) [0x0000000000000000] int SaveSlotIndex;
    // // 0x0018 (0x0004) [0x0000000000000000] int UpdatedItemIdIndex;
    // // 0x001C (0x0004) [0x0000000000000000] int FoundItemIndex;
    // // 0x0020 (0x0004) [0x0000000000000000] int ResponseCode;
    // // 0x0024 (0x0004) [0x0000000000000000] struct FString ResponseString;
    // // 0x0028 (0x0010) [0x0000000000000000] TArray< struct FString >
    // UpdatedItemIds;                                   		// 0x0038 (0x0010)
    // [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execSellItem_Parms {
    ...
    // // 0x0034 (0x0004) [0x0000000000000000] TArray< struct
    // FMcpInventoryItemContainer >     ExpectedResultItems;
    // // 0x0038 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0048 (0x0010) [0x0000000000000000] struct FString
    // expectedResultsItemsJson;                         		// 0x0058 (0x0010)
    // [0x0000000000000000] class UHttpRequestInterface* Request;
    // // 0x0068 (0x0008) [0x0000000000000000] int AddAt;
    // // 0x0070 (0x0004) [0x0000000000000000] int ExistingIndex;
    // // 0x0074 (0x0004) [0x0000000000000000] int Index;
...
struct UMcpUserInventoryManager_execPurchaseItem_Parms {
    ...
    // [0x0000000000000000] float Scalar; // 0x0048 (0x0004)
    // [0x0000000000000000] struct FString                                  URL;
    // // 0x004C (0x0010) [0x0000000000000000] struct FString paymentItemsJson;
    // // 0x005C (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x006C (0x0008)
    // [0x0000000000000000] int AddAt; // 0x0074 (0x0004) [0x0000000000000000]
    // int                                             ExistingIndex;
    // // 0x0078 (0x0004) [0x0000000000000000] int Index;
    // // 0x007C (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execFindItemRequest_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString ItemId;
    // // 0x0020 (0x0010) [0x0000000000000000] TArray< struct
    // FInventoryItemRequestState >     InItemRequests;
    // // 0x0030 (0x0010) [0x0000000000000000] int ReturnValue;
    // // 0x0040 (0x0004) [0x0000000000000000] int Index;
...
struct UMcpUserInventoryManager_execFindSaveSlotRequest_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString SaveSlotId;
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< struct
    // UMcpUserInventoryManager_FSaveSlotRequestState > InSaveSlotRequests;
    // // 0x0020 (0x0010) [0x0000000000000000] int ReturnValue;
    // // 0x0030 (0x0004) [0x0000000000000000] int Index;
    // // 0x0034 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execParseSaveSlotList_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString JsonPayload;
    // // 0x0010 (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0020 (0x0008) [0x0000000000000000] int JsonIndex;
    // // 0x0028 (0x0004) [0x0000000000000000] int SaveSlotIndex;
    // // 0x002C (0x0004) [0x0000000000000000] struct FString SaveSlotId;
...
struct UMcpUserInventoryManager_execParseInventoryForSaveSlot_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString JsonPayload;
    // // 0x0020 (0x0010) [0x0000000000000000] TArray< struct FString >
    // ReturnValue;                                      		// 0x0030 (0x0010)
    // [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0040 (0x0008) [0x0000000000000000] class UJsonObject*
    // ParsedJsonAttrs;                                  		// 0x0048 (0x0008)
    // [0x0000000000000000] int JsonIndex; // 0x0050 (0x0004)
    // [0x0000000000000000] int SaveSlotIndex; // 0x0054 (0x0004)
    // [0x0000000000000000] int ItemIndex; // 0x0058 (0x0004)
    // [0x0000000000000000] int JsonAttrsIndex; // 0x005C (0x0004)
    // [0x0000000000000000] struct FString GlobalItemId;
    // // 0x0060 (0x0010) [0x0000000000000000] struct FString InstanceItemId;
    // // 0x0070 (0x0010) [0x0000000000000000] TArray< struct FString >
    // UpdatedItemIds;                                   		// 0x0080 (0x0010)
    // [0x0000000000000000] TArray< class UJsonObject* > ObjectArray;
    // // 0x0090 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execGetInventoryItem_Parms {
    ...
    // OutInventoryItem;                                 		// 0x0030 (0x004C)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x007C (0x0004)
    // [0x0000000000000000] [0x00000001] int SaveSlotIndex;
    // // 0x0080 (0x0004) [0x0000000000000000] int ItemIndex;
    // // 0x0084 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execGetInventoryItems_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] TArray< struct FMcpInventoryItem
    // >              OutInventoryItems;                                		//
    // 0x0020 (0x0010) [0x0000000000000000] int SaveSlotIndex;
    // // 0x0030 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execOnQueryInventoryItemsRequestComplete_Parms {
    ...
    // // 0x0014 (0x0004) [0x0000000000000000] int SaveSlotIndex;
    // // 0x0018 (0x0004) [0x0000000000000000] int ResponseCode;
    // // 0x001C (0x0004) [0x0000000000000000] struct FString ResponseString;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execGetSaveSlotList_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] TArray< struct FString >
    // ReturnValue;                                      		// 0x0010 (0x0010)
    // [0x0000000000000000] TArray< struct FString > OutSaveSlots;
    // // 0x0020 (0x0010) [0x0000000000000000] int SaveSlotIndex;
    // // 0x0030 (0x0004) [0x0000000000000000]
};
...
struct UMcpUserInventoryManager_execQuerySaveSlotList_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0010 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x0020 (0x0008)
    // [0x0000000000000000] int AddAt; // 0x0028 (0x0004) [0x0000000000000000]
    // int                                             ExistingIndex;
    // // 0x002C (0x0004) [0x0000000000000000]
};
...
struct UMcpUserManagerBase_execGetUser_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpUserStatus User;
    // // 0x0010 (0x0068) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0078 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMcpUserManagerBase_execQueryUser_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bShouldUpdateLastActive :
...
struct UMcpUserManagerBase_execOnAuthenticateUserComplete_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString Token;
    // // 0x0010 (0x0010) [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // Error;                                            		// 0x0024 (0x0010)
    // [0x0000000000000000]
...
struct UMcpUserManagerBase_execAuthenticateUserMcp_Parms {
    // struct FString                                  McpId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString ClientSecret;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString UDID;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserManagerBase_execAuthenticateUserFacebook_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString FacebookToken;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString UDID;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserManagerBase_execRegisterUserFacebook_Parms {
    // struct FString                                  FacebookId;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString FacebookAuthToken;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserManagerBase_execCreateInstance_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass*
    // McpUserManagerBaseClass;                          		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMcpUserManagerBase* NewInstance;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct UMcpUserManager_execOnDeleteUserRequestComplete_Parms {
    ...
    // [0x0000000000000000] DWORD bWasSuccessful : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int Index;
    // // 0x0014 (0x0004) [0x0000000000000000] int UserIndex;
    // // 0x0018 (0x0004) [0x0000000000000000] int ResponseCode;
    // // 0x001C (0x0004) [0x0000000000000000]
};
...
struct UMcpUserManager_execGetUser_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FMcpUserStatus User;
    // // 0x0010 (0x0068) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0078 (0x0004) [0x0000000000000000] [0x00000001] int UserIndex;
    // // 0x007C (0x0004) [0x0000000000000000]
};
...
struct UMcpUserManager_execParseUsers_Parms {
    // struct FString                                  JsonPayload;
    // // 0x0000 (0x0010) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0010 (0x0008) [0x0000000000000000] int JsonIndex;
    // // 0x0018 (0x0004) [0x0000000000000000] int UserIndex;
    // // 0x001C (0x0004) [0x0000000000000000] struct FString McpId;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserManager_execQueryUsers_Parms {
    ...
    // [0x0000000000000000] int AddAt; // 0x0028 (0x0004) [0x0000000000000000]
    // struct FString                                  JsonPayload;
    // // 0x002C (0x0010) [0x0000000000000000] int Index;
    // // 0x003C (0x0004) [0x0000000000000000]
};
...
struct UMcpUserManager_execQueryUser_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bShouldUpdateLastActive :
    // 1;                      		// 0x0010 (0x0004) [0x0000000000000000]
    // [0x00000001] struct FString                                  URL;
    // // 0x0014 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x0024 (0x0008)
    // [0x0000000000000000] int AddAt; // 0x002C (0x0004) [0x0000000000000000]
};
...
struct UMcpUserManager_execOnAuthenticateUserRequestComplete_Parms {
    ...
    // // 0x0018 (0x0004) [0x0000000000000000] int UserIndex;
    // // 0x001C (0x0004) [0x0000000000000000] struct FString ResponseString;
    // // 0x0020 (0x0010) [0x0000000000000000] struct FString McpId;
    // // 0x0030 (0x0010) [0x0000000000000000] struct FString Ticket;
    // // 0x0040 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserManager_execParseUser_Parms {
    // struct FString                                  JsonPayload;
    // // 0x0000 (0x0010) [0x0000000000000000] int ReturnValue;
    // // 0x0010 (0x0004) [0x0000000000000000] class UJsonObject* ParsedJson;
    // // 0x0014 (0x0008) [0x0000000000000000] int UserIndex;
    // // 0x001C (0x0004) [0x0000000000000000] struct FString McpId;
    // // 0x0020 (0x0010) [0x0000000000000000]
};
...
struct UMcpUserManager_execRegisterUserGenerated_Parms {
    // struct FString                                  URL;
    // // 0x0000 (0x0010) [0x0000000000000000] class UHttpRequestInterface*
    // Request;                                          		// 0x0010 (0x0008)
    // [0x0000000000000000] int AddAt; // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct UOnlineImageDownloaderWeb_execDebugDraw_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float PosX;
    // // 0x0008 (0x0004) [0x0000000000000000] float PosY;
    // // 0x000C (0x0004) [0x0000000000000000] int Idx;
    // // 0x0010 (0x0004) [0x0000000000000000]
};
...
struct UOnlineImageDownloaderWeb_execOnDownloadComplete_Parms {
    ...
    // Response;                                         		// 0x0008 (0x0008)
    // [0x0000000000000000] DWORD bDidSucceed : 1; // 0x0010 (0x0004)
    // [0x0000000000000000] [0x00000001] int FoundIdx; // 0x0014 (0x0004)
    // [0x0000000000000000] TArray< unsigned char > JPEGData;
    // // 0x0018 (0x0010) [0x0000000000000000]
};
...
struct UOnlineImageDownloaderWeb_execDownloadNextImage_Parms {
    // int                                             Idx;
    // // 0x0000 (0x0004) [0x0000000000000000] int PendingDownloads;
    // // 0x0004 (0x0004) [0x0000000000000000]
};
...
struct UOnlineImageDownloaderWeb_execClearDownloads_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] int Idx;
    // // 0x0010 (0x0004) [0x0000000000000000]
};
...
struct UOnlineImageDownloaderWeb_execGetNumPendingDownloads_Parms {
    // int                                             ReturnValue;
    // // 0x0000 (0x0004) [0x0000000000000000] int Idx;
...
struct UOnlineImageDownloaderWeb_execRequestOnlineImages_Parms {
    // TArray< struct FString >                        URLs;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0010 (0x0010) [0x0000000000000000] int FoundIdx;
    // // 0x0020 (0x0004) [0x0000000000000000] int Idx;
    // // 0x0024 (0x0004) [0x0000000000000000]
};
...
struct UOnlineImageDownloaderWeb_execGetOnlineImageTexture_Parms {
    // struct FString                                  URL;
    // // 0x0000 (0x0010) [0x0000000000000000] class UTexture* ReturnValue;
    // // 0x0010 (0x0008) [0x0000000000000000] int FoundIdx;
    // // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct AWebConnection_eventReceivedText_Parms {
    // struct FString                                  Text;
    // // 0x0000 (0x0010) [0x0000000000000000] int I;
    // // 0x0010 (0x0004) [0x0000000000000000] struct FString S;
    // // 0x0014 (0x0010) [0x0000000000000000]
};
