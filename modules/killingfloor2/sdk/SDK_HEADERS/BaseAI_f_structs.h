...
struct ABaseAIController_execDrawDebugTextToHud_Parms {
    // class AHUD*                                     HUD;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FString Text;
    // // 0x0008 (0x0010) [0x0000000000000000] struct FColor TextColor;
...
struct ABaseAIController_execNotifyKilled_Parms {
    ...
    // // 0x0010 (0x0008) [0x0000000000000000] class UClass* damageTyp;
...
struct ABaseAIController_execBroadcastEnemyKnowledge_Parms {
    // class APawn*                                    EnemyPawn;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char Perception;
    // // 0x0008 (0x0001) [0x0000000000000000] int ReturnValue;
...
struct ABaseAIController_execGetAiPlugInHistory_Parms {
    // class UBaseAiPlugInHistory*                     ReturnValue;
    // // 0x0000 (0x0008) [0x0000000000000000]
};
...
struct ABaseAISquad_execGetSquadMembers_Parms {
    // TArray< class ABaseAIPawn* >                    Members;
...
struct ABaseAISquad_execEnemyPerceivedBy_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char PerceptionType;
    // // 0x0008 (0x0001) [0x0000000000000000] class APawn* Enemy;
...
struct UBaseAISubsystem_execNotifyKilled_Parms {
    // class AController*                              Killer;
    // // 0x0000 (0x0008) [0x0000000000000000] class AController*
    // KilledController;                                 		// 0x0008 (0x0008)
    // [0x0000000000000000] class APawn* KilledPawn;
    // // 0x0010 (0x0008) [0x0000000000000000] class UClass* DamageType;
    // // 0x0018 (0x0008) [0x0000000000000000]
};
...
struct UBaseAISubsystem_execGetAIDebugTool_Parms {
    // class UAIDebugTool*                             ReturnValue;
    // // 0x0000 (0x0008) [0x0000000000000000]
};
...
struct UBaseAISubsystem_execGetInstance_Parms {
    // class UBaseAISubsystem*                         ReturnValue;
    // // 0x0000 (0x0008) [0x0000000000000000]
};
...
struct ULatentActionObserver_execOnLatentFinished_Parms {
    // class ABaseAIController*                        Observer;
    // // 0x0000 (0x0008) [0x0000000000000000] class UObject* Action;
    // // 0x0008 (0x0008) [0x0000000000000000] unsigned char FinishResult;
...
struct UBaseAiPlugInHistory_execDrawDebugToHud_Parms {
    ...
    // // 0x0008 (0x0008) [0x0000000000000000] int plugInCnt;
    // // 0x0010 (0x0004) [0x0000000000000000] class UCanvas* canToUse;
    // // 0x0014 (0x0008) [0x0000000000000000] struct FBaseAIPlugInHistoryItem
    // plugInItem;                                       		// 0x001C (0x0034)
    // [0x0000000000000000]
};
...
struct UBaseAiPlugInHistory_eventSetup_Parms {
    // int                                             InPlugInHistoryNum;
    // // 0x0000 (0x0004) [0x0000000000000000] class ABaseAIController*
    // InCtrlOwner;                                      		// 0x0004 (0x0008)
    // [0x0000000000000000]
};
...
struct UAIPluginLeap_execLeap_Parms {
    // struct FLeapRequest                             InLeapRequest;
    // // 0x0000 (0x0020) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UAIPluginMovement_execGetDestination_Parms {
    // struct FMovementRequest                         Request;
    // // 0x0000 (0x0068) [0x0000000000000000] struct FVector ReturnValue;
...
struct UAIPluginMovement_execSetMovementLock_Parms {
    ...
    // Priority;                                         		// 0x0004 (0x0001)
    // [0x0000000000000000] DWORD bNewRequest : 1; // 0x0008 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UAIPluginMovement_execFollowPlugInsPath_Parms {
    // class UNavigationPath*                          InPath;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char CommandPriority;
    // // 0x0008 (0x0001) [0x0000000000000000] class UObject* ActionObserver;
    // // 0x000C (0x0008) [0x0000000000000000] DWORD bStopAtEnd : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] class AActor*
    // RotateAtEndToMatch;                               		// 0x0018 (0x0008)
    // [0x0000000000000000] float AcceptableDistance;
...
struct UAIPluginMovement_execMoveToActorRequest_Parms {
    // class AActor*                                   inPawnGoal;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char CommandPriority;
    // // 0x0008 (0x0001) [0x0000000000000000] class UObject* ActionObserver;
    // // 0x000C (0x0008) [0x0000000000000000] DWORD bInAllowedToFire : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] float
    // AcceptableDistance;                               		// 0x0018 (0x0004)
    // [0x0000000000000000] struct FVector DestOffset;
    // // 0x001C (0x000C) [0x0000000000000000] struct FVector MidPointOffset;
    // // 0x0028 (0x000C) [0x0000000000000000] DWORD bDynamicMidPoint : 1;
    // // 0x0034 (0x0004) [0x0000000000000000] [0x00000001] DWORD bStopAtEnd :
    // 1;                                   		// 0x0038 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bStickToNavmesh : 1;
    // // 0x003C (0x0004) [0x0000000000000000] [0x00000001] DWORD ReturnValue :
    // 1;                                  		// 0x0040 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UAIPluginMovement_execMoveToPointRequest_Parms {
    // struct FVector                                  InDestLocation;
    // // 0x0000 (0x000C) [0x0000000000000000] unsigned char CommandPriority;
    // // 0x000C (0x0001) [0x0000000000000000] class UObject* ActionObserver;
    // // 0x0010 (0x0008) [0x0000000000000000] DWORD bStopAtEnd : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // bStickToNavmesh : 1;                              		// 0x001C (0x0004)
    // [0x0000000000000000] [0x00000001] float AcceptableDistance;
    // // 0x0020 (0x0004) [0x0000000000000000] class AActor* RotateAtEndToMatch;
    // // 0x0024 (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
...
struct UAIPluginMovement_execMoveToRequest_Parms {
    // struct FMovementRequest                         Request;
    // // 0x0000 (0x0068) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0068 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UPluginSquad_execEnemyPerceived_Parms {
    ...
    // // 0x0000 (0x0001) [0x0000000000000000] class APawn* PerceivedEnemy;
...
struct UAIDebugTool_execDumpNativeCallStack_Parms {
    // class AActor*                                   Actor;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FName LogCategory;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct UAIDebugTool_execGetActorEntryLocation_Parms {
    ...
    // // 0x0008 (0x0004) [0x0000000000000000] struct FVector ReturnValue;
...
struct UAIDebugTool_execAddETQLog_Parms {
    // struct FString                                  QueryName;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString TestName;
    // // 0x0010 (0x0010) [0x0000000000000000] class AActor* Querier;
...
struct UAIDebugTool_execSetHistoryFilter_Parms {
    // struct FName                                    Filter;
    // // 0x0000 (0x0008) [0x0000000000000000] DWORD bVal : 1; // 0x0008
...
struct UAIDebugTool_execDisplayNextEntry_Parms {
    // int                                             Count;
    // // 0x0000 (0x0004) [0x0000000000000000] int Direction;
    // // 0x0004 (0x0004) [0x0000000000000000]
};
...
struct UAIDebugTool_execLogSpaceLine_Parms {
    // class AActor*                                   Actor;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FVector Start;
    // // 0x0008 (0x000C) [0x0000000000000000] struct FVector End;
    // // 0x0014 (0x000C) [0x0000000000000000] unsigned char Type;
    // // 0x0020 (0x0001) [0x0000000000000000] struct FString Comment;
    // // 0x0024 (0x0010) [0x0000000000000000] struct FName Category;
...
struct UAIDebugTool_execLog_Parms {
    // class AActor*                                   Actor;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FString LogText;
    // // 0x0008 (0x0010) [0x0000000000000000] struct FName LogCategory;
    // // 0x0018 (0x0008) [0x0000000000000000]
};
...
struct UAIDebugTool_execSetDebugTarget_Parms {
    // class ABaseAIController*                        NewDebugTarget;
    // // 0x0000 (0x0008) [0x0000000000000000]
};
...
struct UAIDebugTool_execFlushLogs_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] class ABaseAIController* AI;
...
struct UAIDebugTool_execLoadLogFile_Parms {
    // struct FString                                  Filename;
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bAppendMapName : 1;
...
struct UAIDebugTool_execDrawLog_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class AActor* Actor;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct UNavigationPath_execDrawPath_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char R; // 0x0008
    // (0x0001) [0x0000000000000000] unsigned char G;
    // // 0x0009 (0x0001) [0x0000000000000000] unsigned char B; // 0x000A
    // (0x0001) [0x0000000000000000] DWORD bPersistent : 1;
...
struct UNavigationPath_execSetRoute_Parms {
    // TArray< struct FPathPoint >                     Route;
    // // 0x0000 (0x0010) [0x0000000000000000]
};
