...
struct AGameAIController_eventGetActionString_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString ActionStr;
    // // 0x0010 (0x0010) [0x0000000000000000] class UGameAICommand* ActiveCmd;
...
struct AGameAIController_execSetDesiredRotation_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] DWORD InLockDesiredRotation : 1;
    // // 0x000C (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // InUnlockWhenReached : 1;                          		// 0x0010 (0x0004)
    // [0x0000000000000000] [0x00000001] float InterpolationTime;
...
struct AGameAIController_eventAILog_Internal_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FName LogCategory;
    // // 0x0010 (0x0008) [0x0000000000000000] DWORD bForce : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001] DWORD BugIt : 1;
    // // 0x001C (0x0004) [0x0000000000000000] [0x00000001] DWORD bSkipExtraInfo
    // : 1;                               		// 0x0020 (0x0004)
    // [0x0000000000000000] [0x00000001] int Idx; // 0x0024 (0x0004)
    // [0x0000000000000000] struct FString ActionStr;
    // // 0x0028 (0x0010) [0x0000000000000000] struct FString FinalStr;
    // // 0x0038 (0x0010) [0x0000000000000000] struct FString Filename;
    // // 0x0048 (0x0010) [0x0000000000000000] class UGameAICommand*
    // ActiveCommand;                                    		// 0x0058 (0x0008)
    // [0x0000000000000000] int FileNameLength; // 0x0060 (0x0004)
    // [0x0000000000000000] class UEngine*                                  Eng;
...
struct AGameAIController_execGetAICommandInStack_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UGameAICommand*
...
struct AGameAIController_execAbortCommand_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UClass* AbortClass;
...
struct AGameAIController_execAllCommands_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UGameAICommand* Cmd;
...
struct AGamePawn_eventUpdateShadowSettings_Parms {
    // DWORD                                           bInWantShadow : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] DWORD bNewCastShadow
    // : 1;                               		// 0x0004 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bNewCastDynamicShadow : 1;
...
struct UGameAICommand_execMoveUnreachable_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] class AActor* AttemptedTarget;
...
struct UGameAICommand_execGetDebugOverheadText_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] TArray< struct FString > OutText;
...
struct UGameAICommand_execInitCommandUserActor_Parms {
    // class AGameAIController*                        AI;
    // // 0x0000 (0x0008) [0x0000000000000000] class AActor* UserActor;
    // // 0x0008 (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGamePlayerController_execClientColorFade_Parms {
    ...
    // // 0x0000 (0x0004) [0x0000000000000000] unsigned char FromAlpha;
    // // 0x0004 (0x0001) [0x0000000000000000] unsigned char ToAlpha;
    // // 0x0005 (0x0001) [0x0000000000000000] float FadeTime; // 0x0008
...
struct AGamePlayerController_eventWarmupPause_Parms {
    // DWORD                                           bDesiredPauseState : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] struct FColor
    // FadeColor;                                        		// 0x0004 (0x0004)
    // [0x0000000000000000] class APlayerController*                        PC;
    // // 0x0008 (0x0008) [0x0000000000000000] struct FString MovieName;
...
struct AGamePlayerController_eventClientStopMovie_Parms {
    ...
    // // 0x0000 (0x0004) [0x0000000000000000] DWORD bAllowMovieToFinish : 1;
    // // 0x0004 (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // bForceStopNonSkippable : 1;                       		// 0x0008 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bForceStopLoadingMovie : 1;
...
struct AGamePlayerController_eventClientPlayMovie_Parms {
    // struct FString                                  MovieName;
    // // 0x0000 (0x0010) [0x0000000000000000] int InStartOfRenderingMovieFrame;
    // // 0x0010 (0x0004) [0x0000000000000000] int InEndOfRenderingMovieFrame;
    // // 0x0014 (0x0004) [0x0000000000000000] DWORD bRestrictPausing : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // bPlayOnceFromStream : 1;                          		// 0x001C (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bOnlyBackButtonSkipsMovie : 1;
...
struct AGamePlayerController_execShowLoadingMovie_Parms {
    ...
    // bPauseAfterHide : 1;                              		// 0x0004 (0x0004)
    // [0x0000000000000000] [0x00000001] float PauseDuration;
    // // 0x0008 (0x0004) [0x0000000000000000] float KeepPlayingDuration;
    // // 0x000C (0x0004) [0x0000000000000000] DWORD bOverridePreviousDelays :
    // 1;                      		// 0x0010 (0x0004) [0x0000000000000000]
    // [0x00000001]
};
...
struct AGamePlayerController_execSetSoundMode_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UAudioDevice* Audio;
    // // 0x0008 (0x0008) [0x0000000000000000] DWORD bSet : 1; // 0x0010
...
struct AGamePlayerController_execDoForceFeedbackForScreenShake_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] float Scale;
    // // 0x0008 (0x0004) [0x0000000000000000] int ShakeLevel;
    // // 0x000C (0x0004) [0x0000000000000000] float RotMag;
    // // 0x0010 (0x0004) [0x0000000000000000] float LocMag;
    // // 0x0014 (0x0004) [0x0000000000000000] float FOVMag;
...
struct AGamePlayerController_execCrowdDebug_Parms {
    ...
    // // 0x000C (0x0004) [0x0000000000000000] int AgentCount;
    // // 0x0010 (0x0004) [0x0000000000000000] float DebugRadius;
    // // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct AGamePlayerController_execOnToggleMouseCursor_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UGameViewportClient* GVC;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct UGameCheatManager_execOnRequestComplete_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UHttpResponseInterface*
    // Response;                                         		// 0x0008 (0x0008)
    // [0x0000000000000000] DWORD bDidSucceed : 1; // 0x0010 (0x0004)
    // [0x0000000000000000] [0x00000001] TArray< struct FString > Headers;
    // // 0x0014 (0x0010) [0x0000000000000000] struct FString Header;
    // // 0x0024 (0x0010) [0x0000000000000000] struct FString Payload;
    // // 0x0034 (0x0010) [0x0000000000000000] int PayloadIndex;
...
struct UGameCheatManager_execTestHttp_Parms {
    // struct FString                                  Verb;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString Payload;
    // // 0x0010 (0x0010) [0x0000000000000000] struct FString URL;
    // // 0x0020 (0x0010) [0x0000000000000000] DWORD bSendParallelRequest : 1;
    // // 0x0030 (0x0004) [0x0000000000000000] [0x00000001] class
    // UHttpRequestInterface*                    R;
...
struct UGameCheatManager_execEnableDebugCamera_Parms {
    // DWORD                                           bEnableDebugText : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] class UPlayer* P;
    // // 0x0004 (0x0008) [0x0000000000000000] struct FVector eyeLoc;
    // // 0x000C (0x000C) [0x0000000000000000] struct FRotator eyeRot;
    // // 0x0018 (0x000C) [0x0000000000000000] float CameraFOVAngle;
...
struct UGameCheatManager_execTeleportPawnToCamera_Parms {
    // DWORD                                           bToggleDebugCameraOff :
    // 1;                        		// 0x0000 (0x0004) [0x0000000000000000]
    // [0x00000001] class APlayerController*                        PC;
    // // 0x0004 (0x0008) [0x0000000000000000] class ADebugCameraController*
    // DCC;                                              		// 0x000C (0x0008)
    // [0x0000000000000000] struct FVector ViewLocation;
    // // 0x0014 (0x000C) [0x0000000000000000] struct FRotator ViewRotation;
...
struct UGameCheatManager_execPatchDebugCameraController_Parms {
    // class UClass*
    // TempCameraControllerClass;                        		// 0x0000 (0x0008)
    // [0x0000000000000000]
};
...
struct AGameCrowdAgent_execGetBehaviorString_Parms {
    // struct FString                                  ReturnValue;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString BehaviorString;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct AGameCrowdAgent_execGetDestString_Parms {
    // struct FString                                  ReturnValue;
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString DestString;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct AGameCrowdAgent_eventPostRenderFor_Parms {
    // class APlayerController*                        PC;
    // // 0x0000 (0x0008) [0x0000000000000000] class UCanvas* Canvas;
    // // 0x0008 (0x0008) [0x0000000000000000] struct FVector CameraPosition;
    // // 0x0010 (0x000C) [0x0000000000000000] struct FVector CameraDir;
    // // 0x001C (0x000C) [0x0000000000000000] float NameXL;
    // // 0x0028 (0x0004) [0x0000000000000000] float TextXL;
    // // 0x002C (0x0004) [0x0000000000000000] float BehavXL;
    // // 0x0030 (0x0004) [0x0000000000000000] float TextYL;
    // // 0x0034 (0x0004) [0x0000000000000000] float YL;
    // // 0x0038 (0x0004) [0x0000000000000000] float XL;
    // // 0x003C (0x0004) [0x0000000000000000] struct FVector ScreenLoc;
    // // 0x0040 (0x000C) [0x0000000000000000] struct FString ScreenName;
    // // 0x004C (0x0010) [0x0000000000000000] struct FString DestString;
    // // 0x005C (0x0010) [0x0000000000000000] struct FString BehaviorString;
    // // 0x006C (0x0010) [0x0000000000000000] struct FFontRenderInfo FontInfo;
    // // 0x007C (0x0028) [0x0000000000000000]
};
...
struct AGameCrowdAgent_eventGeneratePathToActor_Parms {
    // class AActor*                                   Goal;
    // // 0x0000 (0x0008) [0x0000000000000000] float WithinDistance;
    // // 0x0008 (0x0004) [0x0000000000000000] DWORD bAllowPartialPath : 1;
    // // 0x000C (0x0004) [0x0000000000000000] [0x00000001] struct FVector
    // ReturnValue;                                      		// 0x0010 (0x000C)
    // [0x0000000000000000] struct FVector NextDest; // 0x001C (0x000C)
    // [0x0000000000000000]
};
...
struct AGameCrowdAgent_execCalcCamera_Parms {
    // float                                           fDeltaTime;
    // // 0x0000 (0x0004) [0x0000000000000000] struct FVector out_CamLoc;
    // // 0x0004 (0x000C) [0x0000000000000000] struct FRotator out_CamRot;
    // // 0x0010 (0x000C) [0x0000000000000000] float out_FOV;
    // // 0x001C (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] struct FVector
    // HitNormal;                                        		// 0x0024 (0x000C)
    // [0x0000000000000000] float Radius; // 0x0030 (0x0004)
    // [0x0000000000000000]
};
...
struct AGameCrowdAgent_eventHandleBehaviorEvent_Parms {
    ...
    // // 0x0000 (0x0001) [0x0000000000000000] class AActor* InInstigator;
    // // 0x0004 (0x0008) [0x0000000000000000] DWORD bViralCause : 1;
    // // 0x000C (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // bPropagateViralFlag : 1;                          		// 0x0010 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bActivatedBehavior : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGameCrowdAgent_eventActivateBehavior_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class AActor* LookAtActor;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct AGameCrowdAgent_eventNotifySeePlayer_Parms {
    // class APlayerController*                        PC;
    // // 0x0000 (0x0008) [0x0000000000000000] DWORD bFoundBehavior : 1;
...
struct AGameCrowdAgent_execInitializeAgent_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] TArray< struct
    // FCrowdSpawnerPlayerInfo >        PlayerInfo;
    // // 0x0008 (0x0010) [0x0000000000000000] class AGameCrowdAgent*
    // AgentTemplate;                                    		// 0x0018 (0x0008)
    // [0x0000000000000000] class UGameCrowdGroup* NewGroup;
    // // 0x0020 (0x0008) [0x0000000000000000] float AgentWarmupTime;
    // // 0x0028 (0x0004) [0x0000000000000000] DWORD bWarmupPosition : 1;
    // // 0x002C (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // bCheckWarmupVisibility : 1;                       		// 0x0030 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bGroupDestination : 1;
    // // 0x0034 (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // bRealPreferVisible : 1;                           		// 0x0038 (0x0004)
    // [0x0000000000000000] [0x00000001] class AGameCrowdDestination* SpawnDest;
    // // 0x003C (0x0008) [0x0000000000000000] float TryPct;
    // // 0x0044 (0x0004) [0x0000000000000000] float MaxSpawnDist;
    // // 0x0048 (0x0004) [0x0000000000000000] float DestDist; // 0x004C
    // (0x0004) [0x0000000000000000] float StartDist;
    // // 0x0050 (0x0004) [0x0000000000000000] struct FVector TryLoc;
    // // 0x0054 (0x000C) [0x0000000000000000] class AActor* HitActor;
    // // 0x0060 (0x0008) [0x0000000000000000] struct FVector HitLocation;
    // // 0x0068 (0x000C) [0x0000000000000000] struct FVector HitNormal;
    // // 0x0074 (0x000C) [0x0000000000000000] struct FVector
    // NearestViewLocation;                              		// 0x0080 (0x000C)
    // [0x0000000000000000] struct FVector YAdjust; // 0x008C (0x000C)
    // [0x0000000000000000] DWORD bVisibleTryLoc : 1;
    // // 0x0098 (0x0004) [0x0000000000000000] [0x00000001] DWORD bFoundOption :
    // 1;                                 		// 0x009C (0x0004)
    // [0x0000000000000000] [0x00000001] int CheckCnt; // 0x00A0 (0x0004)
    // [0x0000000000000000] int MaxCheckCnt; // 0x00A4 (0x0004)
    // [0x0000000000000000] int OptionIdx; // 0x00A8 (0x0004)
    // [0x0000000000000000] TArray< struct FVector > TryOptions;
    // // 0x00AC (0x0010) [0x0000000000000000] float SpawnDestRadius;
    // // 0x00BC (0x0004) [0x0000000000000000] float TravelDestRadius;
    // // 0x00C0 (0x0004) [0x0000000000000000] int PlayerIdx;
    // // 0x00C4 (0x0004) [0x0000000000000000] float NearestViewDistSq;
    // // 0x00C8 (0x0004) [0x0000000000000000] float ViewDistSq;
    // // 0x00CC (0x0004) [0x0000000000000000] DWORD bVisibleOption : 1;
    // // 0x00D0 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGameCrowdAgent_execGetAttemptedSpawnLocation_Parms {
    // float                                           Pct;
    // // 0x0000 (0x0004) [0x0000000000000000] struct FVector CurPos;
    // // 0x0004 (0x000C) [0x0000000000000000] float CurRadius; // 0x0010
    // (0x0004) [0x0000000000000000] struct FVector DestPos;
    // // 0x0014 (0x000C) [0x0000000000000000] float DestRadius;
    // // 0x0020 (0x0004) [0x0000000000000000] struct FVector ReturnValue;
    // // 0x0024 (0x000C) [0x0000000000000000] float MaxLateralOffset;
    // // 0x0030 (0x0004) [0x0000000000000000] float LateralOffset;
    // // 0x0034 (0x0004) [0x0000000000000000] struct FVector LateralDir;
    // // 0x0038 (0x000C) [0x0000000000000000]
};

// Function GameFramework.GameCrowdAgent.SetLighting
// [0x00020102]
struct AGameCrowdAgent_execSetLighting_Parms {
    // DWORD                                           bEnableLightEnvironment :
    // 1;                      		// 0x0000 (0x0004) [0x0000000000000000]
    // [0x00000001] struct FLightingChannelContainer AgentLightingChannel;
    // // 0x0004 (0x0004) [0x0000000000000000] DWORD bCastShadows : 1;
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGameCrowdAgent_execDisplayDebug_Parms {
    // class AHUD*                                     HUD;
    // // 0x0000 (0x0008) [0x0000000000000000] float out_YL;
    // // 0x0008 (0x0004) [0x0000000000000000] float out_YPos; // 0x000C
    // (0x0004) [0x0000000000000000] struct FString T;
    // // 0x0010 (0x0010) [0x0000000000000000] class UCanvas* Canvas;
    // // 0x0020 (0x0008) [0x0000000000000000]
};
...
struct AGameCrowdAgent_execPostBeginPlay_Parms {
    // struct FVector                                  AgentScale3D;
    // // 0x0000 (0x000C) [0x0000000000000000] int I;
    // // 0x000C (0x0004) [0x0000000000000000] float MaxSeePlayerDist;
...
struct AGameCrowdAgent_execPickBehaviorFrom_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FVector BestCameraLoc;
    // // 0x0010 (0x000C) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x001C (0x0004) [0x0000000000000000] [0x00000001] struct FVector
    // CameraLoc;                                        		// 0x0020 (0x000C)
    // [0x0000000000000000] struct FRotator CameraRot;
    // // 0x002C (0x000C) [0x0000000000000000] class APlayerController* PC;
    // // 0x0038 (0x0008) [0x0000000000000000] float BestDistSq;
    // // 0x0040 (0x0004) [0x0000000000000000] float NewDistSq; // 0x0044
    // (0x0004) [0x0000000000000000] int I; // 0x0048 (0x0004)
    // [0x0000000000000000] float FreqSum; // 0x004C (0x0004)
    // [0x0000000000000000] float RandPick; // 0x0050 (0x0004)
    // [0x0000000000000000]
};
...
struct AGameCrowdAgentSkeletal_execCreateAttachments_Parms {
    // int                                             AttachIdx;
    // // 0x0000 (0x0004) [0x0000000000000000] int InfoIdx;
    // // 0x0004 (0x0004) [0x0000000000000000] int PickedInfoIdx;
    // // 0x0008 (0x0004) [0x0000000000000000] float ChanceTotal;
    // // 0x000C (0x0004) [0x0000000000000000] float RandVal;
    // // 0x0010 (0x0004) [0x0000000000000000] class UStaticMeshComponent*
    // StaticMeshComp;                                   		// 0x0014 (0x0008)
    // [0x0000000000000000] DWORD bUseSocket : 1; // 0x001C (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bUseBone : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGameCrowdAgentSM_execChangeDebugColor_Parms {
    // struct FColor                                   InC;
    // // 0x0000 (0x0004) [0x0000000000000000] struct FLinearColor C;
...
struct UGameCrowdAgentBehavior_execCanBeUsedBy_Parms {
    // class AGameCrowdAgent*                          Agent;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FVector CameraLoc;
...
struct UGameCrowdAgentBehavior_execTriggerCrowdBehavior_Parms {
    // unsigned char                                   EventType;
    // // 0x0000 (0x0001) [0x0000000000000000] class AActor* Instigator;
    // // 0x0004 (0x0008) [0x0000000000000000] struct FVector AtLocation;
    // // 0x000C (0x000C) [0x0000000000000000] float InRange;
    // // 0x0018 (0x0004) [0x0000000000000000] float InDuration;
    // // 0x001C (0x0004) [0x0000000000000000] class AActor* BaseActor;
    // // 0x0020 (0x0008) [0x0000000000000000] DWORD bRequireLOS : 1;
    // // 0x0028 (0x0004) [0x0000000000000000] [0x00000001] class
    // AGameCrowdBehaviorPoint*                  ReturnValue;
...
struct UGameCrowdBehavior_PlayAnimation_execPlayAgentAnimationNow_Parms {
    ...
    // // 0x0000 (0x0004) [0x0000000000000000] float CurrentBlendOutTime;
    // // 0x0004 (0x0004) [0x0000000000000000] class AGameCrowdAgentSkeletal*
    // MySkAgent;                                        		// 0x0008 (0x0008)
    // [0x0000000000000000]
};
...
struct UGameCrowdBehavior_PlayAnimation_execInitBehavior_Parms {
    ...
    // // 0x0008 (0x0008) [0x0000000000000000] class APlayerController*
    // ClosestPC;                                        		// 0x0010 (0x0008)
    // [0x0000000000000000] float ClosestDist; // 0x0018 (0x0004)
    // [0x0000000000000000] float newdist; // 0x001C (0x0004)
    // [0x0000000000000000] class AGameCrowdAgentSkeletal* SkAgent;
    // // 0x0020 (0x0008) [0x0000000000000000]
};
...
struct UGameCrowdBehavior_RunFromPanic_execActivatedBy_Parms {
    // class AActor*                                   NewActionTarget;
    // // 0x0000 (0x0008) [0x0000000000000000] class AGameCrowdDestination*
    // TempDest;                                         		// 0x0008 (0x0008)
    // [0x0000000000000000] class AGameCrowdDestination* PrevDest;
...
struct AGameCrowdInfoVolume_execUnTouch_Parms {
    // class AActor*                                   Other;
    // // 0x0000 (0x0008) [0x0000000000000000] class APawn* P; // 0x0008
    // (0x0008) [0x0000000000000000] class AGameCrowdPopulationManager* PopMgr;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct AGameCrowdBehaviorPoint_eventTouch_Parms {
    ...
    // [0x0000000000000000] struct FVector HitLocation;
    // // 0x0010 (0x000C) [0x0000000000000000] struct FVector HitNormal;
    // // 0x001C (0x000C) [0x0000000000000000] class AGameCrowdAgent* Agent;
...
struct AGameCrowdDestination_execDrawDebug_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bPresistent : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int PlayerIdx;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FVector Extent;
...
struct AGameCrowdDestination_execPrioritizeSpawnPoint_Parms {
    // TArray< struct FCrowdSpawnerPlayerInfo >        PlayerInfo;
    // // 0x0000 (0x0010) [0x0000000000000000] float MaxSpawnDist;
    // // 0x0010 (0x0004) [0x0000000000000000] float DistToSpawn;
    // // 0x0014 (0x0004) [0x0000000000000000] int PlayerIdx;
    // // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdDestination_execAnalyzeSpawnPoint_Parms {
    // TArray< struct FCrowdSpawnerPlayerInfo >        PlayerInfo;
    // // 0x0000 (0x0010) [0x0000000000000000] float MaxSpawnDistSq;
    // // 0x0010 (0x0004) [0x0000000000000000] DWORD bForceNavMeshPathing : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] class
    // UNavigationHandle*                        NavHandle;
    // // 0x0018 (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] class AActor*
    // HitActor;                                         		// 0x0024 (0x0008)
    // [0x0000000000000000] struct FVector HitLocation;
    // // 0x002C (0x000C) [0x0000000000000000] struct FVector HitNormal;
    // // 0x0038 (0x000C) [0x0000000000000000] int NextIdx;
    // // 0x0044 (0x0004) [0x0000000000000000] int PlayerIdx;
    // // 0x0048 (0x0004) [0x0000000000000000] class AGameCrowdDestination*
    // NextGCD;                                          		// 0x004C (0x0008)
    // [0x0000000000000000] float DistFromView; // 0x0054 (0x0004)
    // [0x0000000000000000] float DistFromPred; // 0x0058 (0x0004)
    // [0x0000000000000000]
};
...
struct AGameCrowdDestination_execGetSpawnPosition_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] struct FVector SpawnPos;
    // // 0x0008 (0x000C) [0x0000000000000000] struct FRotator SpawnRot;
    // // 0x0014 (0x000C) [0x0000000000000000] struct FVector SpawnLine;
    // // 0x0020 (0x000C) [0x0000000000000000] float RandScale; // 0x002C
    // (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdDestination_eventAllowableDestinationFor_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001] int I;
    // // 0x000C (0x0004) [0x0000000000000000] DWORD bSupported : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGameCrowdDestination_eventDecrementCustomerCount_Parms {
    ...
    // AGameCrowdDestinationQueuePoint*          QP;
    // // 0x0008 (0x0008) [0x0000000000000000] DWORD bIsInQueue : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGameCrowdDestination_execPickNewDestinationFor_Parms {
    // class AGameCrowdAgent*                          Agent;
    // // 0x0000 (0x0008) [0x0000000000000000] DWORD bIgnoreRestrictions : 1;
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001] int I;
    // // 0x000C (0x0004) [0x0000000000000000] float DestinationFrequencySum;
    // // 0x0010 (0x0004) [0x0000000000000000] float DestinationPickValue;
    // // 0x0014 (0x0004) [0x0000000000000000] TArray< class
    // AGameCrowdDestination* >          DestOptions;
...
struct AGameCrowdDestination_eventReachedDestination_Parms {
    // class AGameCrowdAgent*                          Agent;
    // // 0x0000 (0x0008) [0x0000000000000000] int I;
    // // 0x0008 (0x0004) [0x0000000000000000] int J;
    // // 0x000C (0x0004) [0x0000000000000000] class
    // USeqEvent_CrowdAgentReachedDestination*   ReachedEvent;
    // // 0x0010 (0x0008) [0x0000000000000000] DWORD bEventActivated : 1;
...
struct AGameCrowdDestination_execPostBeginPlay_Parms {
    // int                                             I;
    // // 0x0000 (0x0004) [0x0000000000000000] class
    // AGameCrowdPopulationManager*              PopMgr;
...
struct AGameCrowdDestination_execReachedByAgent_Parms {
    // class AGameCrowdAgent*                          Agent;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FVector TestPosition;
    // // 0x0008 (0x000C) [0x0000000000000000] DWORD bTestExactly : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] DWORD ReturnValue :
    // 1;                                  		// 0x0018 (0x0004)
...
struct AGameCrowdDestinationQueuePoint_execAddCustomer_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class AGameCrowdInteractionPoint*
    // PreviousPosition;                                 		// 0x0008 (0x0008)
    // [0x0000000000000000]
};
...
struct AGameCrowdDestinationQueuePoint_execActuallyAdvance_Parms {
    // class AGameCrowdDestinationQueuePoint*          FrontQueuePosition;
    // // 0x0000 (0x0008) [0x0000000000000000] class AGameCrowdDestination*
    // QueueFront;                                       		// 0x0008 (0x0008)
    // [0x0000000000000000] class AGameCrowdAgent* TempAgent;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct AGameCrowdDestinationQueuePoint_eventReachedDestination_Parms {
    // class AGameCrowdAgent*                          Agent;
    // // 0x0000 (0x0008) [0x0000000000000000] class
    // AGameCrowdDestinationQueuePoint*          QueuePoint;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_eventCreateNewAgent_Parms {
    ...
    // // 0x0000 (0x0090) [0x0000000000000000] class AGameCrowdDestination*
    // SpawnLoc;                                         		// 0x0090 (0x0008)
    // [0x0000000000000000] class AGameCrowdAgent* AgentTemplate;
    // // 0x0098 (0x0008) [0x0000000000000000] class UGameCrowdGroup* NewGroup;
    // // 0x00A0 (0x0008) [0x0000000000000000] class AGameCrowdAgent*
    // ReturnValue;                                      		// 0x00A8 (0x0008)
    // [0x0000000000000000] class AGameCrowdAgent* Agent;
    // // 0x00B0 (0x0008) [0x0000000000000000] struct FRotator SpawnRot;
    // // 0x00B8 (0x000C) [0x0000000000000000] struct FVector SpawnPos;
    // // 0x00C4 (0x000C) [0x0000000000000000] int I;
    // // 0x00D0 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execWarmup_Parms {
    // struct FCrowdSpawnInfoItem                      Item;
    // // 0x0000 (0x0090) [0x0000000000000000] int WarmupNum;
    // // 0x0090 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0094 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGameCrowdPopulationManager_execSpawnAgent_Parms {
    ...
    // // 0x0000 (0x0090) [0x0000000000000000] class AGameCrowdDestination*
    // SpawnLoc;                                         		// 0x0090 (0x0008)
    // [0x0000000000000000] class AGameCrowdAgent* ReturnValue;
    // // 0x0098 (0x0008) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execSpawnAgentByIdx_Parms {
    // int                                             SpawnerIdx;
    // // 0x0000 (0x0004) [0x0000000000000000] class AGameCrowdDestination*
    // SpawnLoc;                                         		// 0x0004 (0x0008)
    // [0x0000000000000000] class AGameCrowdAgent* ReturnValue;
    // // 0x000C (0x0008) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execValidateSpawnAt_Parms {
    // struct FCrowdSpawnInfoItem                      Item;
    // // 0x0000 (0x0090) [0x0000000000000000] class AGameCrowdDestination*
    // Candidate;                                        		// 0x0090 (0x0008)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0098 (0x0004)
    // [0x0000000000000000] [0x00000001] class AActor* HitActor;
    // // 0x009C (0x0008) [0x0000000000000000] struct FVector HitLocation;
    // // 0x00A4 (0x000C) [0x0000000000000000] struct FVector HitNormal;
    // // 0x00B0 (0x000C) [0x0000000000000000] float DistSq;
    // // 0x00BC (0x0004) [0x0000000000000000] float MinDistFromViewSq;
    // // 0x00C0 (0x0004) [0x0000000000000000] float DestDotView;
    // // 0x00C4 (0x0004) [0x0000000000000000] int PlayerIdx;
    // // 0x00C8 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execAddPrioritizedSpawnPoint_Parms {
    // struct FCrowdSpawnInfoItem                      Item;
    // // 0x0000 (0x0090) [0x0000000000000000] class AGameCrowdDestination* GCD;
    // // 0x0090 (0x0008) [0x0000000000000000] int SpawnIdx;
    // // 0x0098 (0x0004) [0x0000000000000000] int StartingIndex;
    // // 0x009C (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execAnalyzeSpawnPoints_Parms {
    // struct FCrowdSpawnInfoItem                      Item;
    // // 0x0000 (0x0090) [0x0000000000000000] int StartIndex;
    // // 0x0090 (0x0004) [0x0000000000000000] int NumToUpdate;
    // // 0x0094 (0x0004) [0x0000000000000000] int UpdateIdx;
    // // 0x0098 (0x0004) [0x0000000000000000] int Idx;
    // // 0x009C (0x0004) [0x0000000000000000] int NumUpdated;
    // // 0x00A0 (0x0004) [0x0000000000000000] class AGameCrowdDestination* GCD;
    // // 0x00A4 (0x0008) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_eventPrioritizeSpawnPoints_Parms {
    // struct FCrowdSpawnInfoItem                      Item;
    // // 0x0000 (0x0090) [0x0000000000000000] float DeltaTime; // 0x0090
    // (0x0004) [0x0000000000000000] int UpdateNum;
    // // 0x0094 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_eventPickSpawnPoint_Parms {
    // struct FCrowdSpawnInfoItem                      Item;
    // // 0x0000 (0x0090) [0x0000000000000000] class AGameCrowdDestination*
    // ReturnValue;                                      		// 0x0090 (0x0008)
    // [0x0000000000000000] int StartingIndex; // 0x0098 (0x0004)
    // [0x0000000000000000] int SpawnIdx; // 0x009C (0x0004)
    // [0x0000000000000000] class AGameCrowdDestination* Candidate;
...
struct AGameCrowdPopulationManager_eventUpdateSpawner_Parms {
    ...
    // // 0x0094 (0x0004) [0x0000000000000000] [0x00000001] class
    // AGameCrowdDestination*                    PickedSpawnPoint;
    // // 0x0098 (0x0008) [0x0000000000000000] class AGameCrowdAgent* A;
    // // 0x00A0 (0x0008) [0x0000000000000000] int NumSpawned;
    // // 0x00A8 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execTick_Parms {
    // float                                           DeltaTime;
    // // 0x0000 (0x0004) [0x0000000000000000] class AGameCrowdDestination*
    // PickedSpawnPoint;                                 		// 0x0004 (0x0008)
    // [0x0000000000000000] int                                             Idx;
    // // 0x000C (0x0004) [0x0000000000000000] int PlayerIdx;
    // // 0x0010 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execIsSpawningActive_Parms {
    // DWORD                                           ReturnValue : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] int SpawnerIdx;
    // // 0x0004 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execDisplayDebug_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] float out_YL;
    // // 0x0008 (0x0004) [0x0000000000000000] float out_YPos; // 0x000C
    // (0x0004) [0x0000000000000000] class UCanvas* Canvas;
    // // 0x0010 (0x0008) [0x0000000000000000] int RenderedNum;
    // // 0x0018 (0x0004) [0x0000000000000000] int LOSNum;
    // // 0x001C (0x0004) [0x0000000000000000] int SimNum;
    // // 0x0020 (0x0004) [0x0000000000000000] int ActualCount;
    // // 0x0024 (0x0004) [0x0000000000000000] int DistanceBucket[ 0x14 ];
    // // 0x0028 (0x0050) [0x0000000000000000] int I;
    // // 0x0078 (0x0004) [0x0000000000000000] int RVONum;
    // // 0x007C (0x0004) [0x0000000000000000] class AActor* HitActor;
    // // 0x0080 (0x0008) [0x0000000000000000] struct FVector HitNormal;
    // // 0x0088 (0x000C) [0x0000000000000000] struct FVector HitLocation;
    // // 0x0094 (0x000C) [0x0000000000000000] class AGameCrowdAgent* GCA;
    // // 0x00A0 (0x0008) [0x0000000000000000] float Dist;
    // // 0x00A8 (0x0004) [0x0000000000000000] TArray< class AGameCrowdAgent* >
    // AgentList;                                        		// 0x00AC (0x0010)
    // [0x0000000000000000] int PlayerIdx; // 0x00BC (0x0004)
    // [0x0000000000000000] int SpawnIdx; // 0x00C0 (0x0004)
    // [0x0000000000000000] DWORD bHasLOS : 1; // 0x00C4 (0x0004)
    // [0x0000000000000000] [0x00000001] float BucketSize;
    // // 0x00C8 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execAgentDestroyed_Parms {
    // class AGameCrowdAgent*                          Agent;
    // // 0x0000 (0x0008) [0x0000000000000000] int SpawnerIdx;
...
struct AGameCrowdPopulationManager_eventFlushAgents_Parms {
    // struct FCrowdSpawnInfoItem                      Item;
    // // 0x0000 (0x0090) [0x0000000000000000] int AgentIdx;
    // // 0x0090 (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_eventCreateSpawner_Parms {
    ...
    // // 0x0008 (0x0004) [0x0000000000000000] int Idx;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct AGameCrowdPopulationManager_execRemoveSpawnPoint_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] int Idx;
    // // 0x0008 (0x0004) [0x0000000000000000] int AgentIdx;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct AGameExplosionActor_execChooseCameraShake_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] class APlayerController* PC;
    // // 0x000C (0x0008) [0x0000000000000000] class UCameraShake* ReturnValue;
    // // 0x0014 (0x0008) [0x0000000000000000] struct FVector CamX;
    // // 0x001C (0x000C) [0x0000000000000000] struct FVector CamY;
    // // 0x0028 (0x000C) [0x0000000000000000] struct FVector CamZ;
    // // 0x0034 (0x000C) [0x0000000000000000] struct FVector ToEpicenter;
    // // 0x0040 (0x000C) [0x0000000000000000] float FwdDot;
    // // 0x004C (0x0004) [0x0000000000000000] float RtDot;
    // // 0x0050 (0x0004) [0x0000000000000000] class UCameraShake* ChosenShake;
    // // 0x0054 (0x0008) [0x0000000000000000] struct FRotator NoPitchRot;
    // // 0x005C (0x000C) [0x0000000000000000]
};
...
struct AGameExplosionActor_execDoExplosionCameraEffects_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] float ShakeScale;
    // // 0x0008 (0x0004) [0x0000000000000000] class APlayerController* PC;
    // // 0x000C (0x0008) [0x0000000000000000]
};
...
struct AGameExplosionActor_execDrawDebug_Parms {
    // struct FColor                                   C;
    // // 0x0000 (0x0004) [0x0000000000000000] float Angle;
    // // 0x0004 (0x0004) [0x0000000000000000]
};
...
struct AGameExplosionActor_execExplode_Parms {
    ...
    // // 0x0008 (0x000C) [0x0000000000000000] float HowLongToLive;
    // // 0x0014 (0x0004) [0x0000000000000000] class UPhysicalMaterial* PhysMat;
    // // 0x0018 (0x0008) [0x0000000000000000] DWORD bHurtSomeone : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct AGameExplosionActor_execDoExplosionDamage_Parms {
    ...
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001] class AActor*
    // Victim;                                           		// 0x000C (0x0008)
    // [0x0000000000000000] class AActor* HitActor; // 0x0014 (0x0008)
    // [0x0000000000000000] struct FVector BBoxCenter;
    // // 0x001C (0x000C) [0x0000000000000000] DWORD bDamageBlocked : 1;
    // // 0x0028 (0x0004) [0x0000000000000000] [0x00000001] DWORD bDoFullDamage
    // : 1;                                		// 0x002C (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bCauseFractureEffects : 1;
    // // 0x0030 (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // bCausePawnEffects : 1;                            		// 0x0034 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bCauseDamageEffects : 1;
    // // 0x0038 (0x0004) [0x0000000000000000] [0x00000001] DWORD bHurtSomeone :
    // 1;                                 		// 0x003C (0x0004)
    // [0x0000000000000000] [0x00000001] float ColRadius;
    // // 0x0040 (0x0004) [0x0000000000000000] float ColHeight; // 0x0044
    // (0x0004) [0x0000000000000000] float CheckRadius;
    // // 0x0048 (0x0004) [0x0000000000000000] float VictimDist;
    // // 0x004C (0x0004) [0x0000000000000000] TArray< class AActor* >
    // VictimsList;                                      		// 0x0050 (0x0010)
    // [0x0000000000000000] struct FBox BBox; // 0x0060 (0x001C)
    // [0x0000000000000000] class AController* ModInstigator;
    // // 0x007C (0x0008) [0x0000000000000000] class AGamePawn* VictimPawn;
    // // 0x0084 (0x0008) [0x0000000000000000] class AFracturedStaticMeshActor*
    // FracActor;                                        		// 0x008C (0x0008)
    // [0x0000000000000000] unsigned char WantPhysChunksAndParticles;
    // // 0x0094 (0x0001) [0x0000000000000000] struct FTraceHitInfo HitInfo;
    // // 0x0098 (0x0028) [0x0000000000000000] class AKActorFromStatic*
    // NewKActor;                                        		// 0x00C0 (0x0008)
    // [0x0000000000000000] class UStaticMeshComponent* HitStaticMesh;
    // // 0x00C8 (0x0008) [0x0000000000000000]
};
...
struct AGameExplosionActor_execBoxDistanceToPoint_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] struct FBox BBox;
    // // 0x000C (0x001C) [0x0000000000000000] float ReturnValue;
...
struct AGameExplosionActor_execGetPhysicalMaterial_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UPhysicalMaterial* Retval;
    // // 0x0008 (0x0008) [0x0000000000000000] struct FVector TraceStart;
    // // 0x0010 (0x000C) [0x0000000000000000] struct FVector TraceDest;
    // // 0x001C (0x000C) [0x0000000000000000] struct FVector OutHitNorm;
    // // 0x0028 (0x000C) [0x0000000000000000] struct FVector ExploNormal;
    // // 0x0034 (0x000C) [0x0000000000000000] struct FTraceHitInfo OutHitInfo;
    // // 0x0040 (0x0028) [0x0000000000000000]
};
...
struct AGameExplosionActor_execStaticTraceExplosive_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] struct FVector TraceStart;
    // // 0x000C (0x000C) [0x0000000000000000] class AActor* SourceActor;
    // // 0x0018 (0x0008) [0x0000000000000000] class AActor* ReturnValue;
    // // 0x0020 (0x0008) [0x0000000000000000]
};
...
struct AGameExplosionActor_execTraceExplosive_Parms {
    // struct FVector                                  TraceEnd;
    // // 0x0000 (0x000C) [0x0000000000000000] struct FVector TraceStart;
    // // 0x000C (0x000C) [0x0000000000000000] class AActor* ReturnValue;
...
struct ADebugCameraController_execConsoleCommand_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] DWORD bWriteToLog : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] struct FString
    // ReturnValue;                                      		// 0x0014 (0x0010)
    // [0x0000000000000000]
};
...
struct ADebugCameraController_execNativeInputKey_Parms {
    // int                                             ControllerId;
    // // 0x0000 (0x0004) [0x0000000000000000] struct FName Key;
    // // 0x0004 (0x0008) [0x0000000000000000] unsigned char Event;
    // // 0x000C (0x0001) [0x0000000000000000] float AmountDepressed;
    // // 0x0010 (0x0004) [0x0000000000000000] DWORD bGamepad : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] DWORD ReturnValue :
    // 1;                                  		// 0x0018 (0x0004)
    // [0x0000000000000000] [0x00000001] struct FVector CamLoc;
    // // 0x001C (0x000C) [0x0000000000000000] struct FVector ZeroVec;
    // // 0x0028 (0x000C) [0x0000000000000000] struct FRotator CamRot;
    // // 0x0034 (0x000C) [0x0000000000000000] struct FTraceHitInfo HitInfo;
    // // 0x0040 (0x0028) [0x0000000000000000] class AActor* HitActor;
    // // 0x0068 (0x0008) [0x0000000000000000] struct FVector HitLoc;
    // // 0x0070 (0x000C) [0x0000000000000000] struct FVector HitNormal;
    // // 0x007C (0x000C) [0x0000000000000000]
};
...
struct ADebugCameraController_execSecondarySelect_Parms {
    ...
    // // 0x000C (0x000C) [0x0000000000000000] struct FTraceHitInfo HitInfo;
    // // 0x0018 (0x0028) [0x0000000000000000]
};
...
struct AMobileHUD_execRenderKismetHud_Parms {
    // int                                             I;
    // // 0x0000 (0x0004) [0x0000000000000000] TArray< unsigned char > boolVars;
    // // 0x0004 (0x0010) [0x0000000000000000]
};
...
struct AMobileHUD_execRefreshKismetLinks_Parms {
    // TArray< class USequenceObject* >                HudEvents;
    // // 0x0000 (0x0010) [0x0000000000000000] class USequence* GameSeq;
...
struct AMobileHUD_execDrawMobileZone_Slider_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] float X;
    // // 0x0008 (0x0004) [0x0000000000000000] float Y;
    // // 0x000C (0x0004) [0x0000000000000000] struct FTextureUVs UVs;
    // // 0x0010 (0x0010) [0x0000000000000000] class UTexture2D* Tex;
    // // 0x0020 (0x0008) [0x0000000000000000]
};
...
struct AMobileHUD_execDrawMobileTilt_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] float X;
    // // 0x0008 (0x0004) [0x0000000000000000] float Y;
    // // 0x000C (0x0004) [0x0000000000000000] float Scale;
    // // 0x0010 (0x0004) [0x0000000000000000] float Yaw;
    // // 0x0014 (0x0004) [0x0000000000000000] float Pitch;
    // // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct AMobileHUD_execDrawMobileZone_Trackball_Parms {
    // class UMobileInputZone*                         Zone;
    // // 0x0000 (0x0008) [0x0000000000000000] int Width;
    // // 0x0008 (0x0004) [0x0000000000000000] int Height;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct AMobileHUD_execDrawMobileZone_Joystick_Parms {
    // class UMobileInputZone*                         Zone;
    // // 0x0000 (0x0008) [0x0000000000000000] int X;
    // // 0x0008 (0x0004) [0x0000000000000000] int Y;
    // // 0x000C (0x0004) [0x0000000000000000] int Width;
    // // 0x0010 (0x0004) [0x0000000000000000] int Height;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FColor LineColor;
    // // 0x0018 (0x0004) [0x0000000000000000] float ClampedX; // 0x001C
    // (0x0004) [0x0000000000000000] float ClampedY; // 0x0020 (0x0004)
    // [0x0000000000000000] float Scale; // 0x0024 (0x0004) [0x0000000000000000]
    // struct FColor                                   TempColor;
    // // 0x0028 (0x0004) [0x0000000000000000]
};
...
struct AMobileHUD_execDrawMobileZone_Button_Parms {
    // class UMobileInputZone*                         Zone;
    // // 0x0000 (0x0008) [0x0000000000000000] int Pressed;
    // // 0x0008 (0x0004) [0x0000000000000000] float X;
    // // 0x000C (0x0004) [0x0000000000000000] float Y;
    // // 0x0010 (0x0004) [0x0000000000000000] float U;
    // // 0x0014 (0x0004) [0x0000000000000000] float V;
    // // 0x0018 (0x0004) [0x0000000000000000] float UL;
    // // 0x001C (0x0004) [0x0000000000000000] float VL;
    // // 0x0020 (0x0004) [0x0000000000000000] float A;
    // // 0x0024 (0x0004) [0x0000000000000000] class UTexture2D* Tex;
    // // 0x0028 (0x0008) [0x0000000000000000]
};
...
struct AMobileHUD_execDrawInputZoneOverlays_Parms {
    // int                                             ZoneIndex;
    // // 0x0000 (0x0004) [0x0000000000000000] class UMobileInputZone* Zone;
    // // 0x0004 (0x0008) [0x0000000000000000] float Fade;
    // // 0x000C (0x0004) [0x0000000000000000] class UMobilePlayerInput*
    // MobileInput;                                      		// 0x0010 (0x0008)
    // [0x0000000000000000] TArray< class UMobileInputZone* > Zones;
    // // 0x0018 (0x0010) [0x0000000000000000]
};
...
struct AMobileHUD_execRenderMobileMenu_Parms {
    // class UMobilePlayerInput*                       MobileInput;
    // // 0x0000 (0x0008) [0x0000000000000000] float Y;
    // // 0x0008 (0x0004) [0x0000000000000000] int I;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct AMobileHUD_execDrawMobileDebugString_Parms {
    // float                                           XPos;
    // // 0x0000 (0x0004) [0x0000000000000000] float YPos;
    // // 0x0004 (0x0004) [0x0000000000000000] struct FString Str;
    // // 0x0008 (0x0010) [0x0000000000000000]
};
...
struct UMobileInputZone_execOnProcessSlide_Parms {
    // class UMobileInputZone*                         Zone;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char EventType;
    // // 0x0008 (0x0001) [0x0000000000000000] int SlideValue;
    // // 0x000C (0x0004) [0x0000000000000000] struct FVector2D ViewportSize;
...
struct UMobileInputZone_execOnDoubleTapDelegate_Parms {
    // class UMobileInputZone*                         Zone;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char EventType;
    // // 0x0008 (0x0001) [0x0000000000000000] struct FVector2D TouchLocation;
    // // 0x000C (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMobileInputZone_execOnProcessInputDelegate_Parms {
    // class UMobileInputZone*                         Zone;
    // // 0x0000 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0008
    // (0x0004) [0x0000000000000000] int Handle; // 0x000C (0x0004)
    // [0x0000000000000000] unsigned char EventType;
    // // 0x0010 (0x0001) [0x0000000000000000] struct FVector2D TouchLocation;
...
struct UMobileMenuObject_execSetCanvasPos_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float OffsetX;
    // // 0x0008 (0x0004) [0x0000000000000000] float OffsetY;
    // // 0x000C (0x0004) [0x0000000000000000] float PosX;
    // // 0x0010 (0x0004) [0x0000000000000000] float PosY;
    // // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuObject_execInitMenuObject_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UMobileMenuScene* Scene;
    // // 0x0008 (0x0008) [0x0000000000000000] int ScreenWidth;
    // // 0x0010 (0x0004) [0x0000000000000000] int ScreenHeight;
    // // 0x0014 (0x0004) [0x0000000000000000] DWORD bIsFirstInitialization : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001] int X;
    // // 0x001C (0x0004) [0x0000000000000000] int Y;
    // // 0x0020 (0x0004) [0x0000000000000000] int W;
    // // 0x0024 (0x0004) [0x0000000000000000] int H;
    // // 0x0028 (0x0004) [0x0000000000000000] int oX;
    // // 0x002C (0x0004) [0x0000000000000000] int oY;
    // // 0x0030 (0x0004) [0x0000000000000000] int RelativeIdx;
...
struct UMobileMenuObject_eventGetRealPosition_Parms {
    // float                                           PosX;
    // // 0x0000 (0x0004) [0x0000000000000000] float PosY;
    // // 0x0004 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuObject_eventOnTouch_Parms {
    // unsigned char                                   EventType;
    // // 0x0000 (0x0001) [0x0000000000000000] float TouchX;
    // // 0x0004 (0x0004) [0x0000000000000000] float TouchY;
    // // 0x0008 (0x0004) [0x0000000000000000] class UMobileMenuObject*
    // ObjectOver;                                       		// 0x000C (0x0008)
    // [0x0000000000000000] float DeltaTime; // 0x0014 (0x0004)
...
struct UMobileMenuImage_execRenderObject_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0008
    // (0x0004) [0x0000000000000000] float W; // 0x000C (0x0004)
    // [0x0000000000000000] float                                           H;
    // // 0x0010 (0x0004) [0x0000000000000000] float U;
    // // 0x0014 (0x0004) [0x0000000000000000] float V;
    // // 0x0018 (0x0004) [0x0000000000000000] float UL;
    // // 0x001C (0x0004) [0x0000000000000000] float VL;
    // // 0x0020 (0x0004) [0x0000000000000000] struct FLinearColor DrawColor;
...
struct UMobileMenuScene_execFindMenuObject_Parms {
    // struct FString                                  Tag;
    // // 0x0000 (0x0010) [0x0000000000000000] class UMobileMenuObject*
    // ReturnValue;                                      		// 0x0010 (0x0008)
    // [0x0000000000000000] int                                             Idx;
    // // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuScene_eventOnSceneTouch_Parms {
    ...
    // // 0x0000 (0x0001) [0x0000000000000000] float TouchX;
    // // 0x0004 (0x0004) [0x0000000000000000] float TouchY;
    // // 0x0008 (0x0004) [0x0000000000000000] DWORD bInside : 1;
...
struct UMobileMenuScene_eventOnTouch_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char EventType;
    // // 0x0008 (0x0001) [0x0000000000000000] float TouchX;
    // // 0x000C (0x0004) [0x0000000000000000] float TouchY;
    // // 0x0010 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuScene_execPreRenderMenuObject_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UCanvas* Canvas;
    // // 0x0008 (0x0008) [0x0000000000000000] float RenderDelta;
    // // 0x0010 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuScene_execRenderScene_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float RenderDelta;
    // // 0x0008 (0x0004) [0x0000000000000000] class UMobileMenuObject*
    // MenuObject;                                       		// 0x000C (0x0008)
    // [0x0000000000000000]
};
...
struct UMobileMenuScene_eventInitMenuScene_Parms {
    // class UMobilePlayerInput*                       PlayerInput;
    // // 0x0000 (0x0008) [0x0000000000000000] int ScreenWidth;
    // // 0x0008 (0x0004) [0x0000000000000000] int ScreenHeight;
    // // 0x000C (0x0004) [0x0000000000000000] DWORD bIsFirstInitialization : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] int I;
    // // 0x0014 (0x0004) [0x0000000000000000] int X;
    // // 0x0018 (0x0004) [0x0000000000000000] int Y;
    // // 0x001C (0x0004) [0x0000000000000000] int W;
    // // 0x0020 (0x0004) [0x0000000000000000] int H;
    // // 0x0024 (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execOpenMobileMenuMode_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] struct FString Mode;
    // // 0x0010 (0x0010) [0x0000000000000000] class UMobileMenuScene*
    // ReturnValue;                                      		// 0x0020 (0x0008)
    // [0x0000000000000000] class UClass* MenuClass;
    // // 0x0028 (0x0008) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execOpenMobileMenu_Parms {
    // struct FString                                  MenuClassName;
    // // 0x0000 (0x0010) [0x0000000000000000] class UMobileMenuScene*
    // ReturnValue;                                      		// 0x0010 (0x0008)
    // [0x0000000000000000] class UClass* MenuClass;
    // // 0x0018 (0x0008) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execPreClientTravel_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] unsigned char TravelType;
    // // 0x0010 (0x0001) [0x0000000000000000] DWORD bIsSeamlessTravel : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] int I;
    // // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_eventCloseMenuScene_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] int I;
    // // 0x0008 (0x0004) [0x0000000000000000] int Idx;
    // // 0x000C (0x0004) [0x0000000000000000] DWORD bClosedTopMenu : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMobilePlayerInput_eventOpenMenuScene_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] struct FString Mode;
    // // 0x0008 (0x0010) [0x0000000000000000] class UMobileMenuScene*
    // ReturnValue;                                      		// 0x0018 (0x0008)
    // [0x0000000000000000] class UMobileMenuScene* Scene;
    // // 0x0020 (0x0008) [0x0000000000000000] struct FVector2D ViewportSize;
    // // 0x0028 (0x0008) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execSetMobileInputConfig_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] int NewConfig;
    // // 0x0010 (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execFindorAddZone_Parms {
    ...
    // // 0x0000 (0x0010) [0x0000000000000000] class UMobileInputZone*
    // ReturnValue;                                      		// 0x0010 (0x0008)
    // [0x0000000000000000] class UMobileInputZone* Zone;
    // // 0x0018 (0x0008) [0x0000000000000000] class UClass* ClassType;
    // // 0x0020 (0x0008) [0x0000000000000000] int ClassIndex;
    // // 0x0028 (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_eventRefreshKismetLinks_Parms {
    // TArray< class USequenceObject* >                MobileInputSeqEvents;
    // // 0x0000 (0x0010) [0x0000000000000000] class USequence* GameSeq;
    // // 0x0010 (0x0008) [0x0000000000000000] int I;
    // // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execInitializeInputZones_Parms {
    // int                                             I;
    // // 0x0000 (0x0004) [0x0000000000000000] int J;
    // // 0x0004 (0x0004) [0x0000000000000000] class UMobileInputZone* Zone;
    // // 0x0008 (0x0008) [0x0000000000000000] class UClass* FrameworkGameClass;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execSendInputAxis_Parms {
    // struct FName                                    Key;
    // // 0x0000 (0x0008) [0x0000000000000000] float Delta;
    // // 0x0008 (0x0004) [0x0000000000000000] float DeltaTime; // 0x000C
    // (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execSendInputKey_Parms {
    // struct FName                                    Key;
    // // 0x0000 (0x0008) [0x0000000000000000] unsigned char Event;
    // // 0x0008 (0x0001) [0x0000000000000000] float AmountDepressed;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execConditionalUpdateInputZones_Parms {
    // int                                             NewViewportX;
    // // 0x0000 (0x0004) [0x0000000000000000] int NewViewportY;
    // // 0x0004 (0x0004) [0x0000000000000000] int NewViewportSizeX;
    // // 0x0008 (0x0004) [0x0000000000000000] int NewViewportSizeY;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execOnInputTouch_Parms {
    ...
    // // 0x0004 (0x0001) [0x0000000000000000] struct FVector2D TouchLocation;
    // // 0x0008 (0x0008) [0x0000000000000000] float DeviceTimestamp;
    // // 0x0010 (0x0004) [0x0000000000000000] int TouchpadIndex;
    // // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UMobilePlayerInput_execOnPreviewTouch_Parms {
    // float                                           X;
    // // 0x0000 (0x0004) [0x0000000000000000] float Y;
    // // 0x0004 (0x0004) [0x0000000000000000] int TouchpadIndex;
...
struct UNavMeshGoal_OutOfViewFrom_execMustBeHiddenFromThisPoint_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] struct FVector
    // InOutOfViewLocation;                              		// 0x0008 (0x000C)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0014 (0x0004)
    // [0x0000000000000000] [0x00000001] class UNavMeshGoal_OutOfViewFrom* Eval;
    // // 0x0018 (0x0008) [0x0000000000000000]
};
...
struct
    ...
    // class UNavigationHandle*                        NavHandle;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FVector InLocation;
    // // 0x0008 (0x000C) [0x0000000000000000] struct FRotator InRotation;
    // // 0x0014 (0x000C) [0x0000000000000000] float InDistanceToCheck;
    // // 0x0020 (0x0004) [0x0000000000000000] TArray< struct FVector >
    // InLocationsToCheck;                               		// 0x0024 (0x0010)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0034 (0x0004)
    // [0x0000000000000000] [0x00000001] class
    // UNavMeshPath_BiasAgainstPolysWithinDistanceOfLocations* Con;
...
struct UMobileSecondaryViewportClient_eventPostRender_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] class APlayerController* PC;
    // // 0x0008 (0x0008) [0x0000000000000000] class UMobilePlayerInput* MPI;
    // // 0x0010 (0x0008) [0x0000000000000000] class AMobileHUD* MH;
    // // 0x0018 (0x0008) [0x0000000000000000]
};
...
struct
    ...
    // // 0x0000 (0x0090) [0x0000000000000000] class
    // AGameCrowdPopulationManager*              PopMgr;
    // // 0x0090 (0x0008) [0x0000000000000000] int I;
...
struct USeqAct_PlayAgentAnimation_execSetCurrentAnimationActionFor_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class
    // UGameCrowdBehavior_PlayAnimation*         AnimBehavior;
...
struct USeqEvent_HudRender_execRender_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class AHUD* TargetHud;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct USeqEvent_HudRender_eventRegisterEvent_Parms {
    // int                                             I;
    // // 0x0000 (0x0004) [0x0000000000000000] class AGamePlayerController* GPC;
    // // 0x0004 (0x0008) [0x0000000000000000] class AMobileHUD* TargetHud;
    // // 0x000C (0x0008) [0x0000000000000000]
};
...
struct USeqEvent_MobileBase_eventRegisterEvent_Parms {
    // class AWorldInfo*                               WI;
    // // 0x0000 (0x0008) [0x0000000000000000] class AGamePlayerController* GPC;
    // // 0x0008 (0x0008) [0x0000000000000000] class UMobilePlayerInput* MPI;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct USeqEvent_MobileZoneBase_eventAddToMobileInput_Parms {
    // class UMobilePlayerInput*                       MPI;
    // // 0x0000 (0x0008) [0x0000000000000000] class UMobileInputZone* Zone;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct UGameCameraBase_eventModifyPostProcessSettings_Parms {
    ...
    // // 0x0000 (0x0220) [0x0000000000000000]
};
...
struct UGameCameraBase_execProcessViewRotation_Parms {
    // float                                           DeltaTime;
    // // 0x0000 (0x0004) [0x0000000000000000] class AActor* ViewTarget;
    // // 0x0004 (0x0008) [0x0000000000000000] struct FRotator out_ViewRotation;
    // // 0x000C (0x000C) [0x0000000000000000] struct FRotator out_DeltaRot;
    // // 0x0018 (0x000C) [0x0000000000000000]
};
...
struct UGameThirdPersonCamera_execUpdateCameraMode_Parms {
    // class APawn*                                    P;
    // // 0x0000 (0x0008) [0x0000000000000000] class UGameThirdPersonCameraMode*
    // NewCamMode;                                       		// 0x0008 (0x0008)
    // [0x0000000000000000]
};
...
struct UGameThirdPersonCamera_execGetActualFocusLocation_Parms {
    // struct FVector                                  ReturnValue;
    // // 0x0000 (0x000C) [0x0000000000000000] struct FVector FocusLoc;
    // // 0x000C (0x000C) [0x0000000000000000] class USkeletalMeshComponent*
    // ComponentIt;                                      		// 0x0018 (0x0008)
    // [0x0000000000000000]
};
...
struct UGameThirdPersonCamera_execSetFocusOnActor_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] struct FName FocusBoneName;
    // // 0x0008 (0x0008) [0x0000000000000000] struct FVector2D
    // InterpSpeedRange;                                 		// 0x0010 (0x0008)
    // [0x0000000000000000] struct FVector2D InFocusFOV;
    // // 0x0018 (0x0008) [0x0000000000000000] float CameraFOV; // 0x0020
    // (0x0004) [0x0000000000000000] DWORD bAlwaysFocus : 1;
    // // 0x0024 (0x0004) [0x0000000000000000] [0x00000001] DWORD bAdjustCamera
    // : 1;                                		// 0x0028 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bIgnoreTrace : 1;
    // // 0x002C (0x0004) [0x0000000000000000] [0x00000001] float
    // FocusPitchOffsetDeg;                              		// 0x0030 (0x0004)
    // [0x0000000000000000]
};
...
struct UGameThirdPersonCamera_execSetFocusOnLoc_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] struct FVector2D
    // InterpSpeedRange;                                 		// 0x000C (0x0008)
    // [0x0000000000000000] struct FVector2D InFocusFOV;
    // // 0x0014 (0x0008) [0x0000000000000000] float CameraFOV; // 0x001C
    // (0x0004) [0x0000000000000000] DWORD bAlwaysFocus : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001] DWORD bAdjustCamera
    // : 1;                                		// 0x0024 (0x0004)
    // [0x0000000000000000] [0x00000001] DWORD bIgnoreTrace : 1;
    // // 0x0028 (0x0004) [0x0000000000000000] [0x00000001] float
    // FocusPitchOffsetDeg;                              		// 0x002C (0x0004)
    // [0x0000000000000000]
};
...
struct UGameThirdPersonCamera_execBeginTurn_Parms {
    // int                                             StartAngle;
    // // 0x0000 (0x0004) [0x0000000000000000] int EndAngle;
    // // 0x0004 (0x0004) [0x0000000000000000] float TimeSec;
    // // 0x0008 (0x0004) [0x0000000000000000] float DelaySec; // 0x000C
    // (0x0004) [0x0000000000000000] DWORD bAlignTargetWhenFinished : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UGameThirdPersonCamera_execCreateCameraMode_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UGameThirdPersonCameraMode*
    // ReturnValue;                                      		// 0x0008 (0x0008)
    // [0x0000000000000000] class UGameThirdPersonCameraMode* NewMode;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct AGamePlayerCamera_execAdjustFOVForViewport_Parms {
    // float                                           inHorizFOV;
    // // 0x0000 (0x0004) [0x0000000000000000] class APawn* CameraTargetPawn;
    // // 0x0004 (0x0008) [0x0000000000000000] float ReturnValue;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct AGamePlayerCamera_execUpdateCameraLensEffects_Parms {
    ...
    // // 0x0000 (0x0038) [0x0000000000000000] int Idx;
...
struct AGamePlayerCamera_execUpdateViewTarget_Parms {
    // struct FTViewTarget                             OutVT;
    // // 0x0000 (0x0038) [0x0000000000000000] float DeltaTime; // 0x0038
    // (0x0004) [0x0000000000000000] class APawn* P;
    // // 0x003C (0x0008) [0x0000000000000000] class UGameCameraBase* NewCamera;
    // // 0x0044 (0x0008) [0x0000000000000000] class ACameraActor* CamActor;
...
struct AGamePlayerCamera_execFindBestCameraType_Parms {
    ...
    // ReturnValue;                                      		// 0x0008 (0x0008)
    // [0x0000000000000000] class UGameCameraBase* BestCam;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct AGamePlayerCamera_execCreateCamera_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UGameCameraBase*
    // ReturnValue;                                      		// 0x0008 (0x0008)
    // [0x0000000000000000] class UGameCameraBase* NewCam;
    // // 0x0010 (0x0008) [0x0000000000000000]
};
...
struct UGameThirdPersonCameraMode_execSetViewOffset_Parms {
    ...
    // // 0x0000 (0x0024) [0x0000000000000000]
};
...
struct UGameThirdPersonCameraMode_execUpdatePostProcess_Parms {
    ...
    // // 0x0000 (0x0038) [0x0000000000000000] float DeltaTime; // 0x0038
    // (0x0004) [0x0000000000000000] struct FVector FocusLoc;
    // // 0x003C (0x000C) [0x0000000000000000] struct FVector StartTrace;
    // // 0x0048 (0x000C) [0x0000000000000000] struct FVector EndTrace;
    // // 0x0054 (0x000C) [0x0000000000000000] struct FVector CamDir;
    // // 0x0060 (0x000C) [0x0000000000000000] float FocusDist; // 0x006C
    // (0x0004) [0x0000000000000000] float SubjectDist;
    // // 0x0070 (0x0004) [0x0000000000000000] float Pct;
    // // 0x0074 (0x0004) [0x0000000000000000]
};
...
struct UGameThirdPersonCameraMode_execDOFTrace_Parms {
    ...
    // // 0x0008 (0x000C) [0x0000000000000000] struct FVector EndTrace;
    // // 0x0014 (0x000C) [0x0000000000000000] struct FVector ReturnValue;
    // // 0x0020 (0x000C) [0x0000000000000000] struct FVector HitLocation;
    // // 0x002C (0x000C) [0x0000000000000000] struct FVector HitNormal;
    // // 0x0038 (0x000C) [0x0000000000000000] class AActor* HitActor;
    // // 0x0044 (0x0008) [0x0000000000000000]
};
...
struct UGameThirdPersonCameraMode_eventGetCameraWorstCaseLoc_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] struct FTViewTarget
    // CurrentViewTarget;                                		// 0x0008 (0x0038)
...
struct UGameThirdPersonCameraMode_eventAdjustViewOffset_Parms {
    // class APawn*                                    P;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FVector Offset;
    // // 0x0008 (0x000C) [0x0000000000000000] struct FVector ReturnValue;
...
struct UGameSpecialMove_execRelativeToWorldOffset_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] struct FVector
    // RelativeSpaceOffset;                              		// 0x000C (0x000C)
    // [0x0000000000000000] struct FVector ReturnValue;
    // // 0x0018 (0x000C) [0x0000000000000000]
};
...
struct UGameSpecialMove_execWorldToRelativeOffset_Parms {
    // struct FRotator                                 InRotation;
    // // 0x0000 (0x000C) [0x0000000000000000] struct FVector WorldSpaceOffset;
    // // 0x000C (0x000C) [0x0000000000000000] struct FVector ReturnValue;
    // // 0x0018 (0x000C) [0x0000000000000000]
};
...
struct UGameSpecialMove_execForcePawnRotation_Parms {
    // class APawn*                                    P;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FRotator NewRotation;
    // // 0x0008 (0x000C) [0x0000000000000000] DWORD bIgnoreHumanController : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UGameSpecialMove_execMessageEvent_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UObject* Sender;
    // // 0x0008 (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UGameSpecialMove_execSetFacePreciseRotation_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] float InterpolationTime;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct UGameSpecialMove_execSetReachPreciseDestination_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] DWORD bCancel : 1;
    // // 0x000C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UGameSpecialMove_execInitSpecialMove_Parms {
    // class APawn*                                    inPawn;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FName InHandle;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct UGameStatsAggregator_execGetAggregateMappingIDs_Parms {
    // int                                             EventID;
    // // 0x0000 (0x0004) [0x0000000000000000] int AggregateID;
    // // 0x0004 (0x0004) [0x0000000000000000] int TargetAggregateID;
    // // 0x0008 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x000C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct ADebugCameraHUD_eventPostRender_Parms {
    // class ADebugCameraController*                   DCC;
    // // 0x0000 (0x0008) [0x0000000000000000] float XL;
    // // 0x0008 (0x0004) [0x0000000000000000] float YL;
    // // 0x000C (0x0004) [0x0000000000000000] float X;
    // // 0x0010 (0x0004) [0x0000000000000000] float Y;
    // // 0x0014 (0x0004) [0x0000000000000000] struct FString MyText;
    // // 0x0018 (0x0010) [0x0000000000000000] struct FVector CamLoc;
    // // 0x0028 (0x000C) [0x0000000000000000] struct FVector ZeroVec;
    // // 0x0034 (0x000C) [0x0000000000000000] struct FRotator CamRot;
    // // 0x0040 (0x000C) [0x0000000000000000] struct FTraceHitInfo HitInfo;
    // // 0x004C (0x0028) [0x0000000000000000] class AActor* HitActor;
    // // 0x0074 (0x0008) [0x0000000000000000] class UMeshComponent* MeshComp;
    // // 0x007C (0x0008) [0x0000000000000000] struct FVector HitLoc;
    // // 0x0084 (0x000C) [0x0000000000000000] struct FVector HitNormal;
    // // 0x0090 (0x000C) [0x0000000000000000] DWORD bFoundMaterial : 1;
    // // 0x009C (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct ADebugCameraHUD_execDisplayMaterials_Parms {
    // float                                           X;
    // // 0x0000 (0x0004) [0x0000000000000000] float Y;
    // // 0x0004 (0x0004) [0x0000000000000000] float DY;
    // // 0x0008 (0x0004) [0x0000000000000000] class UMeshComponent* MeshComp;
    // // 0x000C (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] int MaterialIndex;
    // // 0x0018 (0x0004) [0x0000000000000000] DWORD bDisplayedMaterial : 1;
    // // 0x001C (0x0004) [0x0000000000000000] [0x00000001] class
...
struct UDebugCameraInput_execInputKey_Parms {
    ...
    // // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] DWORD ReturnValue :
    // 1;                                  		// 0x0018 (0x0004)
    // [0x0000000000000000] [0x00000001] class APlayerController* PC;
    // // 0x001C (0x0008) [0x0000000000000000] class ADebugCameraController*
    // DCC;                                              		// 0x0024 (0x0008)
    // [0x0000000000000000]
};
...
struct UGameAICmd_Hover_MoveToGoal_execMoveToGoal_Parms {
    // class AGameAIController*                        AI;
    // // 0x0000 (0x0008) [0x0000000000000000] class AActor* InGoal;
    // // 0x0008 (0x0008) [0x0000000000000000] float InGoalDistance;
    // // 0x0010 (0x0004) [0x0000000000000000] float InHoverHeight;
    // // 0x0014 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001] class
    // UGameAICmd_Hover_MoveToGoal*              Cmd;
...
struct UGameAICmd_Hover_MoveToGoal_Mesh_execHoverBackToMesh_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001] class
    // UGameAICmd_Hover_MoveToGoal_Mesh*         Cmd;
    // // 0x000C (0x0008) [0x0000000000000000]
};
...
struct UGameAICmd_Hover_MoveToGoal_Mesh_execHoverToPoint_Parms {
    // class AGameAIController*                        AI;
    // // 0x0000 (0x0008) [0x0000000000000000] struct FVector InPoint;
    // // 0x0008 (0x000C) [0x0000000000000000] float InGoalDistance;
    // // 0x0014 (0x0004) [0x0000000000000000] float InHoverHeight;
...
struct UGameFixedCamera_execUpdateCamera_Parms {
    ...
    // [0x0000000000000000] float DeltaTime; // 0x0010 (0x0004)
    // [0x0000000000000000] struct FTViewTarget OutVT;
    // // 0x0014 (0x0038) [0x0000000000000000] class ACameraActor* CamActor;
    // // 0x004C (0x0008) [0x0000000000000000]
};
...
struct AMobileDebugCameraController_execSetupDebugZones_Parms {
    // float                                           Ratio;
    // // 0x0000 (0x0004) [0x0000000000000000] float Spacer;
    // // 0x0004 (0x0004) [0x0000000000000000] class UMobileInputZone*
    // StickMoveZone;                                    		// 0x0008 (0x0008)
    // [0x0000000000000000] class UMobileInputZone* StickLookZone;
    // // 0x0010 (0x0008) [0x0000000000000000] struct FVector2D ViewportSize;
    // // 0x0018 (0x0008) [0x0000000000000000]
};
...
struct AMobileDebugCameraController_execOnDeactivate_Parms {
    // class APlayerController*                        PC;
    // // 0x0000 (0x0008) [0x0000000000000000] class UMobilePlayerInput*
    // MobileInput;                                      		// 0x0008 (0x0008)
    // [0x0000000000000000]
};
...
struct UMobileDebugCameraInput_execInputKey_Parms {
    ...
    // 1;                                  		// 0x0018 (0x0004)
    // [0x0000000000000000] [0x00000001] class APlayerController* PC;
    // // 0x001C (0x0008) [0x0000000000000000] class
    // AMobileDebugCameraController*             DCC;
...
struct AMobileDebugCameraHUD_eventPostRender_Parms {
    // class AMobileDebugCameraController*             DCC;
    // // 0x0000 (0x0008) [0x0000000000000000] float XL;
    // // 0x0008 (0x0004) [0x0000000000000000] float YL;
    // // 0x000C (0x0004) [0x0000000000000000] float X;
    // // 0x0010 (0x0004) [0x0000000000000000] float Y;
    ...
    // // 0x0084 (0x000C) [0x0000000000000000] struct FVector HitNormal;
    // // 0x0090 (0x000C) [0x0000000000000000] DWORD bFoundMaterial : 1;
    // // 0x009C (0x0004) [0x0000000000000000] [0x00000001] DWORD
    // bOldForceMobileHUD : 1;                           		// 0x00A0 (0x0004)
    // [0x0000000000000000] [0x00000001]
};
...
struct UMobileMenuBar_execUpdateItemViewports_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] float pos;
    // // 0x0008 (0x0004) [0x0000000000000000] int CurIndex;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuBar_execRenderItem_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0008
    // (0x0004) [0x0000000000000000] int ItemIndex;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuBar_execRenderObject_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0008
    // (0x0004) [0x0000000000000000] float OrgX; // 0x000C (0x0004)
    // [0x0000000000000000] float OrgY; // 0x0010 (0x0004) [0x0000000000000000]
    // int                                             CurIndex;
    // // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuBarItem_execRenderItem_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UCanvas* Canvas;
    // // 0x0008 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0010
    // (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuButton_execRenderCaption_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float UL;
    // // 0x0008 (0x0004) [0x0000000000000000] float VL;
    // // 0x000C (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuButton_execRenderObject_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0008
    // (0x0004) [0x0000000000000000] int Idx; // 0x000C (0x0004)
    // [0x0000000000000000] struct FLinearColor DrawColor;
    // // 0x0010 (0x0010) [0x0000000000000000]
};
...
struct UMobileMenuButton_execInitMenuObject_Parms {
    ...
    // // 0x0010 (0x0004) [0x0000000000000000] int ScreenHeight;
    // // 0x0014 (0x0004) [0x0000000000000000] DWORD bIsFirstInitialization : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001] int I;
...
struct UMobileMenuElement_execRenderElement_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UCanvas* Canvas;
    // // 0x0008 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0010
    // (0x0004) [0x0000000000000000] float Opacity; // 0x0014 (0x0004)
    // [0x0000000000000000]
};
...
struct AMobileMenuGame_eventPostLogin_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UMobilePlayerInput* MI;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct UMobileMenuInventory_execRenderDragItem_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0008
    // (0x0004) [0x0000000000000000] class UMobileMenuElement* Element;
    // // 0x000C (0x0008) [0x0000000000000000] float OrgX;
    // // 0x0014 (0x0004) [0x0000000000000000] float OrgY;
    // // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuInventory_execFindSlotIndexAt_Parms {
    // float                                           X;
    // // 0x0000 (0x0004) [0x0000000000000000] float Y;
    // // 0x0004 (0x0004) [0x0000000000000000] int ReturnValue;
    // // 0x0008 (0x0004) [0x0000000000000000] class UMobileMenuElement*
    // Element;                                          		// 0x000C (0x0008)
    // [0x0000000000000000] float ExtraX; // 0x0014 (0x0004)
    // [0x0000000000000000] float ExtraY; // 0x0018 (0x0004)
    // [0x0000000000000000] int                                             Idx;
    // // 0x001C (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuInventory_execInitDragAt_Parms {
    // int                                             TouchX;
    // // 0x0000 (0x0004) [0x0000000000000000] int TouchY;
    // // 0x0004 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuInventory_execUpdateItemInSlot_Parms {
    // int                                             InSlot;
    // // 0x0000 (0x0004) [0x0000000000000000] class UMobileMenuElement*
    // Element;                                          		// 0x0004 (0x0008)
    // [0x0000000000000000] class UMobileMenuElement* Slot;
    // // 0x000C (0x0008) [0x0000000000000000]
};
...
struct UMobileMenuInventory_execAddItemToSlot_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] int ToSlot;
    // // 0x0008 (0x0004) [0x0000000000000000] class UMobileMenuElement*
    // ReturnValue;                                      		// 0x000C (0x0008)
    // [0x0000000000000000] class UMobileMenuElement* PrevElement;
...
struct UMobileMenuInventory_execSwapItemsInSlots_Parms {
    // int                                             Slot0;
    // // 0x0000 (0x0004) [0x0000000000000000] int Slot1;
    // // 0x0004 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0008 (0x0004) [0x0000000000000000] [0x00000001] class
    // UMobileMenuElement*                       Element0;
    // // 0x000C (0x0008) [0x0000000000000000] class UMobileMenuElement*
    // Element1;                                         		// 0x0014 (0x0008)
    // [0x0000000000000000]
};
...
struct UMobileMenuInventory_eventOnTouch_Parms {
    ...
    // [0x0000000000000000] float DeltaTime; // 0x0014 (0x0004)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0018 (0x0004)
    // [0x0000000000000000] [0x00000001] struct FDragElementInfo OrigDrag;
    // // 0x001C (0x0028) [0x0000000000000000]
};
...
struct UMobileMenuInventory_execCanPutItemInSlot_Parms {
    // class UMobileMenuElement*                       Item;
    // // 0x0000 (0x0008) [0x0000000000000000] class UMobileMenuElement* ToSlot;
    // // 0x0008 (0x0008) [0x0000000000000000] int ToIdx;
    // // 0x0010 (0x0004) [0x0000000000000000] int FromIdx;
    // // 0x0014 (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0018 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMobileMenuInventory_execOnUpdateDrag_Parms {
    ...
    // // 0x0000 (0x0028) [0x0000000000000000] struct FDragElementInfo After;
    // // 0x0028 (0x0028) [0x0000000000000000]
};
...
struct UMobileMenuInventory_execDoCanPutItemInSlot_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UMobileMenuElement* Item;
    // // 0x0008 (0x0008) [0x0000000000000000] class UMobileMenuElement* ToSlot;
    // // 0x0010 (0x0008) [0x0000000000000000] int ToIdx;
    // // 0x0018 (0x0004) [0x0000000000000000] int FromIdx;
    // // 0x001C (0x0004) [0x0000000000000000] DWORD ReturnValue : 1;
    // // 0x0020 (0x0004) [0x0000000000000000] [0x00000001]
};
...
struct UMobileMenuInventory_execOnUpdateItemInSlot_Parms {
    // class UMobileMenuInventory*                     FromInv;
    // // 0x0000 (0x0008) [0x0000000000000000] int SlotIndex;
    // // 0x0008 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuLabel_execRenderObject_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0008
    // (0x0004) [0x0000000000000000] float CX; // 0x000C (0x0004)
    // [0x0000000000000000] float                                           CY;
    // // 0x0010 (0x0004) [0x0000000000000000] float TX;
    // // 0x0014 (0x0004) [0x0000000000000000] float TY;
    // // 0x0018 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuList_execRenderObject_Parms {
    // class UCanvas*                                  Canvas;
    // // 0x0000 (0x0008) [0x0000000000000000] float DeltaTime; // 0x0008
    // (0x0004) [0x0000000000000000] class UMobileMenuListItem* Item;
    // // 0x000C (0x0008) [0x0000000000000000] float OrgX;
    // // 0x0014 (0x0004) [0x0000000000000000] float OrgY;
    // // 0x0018 (0x0004) [0x0000000000000000] int VpEnd;
    // // 0x001C (0x0004) [0x0000000000000000] int CurIndex;
    // // 0x0020 (0x0004) [0x0000000000000000] int first;
    // // 0x0024 (0x0004) [0x0000000000000000] int Last;
    // // 0x0028 (0x0004) [0x0000000000000000] int SelectedIdx;
    // // 0x002C (0x0004) [0x0000000000000000] int NumItems;
    // // 0x0030 (0x0004) [0x0000000000000000] int RealIndex;
    // // 0x0034 (0x0004) [0x0000000000000000] struct FVector2D VpPos;
    // // 0x0038 (0x0008) [0x0000000000000000] struct FVector2D VpSize;
    // // 0x0040 (0x0008) [0x0000000000000000]
};
...
struct UMobileMenuList_execUpdateScroll_Parms {
    // float                                           DeltaTime;
    // // 0x0000 (0x0004) [0x0000000000000000] float ScrollAmount;
    // // 0x0004 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuList_execCalculateSelectedItem_Parms {
    ...
    // // 0x0000 (0x000C) [0x0000000000000000] float ScrollAmount;
    // // 0x000C (0x0004) [0x0000000000000000] DWORD bForceZeroAdjustment : 1;
    // // 0x0010 (0x0004) [0x0000000000000000] [0x00000001] float ReturnValue;
    // // 0x0014 (0x0004) [0x0000000000000000] float AdjustValue;
    // // 0x0018 (0x0004) [0x0000000000000000] float ScrollSize;
    // // 0x001C (0x0004) [0x0000000000000000] float Scrolled; // 0x0020
    // (0x0004) [0x0000000000000000] float HalfScroll;
    // // 0x0024 (0x0004) [0x0000000000000000] int CurIndex;
    // // 0x0028 (0x0004) [0x0000000000000000] class UMobileMenuListItem* Item;
    // // 0x002C (0x0008) [0x0000000000000000]
};
...
struct UMobileMenuList_execGetItemClickPosition_Parms {
    // float                                           MouseX;
    // // 0x0000 (0x0004) [0x0000000000000000] float MouseY;
    // // 0x0004 (0x0004) [0x0000000000000000] class UMobileMenuListItem*
    // ReturnValue;                                      		// 0x0008 (0x0008)
    // [0x0000000000000000] int ScrollAmount; // 0x0010 (0x0004)
    // [0x0000000000000000] int CurIndex; // 0x0014 (0x0004)
    // [0x0000000000000000] int ScrollSize; // 0x0018 (0x0004)
    // [0x0000000000000000] class UMobileMenuListItem* Item;
    // // 0x001C (0x0008) [0x0000000000000000]
};
...
struct UMobileMenuList_eventOnTouch_Parms {
    ...
    // [0x0000000000000000] float DeltaTime; // 0x0014 (0x0004)
    // [0x0000000000000000] DWORD ReturnValue : 1; // 0x0018 (0x0004)
    // [0x0000000000000000] [0x00000001] float Velocity;
    // // 0x001C (0x0004) [0x0000000000000000] float SwipeDelta;
    // // 0x0020 (0x0004) [0x0000000000000000] float FinalScrollDist;
    // // 0x0024 (0x0004) [0x0000000000000000] float CalcScrollDist;
    // // 0x0028 (0x0004) [0x0000000000000000] float SwipeTime; // 0x002C
    // (0x0004) [0x0000000000000000] class UMobileMenuListItem* Selected;
    // // 0x0030 (0x0008) [0x0000000000000000] int Index;
    // // 0x0038 (0x0004) [0x0000000000000000] int Index0;
    // // 0x003C (0x0004) [0x0000000000000000] DWORD bUdpateTouchItem : 1;
...
struct UMobileMenuList_execSetSelectedItem_Parms {
    // int                                             ItemIndex;
    // // 0x0000 (0x0004) [0x0000000000000000] DWORD bForceAll : 1;
...
struct UMobileMenuList_execGetNumVisible_Parms {
    // int                                             ReturnValue;
    // // 0x0000 (0x0004) [0x0000000000000000] int Index;
    // // 0x0004 (0x0004) [0x0000000000000000] int Count;
    // // 0x0008 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuList_execSetSelectedToVisibleIndex_Parms {
    ...
    // // 0x0004 (0x0004) [0x0000000000000000] int Index;
    // // 0x0008 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuList_execGetVisibleIndexOfSelected_Parms {
    // int                                             ReturnValue;
    // // 0x0000 (0x0004) [0x0000000000000000] class UMobileMenuListItem* Item;
    // // 0x0004 (0x0008) [0x0000000000000000] class UMobileMenuListItem*
    // Selected;                                         		// 0x000C (0x0008)
    // [0x0000000000000000] int Index; // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuList_execGetAmountSelected_Parms {
    // class UMobileMenuListItem*                      Item;
    // // 0x0000 (0x0008) [0x0000000000000000] float ReturnValue;
    // // 0x0008 (0x0004) [0x0000000000000000] class UMobileMenuListItem*
    // Selected;                                         		// 0x000C (0x0008)
    // [0x0000000000000000] float Half; // 0x0014 (0x0004) [0x0000000000000000]
};
...
struct UMobileMenuList_execGetSelected_Parms {
    ...
    // // 0x0000 (0x0008) [0x0000000000000000] class UMobileMenuListItem* Item;
    // // 0x0008 (0x0008) [0x0000000000000000]
};
...
struct UMobileMenuObjectProxy_execOnTouchEvent_Parms {
    ...
    // // 0x0008 (0x0001) [0x0000000000000000] float TouchX;
    // // 0x000C (0x0004) [0x0000000000000000] float TouchY;
    // // 0x0010 (0x0004) [0x0000000000000000] class UMobileMenuObject*
    // ObjectOver;                                       		// 0x0014 (0x0008)
    // [0x0000000000000000] float DeltaTime; // 0x001C (0x0004)
...
struct APlayerCollectorGame_eventGetSeamlessTravelActorList_Parms {
    // DWORD                                           bToEntry : 1;
    // // 0x0000 (0x0004) [0x0000000000000000] [0x00000001] TArray< class
    // AActor* >                         ActorList;
    // // 0x0004 (0x0010) [0x0000000000000000]
};
...
struct APlayerCollectorGame_eventLogin_Parms {
    ...
    // // 0x0010 (0x0010) [0x0000000000000000] struct FUniqueNetId UniqueId;
    // // 0x0020 (0x0008) [0x0000000000000000] struct FString ErrorMessage;
    // // 0x0028 (0x0010) [0x0000000000000000] class APlayerController*
    // ReturnValue;                                      		// 0x0038 (0x0008)
    // [0x0000000000000000] class APlayerController*                        PC;
    // // 0x0040 (0x0008) [0x0000000000000000]
};
...
struct USeqEvent_HudRenderImage_execRender_Parms {
    // class UCanvas*                                  TargetCanvas;
    // // 0x0000 (0x0008) [0x0000000000000000] class AHUD* TargetHud;
    // // 0x0008 (0x0008) [0x0000000000000000] float UsedX;
    // // 0x0010 (0x0004) [0x0000000000000000] float UsedY;
    // // 0x0014 (0x0004) [0x0000000000000000] float UsedXL;
    // // 0x0018 (0x0004) [0x0000000000000000] float UsedYL;
    // // 0x001C (0x0004) [0x0000000000000000] float GlobalScaleX;
    // // 0x0020 (0x0004) [0x0000000000000000] float GlobalScaleY;
    // // 0x0024 (0x0004) [0x0000000000000000]
};
...
struct USeqEvent_HudRenderText_execRender_Parms {
    // class UCanvas*                                  TargetCanvas;
    // // 0x0000 (0x0008) [0x0000000000000000] class AHUD* TargetHud;
    // // 0x0008 (0x0008) [0x0000000000000000] float XL;
    // // 0x0010 (0x0004) [0x0000000000000000] float YL;
    // // 0x0014 (0x0004) [0x0000000000000000] float UsedX;
    // // 0x0018 (0x0004) [0x0000000000000000] float UsedY;
    // // 0x001C (0x0004) [0x0000000000000000] float UsedScaleX;
    // // 0x0020 (0x0004) [0x0000000000000000] float UsedScaleY;
    // // 0x0024 (0x0004) [0x0000000000000000] float GlobalScaleX;
    // // 0x0028 (0x0004) [0x0000000000000000] float GlobalScaleY;
