...
#define GObjects 0x7FF70B28C800
#define GNames 0x7FF70B28C750
...
struct FName {
    ...
    char* GetName() { return this->Names()->Data[Index]->Name; };

    bool operator==(const FName& A) const { return (Index == A.Index); };
};
