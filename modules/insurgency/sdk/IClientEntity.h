...
class C_BaseEntity : public IClientEntity {
   public:
    ...
    MoveType_t GetMoveType() {
        return *(MoveType_t*)((uintptr_t)this +
                              offsets.DT_BaseEntity.m_MoveType);
    }

    ICollideable* GetCollideable() {
        return (ICollideable*)((uintptr_t)this +
                               offsets.DT_BaseEntity.m_Collision);
    }
...
class C_BasePlayer : public C_BaseEntity {
   public:
    QAngle* GetViewPunchAngle() {
        return (QAngle*)((uintptr_t)this +
                         offsets.DT_BasePlayer.m_viewPunchAngle);
    }

    QAngle* GetAimPunchAngle() {
        return (QAngle*)((uintptr_t)this +
                         offsets.DT_BasePlayer.m_aimPunchAngle);
    }

    Vector GetVecViewOffset() {
        return *(Vector*)((uintptr_t)this +
                          offsets.DT_BasePlayer.m_vecViewOffset);
    }

    unsigned int GetTickBase() {
        return *(unsigned int*)((uintptr_t)this +
                                offsets.DT_BasePlayer.m_nTickBase);
    }
    ...
    unsigned char GetLifeState() {
        return *(unsigned char*)((uintptr_t)this +
    ...
    ObserverMode_t* GetObserverMode() {
        return (ObserverMode_t*)((uintptr_t)this +
    ...
    const char* GetLastPlaceName() {
        return (const char*)((uintptr_t)this +
                             offsets.DT_BasePlayer.m_szLastPlaceName);
    }

    QAngle* GetEyeAngles() {
        return (QAngle*)((uintptr_t)this +
                         offsets.DT_INSPlayer.m_angEyeAngles[0]);
    }

    float GetFlashDuration() {
        return *(float*)((uintptr_t)this +
                         offsets.DT_INSPlayer.m_flFlashDuration);
    }

    float* GetFlashMaxAlpha() {
        return (float*)((uintptr_t)this +
                        offsets.DT_INSPlayer.m_flFlashMaxAlpha);
    }

    void* GetActiveWeapon() {
        return (void*)((uintptr_t)this +
                       offsets.DT_BaseCombatCharacter.m_hActiveWeapon);
    }
    ...
    int* GetWearables() {
        return (int*)((uintptr_t)this +
                      offsets.DT_BaseCombatCharacter.m_hMyWearables);
    }
    ...
    QAngle* GetVAngles() {
        return (QAngle*)((uintptr_t)this + offsets.DT_BasePlayer.deadflag +
                         0x4);
    }

    unsigned* GetINSFlags() {
        return (unsigned*)((uintptr_t)this +
                           offsets.DT_INSPlayer.m_iPlayerFlags);
    }

    bool IsScoped() { return (bool)(*(GetINSFlags()) & 1); }

    bool IsSprinting() { return (bool)(*(GetINSFlags()) & 4); }

    float GetSpawnTime() {
        return *(
            (float*)((uintptr_t)this + offsets.DT_INSPlayer.m_flSpawnTime));
    }

    int GetSpecialRole() {
        return *((int*)((uintptr_t)this +
                        offsets.DT_INSPlayer.m_nPlayerSpecialRole));
    }
    ...
    int GetStance() {
        return *(
            (int*)((uintptr_t)this + offsets.DT_INSPlayer.m_iCurrentStance));
    }
};
...
class C_BaseCombatWeapon : public C_BaseEntity {
   public:
    ...
    unsigned int GetAmmo() {
        return *(unsigned int*)((uintptr_t)this +
                                offsets.DT_BaseCombatWeapon.m_iClip1);
    }

    float GetNextPrimaryAttack() {
        return *(float*)((uintptr_t)this +
                         offsets.DT_BaseCombatWeapon.m_flNextPrimaryAttack);
    }
    ...
    bool GetInReload() {
        return *(bool*)((uintptr_t)this +
                        offsets.DT_BaseCombatWeapon.m_bInReload);
    }

    int GetFiremode() {
        return *(int*)((uintptr_t)this +
                       offsets.DT_BaseCombatWeapon.m_iActiveFiremode);
    }
...
class GrenadeThrownBase : C_BaseEntity {
   public:
    bool IsPinPulled() {
        return *(bool*)((uintptr_t)this +
                        offsets.DT_INSGrenadeBase.m_bPinPulled);
    }

    float GetThrowTime() {
        return *(float*)((uintptr_t)this +
                         offsets.DT_INSGrenadeBase.m_fThrowTime);
    }

    Vector GetVecInitialVelocity() {
        return *(Vector*)((uintptr_t)this +
                          offsets.DT_GrenadeThrownBase.m_vecInitialVelocity);
    }

    Vector GetVecVelocity() {
        return *(Vector*)((uintptr_t)this +
                          offsets.DT_GrenadeThrownBase.m_vecVelocity);
    }
};
