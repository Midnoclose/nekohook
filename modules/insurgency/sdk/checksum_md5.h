...
// Output : static void
//-----------------------------------------------------------------------------
inline static void MD5Transform(unsigned int buf[4],
...
//            len -
//-----------------------------------------------------------------------------
inline void MD5Update(MD5Context_t *ctx, unsigned char const *buf,
                      unsigned int len) {
    unsigned int t;
...
//            *ctx -
//-----------------------------------------------------------------------------
inline void MD5Final(unsigned char digest[MD5_DIGEST_LENGTH],
                     MD5Context_t *ctx) {
    unsigned count;
    unsigned char *p;
