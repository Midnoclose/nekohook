...
//            Data is stored in key (string names) - (string/int/float)value
//            pairs called nodes.
//
...
class KeyValues {
   public:
    ...
    //    objects are allocated or it will result in undefined behavior. If you
    //    use the growable string table, you cannot share KeyValues pointers
    ...
    //    this option was written for, but may not be in other situations. Make
    //    sure to understand the implications before using this.
   ...
   private:
    ...
    //    void RecursiveSaveToFile( IBaseFileSystem *filesystem, void*buffer,
    //    int indentLevel ); void WriteConvertedString( void*buffer, const char
    //    *pszString );
