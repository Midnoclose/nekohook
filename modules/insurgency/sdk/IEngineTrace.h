...
class IEngineTrace {
   public:
    ...
    /*
    void TraceRay(const Ray_t &ray, unsigned int fMask, ITraceFilter
    *pTraceFilter, trace_t *pTrace)
    {
        typedef void (* oTraceRay)(void*, const Ray_t &ray, unsigned int fMask,
    ITraceFilter *pTraceFilter, trace_t *pTrace); return
    getvfunc<oTraceRay>(this, 1)(this, ray, fMask, pTraceFilter, pTrace);
    }
    //*/
