...
struct MaterialSystem_Config_t {
    ...
    unsigned char proxiesTestMode;  // 0 = normal, 1 = no proxies, 2 = alpha
                                    // test all, 3 = color mod all
    ...
    bool bShowSpecular;  // This is the fast version that doesn't require
                         // reloading materials
    bool bShowDiffuse;   // This is the fast version that doesn't require
                         // reloading materials
    ...
    /*
        ...
        // Depth bias for biasing shadow depth map rendering away from the
       camera float m_SlopeScaleDepthBias_ShadowMap; float
       m_DepthBias_ShadowMap;
    */
    ...
    bool cheatConfigInitialized;  // set by us cheaters when the config has been
                                  // copied over.
    ...
    MaterialSystem_Config_t() {
        ...
        m_bGammaTVEnabled = false;  // IsX360(); If we make project-spartan xbox
                                    // port, change this
