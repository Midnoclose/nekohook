...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              // not.
              TalkBackStartupLibrary(
                  char const *iCoreDataDir);  // IN:      full path of folder
                                              // containing TalkBack data files.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackCheckSoundFile(
                  char const *iSoundFileName,  // IN:      name of sound file to
                                               // be checked.
                  long *oCanBeAnalyzed,  // OUT:     1 if sound can be analyzed,
                                         // 0 if not.
                  long
                      *oIsClipped,  // OUT:     1 if sound is clipped, 0 if not.
                  double
                      *oDecibelRange);  // OUT:     used decibel range of sound.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetSoundFileMetrics(
                  char const *iSoundFileName,  // IN:      name of sound file to
                                               // be checked.
                  TALKBACK_SOUND_FILE_METRICS
                      *ioMetrics);  // IN/OUT:  address of a structure where the
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackCheckSpokenText(
                  ...
                  char *oAnalyzedText);  // OUT:     buffer for text as it will
                                         // be analyzed.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetErrorString(
                  TALKBACK_ERR
                      iErrorCode,  // IN:      TalkBack error code to convert.
                  long iMaxChars,  // IN:      size of the buffer.
                  char *oErrorString);  // OUT:     buffer for the description
                                        // string.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetLastError(
                  ...
                  char *oErrorString,  // OUT:     buffer for the description
                                       // string.
                  TALKBACK_ERR *
                      oErrorCode);  // OUT:     most recent TalkBack error code.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetAnalysis(
                  TALKBACK_ANALYSIS *
                      *ioAnalysis,  // IN/OUT:  address of a TALKBACK_ANALYSIS
                                    // *variable where analysis will be stored.
                  char const *iSoundFileName,  // IN:      name of the sound
                                               // file to analyze.
                  char const
                      *iSoundText,  // IN:      text spoken in sound file (can
                                    // be NULL to use textless analysis).
                  TALKBACK_ANALYSIS_SETTINGS
                      *iSettings);  // IN:      pointer to a
                                    // TALKBACK_ANALYSIS_SETTINGS structure (can
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackFreeAnalysis(
                  TALKBACK_ANALYSIS *
                      *ioAnalysis);  // IN/OUT:  analysis to free.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetNumSpeechTargetTracks(
                  TALKBACK_ANALYSIS
                      *iAnalysis,  // IN:      opaque analysis object returned
                                   // by TalkBackGetAnalysis().
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetNumSpeechTargetKeys(
                  ...
                  long *oResult);  // OUT:     number of keys in the speech
                                   // target track.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetSpeechTargetKeyInfo(
                  ...
                  double
                      *oDerivativeIn,  // OUT:     incoming derivative of key.
                  double
                      *oDerivativeOut);  // OUT:     outgoing derivative of key.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetSpeechTargetDerivativesAtTime(
                  ...
                  long iTrackNum,  // IN:      speech target track.
                  double iTime,    // IN:      time in seconds.
                  double *oDerivativeIn,    // OUT:     value of the incoming
                                            // derivative of the function curve.
                  double *oDerivativeOut);  // OUT:     value of the outgoing
                                            // derivative of the function curve.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetFrameStartTime(
                  ...
                  double *
                      oResult);  // OUT:     start time of the frame in seconds.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetFrameEndTime(
                  ...
                  long iFrameNum,  // IN:      frame.
                  double
                      *oResult);  // OUT:     end time of the frame in seconds.
              ...
              TalkBackGetDominantSpeechTargetAtFrame(
                  TALKBACK_ANALYSIS
                      *iAnalysis,  // IN:      opaque analysis object returned
                                   // by TalkBackGetAnalysis().
                  long iFrameNum,  // IN:      frame number.
                  TALKBACK_SPEECH_TARGET
                      *oSpeechTarget);  // OUT:     dominant speech target.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetPhonemeEnum(
                  ...
                  TALKBACK_PHONEME *oResult);  // OUT:     enumeration of the
                                               // specified phoneme.
              ...
              TalkBackGetPhonemeStartTime(
                  TALKBACK_ANALYSIS
                      *iAnalysis,    // IN:      opaque analysis object returned
                                     // by TalkBackGetAnalysis().
                  long iPhonemeNum,  // IN:      phoneme.
                  double *oResult);  // OUT:     start time of the phoneme in
                                     // seconds.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetPhonemeEndTime(
                  ...
                  long iPhonemeNum,  // IN:      phoneme.
                  double *
                      oResult);  // OUT:     end time of the phoneme in seconds.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetWordStartTime(
                  ...
                  long iWordNum,   // IN:      word.
                  double
                      *oResult);  // OUT:     start time of the word in seconds.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackGetWordEndTime(
                  ...
                  long iWordNum,   // IN:      word.
                  double
                      *oResult);  // OUT:     end time of the word in seconds.
              ...
              TalkBackInsertPhoneme(
                  TALKBACK_ANALYSIS
                      *iAnalysis,  // IN:      opaque analysis object returned
                                   // by TalkBackGetAnalysis().
                  TALKBACK_PHONEME
                      iPhoneme,  // IN:      enumeration of phoneme to insert.
                  long iInsertPosition,  // IN:      position (phoneme number)
                                         // at which to insert.
                  int iInsertBefore);    // IN:      manner of insertion:
                                         //            0 means put phoneme after
                                       //            insert position; 1 means
                                       //            put phoneme before insert
                                       //            position.
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackChangePhonemeStart(
                  ...
                  double *ioNewTime);     // IN/OUT:  new start time value in
                                       // seconds (in); actual start time (out).
              ...
              TalkBackChangePhonemeEnd(
                  TALKBACK_ANALYSIS
                      *iAnalysis,  // IN:      opaque analysis object returned
                                   // by TalkBackGetAnalysis().
                  long iPhonemeToChange,  // IN:      phoneme to change.
                  double *ioNewTime);  // IN/OUT:  new end time value in seconds
                                       // (in); actual end time (out).
...
TALKBACK_ERR  // RETURNS: TALKBACK_NOERR if successful, TalkBack error code if
              ...
              TalkBackChangePhonemeEnum(
                  ...
                  long iPhonemeToChange,  // IN:      phoneme to change.
                  TALKBACK_PHONEME
                      iNewPhoneme);  // IN:      new phoneme enumeration.
