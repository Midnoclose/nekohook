...
//	pIncludedFromFileName	is the name of the parent file or NULL if loaded
//because of "LoadScriptFile" toplevel call. 	nIncludeLineNumber		is the
//number of the line in the parent file with $include statement or 0 in case of
//"LoadScriptFile"
