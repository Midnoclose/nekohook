...
struct s_loddata_t {
    ...
    // remaps verts from an lod's source mesh to this all-lod processed
    // aggregate pool
...
struct s_source_t {
    ...
    int texmap[MAXSTUDIOSKINS *
               4];  // map local MAX materials to unique textures
    ...
    s_boneweight_t
        *globalBoneweight;       // vertex info about global bone weighting
