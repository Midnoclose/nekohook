...
SRes XzBlock_ReadHeader(CXzBlock *p, ISeqInStream *inStream, Bool *isIndex,
...
typedef struct _IStateCoder {
    ...
    SRes (*SetProps)(void *p, const Byte *props, size_t propSize,
                     ISzAlloc *alloc);
    void (*Init)(void *p);
    SRes (*Code)(void *p, Byte *dest, SizeT *destLen, const Byte *src,
...
SRes MixCoder_Code(CMixCoder *p, Byte *dest, SizeT *destLen, const Byte *src,
