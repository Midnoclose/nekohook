...
// 			These should be used instead of direct manipulation to allow
// more
...
// 			pointer should be considered transient and should not be
// stored.
//-----------------------------------------------------------------------------
...
struct castable_string_t : public string_t  // string_t is used in unions,
                                            // hence, no constructor allowed
{
