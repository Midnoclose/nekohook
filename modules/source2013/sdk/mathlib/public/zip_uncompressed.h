...
struct ZIP_PreloadHeader {
    ...
    unsigned int
        PreloadDirectoryEntries;  // Number of preloaded directory entries
                                  // (equal or less than the zip dir).
...
struct ZIP_PreloadDirectoryEntry {
    ...
    unsigned int DataOffset;  // Offset the file data in the .zip, relative to
                              // the logical beginning of the preload file.
};
