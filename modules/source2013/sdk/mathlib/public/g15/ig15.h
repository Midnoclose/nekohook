...
typedef enum { G15_SMALL, G15_MEDIUM, G15_BIG } G15TextSize;
...
class IG15 {
   public:
    ...
    // Add/remove
    virtual G15_HANDLE AddText(G15ObjectType type, G15TextSize size,
                               int alignment, int maxLengthPixels) = 0;
