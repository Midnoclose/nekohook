...
//			consistent way across all branches, including Steam. If you
//change 			this packing format you need to do so in a backward compatible way 			so
//that the Steam servers and all the various GCs can still talk to 			each other.
//-----------------------------------------------------------------------------
class KVPacker {
   public:
   ...
   private:
    ...
    enum EPackType {
        ...
        PACKTYPE_COLOR,
        PACKTYPE_UINT64,
        PACKTYPE_NULLMARKER,  // used to mark the end of a block in the binary
                              // format
    };
};
