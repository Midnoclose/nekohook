   ...
   public:
    ...
    class CBaseCommand {
       public:
        ...
        ~CBaseCommand() { ReleaseCachedRenderData(); }
       ...
       public:
        ...
        // The renderer can cache data with the commands to speedup the
        // rendering after the first time (text uses this big time).
