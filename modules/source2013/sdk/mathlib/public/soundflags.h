...
enum soundlevel_t {
    ...
    SNDLVL_95dB = 95,
    SNDLVL_100dB = 100,  // 0.4	// subway train, diesel truck, woodworking shop,
                         // pneumatic drill, boiler shop, jackhammer
    SNDLVL_105dB = 105,  // helicopter, power mower
    SNDLVL_110dB =
        110,  // snowmobile drvrs seat, inboard motorboat, sandblasting
...
enum SoundFlags_t {
    ...
    SND_SPAWNING =
        (1 << 3),  // we're spawning, used in some cases for ambients
...
#define MAX_SOUND_DELAY_MSEC                  \
    (1 << (MAX_SOUND_DELAY_MSEC_ENCODE_BITS - \
           1))  // 4096 msec or about 4 seconds
