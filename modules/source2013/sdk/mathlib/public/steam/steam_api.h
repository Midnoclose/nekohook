...
// Detects if your executable was launched through the Steam client, and
// restarts your game through the client if necessary. The Steam client will be
// started if it is not running.
//
// Returns: true if your executable was NOT launched through the Steam client.
// This function will
//          then start your application through the client. Your current process
//          should exit.
//
//          false if your executable was started through the Steam client or a
//          steam_appid.txt file is present in your game's directory (for
//          development). Your current process should continue.
//
// NOTE: This function should be used only if you are using CEG or not using
// Steam's DRM. Once applied
//       to your executable, Steam's DRM will handle restarting through Steam if
//       necessary.
...
//
// VERSION_SAFE_STEAM_API_INTERFACES is usually not necessary, but it provides
// safety against releasing new steam_api.dll's without recompiling/rereleasing
// modules that use it.
//
// If you use VERSION_SAFE_STEAM_API_INTERFACES, then you should call
// SteamAPI_InitSafe(). Also, to get the Steam interfaces, you must create and
// Init() a CSteamAPIContext (below) and use the interfaces in there.
//
// If you don't use VERSION_SAFE_STEAM_API_INTERFACES, then you can use
// SteamAPI_Init() and the SteamXXXX() functions below to get at the Steam
// interfaces.
//
