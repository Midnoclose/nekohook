...
//
// Purpose: provides an interface for plugins to query information about the
// gamerules in a simple and organized mannor.
//
//===============================================================================================//
#ifndef IGAMEINFO_H
#define IGAMEINFO_H
...
// Tony; prefixing everything in this so that i can make IGameInfo an extension
// of CGameRules and not stomp on anything, since gamerules isn't an entity.
abstract_class IGameInfo {
   public:
    ...
    // returns how many teams the game has (typically always 4; 0 = unassigned,
    // 1 = spectator, 2 = team1, 3 = team2)
    ...
    // accessor to hook mod specific information about the rules. for TF2,
    // fields such as
    virtual bool GetInfo_Custom(int valueType, pluginvariant &outValue,
                                pluginvariant options) = 0;
};

// Interface is very simple, there's not much really needed for the manager,
// this stuff is just in it's own interface so it's not mixed up with the entity
// or player managers.
