...
// This provides an alternative to HOOK_MESSAGE, where you can declare it
// globally instead of finding a place to run it. It registers a function called
// __MsgFunc_<msgName>
#define USER_MESSAGE_REGISTER(msgName)                         \
    static CUserMessageRegister userMessageRegister_##msgName( \
        #msgName, __MsgFunc_##msgName);
