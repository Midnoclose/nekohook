...
class CHudBitmapNumericDisplay : public vgui::Panel {
   ...
   protected:
    ...
    virtual void Paint();
    void PaintNumbers(int xpos, int ypos, int value, Color col,
                      int numSigDigits);
    ...
    CPanelAnimationVarAliasType(float, digit_xpos, "digit_xpos", "0",
                                "proportional_float");
    CPanelAnimationVarAliasType(float, digit_ypos, "digit_ypos", "0",
                                "proportional_float");
    CPanelAnimationVarAliasType(float, digit_height, "digit_height", "16",
                                "proportional_float");
