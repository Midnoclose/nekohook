...
class C_SceneEntity : public C_BaseEntity, public IChoreoEventCallback {
   ...
   private:
    ...
    virtual void DispatchStartFlexAnimation(CChoreoScene *scene,
                                            C_BaseFlex *actor,
                                            CChoreoEvent *event);
    virtual void DispatchEndFlexAnimation(CChoreoScene *scene,
                                          C_BaseFlex *actor,
                                          CChoreoEvent *event);
    ...
    virtual void DispatchStartGesture(CChoreoScene *scene, C_BaseFlex *actor,
                                      CChoreoEvent *event);
    virtual void DispatchProcessGesture(CChoreoScene *scene, C_BaseFlex *actor,
                                        CChoreoEvent *event);
    ...
    virtual void DispatchStartSequence(CChoreoScene *scene, C_BaseFlex *actor,
                                       CChoreoEvent *event);
    virtual void DispatchProcessSequence(CChoreoScene *scene, C_BaseFlex *actor,
                                         CChoreoEvent *event);
   ...
   private:
    ...
    CHandle<C_BaseFlex> m_hOwner;  // if set, this overrides the m_hActorList in
                                   // FindNamedActor()
