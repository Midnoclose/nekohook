...
class CommandMenu : public Menu {
   ...
   public:
    ...
    void RebuildMenu();  // rebuilds menu respecting changed game state (map,
                         // team etc)
   ...
   public:
    ...
    // *panelName, IViewPort * viewport = NULL, IFileSystem * pFileSytem =
    // NULL); // overwrite
    ...
    virtual void OnCustomItem(
        KeyValues *params){};  // a custom item was pressed
