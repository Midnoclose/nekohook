...
class CReplayRenderDialog : public CReplayBasePanel {
   ...
   public:
    CReplayRenderDialog(Panel *pParent, ReplayHandle_t hReplay, bool bSetQuit,
                        int iPerformance);
   ...
   private:
    ...
    CPanelAnimationVarAliasType(int, m_nStartY, "start_y", "0",
                                "proportional_ypos");
    CPanelAnimationVarAliasType(int, m_nVerticalBuffer, "vertical_buffer", "0",
                                "proportional_ypos");
    CPanelAnimationVarAliasType(int, m_nDefaultX, "default_x", "0",
                                "proportional_xpos");
...
void ReplayUI_ShowRenderDialog(Panel *pParent, ReplayHandle_t hReplay,
                               bool bSetQuit, int iPerformance);
