...
#define NUM_CLASSES_IN_LOADOUT_PANEL \
    (TF_LAST_NORMAL_CLASS - 1)  // We don't allow unlockables for the civilian
...
class CKeyValueLabelPanel : public EditablePanel {
   ...
   public:
    ...
    CKeyValueLabelPanel(Panel *pParent, const char *pKey,
...
class CBaseDetailsPanel : public EditablePanel {
   ...
   public:
    CBaseDetailsPanel(Panel *pParent, const char *pName,
...
class CMovieInfoPanel : public CBaseDetailsPanel {
   ...
   public:
    CMovieInfoPanel(Panel *pParent, ReplayHandle_t hReplay,
                    QueryableReplayItemHandle_t hMovie,
...
class CTitleEditPanel : public EditablePanel {
   ...
   public:
    CTitleEditPanel(Panel *pParent, QueryableReplayItemHandle_t hReplayItem,
                    IReplayItemManager *pItemManager);
    ~CTitleEditPanel();
...
class CCutImagePanel : public CExImageButton {
   ...
   private:
    virtual IBorder *GetBorder(bool bDepressed, bool bArmed, bool bSelected,
                               bool bKeyFocus);
...
class CCutsPanel : public CBaseDetailsPanel {
   ...
   public:
    ...
    CPanelAnimationVarAliasType(int, m_nCutButtonWidth, "cut_button_width", "0",
                                "proportional_xpos");
    CPanelAnimationVarAliasType(int, m_nCutButtonHeight, "cut_button_height",
                                "0", "proportional_ypos");
    CPanelAnimationVarAliasType(int, m_nCutButtonBuffer, "cut_button_buffer",
                                "0", "proportional_xpos");
    CPanelAnimationVarAliasType(int, m_nCutButtonSpace, "cut_button_space", "0",
                                "proportional_xpos");
    CPanelAnimationVarAliasType(int, m_nCutButtonSpaceWide,
                                "cut_button_space_wide", "0",
                                "proportional_xpos");
    CPanelAnimationVarAliasType(int, m_nTopMarginHeight, "top_margin_height",
                                "0", "proportional_ypos");
    CPanelAnimationVarAliasType(int, m_nNameLabelTopMargin,
                                "name_label_top_margin", "0",
                                "proportional_ypos");
    CPanelAnimationVarAliasType(int, m_nButtonStartY, "button_start_y", "0",
                                "proportional_ypos");
   ...
   private:
    ...
    enum Consts_t { BUTTONS_PER_PAGE = 4 };
...
class CReplayDetailsPanel : public EditablePanel {
   ...
   public:
    CReplayDetailsPanel(Panel *pParent, QueryableReplayItemHandle_t hReplayItem,
    ...
    EditablePanel *m_pInsetPanel;  // Parent to most child panels listed here -
                                   // narrower than screen width
    ...
    CUtlVector<CBaseDetailsPanel *>
        m_vecInfoPanels;  // List of panels on the right
   ...
   private:
    ...
    CPanelAnimationVarAliasType(int, m_nMarginWidth, "margin_width", "0",
                                "proportional_xpos");
