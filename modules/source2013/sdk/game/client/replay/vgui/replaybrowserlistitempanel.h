...
class CReplayScreenshotSlideshowPanel : public CSlideshowPanel {
   ...
   public:
    CReplayScreenshotSlideshowPanel(Panel *pParent, const char *pName,
...
class CReplayBrowserThumbnail : public CReplayBasePanel {
   ...
   public:
    CReplayBrowserThumbnail(Panel *pParent, const char *pName,
...
class CReplayBrowserThumbnailRow : public EditablePanel {
   ...
   public:
    CReplayBrowserThumbnailRow(Panel *pParent, const char *pName,
                               IReplayItemManager *pReplayItemManager);
...
class CBaseThumbnailCollection : public EditablePanel {
   ...
   public:
    CBaseThumbnailCollection(CReplayListPanel *pParent, const char *pName,
                             IReplayItemManager *pReplayItemManager);
    ...
    CReplayBrowserThumbnailRow *FindReplayItemThumbnailRow(
   ...
   protected:
    // Called from PerformLayout() - layout any panels that should appear at the
    // top (vertically)-most position
   ...
   private:
    ...
    CReplayListPanel *m_pParentListPanel;  // Parent gets altered so we keep
                                           // this cached ptr around
};
...
class CReplayThumbnailCollection : public CBaseThumbnailCollection {
   ...
   public:
    CReplayThumbnailCollection(CReplayListPanel *pParent, const char *pName,
                               IReplayItemManager *pReplayItemManager);
...
class CMovieThumbnailCollection : public CBaseThumbnailCollection {
   ...
   public:
    CMovieThumbnailCollection(CReplayListPanel *pParent, const char *pName,
                              IReplayItemManager *pReplayItemManager, int nDay,
