...
class CReplayPreviewPanelBase : public EditablePanel {
   ...
   public:
    CReplayPreviewPanelBase(Panel *pParent, QueryableReplayItemHandle_t hItem,
...
class CReplayPreviewPanelSlideshow : public CReplayPreviewPanelBase {
   ...
   public:
    CReplayPreviewPanelSlideshow(Panel *pParent,
                                 QueryableReplayItemHandle_t hItem,
                                 IReplayItemManager *pItemManager);
...
class CReplayPreviewPanelMovie : public CReplayPreviewPanelBase {
   ...
   public:
    CReplayPreviewPanelMovie(Panel *pParent, QueryableReplayItemHandle_t hItem,
                             IReplayItemManager *pItemManager);
