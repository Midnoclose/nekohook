...
class C_BaseTeamObjectiveResource : public C_BaseEntity {
   ...
   public:
    ...
    int GetPreviousPointForPoint(int index, int team, int iPrevIndex) {
        ...
        int iIntIndex = iPrevIndex + (index * MAX_PREVIOUS_POINTS) +
                        (team * MAX_CONTROL_POINTS * MAX_PREVIOUS_POINTS);
    ...
    void GetCapLayoutCustomPosition(float &flCustomPositionX,
                                    float &flCustomPositionY) {
    ...
    virtual const char *GetGameSpecificCPCappingSwipe(int index,
                                                      int iCappingTeam) {
   ...
   protected:
    ...
    int m_iPreviousPoints[MAX_CONTROL_POINTS * MAX_CONTROL_POINT_TEAMS *
                          MAX_PREVIOUS_POINTS];
