...
class CLCDItemIcon : public CLCDItem {
   ...
   public:
    CLCDItemIcon() : m_icon(NULL) { m_Type = LCDITEM_ICON; }
...
class CLCDItemAggregate : public CLCDItem {
   ...
   public:
    CLCDItemAggregate()
        : m_AggType(AGGTYPE_UNKNOWN), m_dwNextUpdateTime(0), m_yincrement(0) {
...
class CLCD : public IHudLCD {
   ...
   private:
    CLCDItemIcon *ParseItemIcon(CLCDPage *page, bool bCreateHandles,
                                KeyValues *sub);
    CLCDItemText *ParseItemText(CLCDPage *page, bool bCreateHandles,
                                KeyValues *sub);
    void ParseItems_R(CLCDPage *page, bool bCreateHandles, KeyValues *kv,
                      CUtlVector<CLCDItem *> &list);
    ...
    void ShowItems_R(CLCDPage *page, unsigned int dwCurTime,
                     CUtlVector<CLCDItem *> &list, bool show);
