...
class CClientThinkList : public IGameSystemPerFrame {
   ...
   private:
    ...
    void AddEntityToFrameThinkList(ThinkEntry_t *pEntry, bool bAlwaysChain,
                                   int &nCount,
   ...
   private:
    ...
    // Makes sure the entries are thinked once per frame in the face of
    // hierarchy
    int m_nIterEnum;
    bool m_bInThinkLoop;
};
...
inline CClientThinkList::ThinkEntry_t *CClientThinkList::GetThinkEntry(
    ClientThinkHandle_t hThink) {
