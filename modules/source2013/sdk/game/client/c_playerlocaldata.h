...
class CPlayerLocalData {
   public:
    ...
    CPlayerLocalData()
        ...
        m_iv_vecPunchAngle.Setup(&m_vecPunchAngle.m_Value,
                                 LATCH_SIMULATION_VAR);
        m_iv_vecPunchAngleVel.Setup(&m_vecPunchAngleVel.m_Value,
                                    LATCH_SIMULATION_VAR);
        m_flFOVRate = 0;
    }
    ...
    unsigned char
        m_chAreaPortalBits[MAX_AREA_PORTAL_STATE_BYTES];  // Area portal
                                                          // visibility flags.
