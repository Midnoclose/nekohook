...
class VoteBarPanel : public vgui::Panel, public CGameEventListener {
   ...
   private:
    ...
    CPanelAnimationVarAliasType(int, m_iBoxSize, "box_size", "16",
                                "proportional_int");
    CPanelAnimationVarAliasType(int, m_iSpacer, "spacer", "4",
                                "proportional_int");
    CPanelAnimationVarAliasType(int, m_iBoxInset, "box_inset", "1",
                                "proportional_int");
    CPanelAnimationVarAliasType(int, m_nYesTextureId, "yes_texture",
                                "vgui/hud/vote_yes", "textureid");
    CPanelAnimationVarAliasType(int, m_nNoTextureId, "no_texture",
                                "vgui/hud/vote_no", "textureid");
};

//-----------------------------------------------------------------------------
// Purpose: A selection UI for votes that require additional parameters - such
// as players, maps
//-----------------------------------------------------------------------------
