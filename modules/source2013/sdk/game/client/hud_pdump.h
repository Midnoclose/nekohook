...
class CPDumpPanel : public CHudElement, public vgui::Panel {
   ...
   public:
    ...
    void DumpComparision(const char *classname, const char *fieldname,
                         const char *fieldtype, bool networked,
                         bool noterrorchecked, bool differs,
                         bool withintolerance, const char *value);

   private:
    void PredictionDumpColor(bool networked, bool errorchecked, bool differs,
                             bool withintolerance, int &r, int &g, int &b,
                             int &a);
    //-----------------------------------------------------------------------------
    // Purpose: Stores some info about the various fields of an entity for
    // display
    //-----------------------------------------------------------------------------
    struct DumpInfo {
    ...
    CPanelAnimationVar(vgui::HFont, m_FontSmall, "ItemFont",
                       "DefaultVerySmall");
