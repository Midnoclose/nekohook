...
abstract_class IRagdoll {
   public:
    ...
    virtual void RagdollBone(C_BaseEntity * ent, mstudiobone_t * pbones,
    ...
    virtual bool TransformVectorToWorld(int boneIndex, const Vector *vTemp,
                                        Vector *vOut) = 0;
};
...
class CRagdoll : public IRagdoll {
   public:
    ...
    void Init(C_BaseEntity *ent, CStudioHdr *pstudiohdr,
    ...
    virtual bool TransformVectorToWorld(int iBoneIndex, const Vector *vTemp,
                                        Vector *vOut);
    ...
    void SetInitialBonePosition(CStudioHdr *pstudiohdr,
