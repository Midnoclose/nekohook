...
// VGUI_VIDEO_PLAYER
//
//  Creates a VGUI Panel that can play a video in engine with "media player
//  like"
//     functionality.  vgui_video.h has a basic player panel, but this allows
//     for much greater control over playback, etc
//
//=============================================================================
...
class VideoPlayerPanel : public vgui::Panel  // Should this be EditablePanel ?
{
   public:
    ...
    VideoPlayerPanel(vgui::Panel *parent, const char *panelName, int nXpos,
                     int nYpos, int nWidth, int nHeight,
