...
inline void UpdateScreenEffectTexture(int textureIndex, int x, int y, int w,
    ...
    if (!bDestFullScreen &&
        ...
        // the source and target sizes aren't necessarily the same (specifically
        // in dx7 where nonpow2 rendertargets aren't supported), so lets figure
        // it out here.
...
inline void DrawScreenEffectMaterial(IMaterial *pMaterial, int x, int y, int w,
    ...
    pRenderContext->DrawScreenSpaceRectangle(
        ...
        actualRect.x + actualRect.width - 1,
...
inline void UpdateScreenEffectTexture(void) {
    ...
    UpdateScreenEffectTexture(0, pViewSetup->x, pViewSetup->y,
