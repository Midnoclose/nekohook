...
class ParticleDraw {
   ...
   public:
    ...
    void Init(CMeshBuilder *pMeshBuilder, IMaterial *pMaterial,
              float fTimeDelta);

    // Time delta..
    float GetTimeDelta() const;

    // Get the material being used (mostly useful for getting the tcoord
    // padding).
...
inline ParticleDraw::ParticleDraw() { m_pMaterial = 0; }

inline void ParticleDraw::Init(CMeshBuilder *pMeshBuilder, IMaterial *pMaterial,
                               float fTimeDelta) {
...
inline float ParticleDraw::GetTimeDelta() const { return m_fTimeDelta; }

inline CMeshBuilder *ParticleDraw::GetMeshBuilder() { return m_pMeshBuilder; }
