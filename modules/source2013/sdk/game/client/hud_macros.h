...
#define HOOK_HUD_MESSAGE(y, x) \
    usermessages->HookMessage(#x, __MsgFunc_##y##_##x);
// Message declaration for non-CHudElement classes
#define DECLARE_MESSAGE(y, x) \
    void __MsgFunc_##y##_##x(bf_read &msg) { y.MsgFunc_##x(msg); }
...
// Commands
#define HOOK_COMMAND(x, y) \
    static ConCommand x(#x, __CmdFunc_##y, "", FCVAR_SERVER_CAN_EXECUTE);
// Command declaration for non CHudElement classes
#define DECLARE_COMMAND(y, x) \
    void __CmdFunc_##x(void) { y.UserCmd_##x(); }
