...
class CAI_LeadBehavior : public CAI_SimpleBehavior {
   ...
   public:
    CAI_LeadBehavior()
        : m_pSink(NULL), m_LostTimer(3.0, 4.0), m_LostLOSTimer(2.0, 3.0) {
    ...
    void LeadPlayer(const AI_LeadArgs_t &leadArgs,
                    CAI_LeadBehaviorHandler *pSink = NULL);
   ...
   private:
    ...
    bool GetClosestPointOnRoute(const Vector &targetPos,
