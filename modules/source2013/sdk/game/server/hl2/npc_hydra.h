...
#define CHAIN_LINKS 32
    ...
    void Nudge(CBaseEntity *pHitEntity, const Vector &vecContact,
               const Vector &vecSpeed);
    void Stab(CBaseEntity *pHitEntity, const Vector &vecSpeed, trace_t &ptr);
    void Kick(CBaseEntity *pHitEntity, const Vector &vecContact,
              const Vector &vecSpeed);
    ...
    void AttachStabbedEntity(CBaseAnimating *pAnimating, Vector vecForce,
                             trace_t &tr);
