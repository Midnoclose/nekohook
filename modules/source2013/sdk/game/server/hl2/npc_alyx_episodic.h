...
class CNPC_Alyx : public CNPC_PlayerCompanion {
   public:
    ...
    void Use(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType,
             float value);
    bool PlayerInSpread(const Vector &sourcePos, const Vector &targetPos,
   ...
   private:
    enum {
        ...
        COND_ALYX_CAN_INTERACT_WITH_TARGET,  // Hack target is in a suitable
                                             // state and location to hack
