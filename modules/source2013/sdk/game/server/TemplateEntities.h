...
//			that were configured by the level designer. This allows us
//to spawn 			entities with arbitrary sets of key/value data and entity I/O
//			connections.
//
//=============================================================================//
...
// Unique versions of these templates need to be created whenever they're
// instanced.
