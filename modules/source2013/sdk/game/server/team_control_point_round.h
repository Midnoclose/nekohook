...
class CTeamControlPointRound : public CBaseEntity {
   ...
   public:
    ...
    int CheckWinConditions(void);  // returns the team number of the team that's
                                   // won, or returns -1 if no winner
   ...
   private:
    void FindControlPoints(
        void);  // look in the map to find the control points for this round
