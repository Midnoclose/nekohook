...
class CPointTemplate : public CLogicalEntity {
   ...
   public:
    ...
    // Template instancing
    bool CreateInstance(const Vector &vecOrigin, const QAngle &vecAngles,
   ...
   private:
    ...
    // It's only valid between Spawn() & Activate(), because the map entity
    // parsing code removes all the entities in it once it finishes turning them
    // into templates.
