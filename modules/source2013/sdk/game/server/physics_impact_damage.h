...
// UNDONE: Add a flag to turn off aggregation of mass in object systems (e.g.
// ragdolls, vehicles)?
struct impactdamagetable_t {
    ...
    float largeMassFallingScale;  // emphasize downward impacts so that this
                                  // will kill instead of stress (we have more
                                  // information here than there)
    float myMinVelocity;  // filter out any energy lost by me unless my velocity
...
float CalculateDefaultPhysicsDamage(int index, gamevcollisionevent_t *pEvent,
                                    ...
                                    int &damageTypeOut,
                                    string_t iszDamageTableName = NULL_STRING,
...
float CalculateObjectStress(IPhysicsObject *pObject, CBaseEntity *pOwnerEntity,
