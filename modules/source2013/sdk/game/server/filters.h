...
//
//			For example, triggers can use an activator filter to
//determine who 			activates them. NPCs and breakables can use a damage filter to
...
//
//			More than one filter can be combined to create a more
//complex boolean 			expression by using filter_multi.
//
//=============================================================================//
