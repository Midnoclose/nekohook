...
class CPropJeepEpisodic : public CPropJeep {
   ...
   private:
    ...
    float m_flCargoStartTime;  // Time when the cargo was first added to the
                               // vehicle (used for animating into hold)
    float m_flNextAvoidBroadcastTime;  // Next time we'll warn entity to move
                                       // out of us

    COutputEvent m_OnCompanionEnteredVehicle;  // Passenger has completed
                                               // entering the vehicle
    COutputEvent m_OnCompanionExitedVehicle;   // Passenger has completed exited
                                               // the vehicle
    COutputEvent m_OnHostileEnteredVehicle;  // Passenger has completed entering
                                             // the vehicle
    COutputEvent
        m_OnHostileExitedVehicle;  // Passenger has completed exited the vehicle
    ...
    bool m_bBusterHopperVisible;  // is the hopper assembly visible on the
                                  // vehicle? please do not set this directly -
                                  // use the accessor funct.
