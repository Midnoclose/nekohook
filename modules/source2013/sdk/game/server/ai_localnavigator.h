...
class CAI_LocalNavigator : public CAI_Component, public CAI_ProxyMovementSink {
   public:
    ...
    AIMoveResult_t MoveCalc(AILocalMoveGoal_t *pResult,
                            bool bPreviouslyValidated = false);
   ...
   protected:
    ...
    bool MoveCalcDirect(AILocalMoveGoal_t *pMoveGoal, bool bOnlyCurThink,
                        float *pDistClear, AIMoveResult_t *pResult);
    bool MoveCalcSteer(AILocalMoveGoal_t *pMoveGoal, float distClear,
                       AIMoveResult_t *pResult);
    bool MoveCalcStop(AILocalMoveGoal_t *pMoveGoal, float distClear,
                      AIMoveResult_t *pResult);
