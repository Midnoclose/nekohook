...
//
// Purpose: Shared Player Variables / Functions and variables that may or may
// not be networked
//
//===========================================================================================//
...
class CSDKPlayerShared {
   public:
    ...
    void ComputeWorldSpaceSurroundingBox(Vector *pVecWorldMins,
   ...
   public:
#ifdef SDK_USE_PRONE
    float m_flNextProneCheck;  // Prevent it switching their prone state
                               // constantly.
    ...
    // Tony; player speeds; at spawn server and client update both of these
    // based on class (if any)
    float m_flRunSpeed;
