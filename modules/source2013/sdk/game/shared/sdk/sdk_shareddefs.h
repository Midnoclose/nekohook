...
//=========================
// NOTES: The Wizard automatically replaces these strings! If you extract the
// source as is, you will have to add the defines manually!
//
...
//
// Do your players have stamina? - this is a pre-requisite for sprinting, if you
// define sprinting, and don't uncomment this, it will be included anyway.
...
// Tony; stamina is a pre-requisite to sprinting, if you don't declare stamina
// but you do declare sprinting stamina needs to be included.
...
//
// If you're allowing sprinting, do you want to be able to shoot while
// sprinting? define SDK_SHOOT_WHILE_SPRINTING
...
#define SDK_NUM_PLAYERCLASSES \
    3  // Tony; our template sample has 3 player classes.
...
#if defined(SDK_USE_TEAMS)
// Tony; using teams with classes, so make sure the team class panel names are
// defined.
...
// Tony; these defines handle the default speeds for all of these - all are
// listed regardless of which option is enabled.
...
enum SDKPlayerState {
    ...
    // It's switching between intro cameras every few seconds, and there's a
    // level info screen up.
...
// Either way, you can't move while choosing team or class (or while any menu is
// up).
#if defined(SDK_USE_TEAMS)
