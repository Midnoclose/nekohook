...
class CBaseGrenadeProjectile : public CBaseGrenade {
   ...
   public:
    // This gets sent to the client and placed in the client's interpolation
    // history so the projectile starts out moving right off the bat.
    ...
    // Specify what velocity we want the grenade to have on the client
    // immediately. Without this, the entity wouldn't have an interpolation
    // history initially, so it would sit still until it had gotten a few
