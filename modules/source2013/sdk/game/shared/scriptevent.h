...
#define SCRIPT_EVENT_FIREEVENT \
    1003  // Fires OnScriptEventXX output in the script entity, where XX is the
          // event number from the options data.
#define SCRIPT_EVENT_SOUND 1004     // Play named wave file (on CHAN_BODY)
#define SCRIPT_EVENT_SENTENCE 1005  // Play named sentence
#define SCRIPT_EVENT_INAIR \
    1006  // Leave the character in air at the end of the sequence (don't find
          // the floor)
#define SCRIPT_EVENT_ENDANIMATION \
    1007  // Set the animation by name after the sequence completes
...
#define SCRIPT_EVENT_NOT_DEAD \
    1010  // Bring back to life (for life/death sequences)
...
#define SCRIPT_EVENT_BODYGROUPTEMP \
    1022  // Turn a bodygroup on until this sequence ends
