...
#define TE_EXPLFLAG_NONE \
    0x0  // all flags clear makes default Half-Life explosion
#define TE_EXPLFLAG_NOADDITIVE \
    0x1  // sprite will be drawn opaque (ensure that the sprite you send is a
         // non-additive sprite)
...
#define TE_BEAMFOLLOW \
    4  // create a line of decaying beam segments until entity stops moving
