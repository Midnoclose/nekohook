...
typedef enum {
    ...
    ACT_RESET = 0,  // Set m_Activity to this invalid value to force a reset to
                    // m_IdealActivity
    ACT_IDLE,
    ACT_TRANSITION,
    ...
    ACT_RANGE_ATTACK1,
    ACT_RANGE_ATTACK2,
    ACT_RANGE_ATTACK1_LOW,  // FIXME: not used yet, crouched versions of the
                            // range attack
    ACT_RANGE_ATTACK2_LOW,  // FIXME: not used yet, crouched versions of the
                            // range attack
    ACT_DIESIMPLE,
    ACT_DIEBACKWARD,
    ACT_DIEFORWARD,
    ...
    ACT_CROUCH,  // FIXME: obsolete? only used be soldier (the act of crouching
                 // down from a standing position)
    ACT_CROUCHIDLE,  // FIXME: obsolete? only used be soldier (holding body in
                     // crouched position (loops))
    ACT_STAND,  // FIXME: obsolete? should be transition (the act of standing
    ...
    ACT_SMALL_FLINCH,  // FIXME: needed? shouldn't flinching be down with
                       // overlays?
    ACT_BIG_FLINCH,
    ACT_MELEE_ATTACK1,
    ACT_MELEE_ATTACK2,
    ...
    ACT_IDLE_ANGRY,   // FIXME: being used as an combat ready idle?  alternate
                     // idle animation in which the monster is clearly agitated.
                     // (loop)
    ...
    ACT_GESTURE_RANGE_ATTACK1_LOW,  // FIXME: not used yet, crouched versions of
                                    // the range attack
    ACT_GESTURE_RANGE_ATTACK2_LOW,  // FIXME: not used yet, crouched versions of
                                    // the range attack
    ...
    // Sometimes, you just want to set an NPC's sequence to a sequence that
    // doesn't actually have an activity. The AI will reset the NPC's sequence
    // to whatever its IDEAL activity is, though. So if you set ideal activity
    // to DO_NOT_DISTURB, the AI will not interfere with the NPC's current
    // sequence. (SJB)
    ACT_DO_NOT_DISTURB,
    ...
    ACT_VM_HAULBACK,     // bludgeon, haul the weapon back for a hard strike
                         // (secondary attk)
    ...
    ACT_PHYSCANNON_DETACH,  // An activity to be played if we're picking this up
                            // with the physcannon
    ACT_PHYSCANNON_ANIMATE,  // An activity to be played by an object being
                             // picked up with the physcannon, but has different
                             // behavior to DETACH
    ACT_PHYSCANNON_ANIMATE_PRE,   // An activity to be played by an object being
                                  // picked up with the physcannon, before
                                  // playing the ACT_PHYSCANNON_ANIMATE
    ACT_PHYSCANNON_ANIMATE_POST,  // An activity to be played by an object being
                                  // picked up with the physcannon, after
                                  // playing the ACT_PHYSCANNON_ANIMATE
    ...
    // Animation from prone idle to standing/crouch idle. Number designates
    // bullets left
    ACT_VM_UNDEPLOY,
    ACT_VM_UNDEPLOY_8,
    ACT_VM_UNDEPLOY_7,
    ...
    // Animation from standing/crouch idle to prone idle. Number designates
    // bullets left
    ACT_VM_DEPLOY,
    ACT_VM_DEPLOY_8,
    ACT_VM_DEPLOY_7,
    ...
    // Shooting animations for standing/crouch position.  Number designates
    // bullets left at START of animation
    ...
    // Shooting animations for prone position. Number designates bullets left at
    // START of animation
    ...
    // this is the end of the global activities, private per-monster activities
    // start here.
