...
#define RUMBLE_FLAG_STOP \
    0x0001  // Stop any instance of this type of effect that's already playing.
#define RUMBLE_FLAG_LOOP 0x0002  // Make this effect loop.
#define RUMBLE_FLAG_RESTART \
    0x0004  // If this effect is already playing, restart it.
#define RUMBLE_FLAG_UPDATE_SCALE \
    0x0008  // Apply DATA to this effect if already playing, but don't restart.
#define RUMBLE_FLAG_ONLYONE \
    0x0010  // Don't play this effect if it is already playing.
#define RUMBLE_FLAG_RANDOM_AMPLITUDE \
    0x0020  // Amplitude scale will be randomly chosen. Between 10% and 100%
#define RUMBLE_FLAG_INITIAL_SCALE \
    0x0040  // Data is the initial scale to start this effect ( * 100 )
