...
#ifdef VPROF_AI
inline void AI_TraceLine(const Vector &vecAbsStart, const Vector &vecAbsEnd,
...
inline void AI_TraceHull(const Vector &vecAbsStart, const Vector &vecAbsEnd,
                         const Vector &hullMin, const Vector &hullMax,
                         unsigned int mask, const IHandleEntity *ignore,
                         int collisionGroup, trace_t *ptr) {
    VPROF("AI_TraceHull");
    UTIL_TraceHull(vecAbsStart, vecAbsEnd, hullMin, hullMax, mask, ignore,
                   collisionGroup, ptr);
}
...
inline void AI_TraceHull(const Vector &vecAbsStart, const Vector &vecAbsEnd,
                         ...
                         trace_t *ptr) {
    VPROF("AI_TraceHull");
    UTIL_TraceHull(vecAbsStart, vecAbsEnd, hullMin, hullMax, mask, pFilter,
                   ptr);
}

inline void AI_TraceEntity(CBaseEntity *pEntity, const Vector &vecAbsStart,
