...
#define REGISTER_GAMERULES_CLASS(className)                      \
    ...
    static CGameRulesRegister __g_GameRulesRegister_##className( \
        #className, __CreateGameRules_##className);
#else
#define REGISTER_GAMERULES_CLASS(className)                                   \
    void MAKE_NAME_UNIQUE(__CreateGameRules_)##className() { new className; } \
    static CGameRulesRegister __g_GameRulesRegister_##className(              \
        #className, MAKE_NAME_UNIQUE(__CreateGameRules_)##className);
#endif
...
// The client forwards this call so the game rules manager can create the
// appropriate game rules class.
...
// Server calls this to install a specific game rules object. The class should
// have been registered with REGISTER_GAMERULES_CLASS.
