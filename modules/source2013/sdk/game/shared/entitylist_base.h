...
class CBaseEntityList {
   public:
    ...
    // client. The server gets to dictate what the networkable serial numbers
    // are on the client so it can send ehandles over and they work.
    ...
    // Overridables.
   protected:
    // These are notifications to the derived class. It can cache info here if
    // it wants.
