...
struct RenderMovieParams_t {
    ...
    int m_iPerformance;  // -1 for default view, otherwise this is an index into
                         // the replay's m_vecPerformances vector.
    ...
    struct ReplayRenderSettings_t {
        ...
        VideoFrameRate_t
            m_FPS;  // Actual framerate can be calculated with m_FPS.GetFps()
        ...
        bool m_bRaw;  // This movie was exported as raw TGA frames and a .WAV
                      // file?
    } m_Settings;
};
