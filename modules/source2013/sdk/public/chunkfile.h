...
//*szValue); 	virtual bool HandleError(const char *szChunkName, ChunkFileResult_t
//eError);
//};
...
class CChunkFile {
   public:
    ...
    ChunkFileResult_t WriteKeyValuePoint(const char *pszKey,
                                         const Vector &Point);
    ChunkFileResult_t WriteKeyValueVector2(const char *pszKey,
                                           const Vector2D &vec);
    ChunkFileResult_t WriteKeyValueVector3(const char *pszKey,
                                           const Vector &vec);
