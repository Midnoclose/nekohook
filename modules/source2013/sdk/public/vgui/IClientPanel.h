...
//			This interface cannot be changed without rebuilding all vgui
//projects 			Primarily this interface handles dispatching messages from core vgui
//to controls 			The additional functions are all their for debugging or
//optimization reasons 			To add to this later, use QueryInterface() to see if they
