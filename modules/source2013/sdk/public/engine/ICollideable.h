...
abstract_class ICollideable {
   public:
    ...
    // Returns the bounds of a world-space box used when the collideable is
    // being traced against as a trigger. It's only valid to call these methods
    // if the solid flags have the FSOLID_USE_TRIGGER_BOUNDS flag set.
    ...
    // Returns the BRUSH model index if this is a brush model. Otherwise,
    // returns -1.
