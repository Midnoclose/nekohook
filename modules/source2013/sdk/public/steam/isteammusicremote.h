...
class ISteamMusicRemote {
   public:
    ...
    virtual bool UpdateVolume(
        float flValue) = 0;  // volume is between 0.0 and 1.0
    ...
    virtual bool SetQueueEntry(int nID, int nPosition,
                               const char *pchEntryText) = 0;
...
DEFINE_CALLBACK(MusicPlayerRemoteWillActivate_t,
                k_iSteamMusicRemoteCallbacks + 1)
END_DEFINE_CALLBACK_0()

DEFINE_CALLBACK(MusicPlayerRemoteWillDeactivate_t,
...
DEFINE_CALLBACK(MusicPlayerWantsPlayPrevious_t,
...
DEFINE_CALLBACK(MusicPlayerWantsPlayingRepeatStatus_t,
