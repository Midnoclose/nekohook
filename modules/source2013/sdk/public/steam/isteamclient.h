...
//			Steam client.
//			For most uses, this code is wrapped inside of
//SteamAPI_Init()
//=============================================================================
...
extern "C" typedef void(__cdecl *SteamAPIWarningMessageHook_t)(int,
                                                               const char *);
extern "C" typedef void (*SteamAPI_PostAPIResultInProcess_t)(
    SteamAPICall_t callHandle, void *, uint32 unCallbackSize, int iCallbackNum);
...
//SteamAPI_Init(). 			You'll only need to use these interfaces if you have a more
//complex versioning scheme, 			where you want to get different versions of the
//same interface in different dll's in your project.
//-----------------------------------------------------------------------------
class ISteamClient {
   public:
