...
typedef VideoSoundDeviceOperation::EVideoSoundDeviceOperation_t
    VideoSoundDeviceOperation_t;
...
enum EVideoEncodeQuality_t { MIN_QUALITY = 0, MAX_QUALITY = 100 };
};
...
typedef VideoEncodeSourceFormat::EVideoEncodeSourceFormat_t
    VideoEncodeSourceFormat_t;
