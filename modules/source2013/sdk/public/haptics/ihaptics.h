...
abstract_class IHaptics {
   ...
   public:  // Game input handling
    ...
    // Should be called by the game input class after CalculateMove (when not in
    // menu)
   ...
   public:  // Effect methods
    ...
    virtual void ProcessHapticWeaponActivity(const char *weapon,
                                             int activity) = 0;
...
inline void IHaptics::ClearNavigationClass(void) { SetNavigationClass(0); }
