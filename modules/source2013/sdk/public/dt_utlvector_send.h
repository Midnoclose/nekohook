...
SendProp SendPropUtlVector(
    char *pVarName,  // Use SENDINFO_UTLVECTOR to generate these first 4
                     // parameters.
    ...
    SendTableProxyFn varProxy =
        SendProxy_DataTableToDataTable  // This can be overridden to control who
                                        // the array is sent to.
);
