...
class FileOpenDialog : public vgui::Frame {
   ...
   public:
    ...
    // opened a file with that same start dir context before, it will start in
    // the same directory it ended up in.
    void SetStartDirectoryContext(const char *pContext,
    ...
    /*
            messages sent:
                    "FileSelected"
                            ...
                            "filterinfo"	// Returns the filter info
       associated with the active filter "FileSelectionCancelled"
    */
