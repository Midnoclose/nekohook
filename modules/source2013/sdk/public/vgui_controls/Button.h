...
class Button : public Label {
   ...
   public:
    ...
    // Set this button to be the button that is accessed by default when the
    // user hits ENTER or SPACE
    MESSAGE_FUNC_INT(SetAsDefaultButton, "SetAsDefaultButton", state);
    // Set this button to be the button that is currently accessed by default
   ...
   protected:
    ...
    unsigned short m_sArmedSoundName, m_sDepressedSoundName,
        m_sReleasedSoundName;
