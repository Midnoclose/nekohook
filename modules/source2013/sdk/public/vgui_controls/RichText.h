...
class RichText : public Panel {
   ...
   public:
    ...
    void GetText(int offset, OUT_Z_BYTECAP(bufLenInBytes) wchar_t *buf,
                 int bufLenInBytes);
    void GetText(int offset, OUT_Z_BYTECAP(bufLenInBytes) char *pch,
                 int bufLenInBytes);
   ...
   private:
    ...
    const wchar_t *ResolveLocalizedTextAndVariables(
        char const *pchLookup, OUT_Z_BYTECAP(outbufsizeinbytes) wchar_t *outbuf,
    ...
    TRenderState m_CachedRenderState;  // cached render state for the beginning
                                       // of painting
