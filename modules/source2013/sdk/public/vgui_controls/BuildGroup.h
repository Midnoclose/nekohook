...
// contextPanel)
//			Members of this group are viewable and editable in Build
//Mode, via the BuildModeDialog wizard
//-----------------------------------------------------------------------------
class BuildGroup {
   ...
   public:
    ...
    // use when the dialog may have multiple states and the editor will need to
   ...
   protected:
    ...
    virtual bool KeyCodeTyped(ButtonCode_t code, Panel *panel);
    virtual bool KeyCodeReleased(ButtonCode_t code, Panel *panel);
   ...
   private:
    ...
    Panel *m_pBuildContext;  // the panel from which the build dialog gets all
