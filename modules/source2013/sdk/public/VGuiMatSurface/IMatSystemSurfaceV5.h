...
class IMatSystemSurface : public SurfaceV30::ISurface {
   public:
    ...
    // If you specified true for bLetAppDriveInput, then call this for each
    // window message that comes in.
    ...
    virtual int DrawColoredText(vgui::HFont font, int x, int y, int r, int g,
                                int b, int a, PRINTF_FORMAT_STRING char *fmt,
                                ...) = 0;
    ...
    virtual int DrawTextLen(vgui::HFont font, PRINTF_FORMAT_STRING char *fmt,
                            ...) = 0;
