...
//#define VPROJECT_REG_KEY	"SYSTEM\\CurrentControlSet\\Control\\Session
//Manager\\Environment"
// Moved to simply 'Environment' - we need to set in HKEY_CURRENT_USER and not
// local machine, to avoid security issues in vista!
...
bool RemoveObsoleteVConfigRegistrySetting(const char *pValueName,
                                          char *pOldValue = NULL, int size = 0);
#endif
